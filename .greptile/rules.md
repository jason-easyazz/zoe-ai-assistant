...
Use `graphify-out/GRAPH_REPORT.md` as map context, but do not ask contributors to run `graphify update .` or install Graphify hooks; this repo uses the safe full extract command documented in `.cursor/rules/graphify.mdc`.
