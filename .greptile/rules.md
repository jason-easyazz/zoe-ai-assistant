...
- `docs/archive/` was removed (retire by removing — git keeps history). Flag any PR that re-introduces a `docs/archive/` graveyard or instructs moving files there instead of deleting.
