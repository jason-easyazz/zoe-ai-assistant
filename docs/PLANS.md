...
## ✅ Done
- **Config/deploy health hardening (2026-06-28):** made `/health` a real readiness gate for Gemma 4 E4B, Moonshine, and Kokoro while preserving existing top-level liveness fields; removed faster-whisper/whisper warm-resurrection paths; tightened zoe-data startup ordering, auth DB health dependency, and nginx API upload size.
