...
6. **Give Codex an MCP config.** Add `~/.codex/config.toml` (host + container) registering the
   two code-intel servers so Codex gets more than AGENTS.md prose.
