...
1. **STT — Moonshine v2 Medium.** Runs **in-process inside `zoe-data` on CPU** (onnxruntime GPU
   ...
   `ZOE_MOONSHINE_KEYTERMS`, default off) is B1.10 — call sites are unchanged, the model bundle
   moves; runbook + replay A/B recipe in [moonshine-0-1-5-upgrade.md](moonshine-0-1-5-upgrade.md).
