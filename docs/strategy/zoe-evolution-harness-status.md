...
- Graphify was last successfully refreshed through source commit `e734c0da`.
  A refresh attempt after `ca5f1d9` scanned 592 code files and 257 docs but
...
2. Fresh Graphify and architecture inventory.
   ...
   - Latest blocked attempt after `ca5f1d9` scanned 592 code files and 257 docs; all 7 semantic chunks failed, and the partial graph output was discarded.
