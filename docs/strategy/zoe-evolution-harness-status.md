...
- Graphify was last successfully refreshed through source commit `75f5345d`.
  ...
  invalid JSON chunks; no partial graph output was committed. The local backend
  is promising but not yet accepted for full Graphify refreshes.
