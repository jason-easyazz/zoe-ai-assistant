...
2. Fresh Graphify and architecture inventory.
   ...
   - Use the E4B full-repo rejection evidence to design a sharded local/offline Graphify refresh lane with bounded chunking, JSON repair/validation, and partial-output discard before treating Graphify as current for major cleanup.
