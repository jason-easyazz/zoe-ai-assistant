...
- Graphify was last successfully refreshed through source commit `75f5345d`.
  A refresh attempt after `ad76aef` scanned 592 code files and 257 docs but
...
2. Fresh Graphify and architecture inventory.
   ...
   - Latest blocked attempt after `ad76aef` scanned 592 code files and 257 docs; all 7 semantic chunks failed, and the partial graph output was discarded.
