...
2. Fresh Graphify and architecture inventory.
   ...
   - Use the accepted current default shard evidence (`2032b40`: `data-core` and `operators`, no invalid JSON/truncation/context splits) to design a sharded local/offline Graphify merge/sync lane before treating Graphify as current for major cleanup.
