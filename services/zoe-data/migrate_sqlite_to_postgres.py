...
Run ONCE after service is stopped (to avoid writes during migration):
    ...
    POSTGRES_URL=postgresql://zoe:zoe-db-2026-prod@localhost:5432/zoe \
...
POSTGRES_URL = os.environ.get("POSTGRES_URL", "postgresql://zoe:zoe-db-2026-prod@localhost:5432/zoe")
