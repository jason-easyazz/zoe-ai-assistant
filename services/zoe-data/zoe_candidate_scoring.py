...
EXAMPLE_CANDIDATES: tuple[CandidateEvaluation, ...] = (
    ...
    CandidateEvaluation(
        ...
        source="pi",
        task="external capability discovery, packages, and delegated agent workflows",
        score=CandidateScore(fit=5, activity=5, license=5, offline=2, security=3, footprint=1, tests=2, maintainability=3, overlap=4),
        ...
        stars=59100,
        last_activity="v0.78.0 released 2026-05-29; pi.dev docs crawled 2026-06",
        runtime_notes="Promising external runtime, but Zoe host currently lacks node, npm, and pi; execution must stay disabled until local model/runtime prerequisites pass.",
        overlaps_existing=("pi_external_runtime",),
        recommendation="needs_review",
        metadata={
            "install_package": "@earendil-works/pi-coding-agent",
            "repo": "earendil-works/pi",
            "integration_modes": ("cli_rpc", "sdk", "project_agents"),
        },
    ),
)
