...
DEFAULT_CAPABILITY_PROFILES: tuple[CapabilityProfile, ...] = (
    ...
    CapabilityProfile(
        ...
        tests=("services/zoe-data/tests/test_hindsight_bakeoff.py", "services/zoe-data/tests/test_hindsight_memory.py"),
        last_verified_at="2026-06-09",
    ...
    CapabilityProfile(
        ...
        tests=("services/zoe-data/tests/test_graphiti_bakeoff.py",),
        last_verified_at="2026-06-09",
    ...
    CapabilityProfile(
        ...
        owner_surface="pi",
        task_types=("capability_discovery", "external_agent_runtime", "tooling_reuse"),
        trust_level="experimental",
        approval_required=("install_or_runtime_change", "license_review", "security_review"),
        offline_mode="unknown",
        evidence_refs=("docs/strategy/zoe-evolution-harness-plan.md",),
        tests=("candidate scoring required before adoption",),
        known_failures=("No Zoe Pi runtime integration has been measured yet.",),
        rollback="Do not install or execute Pi packages without a scored proposal.",
    ),
    CapabilityProfile(
