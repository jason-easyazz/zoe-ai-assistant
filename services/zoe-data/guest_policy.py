...
FEATURE_ACTIONS: dict[str, tuple[str, ...]] = {
    ...
    "notifications": ("read", "create", "mark_read", "interact", "delete"),
    "notes": ("read", "create", "update", "delete"),
    "people": ("read", "create", "update", "delete", "manage_fields"),
    "journal": ("read", "create", "update", "delete"),
    "proactive": ("create", "read", "delete", "trigger", "accept", "dismiss"),
    "push": ("read", "subscribe", "unsubscribe"),
...
def default_capability_matrix() -> dict[str, dict[str, Any]]:
    ...
    guest_matrix = {
        ...
        "features": {
            ...
            "notifications": {
                "read": False, "create": False, "mark_read": False, "interact": False, "delete": False,
            },
            ...
            "proactive": {
                "create": False, "read": False, "delete": False, "trigger": False, "accept": False, "dismiss": False,
            },
            "push": {"read": False, "subscribe": False, "unsubscribe": False},
