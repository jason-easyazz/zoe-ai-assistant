...
def init_lists_db():
    ...
    # Migrate old "tasks" to "personal_todos" for backward compatibility
    cursor.execute("""
        UPDATE lists 
        SET list_type = 'personal_todos' 
        WHERE list_type = 'tasks' AND list_category = 'personal'
    """)
    
    cursor.execute("""
        UPDATE lists 
        SET list_type = 'work_todos' 
        WHERE list_type = 'tasks' AND list_category = 'work'
    """)
