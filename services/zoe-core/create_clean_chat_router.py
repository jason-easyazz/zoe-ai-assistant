#!/usr/bin/env python3
"""
Create Clean Chat Router
========================

Create a clean chat router that properly integrates with enhancement systems
and provides full conversational AI responses.
"""
    ...
    try:
        ...
        if is_complex:
            ...
            try:
                ...
                enhanced_prompt = f'''You are Zoe, an advanced AI assistant with several enhancement systems:
...
The user ({user_id}) is asking: "{msg.message}"
...
# Write the clean chat router
with open('/app/routers/chat_clean.py', 'w') as f:
    f.write(chat_router_code)

print("✅ Created clean chat router: /app/routers/chat_clean.py")
print("📝 This router properly integrates all enhancement systems")
print("🎯 Next step: Replace the messy chat.py with this clean version")
