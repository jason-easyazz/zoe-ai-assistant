...
const SW_VERSION = '4.78.0'; // multi-zone speaker picker (2-col rows, tap zones to group live) + per-zone volume sliders when grouped; picker redesigned from the cramped 4-up grid
