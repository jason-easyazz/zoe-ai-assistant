...
const SW_VERSION = '4.63.41'; // estate: music overlay layout — control in dock (prev/pp/next), smaller playlist grid, recent tile grid, queue = now-playing + numbered up-next columns
