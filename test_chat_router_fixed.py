#!/usr/bin/env python3
"""
Fixed Chat Router Test
======================

Test the reliable chat router with proper async handling.
"""
...
async def test_chat_router_async():
    """Test the chat router with proper async handling"""
    print("🧪 TESTING CHAT ROUTER (ASYNC)")
    print("=" * 50)
    ...
    try:
        ...
        for i, scenario in enumerate(test_scenarios, 1):
            ...
            try:
                ...
                # Test the reliable chat function with await
                response = await reliable_chat(chat_msg, "test_user")
        ...
        # Save results
        with open("chat_router_async_test_results.json", "w") as f:
            json.dump(results, f, indent=2)
        
        print(f"\n💾 Results saved to: chat_router_async_test_results.json")
...
def main():
    ...
    return asyncio.run(test_chat_router_async())
