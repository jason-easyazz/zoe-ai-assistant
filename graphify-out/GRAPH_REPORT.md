...
## Summary
- 7825 nodes · 13522 edges · 576 communities (349 shown, 227 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1756 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31eb890d`
...
- `Zoe Module System README` --references--> `ModuleWidgetLoader`  [EXTRACTED]
  README_MODULE_SYSTEM.md → services/zoe-ui/dist/js/lib/module-widget-loader.js
- `Zoe Module System README` --references--> `WidgetRegistry`  [EXTRACTED]
  README_MODULE_SYSTEM.md → services/zoe-ui/dist/js/lib/widget-registry.js

## Communities (576 total, 227 thin omitted)
...
Cohesion: 0.04
Nodes (99): All runtime agent paths should persist through shared MemPalace pipeline., test_memory_capture_paths_pi_hermes_openclaw(), Override to customise the prompt per-check., Local voice session WebSocket for voice.html.      Accepts text and binary (audi, websocket_voice(), _background_memory_save(), _bash(), _build_memory_context() (+91 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (75): Start discovering AirPlay devices, Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Get device info from database., AirPlayOutput (+67 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (70): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Validate database structure, Enum, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents. (+62 more)
...
Cohesion: 0.03
Nodes (72): a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, agent_card(), board_cancel(), board_review(), _build_agent_card(), build_engineering_guard_packet() (+64 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (61): _build_hermes_payload(), _build_panel_intent_card(), chat_stream_generator(), _chatgpt_connect_flow(), _check_frustration(), _create_pending_approval(), _detect_preview_urls(), _ensure_user_and_chat_session() (+53 more)
...
Cohesion: 0.03
Nodes (60): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), Critical Files - Do Not Delete, AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn() (+52 more)
...
Cohesion: 0.06
Nodes (37): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+29 more)
...
Cohesion: 0.06
Nodes (43): Get a specific provider by type.                  Args:             provider_typ, _get(), _FakeCollection, fresh_collection(), _install_mempalace_stubs(), _match_where(), Comprehensive MemPalace integration tests.  Tests: user isolation, upsert behavi, Install mempalace module stubs so zoe_agent doesn't require the real package. (+35 more)
...
Cohesion: 0.06
Nodes (40): get_current_user(), get_passcode_status(), guest_login(), InitialPasswordSetupRequest, LoginRequest, logout(), logout_all(), Authentication API Endpoints RESTful API for authentication, session management, (+32 more)
...
Cohesion: 0.07
Nodes (28): Create a person, run process_text → verify DB activity row AND MemPalace entry., recalc_and_save updates health_score in DB., Minimal compatibility wrapper so person_extractor works with raw asyncpg., test_health_score_recalc(), test_person_extractor_dual_fanout(), get_db(), FakeCursor, db_compat.py — asyncpg compatibility shim providing an aiosqlite-style cursor AP (+20 more)

### Community 44 - "Community 44"
Cohesion: 0.1
Nodes (37): Attach Hermes log evidence when a silent exit was really a budget stop., _with_recovered_log_budget(), _budget_phase(), implement_code_audit_post_patch_drift_reason_from_log(), implement_code_audit_post_validation_ship_reason_from_log(), implement_edit_safety_reason_from_log(), implement_pre_edit_drift_reason_from_log(), _is_code_audit_body() (+29 more)
...
Cohesion: 0.09
Nodes (33): board_approve(), create_engineering_workflow_task(), evolution_proposal_action(), get_agent_board(), list_engineering_workflow_tasks(), Return Multica engineering ticket state for AG-UI display.      Falls back grace, Create a Hermes-assigned Multica issue and dispatch it via the executor seam., Act on an evolution proposal: approve|reject|defer.      On approve: creates a M (+25 more)
...
Cohesion: 0.14
Nodes (28): test_create_issue_metadata_preserves_existing_ticket_fields(), test_update_ticket_progress_can_clear_dispatch_approval(), test_block_only_description_does_not_gain_leading_blank_lines(), test_progress_and_children_patch_metadata_only(), test_replacing_middle_block_preserves_suffix_newline(), test_ticket_block_preserves_human_description(), test_ticket_block_replaces_only_zoe_section(), _blocker_followup_marker() (+20 more)
...
Cohesion: 0.1
Nodes (23): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, Exception, _append_audit(), _MissingUserId, Raised when strict mode rejects a tool call with no identity., _build_metadata(), _idempotency_key() (+15 more)
...
Cohesion: 0.09
Nodes (22): migrate_self_entries(), Create self entries for users in the people table, _compute_compatibility(), Compute compatibility score and shared traits between two check-ins., Get all registered providers., test_graphiti_episode_payloads_include_evidence(), test_graphiti_supersession_payloads_have_temporal_order(), test_score_graphiti_answer_reports_missing_terms() (+14 more)
...
Cohesion: 0.13
Nodes (10): Return Atomic semantic hits as normalized records., MemoryRef, MemoryService - the sole read/write surface for Zoe memory.  This module is the, The sole read/write surface for Zoe memory., List rows for a user by status, newest first., Opaque reference returned by MemoryService., Best-effort metadata update - never raises., Public method: bump access_count + last_accessed for the given memory IDs. (+2 more)
...
Cohesion: 0.14
Nodes (24): _event(), test_event_to_hindsight_item_keeps_evidence_and_scope_tags(), test_event_to_hindsight_item_serializes_structured_context_as_json(), _admission_trace(), _plain_event(), test_build_hindsight_retain_admission_request_defaults_to_hindsight_target(), test_build_hindsight_retain_admission_request_keeps_caller_metadata_nested(), test_build_hindsight_retain_admission_request_rejects_invalid_backend() (+16 more)
...
Cohesion: 0.08
Nodes (15): Test that database schema is created correctly, Test embedding generation, Test cosine similarity calculation, Test adding memory with automatic embedding generation, Test entity context generation, Test relationship path generation, Test relationship boost calculation, Test search result caching (+7 more)
...
Cohesion: 0.13
Nodes (20): _extract_memory_candidates(), _persist_memory_candidates(), Back-compat shim: legacy dict shape over the unified extractor.      Kept so in-, Single post-turn memory hook.      Runs two passes in parallel:     1. Regex ext, test_extracts_preference_signal(), test_no_signal_returns_empty(), LLM fact extraction on a single conversation exchange.      Runs in the backgrou, run_turn_digest() (+12 more)
...
Cohesion: 0.11
Nodes (20): AuthResponse, login(), login_passcode(), PasswordChangeRequest, Authenticate with username and password          Args:         request: Login cr, Authenticate with username (or user_id) and passcode.      Accepts either ``user, Register new user (admin only)          Args:         request: User registration, Password change request model (+12 more)
...
Cohesion: 0.11
Nodes (19): test_block_reason_from_handoff_extracts_iteration_budget_from_run_error(), test_block_reason_from_handoff_ignores_dynamic_log_tail(), test_block_reason_from_handoff_prefers_blocker_field(), test_block_reason_ignores_dynamic_log_tail_without_stable_token(), test_infer_outcome_blocked_verify_loops(), test_infer_outcome_closeout_budget_surfaces_block(), test_infer_outcome_done_ignores_freeform_stable_blocker_text(), test_infer_outcome_done_with_verify_budget_surfaces_block() (+11 more)
...
Cohesion: 0.16
Nodes (16): Invalidate a specific session (user can only invalidate their own sessions), quick_user_switch(), Quick user switching for touch panels          Args:         request: Quick swit, Invalidate specific session, validateSession(), QuickAuthManager, QuickAuthResult, Quick user switching for touch panels                  Args:             current (+8 more)
...
Cohesion: 0.11
Nodes (6): Unit tests for the Zoe Agent skills classifier and tool builder.  Tests _select_, _llm_call must accept tool_choice kwarg defaulting to 'auto'., Verify a selection of the weather cue strings would match typical messages., TestBuildPrompt, TestChatCapabilityShortcutExists, TestLlmCallSignature
...
Cohesion: 0.12
Nodes (5): MockMCPServer, Test getting developer tasks, Test calendar event creation, Run a single conversation test, Try to resolve an ambiguous utterance relative to the last intent.         Retur
...
Cohesion: 0.12
Nodes (12): Test Home Assistant integration, Intent System Development Rules, classifier(), Intent Classification Tests ===========================  Tests for HassIL-based, Test turn off patterns., Test queries that should NOT match any intent., Complex queries should return None (fall back to LLM)., Initialize classifier with test intents. (+4 more)
...
Cohesion: 0.23
Nodes (11): _compact_context(), _embeddings_base_url_from_env(), _env_bool(), event_to_hindsight_item(), from_env(), HindsightOfflineConfigError, _is_local_or_private_url(), Hindsight sidecar adapter for Zoe's memory bake-off.  The adapter is disabled by (+3 more)
...
Cohesion: 0.29
Nodes (6): Deleting a CRM entity should archive all scoped MemPalace facts for it., Facts should be returned most-recent-first., migrate_mempalace_legacy_records must retag wing='zoe' → wing='family-admin'., test_archive_by_entity_archives_user_and_wing_rows(), test_migration_retags_legacy_records(), test_recency_ordering()
...
## Knowledge Gaps
- **2887 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2882 more)
...
- **Why does `main()` connect `Community 1` to `Community 2`, `Community 258`, `Community 131`, `Community 5`, `Community 259`, `Community 266`, `Community 139`, `Community 140`, `Community 269`, `Community 142`, `Community 17`, `Community 146`, `Community 19`, `Community 20`, `Community 145`, `Community 23`, `Community 28`, `Community 157`, `Community 30`, `Community 286`, `Community 160`, `Community 167`, `Community 168`, `Community 296`, `Community 41`, `Community 43`, `Community 173`, `Community 51`, `Community 54`, `Community 55`, `Community 185`, `Community 314`, `Community 188`, `Community 319`, `Community 64`, `Community 194`, `Community 197`, `Community 69`, `Community 71`, `Community 78`, `Community 207`, `Community 80`, `Community 81`, `Community 206`, `Community 79`, `Community 84`, `Community 85`, `Community 215`, `Community 87`, `Community 217`, `Community 90`, `Community 216`, `Community 96`, `Community 98`, `Community 235`, `Community 109`, `Community 112`, `Community 115`, `Community 117`, `Community 120`, `Community 121`, `Community 126`?**
  _High betweenness centrality (0.189) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 79` to `Community 1`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 140`, `Community 142`, `Community 15`, `Community 145`, `Community 146`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 30`, `Community 31`, `Community 39`, `Community 298`, `Community 44`, `Community 45`, `Community 52`, `Community 54`, `Community 55`, `Community 314`, `Community 60`, `Community 189`, `Community 192`, `Community 67`, `Community 196`, `Community 197`, `Community 70`, `Community 199`, `Community 76`, `Community 77`, `Community 206`, `Community 80`, `Community 90`, `Community 95`, `Community 223`, `Community 99`, `Community 122`, `Community 230`, `Community 104`, `Community 237`, `Community 239`, `Community 241`, `Community 246`, `Community 121`, `Community 250`, `Community 255`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `get_memory_service()` connect `Community 117` to `Community 1`, `Community 3`, `Community 261`, `Community 142`, `Community 16`, `Community 273`, `Community 21`, `Community 22`, `Community 24`, `Community 177`, `Community 178`, `Community 307`, `Community 324`, `Community 338`, `Community 210`, `Community 95`, `Community 99`, `Community 101`, `Community 236`, `Community 248`, `Community 124`, `Community 125`?**
