...
## Summary
- 8163 nodes · 14451 edges · 573 communities (344 shown, 229 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2025 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `19cec446`
...
## Communities (573 total, 229 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (63): _broadcast_weather_ui(), Mirror chat weather navigation on voice path with durable delivery., _should_supersede_voice_weather_action(), _FakeAdapter, Tests for the Hermes Kanban executor adapter (CLI mocked)., A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., KanbanAdapter with the CLI replaced by a scripted recorder., _row() (+55 more)
...
Cohesion: 0.04
Nodes (94): Override to customise the prompt per-check., Local voice session WebSocket for voice.html.      Accepts text and binary (audi, websocket_voice(), _bash(), _build_memory_context(), _build_prompt(), _build_tools(), _build_voice_tools() (+86 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (76): _issue_sort_key(), Return (sequence_key, phase_number) when title encodes a phased track., True when every lower phase in the same sequence is ``done`` (or missing)., Pick up to ``count`` backlog issues respecting phased ordering.      ``all_issue, select_batch(), _event(), _plain_event(), test_admitted_hindsight_retain_plan_defaults_to_env_config() (+68 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (71): Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100)., Get device info from database. (+63 more)
...
Cohesion: 0.03
Nodes (73): a2a_task(), a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_cancel(), board_review(), build_engineering_guard_packet(), delegate_to_agent() (+65 more)
...
Cohesion: 0.05
Nodes (46): Context Optimizer, Expert Orchestrator Setup, Enhanced MEM Agent Client, GPU Model Setup Configuration, RAG Enhancements, Temporal Memory Integration, Vector Search, LLM Capabilities Awareness Audit (+38 more)
...
Cohesion: 0.07
Nodes (49): Validate database structure, Run all validations.                  Returns:             True if all validatio, Convert to dictionary for API responses., test_capability_profile_index_rejects_duplicate_ids(), test_capability_profile_rejects_unknown_owner_surface(), test_default_capability_profiles_validate_and_cover_core_surfaces(), test_metadata_is_read_only(), test_profiles_requiring_approval_includes_install_memory_and_graph_surfaces() (+41 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (57): AuthResponse, get_current_user(), get_passcode_status(), get_user_profile(), guest_login(), InitialPasswordSetupRequest, login(), login_passcode() (+49 more)
...
Cohesion: 0.08
Nodes (45): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, OutputState, OutputType, Types of output targets., Playback state of an output. (+37 more)
...
Cohesion: 0.07
Nodes (28): AgentZeroClient, _compute_agent_zero_api_key(), Agent Zero Client =================  Client for communicating with Agent Zero's, Get or create context ID for a user.                  Args:             user_id:, Extract URLs from text as sources.                  Args:             text: Text, Send a message to Agent Zero and get response.                  Uses the /api_me, Execute a research task via Agent Zero.                  Args:             query, Compute the API key that Agent Zero expects, using the same algorithm     as its (+20 more)
...
Cohesion: 0.09
Nodes (28): Normalize a YouTube Music item to standard format., Make a request to the Home Assistant API., AppleMusicProvider, Get user's Music User Token from database., Make authenticated API request., Convert Apple Music track data to Track., Search for tracks on Apple Music., Search for albums on Apple Music. (+20 more)
...
Cohesion: 0.1
Nodes (23): FileSystemEventHandler, get_peer_agent_card(), Return a live A2A v1.0 proxy card for a peer agent with dynamic skills[]., Admin-only: force-flush the skill discovery cache for a peer agent., reload_peer_skills(), invalidate_hermes_cache(), invalidate_openclaw_cache(), _parse_hermes_category() (+15 more)
...
Cohesion: 0.12
Nodes (17): generate(), Orbit icebreaker engine — rule cascade, strongest signal wins., Generate the best icebreaker line for a match pair., Zoe Modular Architecture Complete, get_enabled_modules(), MCP Client, ModuleWidgetLoader, WidgetRegistry (+9 more)
...
Cohesion: 0.11
Nodes (19): Register a Tier 2 slow-loop trigger., register_trigger(), hermes_api_key(), hermes_auth_headers(), hermes_bin(), Shared Hermes helpers (gateway auth, CLI paths, repo root)., Locate the hermes CLI; honour HERMES_BIN override., lifespan() (+11 more)
...
Cohesion: 0.11
Nodes (19): clear_all_device_caches(), clear_device_cache(), get_device_config(), list_touch_panel_devices(), Touch Panel API Endpoints Optimized endpoints for touch panel quick authenticati, Validate touch panel session (with offline support)          Args:         reque, Logout from touch panel session          Args:         session_id: Session ID to, Clear cache for touch panel device          Args:         device_id: Touch panel (+11 more)
...
Cohesion: 0.27
Nodes (10): Zoe AI Assistant Changelog, Database Protection Rules, Zoe Docker Compose Base, Jetson Docker Compose Override, Supplemental Docker Compose Modules, Raspberry Pi Docker Compose Override, Hardware Compatibility Guide, Zoe Project Structure & Governance Rules (+2 more)
...
Cohesion: 0.36
Nodes (6): _NoticeDb, test_load_target_patterns_extracts_contract_metadata(), test_record_frustration_signal_stores_contract_snapshot(), test_record_user_issue_stores_contract_snapshot(), test_run_evolution_notice_stores_contract_snapshots(), _WriterDb
...
Cohesion: 0.36
Nodes (7): _approval_refs(), build_multica_memory_admission_request(), Bridge Multica review records into Zoe memory admission decisions.  This module, Build an admission request from a Multica issue/review record.      Explicit `me, _review_identifier(), _safe_id(), _target_backends()
...
Cohesion: 0.33
Nodes (6): Database List Items Table, Database Lists Table, Default Lists (IDs 1-4), GET /api/lists/{list_type} Endpoint, Lists Router Code, User Isolation Fix in lists.html
...
Cohesion: 0.4
Nodes (5): Desktop Dashboard Fixes, Touch Dashboard Drag & Drop Fix, Touch Dashboard Floating Edit Mode (FAB), Touch Dashboard Navigation Bar Upgrade, Touch Dashboard Widget Persistence Fix
...
Cohesion: 0.5
Nodes (4): AG-UI Chat Protocol for Zoe, Chat Page Frontend (chat.html), Chat Backend (chat.py), User Isolation Fix in chat.html

### Community 334 - "Community 334"
Cohesion: 0.5
Nodes (4): Global Exception Handler Middleware, Standard Error Response Model, Custom Exception Classes, Exception Handler Registration in Main
...
Cohesion: 0.67
Nodes (3): PWA Phase 1 Manifest, PWA Phase 1 Service Worker, PWA Phase 1 Service Worker Registration

### Community 353 - "Community 353"
Cohesion: 0.67
Nodes (3): Action Plan Progress Docker Compose, zoe-auth simple_main.py, zoe-auth Dockerfile

## Ambiguous Edges - Review These
- `client.py` → `Agent Zero Implementation Checklist`  [AMBIGUOUS]
  modules/agent-zero/IMPLEMENTATION_CHECKLIST.md · relation: AMBIGUOUS

## Knowledge Gaps
- **2943 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2938 more)
...
- **What is the exact relationship between `client.py` and `Agent Zero Implementation Checklist`?**
  _Edge tagged AMBIGUOUS (relation: AMBIGUOUS) - confidence is low._
- **Why does `main()` connect `Community 1` to `Community 128`, `Community 129`, `Community 2`, `Community 3`, `Community 5`, `Community 134`, `Community 262`, `Community 136`, `Community 137`, `Community 16`, `Community 19`, `Community 276`, `Community 20`, `Community 150`, `Community 151`, `Community 152`, `Community 153`, `Community 26`, `Community 283`, `Community 28`, `Community 156`, `Community 31`, `Community 287`, `Community 33`, `Community 34`, `Community 292`, `Community 165`, `Community 173`, `Community 178`, `Community 180`, `Community 59`, `Community 187`, `Community 61`, `Community 190`, `Community 63`, `Community 317`, `Community 188`, `Community 60`, `Community 199`, `Community 200`, `Community 73`, `Community 74`, `Community 203`, `Community 76`, `Community 207`, `Community 85`, `Community 86`, `Community 215`, `Community 87`, `Community 214`, `Community 222`, `Community 95`, `Community 223`, `Community 225`, `Community 96`, `Community 97`, `Community 100`, `Community 224`, `Community 232`, `Community 105`, `Community 111`, `Community 117`, `Community 246`, `Community 248`, `Community 249`, `Community 123`?**
  _High betweenness centrality (0.182) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 97` to `Community 1`, `Community 129`, `Community 130`, `Community 4`, `Community 5`, `Community 6`, `Community 261`, `Community 136`, `Community 8`, `Community 10`, `Community 137`, `Community 15`, `Community 16`, `Community 19`, `Community 20`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 153`, `Community 156`, `Community 157`, `Community 35`, `Community 169`, `Community 45`, `Community 46`, `Community 50`, `Community 51`, `Community 182`, `Community 56`, `Community 57`, `Community 60`, `Community 61`, `Community 68`, `Community 69`, `Community 202`, `Community 206`, `Community 79`, `Community 82`, `Community 85`, `Community 214`, `Community 88`, `Community 216`, `Community 94`, `Community 100`, `Community 229`, `Community 111`, `Community 239`, `Community 247`, `Community 120`, `Community 250`, `Community 124`, `Community 126`, `Community 255`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 2` to `Community 1`, `Community 3`, `Community 6`, `Community 7`, `Community 200`, `Community 41`, `Community 106`, `Community 75`, `Community 139`, `Community 243`, `Community 247`?**
