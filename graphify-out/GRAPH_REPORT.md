...
## Summary
- 7870 nodes · 13653 edges · 584 communities (355 shown, 229 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1782 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b24e665a`
...
## Communities (584 total, 229 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (55): _FakeAdapter, Tests for the Hermes Kanban executor adapter (CLI mocked)., A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., KanbanAdapter with the CLI replaced by a scripted recorder., _row(), test_dispatch_blocks_existing_pr_revision_when_precheckout_fails(), test_dispatch_blocks_on_first_worker_failure(), test_dispatch_blocks_regular_worktree_failures_with_generic_reason() (+47 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (72): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail(), _is_allowed_line() (+64 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (87): Override to customise the prompt per-check., _bash(), _build_memory_context(), _build_prompt(), _build_tools(), _build_voice_tools(), _cap_tool_result(), _chat_capability_shortcut() (+79 more)
...
Cohesion: 0.03
Nodes (72): MULClient, a2a_task(), a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_approve(), board_cancel(), board_review() (+64 more)
...
Cohesion: 0.04
Nodes (57): _build_hermes_payload(), _build_panel_intent_card(), chat_stream_generator(), _chatgpt_connect_flow(), _check_frustration(), _create_pending_approval(), _hermes_completion(), _hermes_progress_events() (+49 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (59): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), Critical Files - Do Not Delete, AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn() (+51 more)
...
Cohesion: 0.05
Nodes (41): check_permission(), Check if current user has specific permission          Args:         permission:, Helper class for complex permission checking, Check if session has specific permission, Check if session has any of the listed permissions, Check if can access another user's resource, AccessContext, PermissionCheck (+33 more)
...
Cohesion: 0.08
Nodes (36): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, Get a specific provider by type.                  Args:             provider_typ, _get(), _append_audit(), Return Atomic semantic hits as normalized records., _build_metadata(), _idempotency_key() (+28 more)
...
Cohesion: 0.04
Nodes (42): Initialize Agent Zero client.                  Args:             base_url: Base, Initialize safety guardrails.                  Args:             mode: Safety mo, Initialize the affinity engine.                  Args:             half_life_day, AirPlayDevice, AirPlayService, AirPlay Integration Service Discovers and controls AirPlay devices for music pla, Start discovering AirPlay devices, Connect to an AirPlay device (+34 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (56): AuthResponse, get_current_user(), get_passcode_status(), guest_login(), InitialPasswordSetupRequest, login(), login_passcode(), LoginRequest (+48 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (48): Seek to position in current track., Set playback volume (0-100)., Send message to device via WebSocket., Broadcast to all user's devices., Mark a device as disconnected, Pause playback in a zone, Resume playback in a zone, Seek to position in a zone (+40 more)
...
Cohesion: 0.08
Nodes (41): _audit_no_pr_issue(), _chain_for_issue(), _code_audit_implement_hint(), _engineering_mode(), _escalation_model_hint(), _existing_pr_url(), _goal_mode_args(), _greptile_mcp_bin() (+33 more)
...
Cohesion: 0.07
Nodes (42): Get user information (without sensitive data), hash_secret(), OIDC client registration and secret verification., Exact match only — no wildcards., Insert or update a client. Safe to call on every startup., upsert_client(), validate_redirect_uri(), verify_secret() (+34 more)
...
Cohesion: 0.1
Nodes (39): Convert to dictionary for API responses., test_collect_observation_traces_accepts_valid_non_persistent_batch(), test_collect_observation_traces_can_require_single_scope_batch(), test_collect_observation_traces_discards_entire_batch_on_rejection(), test_collect_observation_traces_rejects_disallowed_surface(), test_collect_observation_traces_rejects_empty_batch(), test_collect_observation_traces_rejects_invalid_trace_shape(), test_collect_observation_traces_rejects_mixed_user_batch() (+31 more)
...
Cohesion: 0.11
Nodes (36): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Zoe Evolution Harness Implementation Status, Enum, str, HindsightEvalQuery, EvolutionProposal (+28 more)
...
Cohesion: 0.09
Nodes (29): list_projects(), close_stale_autopilot_wrappers(), _fire_autopilot_job(), get_autopilot_triggers(), get_multica_autopilots(), _headers(), _is_configured(), multica_autopilot_sync.py — Syncs Multica autopilot schedules to APScheduler.  O (+21 more)
...
Cohesion: 0.07
Nodes (26): get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker., Play previous track (from history)., Add a track to the queue.                  Args:             position: If specif (+18 more)
...
Cohesion: 0.08
Nodes (23): Search for k most similar tracks.                  Args:             query: 256-, Search YouTube Music.                  Search works without authentication using, Return mock results when not authenticated., Protocol, test_maintenance_runner_imports_real_bakeoff_module(), test_score_recall_response_reports_missing_terms(), test_summarize_bakeoff_scores_reports_score_and_latency(), test_synthetic_events_validate_and_include_required_cases() (+15 more)
...
Cohesion: 0.09
Nodes (22): Output Target Base Class ========================  Abstract base class for all a, Apple Music Provider ====================  Integration with Apple Music using th, AuthStatus, display_name(), ProviderType, Music Provider Base Class =========================  Abstract base class for all, Supported music provider types., Provider authentication status. (+14 more)

### Community 65 - "Community 65"
Cohesion: 0.08
Nodes (20): Music Zone Manager Handles multi-zone playback with device routing and state syn, Create a new music zone, Current playback state for a zone, Delete a zone (only owner can delete), Get all zones accessible by a user, Add a device to a zone, Remove a device from a zone, Mark a device as connected and store its websocket (+12 more)
...
Cohesion: 0.09
Nodes (26): Normalize a YouTube Music item to standard format., Make a request to the Home Assistant API., AppleMusicProvider, Get user's Music User Token from database., Make authenticated API request., Convert Apple Music track data to Track., Search for tracks on Apple Music., Search for playlists on Apple Music. (+18 more)
...
Cohesion: 0.09
Nodes (21): DatabaseValidator, Find all .db files in data directory, Check if file is in a backup/archive location, Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage. (+13 more)
...
Cohesion: 0.1
Nodes (17): Build a comprehensive Samantha-level system prompt, Analyze overall Samantha-level intelligence, Analyze intelligence level on 1-10 scale, Analyze tool usage effectiveness on 1-10 scale, Run final comprehensive Samantha-level intelligence test, Final comprehensive Samantha-level intelligence testing, Generate final comprehensive report, Test a single model's Samantha-level intelligence (+9 more)
...
Cohesion: 0.11
Nodes (28): get_contact(), get_session_by_code(), Look up an active session by its short join code., Recipient retrieves the contact details., add_item(), create_list(), delete_item(), delete_list() (+20 more)
...
Cohesion: 0.08
Nodes (28): _cleanup_rate_limit_storage(), get_client_info(), get_current_session(), get_permission_checker(), get_session_id_from_bearer_token(), get_session_id_from_header(), _in_memory_rate_limit(), optional_session() (+20 more)
...
Cohesion: 0.12
Nodes (23): addFeedItem(), applyStats(), autoEndSession(), clearHostSession(), confirmEndSession(), connectWS(), endSpeedDating(), fetchStats() (+15 more)
...
Cohesion: 0.09
Nodes (26): _cleanup_expired_pending(), fire_notification(), _is_in_quiet_hours(), Proactive Engine — coordinates all trigger tiers.  Tier 1: APScheduler fires _fi, Internal: import push router and call send_push_to_user. Returns subscriber coun, Tier 2 loop: poll registered triggers every SLOW_LOOP_INTERVAL seconds., Periodically prune expired, unclaimed proactive_pending rows., Swallow APScheduler's double-shutdown error that occurs on rapid restarts. (+18 more)

### Community 96 - "Community 96"
Cohesion: 0.19
Nodes (26): acquire_lock(), analyze_result(), _append_progress(), _diff_changed_lines(), _diff_files(), _finding_hash(), GuardError, GuardPacket (+18 more)

### Community 97 - "Community 97"
Cohesion: 0.14
Nodes (23): _env_float(), _config_values(), _env_bool_snapshot(), _env_float_snapshot(), _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers(), _scan_processes() (+15 more)

### Community 98 - "Community 98"
Cohesion: 0.12
Nodes (25): evolution_proposal_action(), _hermes_review_proposal(), Ask Hermes to review an evolution proposal before implementation is queued., Act on an evolution proposal: approve|reject|defer.      On approve: creates a M, get_engineering_multica_agent_id(), get_multica_client(), get_self_improvement_multica_agent_id(), _lookup_evolution_resources() (+17 more)
...
Cohesion: 0.11
Nodes (20): _board(), _expected_phases(), _protocol_violation_count(), Report aggregate state of a chain by idempotency-key prefix.          Returns {f, Pull a PR URL from the implement/closeout task summaries or comments., Block a task after repeated Hermes protocol violations (silent worker exit)., Stop a running worker when its code-enforced phase budget is exhausted., _issue_sort_key() (+12 more)
...
Cohesion: 0.22
Nodes (20): _approved_evolution_issue(), _issue(), Tests for safe production backlog admission., test_approved_blocked_ticket_halts_single_ticket_lane(), test_blocked_evolution_ticket_without_contract_does_not_halt_lane(), test_evolution_proposal_ticket_requires_matching_contract_marker(), test_malformed_queue_order_cannot_wedge_admission(), test_non_hermes_blocked_ticket_does_not_halt_lane() (+12 more)
...
Cohesion: 0.15
Nodes (19): create_background_task(), get_pending_tasks(), Queue a long-running task for background execution.      Body: {"message": "find, Return completed background tasks not yet shown to the user., _background_profile(), enqueue_background_task(), background_runner.py — Background task queue for Zoe.  Enables "fire and forget", Execute the task via Hermes and store the result. (+11 more)
...
Cohesion: 0.15
Nodes (12): Analyze response quality based on prompt type and expected behavior, Test a single model with a single prompt, BenchmarkResult, ModelBenchmark, Analyze if the model correctly used tools, Analyze response quality on 1-10 scale, Analyze warmth on 1-10 scale, Analyze conciseness on 1-10 scale (+4 more)
...
Cohesion: 0.15
Nodes (14): multica_webhook(), _multica_webhook_dispatch_allowed(), Return True when a webhook is allowed to start code-changing work., Receive Multica webhook events and update evolution proposal status., _adapter_for_assignee(), dispatch_issue(), poll_ref(), Executor adapter registry — routes Multica issues to a backend by assignee.  Mul (+6 more)
...
Cohesion: 0.2
Nodes (13): Manually trigger the LLM memory digest for a user (or the requesting user)., trigger_memory_digest(), _emotional_memory_pass(), _extract_facts_with_gemma(), _load_todays_messages(), LLM-driven nightly memory digest.  Reads today's chat messages for a user, promp, Extract facts from today's chat history and write to MemPalace + memory_items., Extract emotionally significant moments from today's chat and store them.      R (+5 more)
...
Cohesion: 0.18
Nodes (9): GuardedClient, test_append_issue_note_skips_when_get_issue_fails(), test_record_progress_can_clear_blocker(), test_record_progress_skips_when_get_issue_fails(), test_safe_patch_description_skips_when_get_issue_fails(), Update an issue's status and/or other fields (description, title, etc.)., Patch only the fenced Zoe ticket block in an issue description., Append a visible progress note while preserving existing description. (+1 more)
...
Cohesion: 0.2
Nodes (13): _agent_loop(), _build_room_handlers(), _cooldown_watchdog(), _make_participant_state(), _mint_agent_token(), _ParticipantState, voice_livekit.py — Server-side LiveKit agent for voice.html?mode=livekit.  Joins, Periodic task that auto-expires COOLDOWN states whose deadline has passed. (+5 more)
...
Cohesion: 0.17
Nodes (10): Check a single router file for authentication issues.     Returns list of (line_, check_file(), Check a single file for hardcoded database paths, Check a single file against rules, find_references(), load_critical_files(), Load critical files manifest, Find references to file in codebase (+2 more)
...
Cohesion: 0.15
Nodes (11): test_simple_greeting(), Intent System Development Rules, classifier(), Intent Classification Tests ===========================  Tests for HassIL-based, Test greeting intents., Test basic greeting patterns., Test queries that should NOT match any intent., Complex queries should return None (fall back to LLM). (+3 more)
...
Cohesion: 0.2
Nodes (9): IntEnum, _ConnState, _DataPacket, make_room(), livekit_aiortc.py — LiveKit room participant using pure-Python aiortc.  Replaces, Create a new LiveKit room using the aiortc backend., _RemoteParticipant, _TrackKind (+1 more)
...
Cohesion: 0.2
Nodes (10): _actionable_greptile_findings(), assess_merge_readiness(), _ci_status_from_rollup(), _gh_mergeable_state(), _gh_unresolved_review_thread_count(), _greptile_confidence_from_github_comments(), Inline review comments only; PR-level Greptile summaries are not merge blockers., Parse Greptile confidence from PR issue comments (summary posts). (+2 more)
...
Cohesion: 0.2
Nodes (10): _collect_audio_stream(), _on_pipeline_done(), _pcm_frames_to_wav(), Concatenate raw int16-LE PCM frames and wrap in a WAV header., STT → LLM → TTS pipeline, called once end-of-speech is detected., Background task: run energy VAD on incoming audio frames.      Maintains per-par, Called when the pipeline task finishes — move to COOLDOWN., Compute RMS energy of a raw int16-LE PCM frame. (+2 more)
...
Cohesion: 0.22
Nodes (7): _Frame, _FrameEvent, Wraps an aiortc MediaStreamTrack received from a remote participant., Await the next AudioFrame from the underlying aiortc track., Mimics the livekit AudioFrameEvent used in _collect_audio_stream., Mimics livekit AudioFrame — exposes .data as int16-LE PCM bytes., _RemoteAudioTrack
...
Cohesion: 0.25
Nodes (7): Get current playback state from an AirPlay device, Get current playback state from a Chromecast, Get current playback state for a zone, Get current playback state of an AirPlay device., get_state(), Get current playback state of a Home Assistant media player., Get playback state of a device.
...
Cohesion: 0.25
Nodes (7): Broadcast a JSON data message to all participants in the room., LLM → TTS pipeline for text commands sent over the LiveKit data channel., _run_text_pipeline(), _send_data(), _LocalParticipant, Proxy for Room.local_participant — wraps the data channel send., Send bytes over the WebRTC data channel.
...
Cohesion: 0.24
Nodes (7): _extract_concept_tags(), Consolidate 30 days of music events into MemPalace preference memories.      Sco, Run music taste digest for all users who have any music events., Use Gemma to extract concept tags from a fact. Returns [] on failure., REM pass: for each new memory ingested tonight, strengthen related existing memo, _rem_reinforce_pass(), run_music_taste_digest()
...
Cohesion: 0.4
Nodes (4): _AudioStream, make_audio_stream(), Create an AudioStream compatible with voice_livekit._collect_audio_stream., Async iterable that drains an aiortc audio track, resampling to     16 kHz / mon
...
Cohesion: 0.67
Nodes (3): test_tracked_multica_engineering_issues_includes_review_and_deduplicates(), Return unique active/review issues whose engineering chain needs reconciliation., _tracked_multica_engineering_issues()

## Knowledge Gaps
- **2889 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2884 more)
...
- **Why does `main()` connect `Community 1` to `Community 263`, `Community 264`, `Community 137`, `Community 139`, `Community 141`, `Community 142`, `Community 270`, `Community 20`, `Community 21`, `Community 23`, `Community 282`, `Community 156`, `Community 157`, `Community 31`, `Community 160`, `Community 163`, `Community 164`, `Community 291`, `Community 38`, `Community 44`, `Community 46`, `Community 304`, `Community 305`, `Community 178`, `Community 53`, `Community 54`, `Community 183`, `Community 56`, `Community 188`, `Community 189`, `Community 318`, `Community 68`, `Community 70`, `Community 71`, `Community 327`, `Community 73`, `Community 218`, `Community 75`, `Community 205`, `Community 78`, `Community 206`, `Community 77`, `Community 207`, `Community 82`, `Community 87`, `Community 216`, `Community 217`, `Community 90`, `Community 219`, `Community 220`, `Community 92`, `Community 88`, `Community 215`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 228`, `Community 101`, `Community 229`, `Community 104`, `Community 113`, `Community 244`, `Community 118`, `Community 247`, `Community 120`, `Community 125`?**
  _High betweenness centrality (0.179) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 88` to `Community 256`, `Community 1`, `Community 4`, `Community 133`, `Community 7`, `Community 265`, `Community 138`, `Community 11`, `Community 13`, `Community 14`, `Community 141`, `Community 142`, `Community 18`, `Community 21`, `Community 22`, `Community 23`, `Community 33`, `Community 167`, `Community 39`, `Community 42`, `Community 43`, `Community 44`, `Community 46`, `Community 179`, `Community 52`, `Community 53`, `Community 55`, `Community 56`, `Community 316`, `Community 318`, `Community 196`, `Community 70`, `Community 201`, `Community 75`, `Community 76`, `Community 207`, `Community 80`, `Community 85`, `Community 216`, `Community 98`, `Community 99`, `Community 227`, `Community 101`, `Community 103`, `Community 109`, `Community 239`, `Community 115`, `Community 245`, `Community 118`, `Community 117`, `Community 124`, `Community 125`, `Community 254`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `_FakeAdapter` connect `Community 0` to `Community 101`, `Community 9`, `Community 203`, `Community 15`, `Community 18`, `Community 24`?**
