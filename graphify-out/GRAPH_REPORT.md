...
## Summary
- 8218 nodes · 14677 edges · 526 communities (337 shown, 189 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2067 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `068c7e87`
...
## Communities (526 total, 189 thin omitted)
...
Cohesion: 0.04
Nodes (113): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, get_auth_manager(), Get the singleton auth manager instance., Get track metadata from cache., get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us, Get or create a YTMusic client for a user.                  Args:             us (+105 more)
...
Cohesion: 0.04
Nodes (89): Start discovering AirPlay devices, Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100). (+81 more)
...
Cohesion: 0.04
Nodes (59): get_event_tracker(), Get the singleton event tracker instance., get_media_controller(), MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker., Play previous track (from history). (+51 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (68): _build_hermes_payload(), _build_panel_intent_card(), chat_inject_background(), chat_stream_generator(), _chatgpt_connect_flow(), _check_frustration(), _create_pending_approval(), _detect_preview_urls() (+60 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (68): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn(), ha_voice_wake() (+60 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (78): _should_supersede_voice_weather_action(), _FakeAdapter, A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., KanbanAdapter with the CLI replaced by a scripted recorder., _row(), test_dispatch_archives_stale_terminal_revision_phase_row(), test_dispatch_blocks_existing_pr_revision_when_precheckout_fails(), test_dispatch_blocks_on_first_worker_failure() (+70 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (72): RuntimeError, acquire_lock(), _actionable_greptile_findings(), analyze_result(), _append_progress(), assess_merge_readiness(), _ci_status_from_rollup(), _diff_changed_lines() (+64 more)
...
Cohesion: 0.06
Nodes (36): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+28 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (44): BaseHTTPMiddleware, evaluate(), load_device_tokens(), Load all active device tokens from DB into the in-memory cache (call at startup), Manually trigger the morning brief for the calling user.     Useful for testing, trigger_morning_brief(), check(), What a trigger wants to send. (+36 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (39): test_dispatch_adjusts_running_scout_journal_when_scout_row_is_done(), test_dispatch_adjusts_stale_scout_journal_for_scope_split_child(), test_dispatch_does_not_adjust_running_scout_journal_with_active_row(), test_poll_v4_audit_protocol_recovery_reports_partial_for_next_phase(), test_mark_greptile_passes_only_on_five_of_five(), test_mark_reviewed_requires_zero_critical(), test_mark_tested_records_hashed_evidence(), test_record_evidence_retries_once_after_journal_conflict() (+31 more)

### Community 29 - "Community 29"
Cohesion: 0.1
Nodes (46): Convert to dictionary for API responses., test_failed_outcome_trace_becomes_notice_signal_when_repeated(), test_failed_outcome_trace_respects_existing_signal_ids(), test_failed_outcome_trace_threshold_is_repeat_count_two(), test_memory_route_trace_allows_safe_metadata_without_evidence(), test_metadata_allows_author_attribution_key(), test_metadata_rejects_secret_keys(), test_metadata_rejects_secret_keys_inside_lists() (+38 more)
...
Cohesion: 0.09
Nodes (30): Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage., Check for potential security issues., Validates intent system configuration., Run all validations.                  Returns:             True if all validatio (+22 more)
...
Cohesion: 0.11
Nodes (29): MULClient, list_projects(), close_stale_autopilot_wrappers(), _fire_autopilot_job(), get_autopilot_triggers(), get_multica_autopilots(), _headers(), _is_configured() (+21 more)

### Community 60 - "Community 60"
Cohesion: 0.09
Nodes (34): add_item(), create_list(), delete_item(), delete_list(), get_list(), get_list_types(), list_items(), list_lists() (+26 more)
...
Cohesion: 0.13
Nodes (33): _issue_sort_key(), Return (sequence_key, phase_number) when title encodes a phased track., True when every lower phase in the same sequence is ``done`` (or missing)., Pick up to ``count`` backlog issues respecting phased ordering.      ``all_issue, select_batch(), _approved_evolution_issue(), _issue(), Tests for safe production backlog admission. (+25 more)
...
Cohesion: 0.11
Nodes (31): _event(), test_experience_memory_requires_evidence(), test_mapping_rejects_missing_scope(), test_mapping_rejects_missing_user_id(), test_mapping_supports_supersession_with_evidence(), test_relational_memory_requires_evidence(), test_valid_event_serializes_contract_fields(), test_blocked_multica_record_blocks_even_when_approval_flag_is_present() (+23 more)
...
Cohesion: 0.08
Nodes (31): Insert a proactive_scheduled row and register an APScheduler job.     Returns th, schedule_reminder(), init_pool(), Initialize the asyncpg connection pool. Call once at startup., _active_agents_list(), _enqueue_panel_tool(), _execute_tool(), _get_weather_default_location() (+23 more)
...
Cohesion: 0.1
Nodes (21): Get detailed status of Agent Zero service.          Returns:         Status info, status(), _compute_compatibility(), Compute compatibility score and shared traits between two check-ins., Get all registered providers., cli(), disable(), enable() (+13 more)

### Community 87 - "Community 87"
Cohesion: 0.07
Nodes (29): check_no_archive_folders(), check_no_databases_in_git(), check_no_duplicate_configs(), check_no_root_tests(), check_no_temp_files(), check_no_venv_in_git(), check_required_docs(), check_root_md_files() (+21 more)

### Community 88 - "Community 88"
Cohesion: 0.09
Nodes (28): parse_json_fields(), get_connection_icebreaker(), Shorter icebreaker for the QR scan connect page., create_connection(), get_matches(), get_pending_connections(), get_quiz_question(), _make_quiz_question() (+20 more)
...
Cohesion: 0.12
Nodes (21): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, Exception, _append_audit(), _MissingUserId, Raised when strict mode rejects a tool call with no identity., _idempotency_key(), MemoryServiceError (+13 more)
...
Cohesion: 0.14
Nodes (22): _env_float(), _config_values(), _env_bool_snapshot(), _env_float_snapshot(), GraphitiSidecarProbeResult, _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers() (+14 more)
...
Cohesion: 0.1
Nodes (17): _board(), _expected_phases(), _protocol_violation_count(), True when a worker pushed HEAD then got interrupted before PR handoff., Create/record a PR after the worker pushed but lost the terminal handoff., Report aggregate state of a chain by idempotency-key prefix.          Returns {f, Pull a PR URL from the implement/closeout task summaries or comments., Block a task after repeated Hermes protocol violations (silent worker exit). (+9 more)
...
Cohesion: 0.15
Nodes (13): Role-Based Access Control Manager, Assign role to user                  Args:             user_id: User to assign r, Create a custom role                  Args:             role_id: Unique role ide, Validate permission strings, return list of invalid ones, Log role change for audit, Initialize default permission definitions, RBACManager, Current-contract RBAC behavior tests. (+5 more)
...
Cohesion: 0.11
Nodes (15): Test Home Assistant integration, test_simple_greeting(), classifier(), Intent Classification Tests ===========================  Tests for HassIL-based, Test turn off patterns., Test greeting intents., Test basic greeting patterns., Test queries that should NOT match any intent. (+7 more)
...
Cohesion: 0.15
Nodes (13): test_graphiti_episode_payloads_include_evidence(), test_graphiti_supersession_payloads_have_temporal_order(), test_percentile_rejects_out_of_range_values(), test_score_graphiti_answer_reports_missing_terms(), test_score_graphiti_answer_respects_empty_text_field(), test_summarize_graphiti_scores_reports_latency(), graphiti_episode_payloads(), GraphitiEvalEpisode (+5 more)
...
Cohesion: 0.12
Nodes (17): MusicDiscover Intent, MusicLike Intent, MusicMood Intent, MusicNowPlaying Intent, MusicPause Intent, MusicPlay Intent, MusicPrevious Intent, MusicQueue Intent (+9 more)

### Community 183 - "Community 183"
Cohesion: 0.12
Nodes (14): ABC, MusicProvider, ProactiveTrigger, Abstract base class for music streaming providers.          All providers (YouTu, Like/save a track. Override if provider supports it., Add tracks to a playlist. Override if provider supports it., Save a track to user's library., Remove track from user's library. (+6 more)
...
Cohesion: 0.15
Nodes (14): Browser Cache Fix - Clear Old Broken State, Cleanup Safety Rules - Mandatory for All AI Assistants, Critical Files - Do Not Delete, Database Path Enforcement System, Docker Networking Rules - MANDATORY, Enhanced Enforcement System, Intent System Development Rules, Issue Analysis - October 23, 2025 (+6 more)
...
Cohesion: 0.27
Nodes (12): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), Zoe Architecture Review, Architecture Improvements - Implementation Summary (+4 more)
...
Cohesion: 0.25
Nodes (8): test_capabilities_snapshot_is_stable(), test_generated_context_mentions_hermes_engineering_loop(), test_graphify_rebuild_is_opt_in_by_default(), test_graphify_rebuild_opt_in_env_is_recognized(), _build_capabilities_md(), _build_zoe_self_md(), Build a human-readable CAPABILITIES.md at the project root., Build the full ZOE_SELF.md content, capped at _MAX_ZOE_SELF_CHARS.
...
Cohesion: 0.25
Nodes (3): Invalidate cache for specific user, Check if response meets expectations, Try to resolve an ambiguous utterance relative to the last intent.         Retur
...
Cohesion: 0.29
Nodes (7): Data Migration SQL for Misplaced Items, Database Query in GET /api/lists/{list_type}, Default Lists Creation SQL, Frontend Lists Loading Logic, GET /api/lists/{list_type} Endpoint, lists.py Router, Response Format Update in GET /api/lists/{list_type}

### Community 295 - "Community 295"
Cohesion: 0.29
Nodes (7): AgentZeroAnalyze Intent, AgentZeroCompare Intent, AgentZeroPlan Intent, AgentZeroResearch Intent, Agent Zero Research Skill, Agent Zero Comparison Skill, Agent Zero Planning Skill
...
Cohesion: 0.33
Nodes (6): test_patch_soul_block_is_idempotent_per_marker(), test_zoe_why_block_teaches_mission_and_stays_lean(), _build_zoe_why(), _patch_hermes_soul(), Build the ZOE_WHY block: Zoe's mission + charter, condensed for SOUL.md.      Th, Patch a <marker>_BEGIN/END block in SOUL.md. Returns True if patched.      Used
...
## Knowledge Gaps
- **2913 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2908 more)
...
- **Why does `main()` connect `Community 0` to `Community 129`, `Community 130`, `Community 257`, `Community 132`, `Community 131`, `Community 9`, `Community 265`, `Community 11`, `Community 137`, `Community 271`, `Community 16`, `Community 146`, `Community 147`, `Community 20`, `Community 25`, `Community 26`, `Community 282`, `Community 27`, `Community 30`, `Community 160`, `Community 293`, `Community 40`, `Community 42`, `Community 170`, `Community 45`, `Community 48`, `Community 305`, `Community 51`, `Community 57`, `Community 59`, `Community 63`, `Community 66`, `Community 195`, `Community 196`, `Community 197`, `Community 71`, `Community 201`, `Community 75`, `Community 76`, `Community 203`, `Community 206`, `Community 79`, `Community 84`, `Community 212`, `Community 86`, `Community 220`, `Community 221`, `Community 222`, `Community 223`, `Community 99`, `Community 101`, `Community 102`, `Community 105`, `Community 233`, `Community 111`, `Community 113`, `Community 245`, `Community 120`, `Community 122`?**
  _High betweenness centrality (0.191) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 86` to `Community 256`, `Community 0`, `Community 3`, `Community 260`, `Community 4`, `Community 6`, `Community 131`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 141`, `Community 16`, `Community 18`, `Community 21`, `Community 25`, `Community 28`, `Community 29`, `Community 36`, `Community 38`, `Community 40`, `Community 45`, `Community 46`, `Community 47`, `Community 176`, `Community 305`, `Community 51`, `Community 52`, `Community 57`, `Community 58`, `Community 59`, `Community 62`, `Community 64`, `Community 65`, `Community 66`, `Community 71`, `Community 199`, `Community 74`, `Community 76`, `Community 206`, `Community 81`, `Community 82`, `Community 84`, `Community 85`, `Community 343`, `Community 88`, `Community 87`, `Community 90`, `Community 215`, `Community 95`, `Community 105`, `Community 239`, `Community 113`, `Community 243`, `Community 246`, `Community 247`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `_FakeAdapter` connect `Community 8` to `Community 2`, `Community 35`, `Community 207`, `Community 17`, `Community 113`, `Community 28`?**
