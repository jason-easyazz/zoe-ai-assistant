...
## Summary
- 8243 nodes · 14271 edges · 637 communities (351 shown, 286 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1789 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dbe4474b`
...
8. `chat()` - 47 edges
9. `_row()` - 46 edges
10. `KanbanAdapter` - 44 edges

## Surprising Connections (you probably didn't know these)
- `test_service_health_reports_malformed_json_as_unhealthy()` --calls--> `Service Health Fixes`  [INFERRED]
  /tmp/zoe-graphify-snapshot.939Q6T/src/services/zoe-data/tests/test_hindsight_embedding_probe.py → docs/architecture/SERVICE_HEALTH_FIX.md
- `Governed, non-persistent observation trace collection.  This collector is an adm` --rationale_for--> `Zoe Observation Trace Collector`  [EXTRACTED]
  /tmp/zoe-graphify-snapshot.939Q6T/src/services/zoe-data/zoe_observation_trace_collector.py → docs/architecture/zoe-observation-trace-collector.md
- `Candidate scoring for Zoe capability adoption.  Zoe should evaluate existing Pi,` --rationale_for--> `Zoe Candidate Scoring`  [EXTRACTED]
  /tmp/zoe-graphify-snapshot.939Q6T/src/services/zoe-data/zoe_candidate_scoring.py → docs/architecture/zoe-candidate-scoring.md
- `Zoe capability profile contract and seed inventory.  Capability profiles are Zoe` --rationale_for--> `Zoe Capability Profiles`  [EXTRACTED]
  /tmp/zoe-graphify-snapshot.939Q6T/src/services/zoe-data/zoe_capability_profile.py → docs/architecture/zoe-capability-profiles.md
- `Decision Log` --calls--> `merge_string_refs()`  [INFERRED]
  docs/implementation/decision_log.md → /tmp/zoe-graphify-snapshot.939Q6T/src/services/zoe-data/zoe_capability_utils.py

## Communities (637 total, 286 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (65): _should_supersede_voice_weather_action(), _FakeAdapter, Tests for the Hermes Kanban executor adapter (CLI mocked)., A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., KanbanAdapter with the CLI replaced by a scripted recorder., _row(), test_audit_no_pr_phases_do_not_preload_broad_skills(), test_dispatch_blocks_existing_pr_revision_when_precheckout_fails() (+57 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (101): Main optimization function, analyze_database(), Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, check_chat_router_intelligence(), Validate chat router uses intelligent systems, _active_memory_files() (+93 more)
...
Cohesion: 0.04
Nodes (69): _build_hermes_payload(), _build_panel_intent_card(), chat_inject_background(), chat_stream_generator(), _chatgpt_connect_flow(), _check_frustration(), _create_pending_approval(), _detect_preview_urls() (+61 more)
...
Cohesion: 0.07
Nodes (66): test_capability_trust_update_blocks_failed_proposal(), test_capability_trust_update_blocks_unretained_outcome(), test_execution_gate_allows_when_required_evidence_refs_exist(), test_execution_gate_fails_closed_without_approval_evidence(), test_missing_approval_required_blocks_execution(), test_missing_proposal_id_blocks_execution(), test_non_execute_proposal_cannot_execute_even_with_evidence(), test_promote_memory_admission_requires_memory_approval_and_pr() (+58 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (66): get_auth_manager(), Get the singleton auth manager instance., Get or create a YTMusic client for a user.                  Args:             us, Normalize a YouTube Music item to standard format., get_client(), Make a request to the Home Assistant API., AppleMusicProvider, Get user's Music User Token from database. (+58 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (60): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn(), ha_voice_wake() (+52 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (67): a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_cancel(), board_review(), delegate_to_agent(), _EngineeringGuardRunRequest, _EngineeringTaskRequest (+59 more)
...
Cohesion: 0.05
Nodes (43): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+35 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (47): DatabaseValidator, Find all .db files in data directory, Check if file is in a backup/archive location, Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage. (+39 more)
...
Cohesion: 0.08
Nodes (36): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, Get a specific provider by type.                  Args:             provider_typ, _get(), _append_audit(), Return Atomic semantic hits as normalized records., _build_metadata(), _memory_status_visible() (+28 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (48): ProactiveTrigger, Manually trigger the morning brief for the calling user.     Useful for testing, trigger_morning_brief(), check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe, TriggerResult, EveningWindDownTrigger (+40 more)
...
Cohesion: 0.06
Nodes (47): MediaController, Media Controller ================  Routes playback commands to appropriate devic, Seek to position in current track., Set playback volume (0-100)., Controls music playback across devices.          Supports:     - Browser/panel p, Get the current queue., Reorder a track in the queue., Send message to device via WebSocket. (+39 more)
...
Cohesion: 0.06
Nodes (43): Get all discovered AirPlay devices, Get all discovered Chromecast devices, Get a specific device by ID, Get device info from database., AirPlayOutput, get_airplay_output(), Discover available AirPlay devices., Refresh the device list. (+35 more)
...
Cohesion: 0.06
Nodes (44): print_results(), Scan entire project and categorize all files., Check if path should be ignored., Categorize a file and determine if it's in the right location.          Returns:, scan_project(), should_ignore(), check_for_dangerous_patterns(), Print validation results.          Returns:         Exit code (0 if all files ex (+36 more)

### Community 33 - "Community 33"
Cohesion: 0.06
Nodes (43): _build_calendar_form_props(), _build_reminder_form_props(), _intent_action_form_payload(), Build a panel_show_action_form payload for intents that show an in-place overlay, HA full-setup shorthand intent and OpenClaw message expansion., test_detect_ha_full_setup(), test_execute_ha_full_setup_returns_none(), test_openclaw_user_message_expands_with_intent() (+35 more)
...
Cohesion: 0.09
Nodes (19): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., Play a track on the target device.                  Args:             track_id:, Lazy load event tracker., Add a track to the queue.                  Args:             position: If specif, Play on Home Assistant media_player in room. (+11 more)
...
Cohesion: 0.08
Nodes (39): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, OutputState, OutputType, Types of output targets., Playback state of an output. (+31 more)
...
Cohesion: 0.07
Nodes (42): get_contact(), get_reports(), get_session_by_code(), Look up an active session by its short join code., Recipient retrieves the contact details., add_item(), create_list(), delete_item() (+34 more)

### Community 44 - "Community 44"
Cohesion: 0.06
Nodes (26): Play previous track (from history)., Get previous track from history., Music Zone Manager Handles multi-zone playback with device routing and state syn, Create a new music zone, Current playback state for a zone, Delete a zone (only owner can delete), Get all zones accessible by a user, Add a device to a zone (+18 more)

### Community 45 - "Community 45"
Cohesion: 0.09
Nodes (39): BaseHTTPMiddleware, _audit_no_pr_issue(), _chain_for_issue(), _code_audit_implement_hint(), _engineering_mode(), _escalation_model_hint(), _existing_pr_url(), _goal_mode_args() (+31 more)
...
Cohesion: 0.07
Nodes (30): escalate_session(), Refresh current session expiration          Args:         current_session: Curre, Escalate passcode session to full session with password verification          Ar, refresh_session(), AuthValidationResult, Verify user password                  Args:             user_id: User identifier, Result of authentication validation, Verify passcode for user                  Args:             user_id: User identi (+22 more)
...
Cohesion: 0.06
Nodes (38): clear_all_device_caches(), clear_device_cache(), get_cached_users(), get_device_config(), get_device_status(), list_touch_panel_devices(), QuickSwitchRequest, Touch Panel API Endpoints Optimized endpoints for touch panel quick authenticati (+30 more)
...
Cohesion: 0.09
Nodes (34): Create a multi-step plan for a task.                  Args:             task: Ta, plan(), Planning endpoint - creates multi-step plans.          Uses Agent Zero to:, Cursor Prompt Templates, Decision Log, Metrics Tracking, Implementation Progress, Memory & Hallucination Reduction - Implementation Directory (+26 more)

### Community 56 - "Community 56"
Cohesion: 0.09
Nodes (22): test_enabled_status_includes_embedding_config(), test_operation_status_gets_hindsight_operation_endpoint(), test_recall_posts_trace_enabled_request(), test_recall_uses_user_and_scope_isolated_bank_ids(), test_request_wraps_non_json_response(), test_retain_payload_posts_pre_admitted_payload_without_auto_retain(), test_retain_payload_refuses_when_disabled(), test_retain_posts_to_hindsight_memories_endpoint() (+14 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (23): IntEnum, AiortcRoom, _ConnState, _DataPacket, _Frame, _FrameEvent, make_room(), livekit_aiortc.py — LiveKit room participant using pure-Python aiortc.  Replaces (+15 more)

### Community 58 - "Community 58"
Cohesion: 0.08
Nodes (35): create_event(), delete_event(), _enforce_calendar_read_access(), get_event(), list_events(), list_today_events(), FastAPI router for calendar events. Mounted at prefix="/api/calendar" with tag ", Get a single event by ID. (+27 more)
...
Cohesion: 0.08
Nodes (22): create_user(), Create new user (admin only)          Args:         request: User creation detai, change_password(), Change current user's password          Args:         request: Current and new p, AuthManager, Change user password                  Args:             user_id: User identifier, Reset user password (admin function)                  Args:             user_id:, Unlock user account (admin function)                  Args:             user_id: (+14 more)
...
Cohesion: 0.13
Nodes (35): build_engineering_guard_packet(), run_engineering_guard_once(), acquire_lock(), _actionable_greptile_findings(), _append_progress(), assess_merge_readiness(), _ci_status_from_rollup(), _finding_hash() (+27 more)
...
Cohesion: 0.09
Nodes (20): Analyze warmth on 1-10 scale, FinalSamanthaTester, Build a comprehensive Samantha-level system prompt, Analyze overall Samantha-level intelligence, Analyze warmth level on 1-10 scale, Analyze intelligence level on 1-10 scale, Analyze tool usage effectiveness on 1-10 scale, Run final comprehensive Samantha-level intelligence test (+12 more)
...
Cohesion: 0.08
Nodes (29): parse_json_fields(), get_connection_icebreaker(), Orbit icebreaker engine — rule cascade, strongest signal wins., Shorter icebreaker for the QR scan connect page., create_connection(), get_matches(), get_pending_connections(), get_quiz_question() (+21 more)
...
Cohesion: 0.1
Nodes (26): _mock_repo_validators(), test_content_hash_is_stable(), test_sync_pipeline_auto_validators_on_implement_done(), Tests for harness-run repo validators., test_run_repo_validators_failure(), test_run_repo_validators_success(), test_validator_evidence_item_tags_phase(), build_parser() (+18 more)
...
Cohesion: 0.08
Nodes (25): accept_pending_suggestion(), create_schedule(), delete_schedule(), dismiss_pending_suggestion(), list_pending_suggestions(), list_schedules(), Proactive Engine REST router.  Endpoints:   POST   /api/proactive/schedule, List unresolved save offers for the current chat session. (+17 more)
...
Cohesion: 0.09
Nodes (25): Create a notification., acknowledge_reminder(), create_reminder(), delete_reminder(), list_pending_notifications(), list_reminders(), list_today_reminders(), mark_notification_delivered() (+17 more)
...
Cohesion: 0.12
Nodes (16): Check if Agent Zero is available.                  Returns:             True if, EmbeddingService, Embedding Service =================  Generates audio and metadata embeddings for, Initialize projection layer for fused embeddings., Generate audio embedding from audio file using CLAP.                  Args:, Generate text embedding from track metadata.                  Args:, Generate fused embedding from audio and metadata embeddings.                  If, Create and cache all embeddings for a track.                  Args: (+8 more)
...
Cohesion: 0.1
Nodes (17): AirPlay Output Target =====================  Implementation of OutputTarget for, is_initialized(), output_type(), Chromecast Output Target ========================  Implementation of OutputTarge, get_homeassistant_output(), Home Assistant Output Target ============================  Implementation of Out, Get the singleton Home Assistant output instance., get_output_manager() (+9 more)

### Community 120 - "Community 120"
Cohesion: 0.11
Nodes (14): Search for k most similar tracks.                  Args:             query: 256-, Search YouTube Music.                  Search works without authentication using, Return mock results when not authenticated., Protocol, FakeMemoryService, FakeRef, test_recall_text_from_results_supports_refs_dicts_and_strings(), test_run_mempalace_baseline_scores_fake_service() (+6 more)
...
Cohesion: 0.14
Nodes (17): quick_user_switch(), Quick user switching for touch panels          Args:         request: Quick swit, validateSession(), Background sync loop for HA integration, QuickAuthManager, QuickAuthResult, Quick user switching for touch panels                  Args:             current, Validate existing session (with offline support)                  Args: (+9 more)
...
Cohesion: 0.13
Nodes (11): Test lists, tasks, and projects with context, Test calendar and event management, Test journal entries and notes, Test N8N workflow automation, Test developer tools and system management, Test voice and media capabilities, Test advanced orchestration and intelligence features, Send chat message and return response (+3 more)
...
Cohesion: 0.16
Nodes (17): _env_float(), _config_values(), _env_bool_snapshot(), _env_float_snapshot(), GraphitiSidecarProbeResult, _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers() (+9 more)

### Community 151 - "Community 151"
Cohesion: 0.15
Nodes (16): Output Target Base Class ========================  Abstract base class for all a, Apple Music Provider ====================  Integration with Apple Music using th, Album, Artist, display_name(), ProviderType, Music Provider Base Class =========================  Abstract base class for all, Unified artist representation. (+8 more)
...
Cohesion: 0.19
Nodes (18): Zoe Architecture Review, Database Consolidation Plan, Router Consolidation Plan, Service Health Fixes, Setup Verification Report, test_embedding_probe_health_url_for_openai_compatible_base(), test_service_health_reports_malformed_json_as_unhealthy(), _elapsed_ms() (+10 more)

### Community 157 - "Community 157"
Cohesion: 0.11
Nodes (19): test_build_scope_split_packet_preserves_worker_reason(), test_explicit_scope_split_is_allowed_from_scout(), test_repeated_scope_split_is_still_implement_only(), block_fingerprint(), build_scope_split_packet(), Fingerprint a blocked transition so identical failures can abort loops., Track repeated identical block fingerprints; return (state, should_abort)., Classify broad failures that should become split/escalation packets. (+11 more)

### Community 158 - "Community 158"
Cohesion: 0.12
Nodes (15): _broadcast_intent_nav(), _intent_card_data(), Broadcast UI actions to the touch panel when an intent is detected.      For act, Build show_card data payload from intent slots for Google Home-style card., Tests for calendar intent canonical card emission., test_calendar_create_payload_keeps_compat_shape_and_adds_editor_contract(), test_calendar_show_payload_keeps_compat_shape_and_adds_contract(), test_board_status_reports_lifecycle_metadata() (+7 more)
...
Cohesion: 0.16
Nodes (15): ADR: Graphiti Bake-Off Second, ADR: Hindsight Bake-Off First, ADR: Zoe Memory Layer Direction, ADR: Zoe North Star Layer, test_capability_profile_index_rejects_duplicate_ids(), test_capability_profile_rejects_unknown_owner_surface(), test_default_capability_profiles_validate_and_cover_core_surfaces(), test_metadata_is_read_only() (+7 more)
...
Cohesion: 0.18
Nodes (17): detect_and_extract_intent(), Async wrapper around detect_intent that populates structured slots for create, _call_with_tool(), _extract_calendar(), _extract_journal(), _extract_list_add(), _extract_note(), _extract_people() (+9 more)
...
Cohesion: 0.14
Nodes (11): AudioAnalyzer, Audio Analyzer ==============  Extracts audio features from music tracks using E, Synchronous audio analysis (runs in thread pool).                  Args:, Estimate valence (sad-happy) from audio features.                  Simple heuris, Estimate arousal (calm-energetic) from audio features.                  Higher B, Get cached audio features from database., Get the singleton audio analyzer instance., Extract audio features using Essentia.          Jetson-only component for analyz (+3 more)
...
Cohesion: 0.17
Nodes (12): test_graphiti_episode_payloads_include_evidence(), test_graphiti_supersession_payloads_have_temporal_order(), test_score_graphiti_answer_reports_missing_terms(), test_score_graphiti_answer_respects_empty_text_field(), test_summarize_graphiti_scores_reports_latency(), graphiti_episode_payloads(), GraphitiEvalEpisode, GraphitiEvalQuery (+4 more)
...
Cohesion: 0.16
Nodes (8): Invalidate all sessions for user except optionally one, Check if user is within concurrent session limits, Remove invalid sessions for one user/type while holding session_lock., Free one concurrent slot by removing the oldest active session.          Returns, Check if session is still valid, Remove session from memory and mark inactive in DB, Clean up expired sessions from memory and database, Invalidate session on server and locally
...
Cohesion: 0.2
Nodes (9): migrate_self_entries(), Create self entries for users in the people table, _compute_compatibility(), Compute compatibility score and shared traits between two check-ins., list(), List all available modules., _adapt_params(), aiosqlite-compatible shorthand: execute and return all rows immediately. (+1 more)
...
Cohesion: 0.18
Nodes (8): DatabaseAuditor, Save detailed report to JSON, Scan a single file for database references, Recursively scan directory for database references, Print formatted audit report, Print validation report, Print analysis report, Save benchmark report to file
...
Cohesion: 0.18
Nodes (8): Analyze a target (file, system, configuration).                  Args:, analyze(), Analysis endpoint - analyzes files, configurations, systems.          Uses Agent, Analyze all files in root, RootCleaner, Analyze a track and extract audio features.                  Args:             t, Fetch audio segment for analysis.                  Downloads 60-second segment (, Save audio features to database.
...
Cohesion: 0.18
Nodes (6): FileArchiver, Update tags file after archival, Load tagged files from JSON, Show tagged files for review, Ask user to confirm archival, Archive the tagged files

### Community 249 - "Community 249"
Cohesion: 0.18
Nodes (11): Action Plan Progress Report, Chat Integration Diagnosis & Fixes, Chat Integration Fixes - Completed, Chat Page Verification, GPU Model Setup - gemma3n-e2b-gpu:latest, Intent System Browser Test — New Chat Prompt, LLM Capabilities Awareness Audit, Multica Issue Capture — Design Brief (+3 more)
...
Cohesion: 0.33
Nodes (10): Auto-Generated Module Compose, Jetson Docker Compose Override, Supplemental Docker Compose Modules, Raspberry Pi Docker Compose Override, Docker Compose Base Configuration, Docker Networking Rules, Hardware Compatibility Guide, Zoe Operator Runbook (+2 more)

### Community 264 - "Community 264"
Cohesion: 0.31
Nodes (10): MCP-Only Architecture for Zoe Modules, Music Module Migration Guide, Module Intent Auto-Discovery System - Complete!, Zoe Module Requirements - MANDATORY, Zoe Module System - Implementation Complete, Music Module Dependency Audit, Music Module Extraction - Complete Execution Plan, Music Routing Options - Detailed Breakdown (+2 more)
...
Cohesion: 0.47
Nodes (5): execute_admitted_hindsight_retain_plan(), _execution_reason(), HindsightRetainExecutionResult, Execute admitted Hindsight retain plans.  This module is the first runtime hando, Execute an admitted retain plan against the Hindsight sidecar.      Hindsight re
...
Cohesion: 0.33
Nodes (4): check_database(), Send a message to the API and return the response, Query the database directly, test_api()
...
Cohesion: 0.5
Nodes (4): check_home_directory(), get_category(), Determine where a file should go, Check /home/pi for violations

### Community 322 - "Community 322"
Cohesion: 0.4
Nodes (5): Data Migration for Misplaced Items, Database Query in GET /api/lists/{list_type}, Default Lists Creation, GET /api/lists/{list_type} Endpoint, Response Format Update in GET /api/lists/{list_type}

### Community 323 - "Community 323"
Cohesion: 0.5
Nodes (5): Zoe Code Execution with MCP - Implementation Summary, Zoe Harness Current Inventory, Zoe Hindsight Bake-Off, Zoe Memory Admission Gates, Zoe Tool And Capability Inventory
...
Cohesion: 0.67
Nodes (3): Error Handling Improvement in Chat, manifest.json Creation for PWA, Protocol Handling Fix in Chat SSL

### Community 355 - "Community 355"
Cohesion: 0.67
Nodes (3): Code Update in routers/lists.py, Data Migration Script migrate_lists_items.py, Lists Database Schema Update

### Community 356 - "Community 356"
Cohesion: 0.67
Nodes (3): Drag and Drop Implementation, Floating Action Button (FAB) Edit Mode, Widget Persistence System

### Community 357 - "Community 357"
Cohesion: 0.67
Nodes (3): GPU Allocation Error Fix for gemma3n-e2b-gpu, Reduced num_predict for Chat Model, Fixed Warmup Script for Models

### Community 358 - "Community 358"
Cohesion: 0.67
Nodes (3): zoe-capability-extender, zoe-page-builder, zoe-widget-builder

## Knowledge Gaps
- **2995 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2990 more)
...
- **Why does `main()` connect `Community 1` to `Community 132`, `Community 261`, `Community 134`, `Community 262`, `Community 10`, `Community 11`, `Community 140`, `Community 12`, `Community 144`, `Community 147`, `Community 148`, `Community 150`, `Community 279`, `Community 22`, `Community 26`, `Community 156`, `Community 286`, `Community 287`, `Community 32`, `Community 162`, `Community 36`, `Community 164`, `Community 38`, `Community 170`, `Community 42`, `Community 46`, `Community 56`, `Community 184`, `Community 315`, `Community 62`, `Community 320`, `Community 321`, `Community 67`, `Community 196`, `Community 197`, `Community 198`, `Community 70`, `Community 75`, `Community 76`, `Community 205`, `Community 204`, `Community 80`, `Community 84`, `Community 213`, `Community 214`, `Community 215`, `Community 89`, `Community 90`, `Community 92`, `Community 221`, `Community 222`, `Community 223`, `Community 96`, `Community 224`, `Community 98`, `Community 230`, `Community 237`, `Community 110`, `Community 238`, `Community 118`, `Community 248`, `Community 123`?**
  _High betweenness centrality (0.216) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 230` to `Community 1`, `Community 2`, `Community 3`, `Community 259`, `Community 5`, `Community 132`, `Community 8`, `Community 10`, `Community 12`, `Community 140`, `Community 142`, `Community 17`, `Community 18`, `Community 22`, `Community 25`, `Community 30`, `Community 34`, `Community 163`, `Community 41`, `Community 42`, `Community 46`, `Community 49`, `Community 178`, `Community 52`, `Community 55`, `Community 56`, `Community 185`, `Community 186`, `Community 59`, `Community 315`, `Community 65`, `Community 67`, `Community 70`, `Community 77`, `Community 78`, `Community 79`, `Community 80`, `Community 208`, `Community 82`, `Community 84`, `Community 213`, `Community 85`, `Community 87`, `Community 88`, `Community 214`, `Community 93`, `Community 94`, `Community 229`, `Community 112`, `Community 241`, `Community 244`, `Community 245`, `Community 121`, `Community 122`, `Community 123`, `Community 253`, `Community 254`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `_FakeAdapter` connect `Community 0` to `Community 103`, `Community 167`, `Community 77`, `Community 80`, `Community 23`, `Community 90`?**
