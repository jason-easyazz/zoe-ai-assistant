...
## Summary
- 8041 nodes · 14084 edges · 591 communities (343 shown, 248 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1943 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5669f902`
...
## Communities (591 total, 248 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (69): _FakeAdapter, _mock_ensure_worktree(), Tests for the Hermes Kanban executor adapter (CLI mocked)., A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., Dispatch tests must not run real git worktree subprocesses., KanbanAdapter with the CLI replaced by a scripted recorder., _row(), test_dispatch_blocks_existing_pr_revision_when_precheckout_fails() (+61 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (94): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail(), _is_allowed_line() (+86 more)
...
Cohesion: 0.04
Nodes (94): Tests for Kanban handoff → pipeline evidence parsing., test_acceptance_status_in_free_text_does_not_skip_implementation(), test_acceptance_status_is_not_a_routing_signal(), test_audit_no_code_test_exemption_is_verify_only(), test_audit_no_code_verify_tests_count_as_passed(), test_audit_only_from_handoff_detects_kv_field(), test_block_reason_from_handoff_extracts_iteration_budget_from_run_error(), test_block_reason_from_handoff_ignores_dynamic_log_tail() (+86 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (66): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn(), ha_voice_wake() (+58 more)
...
Cohesion: 0.05
Nodes (60): Start discovering AirPlay devices, Get all discovered AirPlay devices, Get all discovered Chromecast devices, Get a specific device by ID, Get device info from database., AirPlayOutput, get_airplay_output(), Discover available AirPlay devices. (+52 more)
...
Cohesion: 0.07
Nodes (56): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, Convert to dictionary for API responses., str, test_experience_memory_requires_evidence(), test_mapping_rejects_unscoped_write() (+48 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (58): a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_cancel(), board_review(), build_engineering_guard_packet(), delegate_to_agent(), _EngineeringGuardRunRequest (+50 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (58): Intent Router, _broadcast_intent_nav(), _build_calendar_form_props(), _build_reminder_form_props(), _intent_action_form_payload(), _intent_card_data(), Build a panel_show_action_form payload for intents that show an in-place overlay, Broadcast UI actions to the touch panel when an intent is detected.      For act (+50 more)
...
Cohesion: 0.05
Nodes (57): OpenClaw, get_plugins(), get_skills(), install_plugin_endpoint(), install_skill_endpoint(), openclaw_health(), preview_skill_endpoint(), routers/openclaw.py — REST API for OpenClaw plugin and skill management.  Endpoi (+49 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (51): test_execution_gate_allows_when_required_evidence_refs_exist(), test_execution_gate_fails_closed_without_approval_evidence(), test_missing_approval_required_blocks_execution(), test_missing_proposal_id_blocks_execution(), test_non_execute_proposal_cannot_execute_even_with_evidence(), test_promote_memory_admission_requires_memory_approval_and_pr(), test_unknown_approval_class_blocks_execution(), test_failed_outcome_remains_pending_only_and_never_trusted_durable_memory() (+43 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (47): _audit_no_pr_issue(), _chain_for_issue(), _code_audit_implement_hint(), _engineering_mode(), _escalation_model_hint(), _existing_pr_url(), _expected_phases(), _goal_mode_args() (+39 more)
...
Cohesion: 0.07
Nodes (41): Normalize a YouTube Music item to standard format., Make a request to the Home Assistant API., AppleMusicProvider, Get user's Music User Token from database., Make authenticated API request., Convert Apple Music track data to Track., Convert Apple Music album data to Album., Search for tracks on Apple Music. (+33 more)
...
Cohesion: 0.07
Nodes (37): Seek to position in current track., Set playback volume (0-100)., Send message to device via WebSocket., Broadcast to all user's devices., Update playback state in database., Pause playback in a zone, Resume playback in a zone, Seek to position in a zone (+29 more)

### Community 37 - "Community 37"
Cohesion: 0.09
Nodes (40): Attach Hermes log evidence when a silent exit was really a budget stop., Stop a running worker when its code-enforced phase budget is exhausted., _with_recovered_log_budget(), _budget_phase(), implement_code_audit_post_patch_drift_reason_from_log(), implement_code_audit_post_validation_ship_reason_from_log(), implement_edit_safety_reason_from_log(), implement_patch_ambiguity_reason_from_log() (+32 more)
...
Cohesion: 0.09
Nodes (28): DatabaseValidator, Find all .db files in data directory, Check if file is in a backup/archive location, Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage. (+20 more)

### Community 43 - "Community 43"
Cohesion: 0.08
Nodes (34): BaseHTTPMiddleware, evaluate(), ProactiveTrigger, check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe, TriggerResult, Fire once per week on Friday at 6pm local time. (+26 more)
...
Cohesion: 0.1
Nodes (31): MULClient, list_projects(), close_stale_autopilot_wrappers(), _fire_autopilot_job(), get_autopilot_triggers(), get_multica_autopilots(), _headers(), _is_configured() (+23 more)

### Community 46 - "Community 46"
Cohesion: 0.07
Nodes (38): Hermes Agent, Zoe Agent, board_approve(), create_engineering_workflow_task(), evolution_proposal_action(), get_agent_board(), list_engineering_workflow_tasks(), multica_webhook() (+30 more)
...
Cohesion: 0.12
Nodes (36): acquire_lock(), _actionable_greptile_findings(), analyze_result(), _append_progress(), assess_merge_readiness(), _ci_status_from_rollup(), _diff_changed_lines(), _diff_files() (+28 more)
...
Cohesion: 0.07
Nodes (26): AgentZeroClient, _compute_agent_zero_api_key(), Agent Zero Client =================  Client for communicating with Agent Zero's, Get or create context ID for a user.                  Args:             user_id:, Extract URLs from text as sources.                  Args:             text: Text, Send a message to Agent Zero and get response.                  Uses the /api_me, Execute a research task via Agent Zero.                  Args:             query, Compute the API key that Agent Zero expects, using the same algorithm     as its (+18 more)
...
Cohesion: 0.13
Nodes (29): test_dispatch_skips_scout_for_code_audit_ticket_block(), test_create_issue_metadata_preserves_existing_ticket_fields(), test_update_ticket_progress_can_clear_dispatch_approval(), test_block_only_description_does_not_gain_leading_blank_lines(), test_progress_and_children_patch_metadata_only(), test_replacing_middle_block_preserves_suffix_newline(), test_ticket_block_preserves_human_description(), test_ticket_block_replaces_only_zoe_section() (+21 more)
...
Cohesion: 0.09
Nodes (25): _board(), _oidc_client_id_configured(), _probe(), run(), _uploads_configured(), _hermes_review_proposal(), Ask Hermes to review an evolution proposal before implementation is queued., Use Hermes for foreground voice escalation; OpenClaw is manual-only. (+17 more)
...
Cohesion: 0.1
Nodes (24): get_auth_manager(), Get the singleton auth manager instance., Check if user is authenticated with Apple Music., Get developer token for MusicKit JS authentication.                  Apple Music, Complete auth with Music User Token from MusicKit JS.                  The auth_, Disconnect user from Apple Music., Convert Apple Music artist data to Artist., Artist (+16 more)

### Community 109 - "Community 109"
Cohesion: 0.1
Nodes (20): IntEnum, _AudioStream, _ConnState, _DataPacket, _Frame, _FrameEvent, make_audio_stream(), make_room() (+12 more)
...
Cohesion: 0.11
Nodes (22): _memory_digest_loop(), Wait until 3am, then run LLM digest for all active users daily., Start the nightly memory digest loop (if not disabled)., start_memory_digest_background(), _load_recent_misses(), _load_target_patterns(), _proposal_exists(), evolution_notice.py — Phase 6 of the nightly dreaming cycle.  NOTICE phase of th (+14 more)
...
Cohesion: 0.2
Nodes (20): test_collect_observation_traces_accepts_valid_non_persistent_batch(), test_collect_observation_traces_can_require_single_scope_batch(), test_collect_observation_traces_discards_entire_batch_on_rejection(), test_collect_observation_traces_rejects_disallowed_surface(), test_collect_observation_traces_rejects_empty_batch(), test_collect_observation_traces_rejects_invalid_trace_shape(), test_collect_observation_traces_rejects_mixed_user_batch(), test_collect_observation_traces_reports_batch_rejections_from_original_input() (+12 more)
...
Cohesion: 0.21
Nodes (16): _env_float(), _package_info(), _package_snapshot(), Read-only Graphiti runtime compatibility probe for Zoe.  This probe checks wheth, _config_values(), _env_bool_snapshot(), _env_float_snapshot(), _matching_lines() (+8 more)
...
Cohesion: 0.13
Nodes (13): EveningWindDownTrigger, Evening wind-down trigger — journal prompt if user hasn't written in 3+ days., EvolutionWeeklyDigestTrigger, EvolutionWeeklyDigestTrigger — Friday 6pm weekly evolution summary.  Fires every, Friday 6pm: evolution summary with quick-approve buttons., get_compat_db(), Async context manager yielding AsyncpgCompat wrapping a pooled connection., Run the evening wind-down trigger for all active users. (+5 more)
...
Cohesion: 0.2
Nodes (11): _compact_context(), _embeddings_base_url_from_env(), HindsightMemoryError, HindsightOfflineConfigError, _is_local_or_private_url(), _positive_count(), Hindsight sidecar adapter for Zoe's memory bake-off.  The adapter is disabled by, Raised when Hindsight is unavailable or returns an invalid response. (+3 more)
...
Cohesion: 0.15
Nodes (13): AG-UI Protocol Implementation Status, AG-UI Chat Protocol for Zoe, Chat Model Fix - GPU Allocation Error, Chat Page Verification, Chat Performance Fix, Zoe Code Execution with MCP - Implementation Summary, Documentation & Rules Audit Report, GPU Model Setup - gemma3n-e2b-gpu:latest (+5 more)

### Community 230 - "Community 230"
Cohesion: 0.23
Nodes (11): _emotional_memory_pass(), _extract_facts_with_gemma(), _is_contradiction(), _load_todays_messages(), LLM-driven nightly memory digest.  Reads today's chat messages for a user, promp, Extract facts from today's chat history and write to MemPalace + memory_items., Extract emotionally significant moments from today's chat and store them.      R, Load today's user-turn messages from chat_messages, joined to chat_sessions. (+3 more)
...
Cohesion: 0.18
Nodes (11): Action Plan Progress Report, API Versioning Strategy, Preventing Hardcoded Logic - Architecture Protection System, Standardized Error Handling Guide, Lists Database, Default Lists (IDs 1-4), Frontend lists.html, GET /api/lists/{list_type} Endpoint (+3 more)

### Community 252 - "Community 252"
Cohesion: 0.22
Nodes (11): All Documentation Complete Index, Calendar Sync Migration and Rollback Playbook, Creating Skills Guide, Cursor and AI Assistant Best Practices, File Tagging System Guide, Hermes Engineering Skills Guide, Quick Journal Widget Guide, Multica-Hermes PR Loop Guide (+3 more)
...
Cohesion: 0.31
Nodes (10): Browser Cache Fix, Critical Files - Do Not Delete, Database Path Enforcement System, Enhanced Enforcement System, Issue Analysis - October 23, 2025, Manifest System Documentation, Project Organization - Implementation Complete, Project Organization - Quick Reference (+2 more)
...
Cohesion: 0.48
Nodes (7): MCP-Only Architecture for Zoe Modules, Music Module Migration Guide, Module Intent Auto-Discovery System Complete, Zoe Module Requirements, Zoe Module System Implementation Complete, Music Module Dependency Audit, Music Module Extraction Execution Plan
...
Cohesion: 0.33
Nodes (6): Manually trigger the LLM memory digest for a user (or the requesting user)., Manually trigger full nightly dreaming cycle including evolution notice (admin o, trigger_memory_digest(), trigger_run_digest(), Run memory digest for all users who had chat activity today., run_digest_for_all_active_users()
...
Cohesion: 0.53
Nodes (6): Home Assistant MCP Bridge Service, Home Assistant Service, Zoe Auth Service, Zoe Database Service, Zoe UI Service, Zoe AI Assistant README
...
Cohesion: 0.33
Nodes (6): Navigation Standardization Report, Dashboard Loaders, Lists Dashboard Loaders, Widget Builder API Endpoints, WidgetManager, Widget Manifest
...
## Knowledge Gaps
- **2947 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2942 more)
...
- **Why does `main()` connect `Community 1` to `Community 3`, `Community 134`, `Community 135`, `Community 264`, `Community 265`, `Community 144`, `Community 147`, `Community 148`, `Community 21`, `Community 150`, `Community 23`, `Community 22`, `Community 283`, `Community 285`, `Community 158`, `Community 31`, `Community 288`, `Community 289`, `Community 164`, `Community 167`, `Community 42`, `Community 43`, `Community 299`, `Community 45`, `Community 46`, `Community 48`, `Community 308`, `Community 54`, `Community 182`, `Community 183`, `Community 184`, `Community 190`, `Community 320`, `Community 193`, `Community 65`, `Community 198`, `Community 70`, `Community 72`, `Community 71`, `Community 75`, `Community 79`, `Community 82`, `Community 84`, `Community 85`, `Community 214`, `Community 213`, `Community 88`, `Community 217`, `Community 91`, `Community 92`, `Community 94`, `Community 223`, `Community 224`, `Community 225`, `Community 226`, `Community 103`, `Community 232`, `Community 233`, `Community 106`, `Community 116`, `Community 246`, `Community 247`, `Community 124`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.176) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 106` to `Community 256`, `Community 1`, `Community 2`, `Community 3`, `Community 258`, `Community 135`, `Community 9`, `Community 266`, `Community 11`, `Community 140`, `Community 12`, `Community 145`, `Community 18`, `Community 17`, `Community 19`, `Community 21`, `Community 150`, `Community 23`, `Community 24`, `Community 22`, `Community 30`, `Community 33`, `Community 37`, `Community 169`, `Community 42`, `Community 44`, `Community 45`, `Community 49`, `Community 50`, `Community 308`, `Community 56`, `Community 58`, `Community 59`, `Community 188`, `Community 186`, `Community 65`, `Community 198`, `Community 71`, `Community 76`, `Community 77`, `Community 79`, `Community 83`, `Community 213`, `Community 89`, `Community 219`, `Community 94`, `Community 101`, `Community 110`, `Community 240`, `Community 248`, `Community 250`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 48` to `Community 1`, `Community 3`, `Community 36`, `Community 5`, `Community 39`, `Community 111`, `Community 245`, `Community 151`, `Community 248`, `Community 183`, `Community 26`?**
