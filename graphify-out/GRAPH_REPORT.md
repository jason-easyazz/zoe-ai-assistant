...
## Communities (549 total, 206 thin omitted)
...
Cohesion: 0.02
Nodes (92): Main optimization function, Agent Spike Playbook, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail() (+84 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (88): Send a chat message to Zoe, Send a chat message and validate response, _build_hermes_payload(), _build_panel_intent_card(), _build_reminder_form_props(), _build_research_package(), _capture_research_screenshot(), chat() (+80 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (87): test_zoe_soul_contains_datetime(), Override to customise the prompt per-check., Local voice session WebSocket for voice.html.      Accepts text and binary (audi, websocket_voice(), _bash(), _build_prompt(), _build_tools(), _build_voice_tools() (+79 more)
...
Cohesion: 0.05
Nodes (67): DatabaseValidator, Find all .db files in data directory, Check if file is in a backup/archive location, Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage. (+59 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (46): Health check endpoint.          Returns service health and Agent Zero availabili, health(), test_enabled_status_includes_embedding_config(), test_event_to_hindsight_item_keeps_evidence_and_scope_tags(), test_event_to_hindsight_item_serializes_structured_context_as_json(), test_operation_status_gets_hindsight_operation_endpoint(), test_recall_posts_trace_enabled_request(), test_request_wraps_non_json_response() (+38 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (53): test_dispatch_does_not_parent_recovered_phase_to_blocked_prior_row(), test_poll_v4_partial_clears_stale_prior_phase_blocker(), test_poll_v4_todo_existing_phase_clears_stale_prior_blocker(), test_audit_profile_closeout_requires_log_not_greptile(), test_audit_profile_verify_does_not_require_test(), test_block_preserves_phase_and_evidence_until_restarted(), test_evidence_metadata_rejects_secret_fields(), test_failed_evidence_does_not_satisfy_gate() (+45 more)
...
Cohesion: 0.06
Nodes (64): add_activity(), add_bucket_item(), add_gift_idea(), add_important_date(), add_relationship(), _archive_person_mempalace(), create_people_field(), create_person() (+56 more)
...
Cohesion: 0.06
Nodes (52): Get current playback state from an AirPlay device, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100)., Send message to device via WebSocket., Broadcast to all user's devices., Pause playback in a zone, Seek to position in a zone (+44 more)
...
Cohesion: 0.08
Nodes (25): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., Play a track on the target device.                  Args:             track_id:, Lazy load event tracker., Add a track to the queue.                  Args:             position: If specif, Update playback state in database. (+17 more)
...
Cohesion: 0.07
Nodes (40): create_event(), delete_event(), _enforce_calendar_read_access(), get_event(), list_events(), list_today_events(), FastAPI router for calendar events. Mounted at prefix="/api/calendar" with tag ", Get a single event by ID. (+32 more)
...
Cohesion: 0.08
Nodes (38): get_compat_db(), Async context manager yielding AsyncpgCompat wrapping a pooled connection., close_stale_autopilot_wrappers(), _fire_autopilot_job(), get_autopilot_triggers(), get_multica_autopilots(), _hermes_agent_id(), _is_configured() (+30 more)
...
Cohesion: 0.12
Nodes (20): Get a specific provider by type.                  Args:             provider_typ, _get(), Return Atomic semantic hits as normalized records., _build_metadata(), _idempotency_key(), MemoryRef, _metadata_value(), _promote_event_metadata() (+12 more)

### Community 52 - "Community 52"
Cohesion: 0.09
Nodes (27): MULClient, list_projects(), evolution_proposal_action(), Act on an evolution proposal: approve|reject|defer.      On approve: creates a M, _headers(), get_multica_client(), _lookup_evolution_resources(), _multica_env_key() (+19 more)
...
Cohesion: 0.07
Nodes (30): Get all discovered AirPlay devices, Get all discovered Chromecast devices, Discover available AirPlay devices., Refresh the device list., Start AirPlay device discovery., Disconnect from all devices., DeviceInfo, discover_devices() (+22 more)
...
Cohesion: 0.06
Nodes (22): Check a single router file for authentication issues.     Returns list of (line_, check_file(), Check a single file for hardcoded database paths, check_api_endpoints(), check_ui_pages(), Check database table schemas, Test critical API endpoints, Audit PROJECT_ROOT root (+14 more)
...
Cohesion: 0.09
Nodes (29): Insert a proactive_scheduled row and register an APScheduler job.     Returns th, schedule_reminder(), init_pool(), Initialize the asyncpg connection pool. Call once at startup., _active_agents_list(), _enqueue_panel_tool(), _execute_tool(), _get_weather_default_location() (+21 more)
...
Cohesion: 0.1
Nodes (21): get_db(), FakeCursor, db_compat.py — asyncpg compatibility shim providing an aiosqlite-style cursor AP, Buffered cursor wrapping a list of asyncpg Records., _adapt_params(), close_pool(), _Cursor, get_pool() (+13 more)
...
Cohesion: 0.14
Nodes (24): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, OutputState, OutputType, Types of output targets., Playback state of an output. (+16 more)

### Community 91 - "Community 91"
Cohesion: 0.13
Nodes (24): _env_float(), _config_values(), _env_bool_snapshot(), _env_float_snapshot(), GraphitiSidecarProbeResult, _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers() (+16 more)
...
Cohesion: 0.11
Nodes (14): Search for k most similar tracks.                  Args:             query: 256-, Search with similarity scores.                  Args:             query: 256-dim, Search YouTube Music.                  Search works without authentication using, Return mock results when not authenticated., Protocol, FakeMemoryService, FakeRef, test_recall_text_from_results_supports_refs_dicts_and_strings() (+6 more)
...
Cohesion: 0.11
Nodes (21): board_approve(), create_engineering_workflow_task(), get_agent_board(), list_engineering_workflow_tasks(), multica_webhook(), _multica_webhook_dispatch_allowed(), Return Multica engineering ticket state for AG-UI display.      Falls back grace, Create a Hermes-assigned Multica issue and dispatch it via the executor seam. (+13 more)
...
Cohesion: 0.1
Nodes (17): IntEnum, _ConnState, _DataPacket, _Frame, _LocalParticipant, make_audio_stream(), make_room(), livekit_aiortc.py — LiveKit room participant using pure-Python aiortc.  Replaces (+9 more)
...
Cohesion: 0.11
Nodes (20): Shut down APScheduler and the slow loop., stop_proactive_engine(), cancel_job(), get_scheduler(), _jobstore_url(), APScheduler wrapper (Tier 1 — precision scheduling).  Uses PostgreSQL job store, Prefer PostgreSQL jobstore; fall back to SQLite for local dev., Schedule func(**kwargs) at run_at (UTC datetime). Returns job_id. (+12 more)
...
Cohesion: 0.11
Nodes (17): test_block_fingerprint_aborts_after_two_identical(), test_build_scope_split_packet_preserves_worker_reason(), test_explicit_scope_split_is_allowed_from_scout(), test_repeated_scope_split_is_still_implement_only(), block_fingerprint(), build_scope_split_packet(), evidence_kinds(), implement_validator_hash() (+9 more)
...
Cohesion: 0.14
Nodes (10): test_dispatch_after_scout_evidence_creates_next_phase(), test_poll_v4_audit_protocol_recovery_reports_partial_for_next_phase(), test_mark_greptile_passes_only_on_five_of_five(), test_mark_reviewed_requires_zero_critical(), test_mark_tested_records_hashed_evidence(), test_record_evidence_retries_once_after_journal_conflict(), test_split_ticket_does_not_save_pipeline_block_when_children_fail(), test_split_ticket_does_not_save_pipeline_block_when_parent_update_fails() (+2 more)
...
Cohesion: 0.11
Nodes (19): _execute_calculate(), _execute_daily_briefing(), _execute_greeting(), execute_intent(), _execute_music_intent(), _execute_music_setup(), _execute_set_volume_intent(), _execute_smart_home_intent() (+11 more)
...
Cohesion: 0.12
Nodes (11): MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play previous track (from history)., Controls music playback across devices.          Supports:     - Browser/panel p, Get the current queue., Reorder a track in the queue., Play on Home Assistant media_player in room., Pre-fetch stream URL for next track in queue (runs in background). (+3 more)
...
Cohesion: 0.19
Nodes (16): HA full-setup shorthand intent and OpenClaw message expansion., test_detect_ha_full_setup(), test_execute_ha_full_setup_returns_none(), test_openclaw_user_message_expands_with_intent(), test_openclaw_user_message_expands_without_intent(), detect_intent(), _infer_list(), _is_ha_full_setup_message() (+8 more)
...
Cohesion: 0.29
Nodes (6): Sync user to Matrix homeserver          Args:         request: Sync request, Sync all users to SSO services          Args:         services: List of service, sync_all_users_to_services(), sync_user_to_matrix(), Sync Zoe user to Matrix homeserver                  Args:             user_id: Z, Create new Matrix user
...
Cohesion: 0.47
Nodes (6): _build_calendar_form_props(), _intent_action_form_payload(), Build a panel_show_action_form payload for intents that show an in-place overlay, _build_command(), _parse_date(), _parse_time()
...
- **Why does `main()` connect `Community 1` to `Community 128`, `Community 130`, `Community 260`, `Community 5`, `Community 6`, `Community 261`, `Community 137`, `Community 16`, `Community 146`, `Community 21`, `Community 24`, `Community 25`, `Community 282`, `Community 27`, `Community 156`, `Community 28`, `Community 29`, `Community 26`, `Community 283`, `Community 293`, `Community 165`, `Community 173`, `Community 48`, `Community 50`, `Community 52`, `Community 310`, `Community 189`, `Community 319`, `Community 193`, `Community 194`, `Community 195`, `Community 69`, `Community 70`, `Community 71`, `Community 329`, `Community 74`, `Community 73`, `Community 204`, `Community 77`, `Community 202`, `Community 203`, `Community 81`, `Community 82`, `Community 83`, `Community 85`, `Community 213`, `Community 119`, `Community 88`, `Community 91`, `Community 92`, `Community 221`, `Community 222`, `Community 223`, `Community 94`, `Community 95`, `Community 224`, `Community 104`, `Community 235`, `Community 236`, `Community 245`, `Community 247`, `Community 120`, `Community 121`, `Community 123`?**
  _High betweenness centrality (0.179) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 95` to `Community 1`, `Community 2`, `Community 3`, `Community 258`, `Community 5`, `Community 6`, `Community 130`, `Community 129`, `Community 137`, `Community 10`, `Community 11`, `Community 15`, `Community 272`, `Community 145`, `Community 147`, `Community 20`, `Community 25`, `Community 26`, `Community 156`, `Community 29`, `Community 35`, `Community 36`, `Community 47`, `Community 50`, `Community 51`, `Community 52`, `Community 310`, `Community 55`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 196`, `Community 197`, `Community 69`, `Community 71`, `Community 202`, `Community 75`, `Community 204`, `Community 76`, `Community 81`, `Community 82`, `Community 85`, `Community 86`, `Community 214`, `Community 93`, `Community 98`, `Community 102`, `Community 237`, `Community 111`, `Community 243`, `Community 244`, `Community 118`, `Community 119`, `Community 248`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 27` to `Community 1`, `Community 2`, `Community 194`, `Community 9`, `Community 41`, `Community 44`, `Community 239`, `Community 116`, `Community 244`, `Community 22`, `Community 89`?**
