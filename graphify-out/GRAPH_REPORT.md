...
## Summary
- 8263 nodes · 14716 edges · 543 communities (352 shown, 191 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2115 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c766e2b1`
...
- `Chat Backend (chat.py)` --conceptually_related_to--> `Action Plan Progress Report`  [INFERRED]
  services/zoe-core/routers/chat.py → docs/architecture/ACTION_PLAN_PROGRESS.md
- `Chat Backend (chat.py)` --conceptually_related_to--> `LLM Capabilities Awareness Audit`  [INFERRED]
  services/zoe-core/routers/chat.py → docs/architecture/LLM_CAPABILITIES_AUDIT.md
...
Cohesion: 0.04
Nodes (52): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker. (+44 more)
...
Cohesion: 0.07
Nodes (67): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, OutputState, OutputType, Types of output targets., Playback state of an output. (+59 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (66): a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_cancel(), board_review(), build_engineering_guard_packet(), delegate_to_agent(), _EngineeringGuardRunRequest (+58 more)
...
Cohesion: 0.05
Nodes (46): test_dispatch_adjusts_running_scout_journal_when_scout_row_is_done(), test_dispatch_adjusts_stale_scout_journal_for_scope_split_child(), test_dispatch_archives_stale_terminal_revision_phase_row(), test_dispatch_does_not_adjust_running_scout_journal_with_active_row(), test_poll_v4_audit_protocol_recovery_reports_partial_for_next_phase(), test_mark_greptile_passes_only_on_five_of_five(), test_mark_reviewed_requires_zero_critical(), test_mark_tested_records_hashed_evidence() (+38 more)
...
Cohesion: 0.1
Nodes (37): _promotion_plan(), _source_text(), test_profile_patch_writer_blocks_missing_source_profile(), test_profile_patch_writer_blocks_stale_source_trust_level(), test_profile_patch_writer_blocks_unapplyable_promotion_plan(), test_profile_patch_writer_renders_deterministic_unified_diff(), test_profile_patch_writer_validates_record_and_plan_invariants(), _review_result() (+29 more)
...
Cohesion: 0.07
Nodes (40): add_item(), create_list(), delete_item(), delete_list(), get_list(), get_list_types(), list_items(), list_lists() (+32 more)
...
Cohesion: 0.08
Nodes (37): board_approve(), create_engineering_workflow_task(), evolution_proposal_action(), list_engineering_workflow_tasks(), multica_webhook(), Create a Hermes-assigned Multica issue and dispatch it via the executor seam., Receive Multica webhook events and update evolution proposal status., Act on an evolution proposal: approve|reject|defer.      On approve: creates a M (+29 more)
...
Cohesion: 0.09
Nodes (31): BaseHTTPMiddleware, evaluate(), ProactiveTrigger, check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe, TriggerResult, EveningWindDownTrigger (+23 more)
...
Cohesion: 0.11
Nodes (23): Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage., Check for potential security issues., Validates intent system configuration., Run all validations.                  Returns:             True if all validatio (+15 more)
...
Cohesion: 0.08
Nodes (22): migrate_self_entries(), Create self entries for users in the people table, _compute_compatibility(), Compute compatibility score and shared traits between two check-ins., Get all registered providers., test_graphiti_episode_payloads_include_evidence(), test_graphiti_supersession_payloads_have_temporal_order(), test_percentile_rejects_out_of_range_values() (+14 more)
...
Cohesion: 0.07
Nodes (28): Browser Cache Fix - Clear Old Broken State, Cleanup Safety Rules - Mandatory for All AI Assistants, Critical Files - Do Not Delete, Disk Space Protection System, Disk Space Protection - Implementation Complete Summary, Docker Networking Rules - MANDATORY, Enhanced Enforcement System, Hermes Optimization Playbook (+20 more)

### Community 100 - "Community 100"
Cohesion: 0.13
Nodes (24): _env_float(), _config_values(), _env_bool_snapshot(), _env_float_snapshot(), _env_int_snapshot(), GraphitiSidecarProbeResult, _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe. (+16 more)
...
Cohesion: 0.11
Nodes (20): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _append_audit(), _idempotency_key(), MemoryServiceError, Raised for operational failures., Fast metadata-filter read for system prompt injection., Right-to-be-forgotten. Returns number of rows removed. (+12 more)
...
Cohesion: 0.12
Nodes (21): test_summarize_graphiti_scores_reports_latency(), test_maintenance_runner_imports_real_bakeoff_module(), test_score_recall_response_reports_missing_terms(), test_summarize_bakeoff_scores_reports_score_and_latency(), test_summarize_recall_latency_ignores_disabled_latencies_in_mixed_run(), test_summarize_recall_latency_ignores_missing_enabled_latency(), test_summarize_recall_latency_marks_disabled_runs_not_measured(), test_summarize_recall_latency_reports_budget_status() (+13 more)
...
Cohesion: 0.1
Nodes (19): Tests for background_runner enqueue, task lifecycle, and Hermes routing., Requests beyond _MAX_REQUEST_DEPTH must raise ValueError immediately., Requests at exactly _MAX_REQUEST_DEPTH must be accepted., enqueue_background_task should INSERT a row and return the new task id., _run_task should set status='done' and store result when Hermes succeeds., _run_task should set status='error' when Hermes raises an exception., test_enqueue_accepts_max_depth(), test_enqueue_inserts_row_and_returns_id() (+11 more)
...
Cohesion: 0.11
Nodes (18): IntEnum, _AudioStream, _ConnState, _DataPacket, _Frame, _FrameEvent, make_audio_stream(), livekit_aiortc.py — LiveKit room participant using pure-Python aiortc.  Replaces (+10 more)
...
Cohesion: 0.17
Nodes (16): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+8 more)
...
Cohesion: 0.18
Nodes (11): test_disabled_probe_is_acceptable_even_when_tools_are_missing(), test_disabled_runtime_does_not_surface_agent_files(), test_empty_env_does_not_fall_through_to_process_environment(), test_enabled_probe_reports_missing_node_before_pi(), test_enabled_runtime_detects_agent_files(), test_execution_can_be_configured_with_explicit_local_model_flag(), test_malformed_boolean_env_reports_misconfigured(), test_probe_uses_current_process_path_when_env_omits_path() (+3 more)
...
Cohesion: 0.15
Nodes (13): API Versioning Strategy, Chat Page Frontend (chat.html), Desktop Dashboard Fixes Complete, Database 'list_items' Table, Database 'lists' Table, Default Lists (IDs 1-4), GET /api/lists/{list_type} Endpoint, Lists Router Code Fix (+5 more)
...
Cohesion: 0.27
Nodes (12): MCP-Only Architecture for Zoe Modules, Module Intent Auto-Discovery System, Music Module Dependency Audit, Music Module Extraction Plan, Music Module Test Results, Music Routing Options, Zoe Modular Architecture - Complete, MCP Client (+4 more)
...
Cohesion: 0.29
Nodes (7): _compact_context(), HindsightOfflineConfigError, _is_local_or_private_url(), _positive_count(), Hindsight sidecar adapter for Zoe's memory bake-off.  The adapter is disabled by, Raised when Hindsight config would violate Zoe's offline-only rule., _retain_result_succeeded()
...
Cohesion: 0.25
Nodes (7): build_run_at(), _parse_due_time(), Tier 2 trigger: reminder table scanner.  Reads the `reminders` table every slow-, Parse a due_time string into (hour, minute) in 24-hour format.      Handles form, Build a UTC datetime for when the reminder should fire.      The reminder times, Tier 2 trigger that scans the reminders table and auto-schedules     upcoming re, ReminderScanTrigger
...
Cohesion: 0.32
Nodes (8): Cloudflare Tunnel Service, Home Assistant MCP Bridge Service, Home Assistant Service, Keeper.sh Calendar Sync Service, LiveKit Service, Zoe Auth Service, Zoe Database Service, Zoe UI Service
...
Cohesion: 0.25
Nodes (8): AgentZeroAnalyze Intent, AgentZeroCompare Intent, AgentZeroPlan Intent, AgentZeroResearch Intent, Agent Zero Research Skill, Agent Zero Comparison Skill, Agent Zero Planning Skill, Agent Zero Deep Research Skill
...
Cohesion: 0.29
Nodes (7): Action Plan Progress Report, AG-UI Chat Protocol for Zoe, Chat Backend (chat.py), Zoe Code Execution with MCP - Implementation Summary, GPU Model Setup - gemma3n-e2b-gpu:latest, LLM Capabilities Awareness Audit, RouteLLM & LiteLLM Status
...
- **Why does `main()` connect `Community 0` to `Community 131`, `Community 4`, `Community 5`, `Community 134`, `Community 135`, `Community 136`, `Community 137`, `Community 270`, `Community 271`, `Community 16`, `Community 22`, `Community 23`, `Community 152`, `Community 26`, `Community 283`, `Community 291`, `Community 166`, `Community 169`, `Community 41`, `Community 174`, `Community 48`, `Community 49`, `Community 306`, `Community 180`, `Community 54`, `Community 55`, `Community 58`, `Community 187`, `Community 195`, `Community 196`, `Community 69`, `Community 197`, `Community 67`, `Community 328`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 204`, `Community 79`, `Community 81`, `Community 84`, `Community 87`, `Community 216`, `Community 217`, `Community 88`, `Community 91`, `Community 218`, `Community 222`, `Community 98`, `Community 100`, `Community 101`, `Community 122`, `Community 230`, `Community 231`, `Community 229`, `Community 228`, `Community 109`, `Community 238`, `Community 111`, `Community 115`, `Community 248`, `Community 250`, `Community 254`, `Community 127`?**
  _High betweenness centrality (0.178) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 81` to `Community 0`, `Community 2`, `Community 3`, `Community 259`, `Community 4`, `Community 6`, `Community 262`, `Community 8`, `Community 9`, `Community 136`, `Community 131`, `Community 130`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 276`, `Community 146`, `Community 145`, `Community 273`, `Community 22`, `Community 23`, `Community 30`, `Community 31`, `Community 32`, `Community 44`, `Community 48`, `Community 49`, `Community 51`, `Community 55`, `Community 57`, `Community 58`, `Community 190`, `Community 67`, `Community 69`, `Community 71`, `Community 203`, `Community 78`, `Community 209`, `Community 83`, `Community 84`, `Community 87`, `Community 217`, `Community 90`, `Community 89`, `Community 218`, `Community 97`, `Community 105`, `Community 236`, `Community 115`, `Community 116`, `Community 120`, `Community 251`, `Community 253`, `Community 255`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `_FakeAdapter` connect `Community 7` to `Community 1`, `Community 208`, `Community 19`, `Community 20`, `Community 84`, `Community 158`?**
