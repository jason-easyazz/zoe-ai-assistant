...
## Summary
- 7857 nodes · 13592 edges · 567 communities (342 shown, 225 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1766 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f168102d`
...
- `Zoe capability profile contract and seed inventory.  Capability profiles are Zoe` --rationale_for--> `Zoe Capability Profiles`  [EXTRACTED]
  services/zoe-data/zoe_capability_profile.py → docs/architecture/zoe-capability-profiles.md
...
- `Zoe Module System README` --references--> `MCP Client`  [EXTRACTED]
  README_MODULE_SYSTEM.md → services/zoe-ui/dist/js/lib/mcp-client.js

## Communities (567 total, 225 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (82): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail(), _is_allowed_line() (+74 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (88): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+80 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (3): _mock_ensure_worktree(), Tests for the Hermes Kanban executor adapter (CLI mocked)., Dispatch tests must not run real git worktree subprocesses.

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (93): Override to customise the prompt per-check., Resolve a browser session_id to a user_id via zoe-auth HTTP.      Calls the same, Local voice session WebSocket for voice.html.      Accepts text and binary (audi, _resolve_ws_user(), websocket_voice(), _bash(), _build_prompt(), _build_tools() (+85 more)
...
Cohesion: 0.05
Nodes (69): Get current playback state from an AirPlay device, Get a specific device by ID, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100)., Get device info from database., Broadcast to all user's devices., Pause playback in a zone (+61 more)
...
Cohesion: 0.03
Nodes (57): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), Critical Files - Do Not Delete, AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn() (+49 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (48): test_dispatch_after_scout_evidence_creates_next_phase(), test_audit_profile_closeout_requires_log_not_greptile(), test_audit_profile_verify_does_not_require_test(), test_block_preserves_phase_and_evidence_until_restarted(), test_evidence_metadata_rejects_secret_fields(), test_failed_evidence_does_not_satisfy_gate(), test_implement_requires_tool_evidence_before_complete(), test_indeterminate_evidence_does_not_satisfy_gate() (+40 more)
...
Cohesion: 0.05
Nodes (35): Play previous track (from history)., Send message to device via WebSocket., Music Zone Manager Handles multi-zone playback with device routing and state syn, Create a new music zone, Current playback state for a zone, Delete a zone (only owner can delete), Get all zones accessible by a user, Get current playback state for a zone (+27 more)
...
Cohesion: 0.06
Nodes (47): hash_secret(), OIDC client registration and secret verification., Exact match only — no wildcards., Insert or update a client. Safe to call on every startup., upsert_client(), validate_redirect_uri(), consume_auth_code(), delete_pending_auth() (+39 more)
...
Cohesion: 0.07
Nodes (43): board_approve(), create_engineering_workflow_task(), evolution_proposal_action(), get_agent_board(), list_engineering_workflow_tasks(), multica_webhook(), _multica_webhook_dispatch_allowed(), Return Multica engineering ticket state for AG-UI display.      Falls back grace (+35 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (23): Health check endpoint.          Returns service health and Agent Zero availabili, health(), test_enabled_status_includes_embedding_config(), test_operation_status_gets_hindsight_operation_endpoint(), test_recall_posts_trace_enabled_request(), test_request_wraps_non_json_response(), test_retain_posts_to_hindsight_memories_endpoint(), test_retain_refuses_auto_write_when_gate_closed() (+15 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (44): create_event(), delete_event(), _enforce_calendar_read_access(), get_event(), list_events(), list_today_events(), FastAPI router for calendar events. Mounted at prefix="/api/calendar" with tag ", Get a single event by ID. (+36 more)
...
Cohesion: 0.06
Nodes (30): check_permission(), Check if current user has specific permission          Args:         permission:, AccessContext, PermissionResult, Role-Based Access Control (RBAC) System Advanced permission management with inhe, Role-Based Access Control Manager, Check if user has specific permission                  Args:             user_id, Check multiple permissions at once                  Args:             user_id: U (+22 more)
...
Cohesion: 0.1
Nodes (38): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Zoe Evolution Proposal Contract, Zoe Evolution Harness Implementation Status, Enum, str, CardType (+30 more)

### Community 36 - "Community 36"
Cohesion: 0.07
Nodes (41): get_auth_manager(), Get the singleton auth manager instance., Check if user is authenticated with Apple Music., Get developer token for MusicKit JS authentication.                  Apple Music, Complete auth with Music User Token from MusicKit JS.                  The auth_, Disconnect user from Apple Music., Convert Apple Music artist data to Artist., Convert Apple Music playlist data to Playlist. (+33 more)
...
Cohesion: 0.07
Nodes (25): Refresh current session expiration          Args:         current_session: Curre, refresh_session(), EnhancedSessionManager, Enhanced session manager with multi-factor support, Authenticate user and create session                  Args:             request:, Refresh session expiration, Extend session expiry to a fixed number of days from now (used for remember_me)., Invalidate all sessions for user except optionally one (+17 more)
...
Cohesion: 0.09
Nodes (34): BaseHTTPMiddleware, ProactiveTrigger, check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe, TriggerResult, EveningWindDownTrigger, Evening wind-down trigger — journal prompt if user hasn't written in 3+ days. (+26 more)

### Community 48 - "Community 48"
Cohesion: 0.08
Nodes (37): add_item(), create_list(), delete_item(), delete_list(), get_list(), get_list_types(), list_items(), list_lists() (+29 more)
...
Cohesion: 0.09
Nodes (27): Tests for background_runner enqueue, task lifecycle, and Hermes routing., Requests beyond _MAX_REQUEST_DEPTH must raise ValueError immediately., Requests at exactly _MAX_REQUEST_DEPTH must be accepted., enqueue_background_task should INSERT a row and return the new task id., _run_task should set status='done' and store result when Hermes succeeds., _run_task should set status='error' when Hermes raises an exception., Minimal async DB context that records calls., test_enqueue_accepts_max_depth() (+19 more)

### Community 52 - "Community 52"
Cohesion: 0.08
Nodes (26): Minimal compatibility wrapper so person_extractor works with raw asyncpg., get_db(), FakeCursor, db_compat.py — asyncpg compatibility shim providing an aiosqlite-style cursor AP, Buffered cursor wrapping a list of asyncpg Records., Thin wrapper around asyncpg Connection providing aiosqlite-compatible execute AP, _adapt_params(), AsyncpgCompat (+18 more)
...
Cohesion: 0.08
Nodes (26): DatabaseValidator, Find all .db files in data directory, Check if file is in a backup/archive location, Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage. (+18 more)
...
Cohesion: 0.1
Nodes (29): get_pending_notifications(), list_notifications(), mark_read(), FastAPI router for notifications. Mounted at prefix="/api/notifications" with ta, Mark a notification as read/delivered., Delete a notification., List notifications for the current user., Get unread/pending notifications count and items. (+21 more)
...
Cohesion: 0.11
Nodes (18): Start AirPlay device discovery., Initialize the output target.                  Override this for setup that need, Start Chromecast discovery., Discover media_player entities., Initialize all available output targets., Get all available devices from all output types., Initialize all available providers.                  Called on startup to regist, _AcpBridge (+10 more)
...
Cohesion: 0.1
Nodes (24): Normalize a YouTube Music item to standard format., Make a request to the Home Assistant API., AppleMusicProvider, Get user's Music User Token from database., Make authenticated API request., Convert Apple Music track data to Track., Search for tracks on Apple Music., Apple Music implementation of MusicProvider.          Uses the Apple Music API w (+16 more)

### Community 84 - "Community 84"
Cohesion: 0.09
Nodes (23): _board(), _expected_phases(), KanbanCLIError, _protocol_violation_count(), Report aggregate state of a chain by idempotency-key prefix.          Returns {f, Pull a PR URL from the implement/closeout task summaries or comments., Raised when a hermes kanban CLI call fails., Correlate a Kanban list row back to its ``multica:{id}:{phase}`` ref.      The l (+15 more)
...
Cohesion: 0.11
Nodes (25): test_block_fingerprint_aborts_after_two_identical(), test_build_scope_split_packet_preserves_worker_reason(), test_explicit_scope_split_is_allowed_from_scout(), test_repeated_scope_split_is_still_implement_only(), block_fingerprint(), build_scope_split_packet(), can_complete_phase(), evidence_kinds() (+17 more)
...
Cohesion: 0.13
Nodes (3): MusicQueueWidget, MusicSearchWidget, Remove a track from the queue.                  Args:             position: If s
...
Cohesion: 0.11
Nodes (21): FileSystemEventHandler, Admin-only: force-flush the skill discovery cache for a peer agent., reload_peer_skills(), invalidate_hermes_cache(), invalidate_openclaw_cache(), _parse_hermes_category(), parse_hermes_skills(), _parse_openclaw_skill() (+13 more)
...
Cohesion: 0.13
Nodes (24): Request model for research endpoint., ResearchRequest, build_package(), _clean_html_text(), _decode_ddg_href(), default_source_for_query(), _extract_price_from_html_text(), _extract_url_price_pairs() (+16 more)
...
Cohesion: 0.16
Nodes (23): test_dispatch_skips_scout_for_code_audit_ticket_block(), test_create_issue_metadata_preserves_existing_ticket_fields(), test_update_ticket_progress_can_clear_dispatch_approval(), test_block_only_description_does_not_gain_leading_blank_lines(), test_progress_and_children_patch_metadata_only(), test_replacing_middle_block_preserves_suffix_newline(), test_ticket_block_preserves_human_description(), test_ticket_block_replaces_only_zoe_section() (+15 more)
...
Cohesion: 0.19
Nodes (17): test_build_memory_route_trace_requires_user_for_personal_scope(), test_collect_memory_route_trace_rejects_non_memory_surface(), test_disabled_runtime_does_not_compute_route_decision(), test_disabled_runtime_trace_is_skipped_and_does_not_route(), test_memory_router_runtime_enabled_is_observe_only(), test_memory_router_runtime_is_disabled_by_default(), test_runtime_route_can_include_observation_trace(), test_runtime_route_personal_trace_requires_user_id() (+9 more)
...
Cohesion: 0.13
Nodes (20): _build_compact(), _build_federation_skills_md(), _collect_intent_patterns(), _collect_mcp_tools(), _collect_openclaw_skills(), _collect_ui_pages(), _env_enabled(), graphify_search() (+12 more)
...
Cohesion: 0.12
Nodes (19): Register a Tier 2 slow-loop trigger., register_trigger(), load_device_tokens(), Load all active device tokens from DB into the in-memory cache (call at startup), Start the nightly memory digest loop (if not disabled)., start_memory_digest_background(), hermes_api_key(), lifespan() (+11 more)

### Community 140 - "Community 140"
Cohesion: 0.12
Nodes (18): accept_pending_suggestion(), dismiss_pending_suggestion(), list_pending_suggestions(), list_schedules(), Proactive Engine REST router.  Endpoints:   POST   /api/proactive/schedule, Manually trigger the morning brief for the calling user.     Useful for testing, List unresolved save offers for the current chat session., Execute a pending save offer (direct API — no intent re-parse). (+10 more)

### Community 141 - "Community 141"
Cohesion: 0.14
Nodes (19): _memory_digest_loop(), Wait until 3am, then run LLM digest for all active users daily., Manually trigger full nightly dreaming cycle including evolution notice (admin o, trigger_run_digest(), _load_recent_misses(), _load_target_patterns(), _proposal_exists(), evolution_notice.py — Phase 6 of the nightly dreaming cycle.  NOTICE phase of th (+11 more)
...
Cohesion: 0.2
Nodes (15): _env_float(), _config_values(), _env_bool_snapshot(), _env_float_snapshot(), GraphitiSidecarProbeResult, _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers() (+7 more)
...
Cohesion: 0.2
Nodes (3): saveZoneEditor(), showToast(), MusicPlaylistsWidget

### Community 171 - "Community 171"
Cohesion: 0.12
Nodes (10): MediaController, Media Controller ================  Routes playback commands to appropriate devic, Controls music playback across devices.          Supports:     - Browser/panel p, Get the current queue., Reorder a track in the queue., Play on Home Assistant media_player in room., Update playback state in database., Pre-fetch stream URL for next track in queue (runs in background). (+2 more)
...
Cohesion: 0.19
Nodes (13): test_event_to_hindsight_item_keeps_evidence_and_scope_tags(), test_event_to_hindsight_item_serializes_structured_context_as_json(), _compact_context(), _embeddings_base_url_from_env(), _env_bool(), event_to_hindsight_item(), from_env(), HindsightOfflineConfigError (+5 more)
...
Cohesion: 0.18
Nodes (15): test_dump_and_load_contract_snapshot_round_trip(), test_loader_rejects_legacy_non_contract_payloads(), test_mcp_contract_snapshot_has_source_evidence_when_freeform_evidence_is_empty(), test_mcp_contract_snapshot_is_valid_and_review_only(), test_normalize_mcp_evolution_proposal_type_matches_contract_fallback(), test_unknown_legacy_type_falls_back_to_intent_pattern(), build_mcp_evolution_proposal_contract(), dump_mcp_evolution_proposal_contract() (+7 more)
...
Cohesion: 0.24
Nodes (15): test_failed_outcome_trace_becomes_notice_signal_when_repeated(), test_failed_outcome_trace_respects_existing_signal_ids(), test_failed_outcome_trace_threshold_is_repeat_count_two(), test_memory_route_trace_allows_safe_metadata_without_evidence(), test_metadata_allows_author_attribution_key(), test_metadata_rejects_secret_keys(), test_metadata_rejects_secret_keys_inside_lists(), test_personal_trace_requires_user_id() (+7 more)
...
Cohesion: 0.13
Nodes (12): Proactive adapters — thin wrappers that translate external service events into T, Executor adapters for Multica-dispatched work.  Multica is the agnostic source o, get_capabilities(), Music Service Module ====================  Platform-aware music system with: - Y, Get music system capabilities for this platform.          Returns:         Dict, Music Output Targets Package ============================  Unified interface for, Zoe Proactive Engine — public surface., Music Providers Package =======================  Unified interface for music str (+4 more)
...
Cohesion: 0.23
Nodes (12): Get user information (without sensitive data), verify_secret(), get_jwks(), Return JWKS dict with all active public keys., _base_url(), _get_user_info(), jwks(), Native OIDC provider endpoints for zoe-auth. (+4 more)
...
Cohesion: 0.5
Nodes (4): Print test results summary, print_summary(), Print completion summary, Print benchmark summary
...
## Knowledge Gaps
- **2892 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2887 more)
...
- **Why does `main()` connect `Community 0` to `Community 1`, `Community 4`, `Community 261`, `Community 267`, `Community 144`, `Community 148`, `Community 21`, `Community 278`, `Community 20`, `Community 24`, `Community 25`, `Community 153`, `Community 27`, `Community 28`, `Community 285`, `Community 284`, `Community 158`, `Community 160`, `Community 163`, `Community 166`, `Community 40`, `Community 176`, `Community 50`, `Community 306`, `Community 52`, `Community 56`, `Community 188`, `Community 189`, `Community 190`, `Community 61`, `Community 317`, `Community 193`, `Community 194`, `Community 62`, `Community 326`, `Community 70`, `Community 72`, `Community 78`, `Community 81`, `Community 210`, `Community 211`, `Community 84`, `Community 85`, `Community 213`, `Community 87`, `Community 89`, `Community 90`, `Community 219`, `Community 220`, `Community 221`, `Community 95`, `Community 100`, `Community 229`, `Community 102`, `Community 230`, `Community 110`, `Community 113`, `Community 115`, `Community 244`, `Community 243`, `Community 246`, `Community 118`, `Community 121`, `Community 122`, `Community 124`?**
  _High betweenness centrality (0.167) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 102` to `Community 0`, `Community 1`, `Community 3`, `Community 132`, `Community 5`, `Community 4`, `Community 131`, `Community 136`, `Community 263`, `Community 138`, `Community 10`, `Community 16`, `Community 273`, `Community 144`, `Community 148`, `Community 21`, `Community 20`, `Community 23`, `Community 25`, `Community 27`, `Community 28`, `Community 31`, `Community 35`, `Community 43`, `Community 44`, `Community 45`, `Community 174`, `Community 49`, `Community 306`, `Community 51`, `Community 52`, `Community 182`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`, `Community 62`, `Community 194`, `Community 195`, `Community 205`, `Community 211`, `Community 84`, `Community 95`, `Community 225`, `Community 227`, `Community 105`, `Community 240`, `Community 245`, `Community 118`, `Community 117`, `Community 120`, `Community 124`, `Community 254`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `get_memory_service()` connect `Community 24` to `Community 0`, `Community 3`, `Community 131`, `Community 136`, `Community 9`, `Community 265`, `Community 139`, `Community 14`, `Community 30`, `Community 297`, `Community 47`, `Community 181`, `Community 57`, `Community 58`, `Community 192`, `Community 197`, `Community 207`, `Community 103`, `Community 125`?**
