...
## Summary
- 8164 nodes · 14516 edges · 540 communities (336 shown, 204 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2044 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2e9cbc7a`
...
- `Zoe Orb System` --conceptually_related_to--> `RouteLLM (Intelligent Model Router)`  [INFERRED]
  docs/architecture/ZOE_ORB_SYSTEM.md → services/zoe-core/route_llm.py
...
- `Zoe Memory Read Write Inventory` --conceptually_related_to--> `MemAgent (Memory Agent)`  [INFERRED]
  docs/architecture/zoe-memory-read-write-inventory.md → services/zoe-core/mem_agent_client.py
- `PersonExpert Analysis & Recommendation` --conceptually_related_to--> `MemAgent (Memory Agent)`  [INFERRED]
  docs/architecture/PERSON_EXPERT_RECOMMENDATION.md → services/zoe-core/mem_agent_client.py

## Communities (540 total, 204 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (143): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, get_auth_manager(), Get the singleton auth manager instance., Get track metadata from cache., get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us, Get or create a YTMusic client for a user.                  Args:             us (+135 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (59): _should_supersede_voice_weather_action(), _FakeAdapter, Tests for the Hermes Kanban executor adapter (CLI mocked)., A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., KanbanAdapter with the CLI replaced by a scripted recorder., _row(), test_dispatch_blocks_existing_pr_revision_when_precheckout_fails(), test_dispatch_blocks_on_first_worker_failure() (+51 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (95): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail(), _is_allowed_line() (+87 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (90): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+82 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (92): Override to customise the prompt per-check., Resolve a browser session_id to a user_id via zoe-auth HTTP.      Calls the same, Local voice session WebSocket for voice.html.      Accepts text and binary (audi, _resolve_ws_user(), websocket_voice(), _bash(), _build_memory_context(), _build_prompt() (+84 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (74): Create a multi-step plan for a task.                  Args:             task: Ta, plan(), Planning endpoint - creates multi-step plans.          Uses Agent Zero to:, Decision Log, _promotion_plan(), _source_text(), test_profile_patch_writer_blocks_missing_source_profile(), test_profile_patch_writer_blocks_stale_source_trust_level() (+66 more)
...
Cohesion: 0.03
Nodes (62): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), Critical Files - Do Not Delete, AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn() (+54 more)
...
Cohesion: 0.07
Nodes (66): Enum, OutputState, OutputType, Types of output targets., Playback state of an output., AuthStatus, ProviderType, Supported music provider types. (+58 more)
...
Cohesion: 0.04
Nodes (63): _broadcast_calendar_chat_prefill_ui(), _broadcast_shopping_chat_ui(), chatgpt_auth_status(), _env_int(), _extract_complete_sentences(), _get_faster_whisper_model(), _get_kokoro_instance(), get_livekit_token() (+55 more)
...
Cohesion: 0.04
Nodes (58): MULClient, a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_cancel(), board_review(), build_engineering_guard_packet(), delegate_to_agent() (+50 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (61): AuthResponse, escalate_session(), get_current_user(), get_passcode_status(), get_user_profile(), guest_login(), InitialPasswordSetupRequest, login() (+53 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (56): check_module_structure(), Check if a file exists, Check if a module has required classes, Verify all enhancement systems, verify_enhancements(), print_results(), Scan entire project and categorize all files., Check if path should be ignored. (+48 more)
...
Cohesion: 0.07
Nodes (49): Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage., Check for potential security issues., Validates intent system configuration., Run all validations.                  Returns:             True if all validatio (+41 more)
...
Cohesion: 0.06
Nodes (50): Seek to position in current track., Set playback volume (0-100)., Send message to device via WebSocket., Broadcast to all user's devices., Pause playback in a zone, Resume playback in a zone, Seek to position in a zone, Set volume for a zone (+42 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (37): list_users(), Get all active sessions for a specific user (admin only)          Args:, List all users (admin only)          Args:         active_only: Filter to active, get_user_sessions(), Refresh current session expiration          Args:         current_session: Curre, Get all active sessions for current user          Args:         current_session:, refresh_session(), Verify user password                  Args:             user_id: User identifier (+29 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (52): clear_all_device_caches(), clear_device_cache(), get_cached_users(), get_device_config(), get_device_status(), list_touch_panel_devices(), quick_user_switch(), QuickSwitchRequest (+44 more)
...
Cohesion: 0.05
Nodes (52): Test that pattern extraction is fast enough for nightly jobs, fresh_collection(), _install_mempalace_stubs(), Comprehensive MemPalace integration tests.  Tests: user isolation, upsert behavi, Install mempalace module stubs so zoe_agent doesn't require the real package., Reset the in-memory Chroma collection before each test.      Also resets the Mem, Writing for 'jason' must not appear when loading facts for 'family-admin'., Deleting a CRM entity should archive all scoped MemPalace facts for it. (+44 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (50): _build_calendar_form_props(), _intent_action_form_payload(), Build a panel_show_action_form payload for intents that show an in-place overlay, HA full-setup shorthand intent and OpenClaw message expansion., test_detect_ha_full_setup(), test_execute_ha_full_setup_returns_none(), test_openclaw_user_message_expands_with_intent(), test_openclaw_user_message_expands_without_intent() (+42 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (49): _audit_no_pr_issue(), _chain_for_issue(), _code_audit_implement_hint(), _engineering_mode(), _escalation_model_hint(), _existing_pr_url(), _expected_phases(), _goal_mode_args() (+41 more)
...
Cohesion: 0.06
Nodes (52): run_music_digest(), Write a journal-derived fact to MemPalace through MemoryService., _store_journal_memory(), Manually trigger the LLM memory digest for a user (or the requesting user)., trigger_memory_digest(), _build_morning_context(), Collect open loops, emotional moments, calendar events, and portrait for the bri, _deep_sleep_pass() (+44 more)
...
Cohesion: 0.06
Nodes (42): Start discovering AirPlay devices, Get all discovered AirPlay devices, Get all discovered Chromecast devices, Get a specific device by ID, Get device info from database., AirPlayOutput, get_airplay_output(), Discover available AirPlay devices. (+34 more)

### Community 36 - "Community 36"
Cohesion: 0.07
Nodes (41): list_projects(), evolution_proposal_action(), Act on an evolution proposal: approve|reject|defer.      On approve: creates a M, close_stale_autopilot_wrappers(), _fire_autopilot_job(), get_autopilot_triggers(), get_multica_autopilots(), _headers() (+33 more)
...
Cohesion: 0.06
Nodes (44): get_reports(), create_entry(), delete_entry(), get_entry(), get_mood_stats(), get_prompts(), get_streak_stats(), list_entries() (+36 more)

### Community 39 - "Community 39"
Cohesion: 0.06
Nodes (43): hash_secret(), OIDC client registration and secret verification., Exact match only — no wildcards., Insert or update a client. Safe to call on every startup., upsert_client(), validate_redirect_uri(), verify_secret(), consume_auth_code() (+35 more)
...
Cohesion: 0.06
Nodes (31): AirPlayDevice, AirPlayService, AirPlay Integration Service Discovers and controls AirPlay devices for music pla, Connect to an AirPlay device, Play media on an AirPlay device                  Args:             device_id: Ta, Represents a discovered AirPlay device, Send a control command to an AirPlay device                  Args:             d, Get current playback state from an AirPlay device (+23 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (26): Sync user to Matrix homeserver          Args:         request: Sync request, sync_user_to_matrix(), create_synapse_auth_provider(), MatrixIntegration, MatrixUser, Matrix (Synapse/Dendrite) SSO Integration Authentication provider for Matrix hom, Sync Zoe user to Matrix homeserver                  Args:             user_id: Z, Deactivate Matrix user                  Args:             username: Username to (+18 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (25): Play previous track (from history)., Music Zone Manager Handles multi-zone playback with device routing and state syn, Create a new music zone, Current playback state for a zone, Delete a zone (only owner can delete), Get all zones accessible by a user, Add a device to a zone, Remove a device from a zone (+17 more)
...
Cohesion: 0.11
Nodes (21): Get a specific provider by type.                  Args:             provider_typ, _get(), Return Atomic semantic hits as normalized records., _build_metadata(), _idempotency_key(), MemoryRef, _metadata_value(), _promote_event_metadata() (+13 more)
...
Cohesion: 0.11
Nodes (16): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., Play a track on the target device.                  Args:             track_id:, Lazy load event tracker., Add a track to the queue.                  Args:             position: If specif, Start playback in a zone (+8 more)
...
Cohesion: 0.06
Nodes (24): Check a single router file for authentication issues.     Returns list of (line_, check_file(), Check a single file for hardcoded database paths, check_api_endpoints(), check_router_expectations(), check_ui_pages(), Check database table schemas, Check what routers expect vs what database has (+16 more)
...
Cohesion: 0.06
Nodes (34): _broadcast_calendar_ui(), _broadcast_lets_talk_ui(), _broadcast_reminder_ui(), _broadcast_weather_ui(), _contains_decision_keyword(), _get_or_create_voice_session(), _handle_introduce_intent(), _load_voice_history() (+26 more)
...
Cohesion: 0.06
Nodes (28): Proactive adapters — thin wrappers that translate external service events into T, Executor adapters for Multica-dispatched work.  Multica is the agnostic source o, get_capabilities(), Music Service Module ====================  Platform-aware music system with: - Y, Get music system capabilities for this platform.          Returns:         Dict, Music Output Targets Package ============================  Unified interface for, Zoe Proactive Engine — public surface., claim_pending() (+20 more)

### Community 71 - "Community 71"
Cohesion: 0.11
Nodes (31): Tests for main.py Multica poll-loop helpers., RecordingClient, test_record_blocked_multica_chain_creates_budget_followup_once(), test_record_blocked_multica_chain_creates_iteration_budget_followup(), test_record_blocked_multica_chain_creates_protocol_followup(), test_record_blocked_multica_chain_does_not_create_recursive_harness_followup(), test_record_blocked_multica_chain_falls_back_to_classification_and_default(), test_record_blocked_multica_chain_records_terminal_block_metadata() (+23 more)
...
Cohesion: 0.08
Nodes (18): HomeAssistantIntegration, initialize_ha_integration(), Sync user deletion to Home Assistant                  Args:             username, Authenticate user for Home Assistant (called by HA auth provider), Get Home Assistant areas for user assignment, Assign user to specific Home Assistant areas                  Args:, Sync all active Zoe users to Home Assistant                  Returns:, Sync user to HA person entity (+10 more)

### Community 79 - "Community 79"
Cohesion: 0.16
Nodes (27): _retained_outcome(), test_capability_trust_update_blocks_failed_proposal(), test_capability_trust_update_blocks_unretained_outcome(), test_capability_trust_update_candidate_validates_trust_levels(), test_capability_trust_update_candidates_require_retained_verified_outcome(), test_capability_trust_update_metadata_is_read_only_and_serializable(), test_capability_trust_update_skips_trusted_noop_candidate(), _candidate() (+19 more)

### Community 80 - "Community 80"
Cohesion: 0.15
Nodes (30): get_engineering_guard(), PR-keyed Greptile grep-loop guard state., acquire_lock(), analyze_result(), _append_progress(), _ci_status_from_rollup(), _diff_changed_lines(), _diff_files() (+22 more)
...
Cohesion: 0.07
Nodes (18): AnalyzeRequest, Request model for analysis endpoint., Agent Zero Safety Guardrails ============================  Provides safety contr, Check if file path is within allowed directories.                  Args:, Check if system command is whitelisted.                  Args:             comma, Get user-friendly message when capability is blocked.                  Args:, Safety modes for Agent Zero., Safety guardrails for Agent Zero capabilities.          Controls what Agent Zero (+10 more)

### Community 83 - "Community 83"
Cohesion: 0.08
Nodes (27): accept_pending_suggestion(), create_schedule(), dismiss_pending_suggestion(), list_pending_suggestions(), list_schedules(), Proactive Engine REST router.  Endpoints:   POST   /api/proactive/schedule, Manually trigger the morning brief for the calling user.     Useful for testing, List unresolved save offers for the current chat session. (+19 more)

### Community 84 - "Community 84"
Cohesion: 0.13
Nodes (25): test_dispatch_skips_scout_for_code_audit_ticket_block(), test_create_issue_metadata_preserves_existing_ticket_fields(), test_update_ticket_progress_can_clear_dispatch_approval(), test_block_only_description_does_not_gain_leading_blank_lines(), test_progress_and_children_patch_metadata_only(), test_replacing_middle_block_preserves_suffix_newline(), test_ticket_block_preserves_human_description(), test_ticket_block_replaces_only_zoe_section() (+17 more)
...
Cohesion: 0.07
Nodes (26): db_conn(), Integration tests: People CRM — PostgreSQL + MemPalace sync.  Tests the dual fan, All CRM tables must exist., 0007 migration columns must exist on people table., The /api/people/fields route fix: /fields must come before /{person_id} in sourc, Open an asyncpg connection for tests., New people table has circle, health_score, notification_count columns., test_create_person_has_crm_columns() (+18 more)
...
Cohesion: 0.1
Nodes (18): ProjectCleaner, Find outdated/redundant documentation, Find Mac OS resource fork files, Find archive folders that can be removed, Find files that are known to be broken, Analyze entire project structure, Find all backup files, Find duplicate router files in archive folder (+10 more)
...
Cohesion: 0.1
Nodes (25): init_pool(), Initialize the asyncpg connection pool. Call once at startup., _active_agents_list(), _enqueue_panel_tool(), _execute_tool(), _get_weather_default_location(), handle_tool(), _load_agents_registry() (+17 more)
...
Cohesion: 0.1
Nodes (19): generate_report(), Generate audit report, Generate final audit report, Generate cleanup report, Generate consolidation report, Generate a report of tagged files, LLMBenchmark, Analyze response quality based on prompt type and expected behavior (+11 more)
...
Cohesion: 0.12
Nodes (22): BaseHTTPMiddleware, ProactiveTrigger, What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe, TriggerResult, EveningWindDownTrigger, Evening wind-down trigger — journal prompt if user hasn't written in 3+ days., MorningCheckInTrigger (+14 more)
...
Cohesion: 0.14
Nodes (17): test_disabled_probe_is_acceptable_even_when_tools_are_missing(), test_disabled_runtime_does_not_surface_agent_files(), test_empty_env_does_not_fall_through_to_process_environment(), test_enabled_probe_reports_missing_node_before_pi(), test_enabled_runtime_detects_agent_files(), test_execution_can_be_configured_with_explicit_local_model_flag(), test_malformed_boolean_env_reports_misconfigured(), test_probe_uses_current_process_path_when_env_omits_path() (+9 more)
...
Cohesion: 0.13
Nodes (21): test_load_target_patterns_extracts_contract_metadata(), test_measure_phase_treats_contract_target_patterns_as_no_patterns(), test_dump_and_load_contract_snapshot_round_trip(), test_legacy_contract_snapshot_preserves_target_patterns_and_writer(), test_legacy_contract_snapshot_supports_user_issue_report(), test_loader_rejects_legacy_non_contract_payloads(), test_mcp_contract_snapshot_has_source_evidence_when_freeform_evidence_is_empty(), test_mcp_contract_snapshot_is_valid_and_review_only() (+13 more)
...
Cohesion: 0.12
Nodes (13): Search for k most similar tracks.                  Args:             query: 256-, Search YouTube Music.                  Search works without authentication using, Return mock results when not authenticated., Protocol, FakeMemoryService, FakeRef, test_recall_text_from_results_supports_refs_dicts_and_strings(), test_run_mempalace_baseline_scores_fake_service() (+5 more)

### Community 130 - "Community 130"
Cohesion: 0.19
Nodes (18): test_adoption_gate_allows_partial_offline_with_ready_evidence(), test_adoption_gate_allows_strong_compatible_candidate(), test_adoption_gate_blocks_incompatible_license(), test_adoption_gate_blocks_partial_offline_without_ready_evidence(), test_adoption_gate_blocks_pi_until_runtime_prerequisites_are_measured(), test_candidate_score_rejects_out_of_range_values(), test_candidate_score_validates_range_and_normalizes(), test_candidate_validation_rejects_unknown_recommendation() (+10 more)
...
Cohesion: 0.11
Nodes (20): Register a Tier 2 slow-loop trigger., register_trigger(), _blocking_synthesize(), _load_pipeline(), _pcm_to_wav(), Load and return the Kokoro pipeline (blocking; run once in thread pool)., Convert a torch.FloatTensor of PCM samples to WAV bytes.      Uses struct.pack i, Run Kokoro inference synchronously (called inside run_in_executor).      Calls t (+12 more)
...
Cohesion: 0.13
Nodes (13): AirPlay Output Target =====================  Implementation of OutputTarget for, is_initialized(), output_type(), Chromecast Output Target ========================  Implementation of OutputTarge, Home Assistant Output Target ============================  Implementation of Out, get_output_manager(), Output Manager ==============  Central manager for all audio output targets. Han, Get the singleton output manager instance. (+5 more)

### Community 145 - "Community 145"
Cohesion: 0.11
Nodes (12): get_media_controller(), MediaController, Media Controller ================  Routes playback commands to appropriate devic, Controls music playback across devices.          Supports:     - Browser/panel p, Get the current queue., Reorder a track in the queue., Play on Home Assistant media_player in room., Update playback state in database. (+4 more)
...
Cohesion: 0.15
Nodes (17): _extract_memory_candidates(), Back-compat shim: legacy dict shape over the unified extractor.      Kept so in-, test_extracts_preference_signal(), test_no_signal_returns_empty(), Questions must not be extracted as memory facts., test_question_not_extracted(), _clean(), extract_and_ingest() (+9 more)
...
Cohesion: 0.17
Nodes (10): GuardedClient, test_append_issue_note_skips_when_get_issue_fails(), test_record_progress_can_clear_blocker(), test_record_progress_skips_when_get_issue_fails(), test_safe_patch_description_skips_when_get_issue_fails(), Fetch a single issue by ID., Update an issue's status and/or other fields (description, title, etc.)., Patch only the fenced Zoe ticket block in an issue description. (+2 more)
...
Cohesion: 0.14
Nodes (8): Scan a single file for database references, Recursively scan directory for database references, Print formatted audit report, DatabaseValidator, Print validation report, Find all .db files in data directory, Check if file is in a backup/archive location, Print analysis report
...
Cohesion: 0.19
Nodes (12): ack_ui_action(), bind_panel(), get_action_ledger(), get_pending_ui_actions(), get_session_context(), requeue_stale_actions(), retry_ui_action(), sync_ui_state() (+4 more)
...
Cohesion: 0.21
Nodes (12): _issue_sort_key(), Return (sequence_key, phase_number) when title encodes a phased track., True when every lower phase in the same sequence is ``done`` (or missing)., Pick up to ``count`` backlog issues respecting phased ordering.      ``all_issue, select_batch(), _has_matching_evolution_contract(), _metadata_sequence(), parse_phased_title() (+4 more)
...
Cohesion: 0.17
Nodes (11): EvolutionWeeklyDigestTrigger, EvolutionWeeklyDigestTrigger — Friday 6pm weekly evolution summary.  Fires every, Friday 6pm: evolution summary with quick-approve buttons., get_compat_db(), Async context manager yielding AsyncpgCompat wrapping a pooled connection., Run the morning check-in trigger for all active users., Run the evening wind-down trigger for all active users., Run the evolution weekly digest trigger for all active users. (+3 more)

### Community 216 - "Community 216"
Cohesion: 0.18
Nodes (10): _hermes_review_proposal(), Ask Hermes to review an evolution proposal before implementation is queued., Use Hermes for foreground voice escalation; OpenClaw is manual-only., _run_hermes_voice_escalation(), hermes_api_key(), hermes_auth_headers(), Shared Hermes helpers (gateway auth, CLI paths, repo root)., bootstrap_runtime_env() (+2 more)
...
Cohesion: 0.26
Nodes (11): Get user information (without sensitive data), get_jwks(), Return JWKS dict with all active public keys., _base_url(), _get_user_info(), jwks(), Native OIDC provider endpoints for zoe-auth., token() (+3 more)
...
Cohesion: 0.21
Nodes (10): _board(), Stop a running worker when its code-enforced phase budget is exhausted., _oidc_client_id_configured(), _probe(), run(), _uploads_configured(), Run full consolidation, Run the update process (+2 more)
...
Cohesion: 0.24
Nodes (12): Zoe Capabilities Inventory, Database Protection Rules, Auto-Generated Module Compose, Jetson Docker Compose Override, Supplemental Docker Compose for Modules, Raspberry Pi Docker Compose Override, Docker Compose Base Configuration, Docker Networking Rules (+4 more)
...
Cohesion: 0.18
Nodes (11): Action Plan Progress Report, AG-UI Protocol Implementation Status, AG-UI Chat Protocol for Zoe, Preventing Hardcoded Logic - Architecture Protection System, Backend chat.py Router, Frontend chat.html, Zoe Code Execution with MCP - Implementation Summary, LLM Capabilities Awareness Audit (+3 more)
...
Cohesion: 0.29
Nodes (8): test_execute_admitted_hindsight_retain_plan_posts_exact_plan_payload(), test_execute_admitted_hindsight_retain_plan_refuses_when_disabled(), test_execute_admitted_hindsight_retain_plan_reports_sidecar_rejection(), test_execute_admitted_hindsight_retain_plan_returns_structured_sidecar_error(), execute_admitted_hindsight_retain_plan(), _execution_reason(), Execute admitted Hindsight retain plans.  This module is the first runtime hando, Execute an admitted retain plan against the Hindsight sidecar.      Hindsight re
...
Cohesion: 0.22
Nodes (9): check(), Fire once per week on Friday at 6pm local time., build_run_at(), _parse_due_time(), Tier 2 trigger: reminder table scanner.  Reads the `reminders` table every slow-, Parse a due_time string into (hour, minute) in 24-hour format.      Handles form, Build a UTC datetime for when the reminder should fire.      The reminder times, Insert a proactive_scheduled row and register an APScheduler job.     Returns th (+1 more)
...
Cohesion: 0.25
Nodes (8): ABC, get_affinity_engine(), Get the singleton affinity engine instance., affinity(), BaseRecommendationEngine, Music Recommendation Engine ===========================  Dual-implementation rec, Abstract base class for recommendation engines.          Platform-specific imple, youtube()
...
Cohesion: 0.5
Nodes (9): MCP-Only Architecture for Zoe Modules, Music Module Migration Guide, Module Intent Auto-Discovery System - Complete!, Zoe Module Requirements - MANDATORY, Zoe Module System - Implementation Complete, Music Module Dependency Audit, Music Module Extraction - Complete Execution Plan, Music Routing Options - Detailed Breakdown (+1 more)
...
Cohesion: 0.25
Nodes (8): API Versioning Strategy, Standardized Error Handling Guide, Database Table: list_items, Database Table: lists, Default Lists (IDs 1-4), GET /api/lists/{list_type} Endpoint, Lists Router Code, User Isolation Audit & Fix Report

### Community 280 - "Community 280"
Cohesion: 0.33
Nodes (6): Exception, _MissingUserId, Raised when strict mode rejects a tool call with no identity., MemoryServiceError, Raised for operational failures., Full JSON dump for GDPR-style export.

### Community 281 - "Community 281"
Cohesion: 0.33
Nodes (5): _hermes_headers(), OpenClawTrigger, Slow-loop Hermes-powered proactive checks.  Subclass this to implement environme, Backwards-compatible base for triggers that delegate check logic to Hermes., Post a task to Hermes and return the parsed JSON response dict,         or None
...
Cohesion: 0.4
Nodes (5): _intent_card_data(), Build show_card data payload from intent slots for Google Home-style card., Tests for calendar intent canonical card emission., test_calendar_create_payload_keeps_compat_shape_and_adds_editor_contract(), test_calendar_show_payload_keeps_compat_shape_and_adds_contract()
...
Cohesion: 0.33
Nodes (6): Chat Model Fix - GPU Allocation Error, Chat Performance Fix, GPU Model Setup - gemma3n-e2b-gpu:latest, LiteLLM Gateway Integration - Architecture Document, RouteLLM & LiteLLM Status, System Test Results - Comprehensive Testing
...
Cohesion: 0.4
Nodes (5): Fetch Interceptor Fix, manifest.json for PWA, Protocol Handling Fix in Chat, Documentation & Rules Audit Report, PWA Phase 1 Implementation Complete
...
Cohesion: 0.67
Nodes (3): Agent Spike Playbook, build_packet(), tool_available()
...
Cohesion: 0.67
Nodes (3): Lists & Calendar Page Errors - Fixed, Lists Database Schema Fix Code, Migration Script migrate_lists_items.py

## Knowledge Gaps
- **2928 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2923 more)
...
- **Why does `main()` connect `Community 2` to `Community 3`, `Community 140`, `Community 269`, `Community 142`, `Community 143`, `Community 272`, `Community 146`, `Community 18`, `Community 20`, `Community 21`, `Community 150`, `Community 158`, `Community 31`, `Community 32`, `Community 33`, `Community 161`, `Community 288`, `Community 36`, `Community 50`, `Community 179`, `Community 180`, `Community 55`, `Community 184`, `Community 56`, `Community 313`, `Community 186`, `Community 185`, `Community 187`, `Community 190`, `Community 63`, `Community 64`, `Community 322`, `Community 68`, `Community 197`, `Community 199`, `Community 73`, `Community 74`, `Community 207`, `Community 80`, `Community 208`, `Community 210`, `Community 209`, `Community 85`, `Community 87`, `Community 89`, `Community 90`, `Community 220`, `Community 221`, `Community 94`, `Community 120`, `Community 103`, `Community 105`, `Community 107`, `Community 236`, `Community 116`, `Community 117`, `Community 118`, `Community 248`, `Community 249`, `Community 124`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.179) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 107` to `Community 128`, `Community 130`, `Community 3`, `Community 2`, `Community 5`, `Community 7`, `Community 9`, `Community 267`, `Community 11`, `Community 143`, `Community 16`, `Community 146`, `Community 147`, `Community 20`, `Community 21`, `Community 22`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 35`, `Community 36`, `Community 44`, `Community 49`, `Community 51`, `Community 53`, `Community 55`, `Community 57`, `Community 186`, `Community 59`, `Community 190`, `Community 62`, `Community 63`, `Community 68`, `Community 202`, `Community 76`, `Community 84`, `Community 214`, `Community 87`, `Community 86`, `Community 88`, `Community 98`, `Community 229`, `Community 102`, `Community 103`, `Community 232`, `Community 105`, `Community 235`, `Community 111`, `Community 254`, `Community 127`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 56` to `Community 0`, `Community 129`, `Community 2`, `Community 3`, `Community 38`, `Community 7`, `Community 233`, `Community 235`, `Community 17`, `Community 179`, `Community 23`, `Community 24`?**
