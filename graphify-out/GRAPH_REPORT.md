...
## Summary
- 8179 nodes · 14521 edges · 587 communities (347 shown, 240 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2059 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dee1bdf0`
...
- `Router Consolidation Plan` --references--> `RouteLLM (Intelligent Model Router)`  [INFERRED]
...
## Communities (587 total, 240 thin omitted)
...
Cohesion: 0.02
Nodes (90): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, fix_router_file(), Fix a single router file's database paths, Fix all routers in the routers directory, Main cleanup function. (+82 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (81): Send a chat message to Zoe, Send a chat message and validate response, Zoe Operator Runbook, _broadcast_intent_nav(), _build_hermes_payload(), _build_panel_intent_card(), _build_research_package(), _capture_research_screenshot() (+73 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (93): Override to customise the prompt per-check., Local voice session WebSocket for voice.html.      Accepts text and binary (audi, websocket_voice(), _bash(), _build_prompt(), _build_tools(), _build_voice_tools(), _cap_tool_result() (+85 more)
...
Cohesion: 0.05
Nodes (52): MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Seek to position in current track., Set playback volume (0-100)., Controls music playback across devices.          Supports:     - Browser/panel p, Get the current queue., Reorder a track in the queue. (+44 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (50): Action Plan Progress Report, AG-UI Chat Protocol for Zoe, Chat Backend (chat.py), Chat Page Frontend (chat.html), LLM Capabilities Awareness Audit, _promotion_plan(), _source_text(), test_profile_patch_writer_blocks_missing_source_profile() (+42 more)
...
Cohesion: 0.09
Nodes (50): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, str, test_experience_memory_requires_evidence(), test_mapping_rejects_missing_scope(), test_mapping_rejects_missing_user_id() (+42 more)
...
Cohesion: 0.06
Nodes (49): fresh_collection(), _install_mempalace_stubs(), Comprehensive MemPalace integration tests.  Tests: user isolation, upsert behavi, Install mempalace module stubs so zoe_agent doesn't require the real package., Reset the in-memory Chroma collection before each test.      Also resets the Mem, Writing for 'jason' must not appear when loading facts for 'family-admin'., Deleting a CRM entity should archive all scoped MemPalace facts for it., Writing for 'family-admin' must not appear when loading facts for 'jason'. (+41 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (48): Get user information (without sensitive data), hash_secret(), OIDC client registration and secret verification., Exact match only — no wildcards., Insert or update a client. Safe to call on every startup., upsert_client(), validate_redirect_uri(), verify_secret() (+40 more)

### Community 27 - "Community 27"
Cohesion: 0.06
Nodes (46): print_results(), Scan entire project and categorize all files., Check if path should be ignored., Categorize a file and determine if it's in the right location.          Returns:, scan_project(), should_ignore(), check_for_dangerous_patterns(), Print validation results.          Returns:         Exit code (0 if all files ex (+38 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (46): Get all discovered AirPlay devices, Get all discovered Chromecast devices, Get a specific device by ID, Get device info from database., AirPlayOutput, Discover available AirPlay devices., Refresh the device list., Stop playback on an AirPlay device. (+38 more)
...
Cohesion: 0.06
Nodes (28): Play previous track (from history)., Add a track to the queue.                  Args:             position: If specif, Get previous track from history., Music Zone Manager Handles multi-zone playback with device routing and state syn, Create a new music zone, Current playback state for a zone, Delete a zone (only owner can delete), Get all zones accessible by a user (+20 more)
...
Cohesion: 0.12
Nodes (37): _FakeIntent, Unit tests for `voice_scope.classify`.  Covers every branch of the classifier wi, test_empty_string_defaults_public(), test_empty_string_strict_mode(), test_intent_build_widget_is_user_scoped(), test_intent_calendar_show_is_public_household(), test_intent_ha_prefix_public(), test_intent_journal_create_is_user_scoped() (+29 more)
...
Cohesion: 0.1
Nodes (34): _audit_no_pr_issue(), _chain_for_issue(), _code_audit_implement_hint(), _engineering_mode(), _escalation_model_hint(), _existing_pr_url(), _goal_mode_args(), _greptile_mcp_bin() (+26 more)
...
Cohesion: 0.06
Nodes (23): Check a single router file for authentication issues.     Returns list of (line_, check_file(), Check a single file for hardcoded database paths, check_api_endpoints(), check_ui_pages(), Check database table schemas, Test critical API endpoints, Audit PROJECT_ROOT root (+15 more)
...
Cohesion: 0.08
Nodes (24): check_router_expectations(), Check what routers expect vs what database has, migrate_self_entries(), Create self entries for users in the people table, _compute_compatibility(), Compute compatibility score and shared traits between two check-ins., Get all registered providers., test_graphiti_episode_payloads_include_evidence() (+16 more)

### Community 74 - "Community 74"
Cohesion: 0.12
Nodes (28): get_agent_board(), Return Multica engineering ticket state for AG-UI display.      Falls back grace, test_create_issue_metadata_preserves_existing_ticket_fields(), test_update_ticket_progress_can_clear_dispatch_approval(), test_block_only_description_does_not_gain_leading_blank_lines(), test_progress_and_children_patch_metadata_only(), test_replacing_middle_block_preserves_suffix_newline(), test_ticket_block_preserves_human_description() (+20 more)
...
Cohesion: 0.09
Nodes (24): Create a person, run process_text → verify DB activity row AND MemPalace entry., recalc_and_save updates health_score in DB., Minimal compatibility wrapper so person_extractor works with raw asyncpg., test_health_score_recalc(), test_person_extractor_dual_fanout(), get_db(), db_compat.py — asyncpg compatibility shim providing an aiosqlite-style cursor AP, Thin wrapper around asyncpg Connection providing aiosqlite-compatible execute AP (+16 more)
...
Cohesion: 0.08
Nodes (25): Proactive adapters — thin wrappers that translate external service events into T, Executor adapters for Multica-dispatched work.  Multica is the agnostic source o, get_capabilities(), Music Service Module ====================  Platform-aware music system with: - Y, Get music system capabilities for this platform.          Returns:         Dict, Music Output Targets Package ============================  Unified interface for, Zoe Proactive Engine — public surface., Music Providers Package =======================  Unified interface for music str (+17 more)
...
Cohesion: 0.2
Nodes (24): Test P0-3: Temperature Adjustment, Test classification performance., Color, failure(), get_docker_logs(), Test 1: Baseline with all features OFF, Test 3: P0-2 Confidence Formatting, Test 5: All P0 features enabled (+16 more)

### Community 117 - "Community 117"
Cohesion: 0.11
Nodes (15): get_event_tracker(), MusicEvent, MusicEventTracker, Music Event Tracker ====================  Captures listening behavior events for, Record a listening event.                  Args:             user_id: User ident, Track play start event., Track play end event.                  Automatically determines if this was a sk, Track explicit skip event. (+7 more)
...
Cohesion: 0.12
Nodes (17): _board(), _expected_phases(), KanbanCLIError, _protocol_violation_count(), Report aggregate state of a chain by idempotency-key prefix.          Returns {f, Pull a PR URL from the implement/closeout task summaries or comments., Raised when a hermes kanban CLI call fails., Correlate a Kanban list row back to its ``multica:{id}:{phase}`` ref.      The l (+9 more)
...
Cohesion: 0.15
Nodes (15): test_percentile_rejects_out_of_range_values(), test_maintenance_runner_imports_real_bakeoff_module(), test_score_recall_response_reports_missing_terms(), test_summarize_bakeoff_scores_reports_score_and_latency(), test_synthetic_events_validate_and_include_required_cases(), percentile(), Synthetic Hindsight bake-off fixtures and scoring helpers., recall_response_text() (+7 more)
...
Cohesion: 0.16
Nodes (11): log(), DatabaseConsolidator, Merge sessions from sessions.db and auth.db, Verify that consolidation was successful, Log message to file and console, Check if table exists in database, Merge users from auth.db into zoe.db, DatabaseReferenceUpdater (+3 more)
...
Cohesion: 0.33
Nodes (15): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), Zoe Architecture Review, Code Execution Testing Summary (+7 more)
...
Cohesion: 0.3
Nodes (11): _env_float(), _package_info(), _package_snapshot(), Read-only Graphiti runtime compatibility probe for Zoe.  This probe checks wheth, _config_values(), _env_bool_snapshot(), _env_float_snapshot(), Read-only Graphiti graph-backend readiness probe for Zoe. (+3 more)
...
Cohesion: 0.29
Nodes (8): Chat Model Fix - GPU Allocation Error, Chat Performance Fix, GPU Model Setup - gemma3n-e2b-gpu:latest, LiteLLM Gateway Integration - Architecture Document, RouteLLM & LiteLLM Status, System Test Results - Comprehensive Testing, Trust Gate Architecture, Voice Pipeline Architecture

### Community 288 - "Community 288"
Cohesion: 0.61
Nodes (8): Music Module Migration Guide, Module Intent Auto-Discovery System - Complete!, Zoe Module Requirements - MANDATORY, Zoe Module System - Implementation Complete, Music Module Dependency Audit, Music Module Extraction - Complete Execution Plan, Music Routing Options - Detailed Breakdown, Music Module Test Results
...
Cohesion: 0.29
Nodes (7): API Versioning Strategy, Documentation & Rules Audit Report, Database Table: list_items, Database Table: lists, Default Lists (IDs 1-4), GET /api/lists/{list_type} Endpoint, Lists Router Code
...
Cohesion: 0.47
Nodes (5): _active_memory_files(), _assert_hindsight_policy(), _fail(), _is_allowed_line(), _scan_active_memory_files()
...
Cohesion: 0.5
Nodes (5): Home Assistant MCP Bridge Service, Home Assistant Service, Zoe Auth Service, Zoe Database Service, Zoe UI Service
...
Cohesion: 0.5
Nodes (4): MCP Client, ModuleWidgetLoader, WidgetRegistry, Zoe Music Module

### Community 339 - "Community 339"
Cohesion: 0.5
Nodes (4): Fetch Interceptor Fix, manifest.json for PWA, Protocol Handling Fix in Chat SSL, PWA Phase 1 Implementation Complete

### Community 340 - "Community 340"
Cohesion: 0.5
Nodes (4): Touch Dashboard Drag & Drop Fix, Touch Dashboard Floating Edit Mode (FAB), Touch Dashboard Navigation Bar Upgrade, Touch Dashboard Widget Persistence Fix
...
## Knowledge Gaps
- **2941 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2936 more)
...
- **Why does `main()` connect `Community 1` to `Community 128`, `Community 129`, `Community 130`, `Community 259`, `Community 132`, `Community 5`, `Community 260`, `Community 135`, `Community 145`, `Community 18`, `Community 274`, `Community 147`, `Community 19`, `Community 22`, `Community 23`, `Community 24`, `Community 27`, `Community 29`, `Community 30`, `Community 285`, `Community 286`, `Community 159`, `Community 290`, `Community 167`, `Community 41`, `Community 171`, `Community 178`, `Community 54`, `Community 186`, `Community 187`, `Community 317`, `Community 63`, `Community 64`, `Community 194`, `Community 195`, `Community 196`, `Community 69`, `Community 324`, `Community 72`, `Community 73`, `Community 202`, `Community 203`, `Community 78`, `Community 208`, `Community 81`, `Community 84`, `Community 213`, `Community 85`, `Community 215`, `Community 89`, `Community 92`, `Community 221`, `Community 223`, `Community 224`, `Community 225`, `Community 102`, `Community 106`, `Community 237`, `Community 238`, `Community 241`, `Community 242`, `Community 116`, `Community 247`, `Community 121`, `Community 124`?**
  _High betweenness centrality (0.171) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 73` to `Community 128`, `Community 1`, `Community 2`, `Community 3`, `Community 130`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 139`, `Community 13`, `Community 270`, `Community 15`, `Community 145`, `Community 20`, `Community 22`, `Community 23`, `Community 152`, `Community 24`, `Community 28`, `Community 30`, `Community 158`, `Community 41`, `Community 171`, `Community 44`, `Community 46`, `Community 48`, `Community 49`, `Community 50`, `Community 184`, `Community 60`, `Community 61`, `Community 63`, `Community 64`, `Community 74`, `Community 75`, `Community 76`, `Community 202`, `Community 79`, `Community 207`, `Community 84`, `Community 96`, `Community 98`, `Community 230`, `Community 104`, `Community 107`, `Community 123`, `Community 112`, `Community 243`, `Community 246`, `Community 251`, `Community 124`, `Community 126`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 18` to `Community 33`, `Community 2`, `Community 194`, `Community 1`, `Community 6`, `Community 39`, `Community 138`, `Community 14`, `Community 17`, `Community 246`, `Community 86`, `Community 90`?**
