...
## Summary
- 7883 nodes · 13683 edges · 582 communities (353 shown, 229 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1796 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `497d9d28`
...
7. `chat()` - 47 edges
8. `EvidenceItem` - 45 edges
9. `chat_stream_generator()` - 44 edges
10. `_row_to_dict()` - 44 edges

## Surprising Connections (you probably didn't know these)
- `test_capability_profile_index_rejects_duplicate_ids()` --calls--> `Zoe Capability Profiles`  [INFERRED]
  services/zoe-data/tests/test_zoe_capability_profile.py → docs/architecture/zoe-capability-profiles.md
- `test_capability_profile_rejects_unknown_owner_surface()` --calls--> `Zoe Capability Profiles`  [INFERRED]
  services/zoe-data/tests/test_zoe_capability_profile.py → docs/architecture/zoe-capability-profiles.md
- `test_trusted_profile_requires_evidence()` --calls--> `Zoe Capability Profiles`  [INFERRED]
  services/zoe-data/tests/test_zoe_capability_profile.py → docs/architecture/zoe-capability-profiles.md
- `test_metadata_is_read_only()` --calls--> `Zoe Capability Profiles`  [INFERRED]
  services/zoe-data/tests/test_zoe_capability_profile.py → docs/architecture/zoe-capability-profiles.md
...
Cohesion: 0.02
Nodes (63): _should_supersede_voice_weather_action(), _FakeAdapter, Tests for the Hermes Kanban executor adapter (CLI mocked)., A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., KanbanAdapter with the CLI replaced by a scripted recorder., _row(), test_dispatch_blocks_existing_pr_revision_when_precheckout_fails(), test_dispatch_blocks_on_first_worker_failure() (+55 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (83): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail(), _is_allowed_line() (+75 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (66): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., get_media_controller(), MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id: (+58 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (80): get_openclaw_info(), _load_skills_and_cron(), post_install_component(), post_openclaw_upgrade(), OpenClaw brain info: skills, cron, gateway, versions., Background: daily npm check, notify users, optional auto-upgrade., run_scheduled_openclaw_version_check(), clear_satisfied_update_notifications() (+72 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (63): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), Critical Files - Do Not Delete, AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn() (+55 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (68): MULClient, a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_approve(), board_cancel(), board_review(), build_engineering_guard_packet() (+60 more)
...
Cohesion: 0.05
Nodes (64): Start discovering AirPlay devices, Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Get device info from database., AirPlayOutput (+56 more)
...
Cohesion: 0.05
Nodes (51): _build_hermes_payload(), _build_panel_intent_card(), chat_stream_generator(), _chatgpt_connect_flow(), _check_frustration(), _create_pending_approval(), _ensure_user_and_chat_session(), _hermes_completion() (+43 more)
...
Cohesion: 0.06
Nodes (53): get_auth_manager(), Get the singleton auth manager instance., Make a request to the Home Assistant API., AppleMusicProvider, Get user's Music User Token from database., Make authenticated API request., Check if user is authenticated with Apple Music., Get developer token for MusicKit JS authentication.                  Apple Music (+45 more)
...
Cohesion: 0.05
Nodes (56): AuthResponse, escalate_session(), get_current_user(), get_passcode_status(), guest_login(), InitialPasswordSetupRequest, login(), login_passcode() (+48 more)

### Community 16 - "Community 16"
Cohesion: 0.08
Nodes (48): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Zoe Evolution Harness Implementation Status, Enum, OutputState, OutputType, Types of output targets. (+40 more)
...
Cohesion: 0.06
Nodes (41): test_dispatch_adjusts_running_scout_journal_when_scout_row_is_done(), test_dispatch_adjusts_stale_scout_journal_for_scope_split_child(), test_dispatch_archives_stale_terminal_revision_phase_row(), test_dispatch_does_not_adjust_running_scout_journal_with_active_row(), test_dispatch_resumed_todo_archives_blocked_current_phase_before_retry(), test_dispatch_resumed_todo_reports_archive_failure_without_create(), test_dispatch_retro_uses_main_repo_workspace(), test_poll_ignores_stale_terminal_row_for_revision_phase() (+33 more)
...
Cohesion: 0.09
Nodes (48): add_activity(), add_bucket_item(), add_gift_idea(), add_important_date(), add_relationship(), create_people_field(), create_person(), delete_field_schema() (+40 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (30): Refresh current session expiration          Args:         current_session: Curre, Invalidate a specific session (user can only invalidate their own sessions), refresh_session(), EnhancedSessionManager, Enhanced session manager with multi-factor support, Authenticate user and create session                  Args:             request:, Refresh session expiration, Extend session expiry to a fixed number of days from now (used for remember_me). (+22 more)
...
Cohesion: 0.08
Nodes (33): Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage., Check for potential security issues., Validates intent system configuration., Run all validations.                  Returns:             True if all validatio (+25 more)
...
Cohesion: 0.07
Nodes (33): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, youtube(), get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us, Get or create a YTMusic client for a user.                  Args:             us, Check if user has valid YouTube Music authentication., Get the stream URL for a track.                  Uses caching to avoid repeated (+25 more)
...
Cohesion: 0.1
Nodes (37): test_collect_observation_traces_accepts_valid_non_persistent_batch(), test_collect_observation_traces_can_require_single_scope_batch(), test_collect_observation_traces_discards_entire_batch_on_rejection(), test_collect_observation_traces_rejects_disallowed_surface(), test_collect_observation_traces_rejects_empty_batch(), test_collect_observation_traces_rejects_invalid_trace_shape(), test_collect_observation_traces_rejects_mixed_user_batch(), test_collect_observation_traces_reports_batch_rejections_from_original_input() (+29 more)

### Community 41 - "Community 41"
Cohesion: 0.08
Nodes (37): Get a specific provider by type.                  Args:             provider_typ, _classify_proposal(), _db_exec(), _get(), _is_noise(), _parse_psql_output(), _patch(), _post() (+29 more)
...
Cohesion: 0.08
Nodes (35): BaseHTTPMiddleware, ProactiveTrigger, Manually trigger the morning brief for the calling user.     Useful for testing, trigger_morning_brief(), check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe, TriggerResult (+27 more)

### Community 44 - "Community 44"
Cohesion: 0.07
Nodes (37): _broadcast_calendar_chat_prefill_ui(), _broadcast_shopping_chat_ui(), chatgpt_auth_status(), _env_int(), _get_faster_whisper_model(), get_livekit_token(), _log_voice_stt_sample(), _parse_voice_escalation_delta() (+29 more)
...
Cohesion: 0.06
Nodes (23): Check a single router file for authentication issues.     Returns list of (line_, check_file(), Check a single file for hardcoded database paths, check_api_endpoints(), check_router_expectations(), check_ui_pages(), Check database table schemas, Check what routers expect vs what database has (+15 more)
...
Cohesion: 0.11
Nodes (26): list_projects(), close_stale_autopilot_wrappers(), _fire_autopilot_job(), get_autopilot_triggers(), get_multica_autopilots(), _headers(), _is_configured(), multica_autopilot_sync.py — Syncs Multica autopilot schedules to APScheduler.  O (+18 more)
...
Cohesion: 0.09
Nodes (24): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+16 more)

### Community 70 - "Community 70"
Cohesion: 0.11
Nodes (27): Tests for main.py Multica poll-loop helpers., RecordingClient, test_record_blocked_multica_chain_creates_budget_followup_once(), test_record_blocked_multica_chain_creates_iteration_budget_followup(), test_record_blocked_multica_chain_creates_protocol_followup(), test_record_blocked_multica_chain_does_not_create_recursive_harness_followup(), test_record_blocked_multica_chain_falls_back_to_classification_and_default(), test_record_blocked_multica_chain_records_terminal_block_metadata() (+19 more)
...
Cohesion: 0.12
Nodes (27): _env_float(), test_extract_model_ids_accepts_openai_and_llama_shapes(), test_models_url_handles_v1_base(), test_runtime_probe_rejects_public_llm_base_url(), test_runtime_probe_reports_backend_offline(), test_runtime_probe_reports_disabled_without_backend_or_llm(), test_runtime_probe_reports_llm_unavailable(), test_runtime_probe_reports_missing_llm_model() (+19 more)
...
Cohesion: 0.15
Nodes (27): _issue_sort_key(), Return (sequence_key, phase_number) when title encodes a phased track., True when every lower phase in the same sequence is ``done`` (or missing)., Pick up to ``count`` backlog issues respecting phased ordering.      ``all_issue, select_batch(), _approved_evolution_issue(), _issue(), Tests for safe production backlog admission. (+19 more)
...
Cohesion: 0.1
Nodes (28): test_content_hash_is_stable(), test_audit_only_from_handoff_detects_kv_field(), test_split_request_from_handoff_parses_multiline_packet(), test_split_request_from_handoff_parses_packet(), content_hash(), Stable SHA-256 hex digest for validator/test stdout or handoff bodies., audit_only_from_handoff(), _greptile_from_closeout() (+20 more)
...
Cohesion: 0.12
Nodes (19): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _append_audit(), _idempotency_key(), MemoryServiceError, Raised for operational failures., Store a fact. Returns None when silently dropped., Fast metadata-filter read for system prompt injection. (+11 more)
...
Cohesion: 0.13
Nodes (11): Return Atomic semantic hits as normalized records., _build_metadata(), MemoryRef, _metadata_value(), MemoryService - the sole read/write surface for Zoe memory.  This module is the, The sole read/write surface for Zoe memory., Opaque reference returned by MemoryService., Best-effort metadata update - never raises. (+3 more)
...
Cohesion: 0.09
Nodes (23): test_board_status_reports_lifecycle_metadata(), test_detects_multica_operator_commands(), test_natural_problem_report_routes_to_multica_capture(), test_operator_commands_report_multica_failures(), _execute_calculate(), _execute_daily_briefing(), _execute_greeting(), execute_intent() (+15 more)

### Community 107 - "Community 107"
Cohesion: 0.13
Nodes (24): add_item(), create_list(), delete_item(), delete_list(), get_list(), get_list_types(), list_items(), list_lists() (+16 more)
...
Cohesion: 0.16
Nodes (22): _event(), _admission_trace(), _plain_event(), test_build_hindsight_retain_admission_request_defaults_to_hindsight_target(), test_build_hindsight_retain_admission_request_keeps_caller_metadata_nested(), test_build_hindsight_retain_admission_request_rejects_invalid_backend(), test_build_hindsight_retain_admission_request_rejects_mismatched_trace_user(), test_build_hindsight_retain_candidate_is_pending_and_evidence_tagged() (+14 more)
...
Cohesion: 0.14
Nodes (9): Legacy single-dim circle values fall back gracefully., TestCalcHealthScore, calc_health_score(), _next_occurrence(), person_health.py — Relationship health scoring.  Health score = weighted combina, Recalculate health_score for one person and persist it to the DB.      Args:, Return the next calendar occurrence of (month, day) on or after ref (default: to, Calculate a relationship health score in [0.0, 1.0].      Args:         last_con (+1 more)

### Community 121 - "Community 121"
Cohesion: 0.09
Nodes (20): Proactive adapters — thin wrappers that translate external service events into T, Executor adapters for Multica-dispatched work.  Multica is the agnostic source o, get_capabilities(), Music Service Module ====================  Platform-aware music system with: - Y, Get music system capabilities for this platform.          Returns:         Dict, Music Output Targets Package ============================  Unified interface for, Zoe Proactive Engine — public surface., Music Providers Package =======================  Unified interface for music str (+12 more)
...
Cohesion: 0.16
Nodes (17): _env_bool_snapshot(), _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers(), _scan_processes(), _scan_runtime(), _env_bool(), _embeddings_base_url_snapshot() (+9 more)
...
Cohesion: 0.1
Nodes (10): Comprehensive Natural Language Integration Tests Tests the entire Zoe system wit, Test memory expert with natural language, Test orchestration system status, End-to-end natural language tests for the complete Zoe system, Test calendar expert with natural language, test_simple_greeting(), TestNaturalLanguageSystem, Test greeting intents. (+2 more)
...
Cohesion: 0.11
Nodes (15): evaluate(), _hermes_review_proposal(), Ask Hermes to review an evolution proposal before implementation is queued., Use Hermes for foreground voice escalation; OpenClaw is manual-only., _run_hermes_voice_escalation(), _hermes_headers(), OpenClawTrigger, Slow-loop Hermes-powered proactive checks.  Subclass this to implement environme (+7 more)
...
Cohesion: 0.13
Nodes (17): Register a Tier 2 slow-loop trigger., register_trigger(), load_device_tokens(), Load all active device tokens from DB into the in-memory cache (call at startup), hermes_api_key(), lifespan(), _memory_capture_retry_task(), _probe_runtimes() (+9 more)
...
Cohesion: 0.18
Nodes (15): get_multica_client(), _lookup_evolution_resources(), _multica_env_key(), multica_client.py — Thin async client for the Multica board API.  Gracefully no-, Return (self_improvement_agent_id, self_improvement_engine_project_id).      Res, Create a Multica issue for a new evolution proposal.      Returns the Multica is, Update a Multica issue when an evolution proposal changes status.      Mapping:, Return a comparable snapshot of the current Multica env vars. (+7 more)
...
Cohesion: 0.17
Nodes (15): Manually trigger the LLM memory digest for a user (or the requesting user)., trigger_memory_digest(), _emotional_memory_pass(), _extract_facts_with_gemma(), _is_contradiction(), _load_todays_messages(), LLM-driven nightly memory digest.  Reads today's chat messages for a user, promp, Extract facts from today's chat history and write to MemPalace + memory_items. (+7 more)
...
Cohesion: 0.15
Nodes (12): EveningWindDownTrigger, Evening wind-down trigger — journal prompt if user hasn't written in 3+ days., get_compat_db(), Async context manager yielding AsyncpgCompat wrapping a pooled connection., Run the morning check-in trigger for all active users., Run the evening wind-down trigger for all active users., Run the evolution weekly digest trigger for all active users., Run the reminder scan to auto-schedule upcoming reminders into APScheduler. (+4 more)
...
Cohesion: 0.15
Nodes (6): Unit tests for the Zoe Agent skills classifier and tool builder.  Tests _select_, _ZOE_SOUL_STATIC must not contain any day/time strings (KV cache stability)., Every tool in _TOOLS must appear in either _SKILL_TOOLS or _ALWAYS_ON_TOOLS., _llm_call must accept tool_choice kwarg defaulting to 'auto'., TestLlmCallSignature, TestStablePrompt
...
Cohesion: 0.18
Nodes (12): Skill Markdown Format, Zoe People System, Repository Layout, MCP-Only Architecture for Zoe Modules, Music Module Migration Guide, Module Intent Auto-Discovery System Complete, Zoe Module Requirements, Zoe Module System - Implementation Complete (+4 more)
...
Cohesion: 0.2
Nodes (11): Manually trigger the weekly consolidation pass.      Admin-only when ``user_id``, trigger_memory_consolidation(), _merge_near_duplicates(), Containment overlap — symmetric inter/min(|A|,|B|).      Jaccard penalises one-s, Collapse near-duplicate approved rows. Returns merge count., Walk pairs of high-similarity approved rows; supersede older if contradicted., Per-user Sunday pass: merge duplicates, resolve contradictions, soft-archive., Run weekly consolidation for every user who has any approved memory. (+3 more)
...
Cohesion: 0.22
Nodes (10): ack_ui_action(), bind_panel(), create_ui_action(), get_action_ledger(), get_pending_ui_actions(), get_session_context(), requeue_stale_actions(), retry_ui_action() (+2 more)
...
Cohesion: 0.18
Nodes (7): User Profile Schema Tests ========================= Tests for the compatibility, Test creating a life goal, Tests for compatibility analysis, Test creating compatibility analysis, Test compatibility level descriptions, Test dimension breakdown, TestLifeGoal
...
Cohesion: 0.18
Nodes (11): API Versioning Strategy, Chat Page Frontend (chat.html), Desktop Dashboard Fixes - COMPLETE, Backend lists.py Router, Data Migration SQL Commands, Database Query in GET /api/lists/{list_type}, Default Lists in Database, GET /api/lists/{list_type} Endpoint (+3 more)

### Community 256 - "Community 256"
Cohesion: 0.25
Nodes (11): Action Plan Progress Report, AG-UI Chat Protocol for Zoe, Chat Backend (chat.py), Zoe Code Execution with MCP - Implementation Summary, Standardized Error Handling Guide, GPU Model Setup - gemma3n-e2b-gpu:latest, Migration Script migrate_lists_items.py, Updated lists.py Router (+3 more)
...
Cohesion: 0.25
Nodes (8): Convert Apple Music playlist data to Playlist., Playlist, Unified playlist representation., Create a new playlist. Override if provider supports it., Convert Spotify playlist data to Playlist., Create a new playlist., Convert provider-specific playlist data to Playlist dataclass., Create a new playlist on YouTube Music.
...
Cohesion: 0.36
Nodes (8): MCP Tools, OpenClaw Skills, Zoe Module System README, MCP Client, ModuleWidgetLoader, WidgetRegistry, Zoe Module CLI, Zoe Music Module
...
Cohesion: 0.38
Nodes (7): _build_calendar_form_props(), _build_reminder_form_props(), _intent_action_form_payload(), Build a panel_show_action_form payload for intents that show an in-place overlay, _build_command(), _parse_date(), _parse_time()
...
Cohesion: 0.4
Nodes (5): Core Capabilities, UI Pages, Zoe Auth Service, Zoe Database Service, Zoe UI Service

### Community 326 - "Community 326"
Cohesion: 0.4
Nodes (5): Database Protection Rules, Hardware Compatibility Guide, Project Structure & Governance Rules, Quick Start Guide, Zoe AI Assistant README
...
Cohesion: 0.5
Nodes (3): Tests for interest categories, Test creating an interest, TestInterestCategory
...
Cohesion: 0.5
Nodes (4): LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router)
...
Cohesion: 0.67
Nodes (3): Consolidate 30 days of music events into MemPalace preference memories.      Sco, Run music taste digest for all users who have any music events., run_music_taste_digest()

## Knowledge Gaps
- **2891 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2886 more)
...
- **Why does `main()` connect `Community 1` to `Community 2`, `Community 135`, `Community 138`, `Community 11`, `Community 269`, `Community 272`, `Community 145`, `Community 18`, `Community 19`, `Community 273`, `Community 149`, `Community 279`, `Community 23`, `Community 155`, `Community 157`, `Community 29`, `Community 34`, `Community 293`, `Community 167`, `Community 168`, `Community 41`, `Community 172`, `Community 303`, `Community 51`, `Community 55`, `Community 184`, `Community 56`, `Community 59`, `Community 317`, `Community 190`, `Community 191`, `Community 192`, `Community 65`, `Community 66`, `Community 323`, `Community 196`, `Community 197`, `Community 69`, `Community 71`, `Community 73`, `Community 75`, `Community 76`, `Community 78`, `Community 81`, `Community 214`, `Community 87`, `Community 88`, `Community 89`, `Community 215`, `Community 119`, `Community 225`, `Community 226`, `Community 227`, `Community 99`, `Community 108`, `Community 239`, `Community 113`, `Community 244`, `Community 254`, `Community 253`, `Community 124`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.179) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 99` to `Community 1`, `Community 259`, `Community 261`, `Community 134`, `Community 7`, `Community 11`, `Community 267`, `Community 141`, `Community 13`, `Community 16`, `Community 145`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 28`, `Community 29`, `Community 170`, `Community 42`, `Community 172`, `Community 45`, `Community 306`, `Community 53`, `Community 182`, `Community 55`, `Community 56`, `Community 317`, `Community 66`, `Community 67`, `Community 196`, `Community 70`, `Community 200`, `Community 75`, `Community 77`, `Community 207`, `Community 85`, `Community 215`, `Community 93`, `Community 96`, `Community 104`, `Community 232`, `Community 234`, `Community 108`, `Community 114`, `Community 118`, `Community 119`, `Community 248`, `Community 246`, `Community 122`, `Community 251`, `Community 126`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `_FakeAdapter` connect `Community 0` to `Community 36`, `Community 108`, `Community 206`, `Community 17`, `Community 146`, `Community 21`?**
...
- **Are the 83 inferred relationships involving `list()` (e.g. with `get_matches()` and `_compute_compatibility()`) actually correct?**
  _`list()` has 83 INFERRED edges - model-reasoned connections that need verification._
