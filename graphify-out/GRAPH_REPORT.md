...
## Summary
- 7750 nodes · 13371 edges · 549 communities (369 shown, 180 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1728 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b8d92a6f`
...
Cohesion: 0.06
Nodes (61): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Validate database structure, Enum, Run all validations.                  Returns:             True if all validatio, OutputState, OutputType (+53 more)
...
Cohesion: 0.06
Nodes (42): test_dispatch_adjusts_running_scout_journal_when_scout_row_is_done(), test_dispatch_adjusts_stale_scout_journal_for_scope_split_child(), test_dispatch_archives_stale_terminal_revision_phase_row(), test_dispatch_does_not_adjust_running_scout_journal_with_active_row(), test_dispatch_retro_uses_main_repo_workspace(), test_poll_ignores_stale_terminal_row_for_revision_phase(), test_poll_v4_audit_protocol_recovery_reports_partial_for_next_phase(), test_poll_v4_running_pipeline_clears_stale_recovered_blocker() (+34 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (43): BaseHTTPMiddleware, evaluate(), ProactiveTrigger, Manually trigger the morning brief for the calling user.     Useful for testing, trigger_morning_brief(), check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe (+35 more)
...
Cohesion: 0.06
Nodes (31): create_user(), Create new user (admin only)          Args:         request: User creation detai, change_password(), Change current user's password          Args:         request: Current and new p, AuthManager, AuthValidationResult, Verify user password                  Args:             user_id: User identifier, Change user password                  Args:             user_id: User identifier (+23 more)
...
Cohesion: 0.07
Nodes (40): _audit_no_pr_issue(), _chain_for_issue(), _code_audit_implement_hint(), _engineering_mode(), _escalation_model_hint(), _existing_pr_url(), _expected_phases(), _goal_mode_args() (+32 more)
...
Cohesion: 0.1
Nodes (33): INTENT_LABELS, params, attachCardActions(), buildActionButtons(), buildMatchCard(), hideSDTimerOverlay(), hideSpeedDatingBanner(), loadMatches() (+25 more)
...
Cohesion: 0.07
Nodes (32): Register a Tier 2 slow-loop trigger., register_trigger(), _hermes_review_proposal(), Ask Hermes to review an evolution proposal before implementation is queued., Use Hermes for foreground voice escalation; OpenClaw is manual-only., _run_hermes_voice_escalation(), _blocking_synthesize(), _load_pipeline() (+24 more)
...
Cohesion: 0.09
Nodes (30): hash_secret(), OIDC client registration and secret verification., Insert or update a client. Safe to call on every startup., upsert_client(), _now_iso(), parse_json_fields(), get_connection_icebreaker(), Shorter icebreaker for the QR scan connect page. (+22 more)
...
Cohesion: 0.11
Nodes (26): _config_values(), _env_bool_snapshot(), _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers(), _scan_processes(), _scan_runtime(), snapshot_from_env() (+18 more)
...
Cohesion: 0.1
Nodes (12): Proactive trigger: birthday 7-day lookahead.  Fires once daily at 8am for contac, Unit tests for person_health.py — calc_health_score() determinism and edge cases, Legacy single-dim circle values fall back gracefully., TestCalcHealthScore, TestNextOccurrence, calc_health_score(), _next_occurrence(), person_health.py — Relationship health scoring.  Health score = weighted combina (+4 more)
...
Cohesion: 0.09
Nodes (19): Test a natural language prompt, Send a chat message and get response, send_chat_message(), test_prompt(), Test code execution service directly, Test search_tools function, Test MCP tool execution via code, Test chat router's code execution integration (+11 more)
...
Cohesion: 0.14
Nodes (9): Create the single current ready phase for a Multica engineering run.          Re, AiortcRoom, Drop-in replacement for livekit.rtc.Room using aiortc + WebSocket signalling., Decorator: @room.on("event_name"), Connect to a LiveKit room using WebSocket signalling + aiortc., Handle SDP re-offer from LiveKit server (subscriber PC)., Add an ICE candidate received from the server., Called when aiortc delivers an audio track — map to participant. (+1 more)

### Community 114 - "Community 114"
Cohesion: 0.11
Nodes (17): Minimal compatibility wrapper so person_extractor works with raw asyncpg., get_db(), db_compat.py — asyncpg compatibility shim providing an aiosqlite-style cursor AP, Thin wrapper around asyncpg Connection providing aiosqlite-compatible execute AP, AsyncpgCompat, close_pool(), _ExecResult, get_pool() (+9 more)
...
Cohesion: 0.15
Nodes (22): _diff_changed_lines(), _diff_files(), _run_git(), _base_ref(), ensure_worktree(), _extract_pr_number(), kanban_db_path(), pin_kanban_workspace() (+14 more)
...
Cohesion: 0.14
Nodes (11): FakeCursor, Buffered cursor wrapping a list of asyncpg Records., _adapt_params(), _Cursor, Return dual-mode result: awaitable or async context manager., aiosqlite-compatible shorthand: execute and return all rows immediately., Convert ? placeholders to $1, $2, $3... for asyncpg.      Also rewrites bare NOW, Buffered cursor providing aiosqlite-compatible fetchall/fetchone/iteration. (+3 more)

### Community 148 - "Community 148"
Cohesion: 0.18
Nodes (18): Zoe Capabilities, Database Protection Rules, Auto-Generated Module Compose, Jetson Docker Compose Override, Zoe Docker Compose Supplemental Modules, Raspberry Pi Docker Compose Override, Zoe Docker Compose Base, Hardware Compatibility Guide (+10 more)
...
Cohesion: 0.17
Nodes (14): _event(), test_event_to_hindsight_item_keeps_evidence_and_scope_tags(), test_event_to_hindsight_item_serializes_structured_context_as_json(), test_build_hindsight_retain_candidate_is_pending_and_evidence_tagged(), test_create_hindsight_retain_candidate_uses_memory_service_pending_ingest(), _compact_context(), event_to_hindsight_item(), Convert a validated Zoe memory event into a Hindsight retain item. (+6 more)
...
Cohesion: 0.17
Nodes (13): _board(), KanbanCLIError, Raised when a hermes kanban CLI call fails., Correlate a Kanban list row back to its ``multica:{id}:{phase}`` ref.      The l, _row_ref_key(), _oidc_client_id_configured(), _probe(), run() (+5 more)
...
Cohesion: 0.2
Nodes (6): api_health_check(), Zoe Core Service - Enhanced Main Application with Enhancement Systems ==========, API health check endpoint (for frontend compatibility), Prometheus metrics endpoint, Health check endpoint, health_check()
...
Cohesion: 0.25
Nodes (8): Action Plan Progress Report, AG-UI Protocol Implementation Status, AG-UI Chat Protocol for Zoe, Preventing Hardcoded Logic - Architecture Protection System, Chat Backend (chat.py), Chat Frontend (chat.html), Zoe Code Execution with MCP - Implementation Summary, LLM Capabilities Awareness Audit

### Community 268 - "Community 268"
Cohesion: 0.25
Nodes (8): Agent Zero Docker Compose Module, Agent Zero Implementation Checklist, Agent Zero Integration - COMPLETE, Agent Zero Live Integration Test Report, Agent Zero Quick Start Guide, Agent Zero Module for Zoe, Agent Zero + Zoe Integration Summary, Agent Zero Integration Test Results
...
Cohesion: 0.4
Nodes (6): API Versioning Strategy, Standardized Error Handling Guide, Lists & Calendar Page Errors - Fixed, Lists Router Code Fix, Lists Data Migration Script, Lists Database Schema Fix
...
Cohesion: 0.6
Nodes (3): Test direct action execution, ZoeOptimizationTester, analyze_result()
...
Cohesion: 0.4
Nodes (5): Desktop Dashboard Fixes - COMPLETE, Drag and Drop Fix, Floating Action Button Edit Mode, Touch Dashboard Navigation Bar, Widget Persistence Fix
...
Cohesion: 0.5
Nodes (4): Database Lists Table, Frontend Lists Handling, get_lists Endpoint, User Isolation Audit & Fix Report

### Community 322 - "Community 322"
Cohesion: 0.5
Nodes (4): manifest.json Creation, Protocol Handling Fix, Documentation & Rules Audit Report, PWA Phase 1 Implementation

### Community 323 - "Community 323"
Cohesion: 0.5
Nodes (4): Trust Gate Architecture, Voice Pipeline Architecture, Zoe Harness Current Inventory, Zoe Tool And Capability Inventory

### Community 339 - "Community 339"
Cohesion: 0.67
Nodes (3): Code Execution Status, Code Execution Testing Results, Code Execution Testing Summary

## Knowledge Gaps
- **2839 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2834 more)
...
- **Why does `main()` connect `Community 1` to `Community 2`, `Community 130`, `Community 7`, `Community 264`, `Community 11`, `Community 15`, `Community 146`, `Community 275`, `Community 20`, `Community 148`, `Community 24`, `Community 26`, `Community 154`, `Community 160`, `Community 161`, `Community 34`, `Community 291`, `Community 162`, `Community 38`, `Community 40`, `Community 41`, `Community 168`, `Community 301`, `Community 304`, `Community 177`, `Community 56`, `Community 185`, `Community 184`, `Community 316`, `Community 190`, `Community 62`, `Community 192`, `Community 64`, `Community 66`, `Community 196`, `Community 70`, `Community 77`, `Community 206`, `Community 205`, `Community 80`, `Community 81`, `Community 82`, `Community 84`, `Community 215`, `Community 216`, `Community 89`, `Community 218`, `Community 87`, `Community 217`, `Community 93`, `Community 223`, `Community 97`, `Community 98`, `Community 234`, `Community 235`, `Community 112`, `Community 114`, `Community 115`, `Community 246`, `Community 247`, `Community 120`, `Community 250`, `Community 125`, `Community 126`, `Community 255`?**
  _High betweenness centrality (0.196) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 84` to `Community 1`, `Community 2`, `Community 3`, `Community 6`, `Community 135`, `Community 8`, `Community 11`, `Community 141`, `Community 15`, `Community 146`, `Community 147`, `Community 19`, `Community 20`, `Community 23`, `Community 25`, `Community 30`, `Community 31`, `Community 34`, `Community 291`, `Community 40`, `Community 41`, `Community 42`, `Community 176`, `Community 178`, `Community 51`, `Community 55`, `Community 56`, `Community 190`, `Community 63`, `Community 191`, `Community 66`, `Community 67`, `Community 200`, `Community 74`, `Community 76`, `Community 205`, `Community 89`, `Community 222`, `Community 96`, `Community 101`, `Community 229`, `Community 104`, `Community 232`, `Community 108`, `Community 110`, `Community 238`, `Community 239`, `Community 115`, `Community 244`, `Community 121`, `Community 125`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `_FakeAdapter` connect `Community 0` to `Community 196`, `Community 5`, `Community 203`, `Community 150`, `Community 23`?**
