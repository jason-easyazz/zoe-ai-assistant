...
## Summary
- 8161 nodes · 14496 edges · 546 communities (345 shown, 201 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2043 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e9e4f357`
...
Cohesion: 0.02
Nodes (93): Main optimization function, Agent Spike Playbook, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail() (+85 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (57): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker. (+49 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (83): Send a chat message to Zoe, Send a chat message and validate response, _build_hermes_payload(), _build_panel_intent_card(), _build_research_package(), _capture_research_screenshot(), chat(), chat_inject_background() (+75 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (97): Override to customise the prompt per-check., Local voice session WebSocket for voice.html.      Accepts text and binary (audi, websocket_voice(), _bash(), _build_memory_context(), _build_prompt(), _build_tools(), _build_voice_tools() (+89 more)
...
Cohesion: 0.04
Nodes (70): Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100)., Get device info from database. (+62 more)
...
Cohesion: 0.06
Nodes (57): Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage., Check for potential security issues., Validates intent system configuration., Run all validations.                  Returns:             True if all validatio (+49 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (60): get_memory_router_status(), Read-only status for Zoe's disabled-by-default memory router runtime., _trace(), test_default_chat_route_keeps_hindsight_and_graphiti_off_hot_path(), test_failure_and_fix_queries_route_to_reflective_memory(), test_fast_chat_layers_are_boring_hot_path_only(), test_reflective_route_is_timeout_bounded_candidate_only(), test_sidecar_layers_are_async_enrichment_not_required_for_chat() (+52 more)
...
Cohesion: 0.04
Nodes (54): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), Critical Files - Do Not Delete, AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn() (+46 more)
...
Cohesion: 0.05
Nodes (54): check_module_structure(), Check if a file exists, Check if a module has required classes, Verify all enhancement systems, verify_enhancements(), print_results(), Scan entire project and categorize all files., Check if path should be ignored. (+46 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (53): get_auth_manager(), Get the singleton auth manager instance., AppleMusicProvider, Get user's Music User Token from database., Check if user is authenticated with Apple Music., Get developer token for MusicKit JS authentication.                  Apple Music, Complete auth with Music User Token from MusicKit JS.                  The auth_, Disconnect user from Apple Music. (+45 more)
...
Cohesion: 0.08
Nodes (46): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, OutputState, OutputType, Types of output targets., Playback state of an output. (+38 more)
...
Cohesion: 0.06
Nodes (40): create_pin_challenge(), get_panel_bindings(), _hash_token(), issue_token(), lookup_device_token(), panel_public_info(), panel_status(), _pin_check_locked() (+32 more)
...
Cohesion: 0.08
Nodes (36): BaseHTTPMiddleware, ProactiveTrigger, Manually trigger the morning brief for the calling user.     Useful for testing, trigger_morning_brief(), check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe, TriggerResult (+28 more)
...
Cohesion: 0.11
Nodes (31): _promotion_plan(), _source_text(), test_profile_patch_writer_blocks_missing_source_profile(), test_profile_patch_writer_blocks_stale_source_trust_level(), test_profile_patch_writer_blocks_unapplyable_promotion_plan(), test_profile_patch_writer_renders_deterministic_unified_diff(), test_profile_patch_writer_validates_record_and_plan_invariants(), _review_result() (+23 more)
...
Cohesion: 0.07
Nodes (35): hash_secret(), OIDC client registration and secret verification., Exact match only — no wildcards., Insert or update a client. Safe to call on every startup., upsert_client(), validate_redirect_uri(), verify_secret(), ensure_signing_key() (+27 more)
...
Cohesion: 0.07
Nodes (31): Test P1-1: Validate behavioral pattern extraction, Test that pattern extraction is fast enough for nightly jobs, Test that all pattern types can be extracted, TestP11BehavioralMemoryImprovements, _extract_memory_candidates(), Back-compat shim: legacy dict shape over the unified extractor.      Kept so in-, test_extracts_preference_signal(), test_no_signal_returns_empty() (+23 more)
...
Cohesion: 0.11
Nodes (28): MULClient, list_projects(), close_stale_autopilot_wrappers(), _fire_autopilot_job(), get_autopilot_triggers(), get_multica_autopilots(), _headers(), _is_configured() (+20 more)
...
Cohesion: 0.12
Nodes (16): Get a specific provider by type.                  Args:             provider_typ, _get(), Return Atomic semantic hits as normalized records., _build_metadata(), MemoryRef, _metadata_value(), _promote_event_metadata(), MemoryService - the sole read/write surface for Zoe memory.  This module is the (+8 more)

### Community 68 - "Community 68"
Cohesion: 0.1
Nodes (26): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, Get or create a YTMusic client for a user.                  Args:             us, Check if user has valid YouTube Music authentication., Get video stream URL for a track (for video playback).                  YouTube, YouTube Music integration provider.          Handles:     - Searching tracks, al, Get playlist with tracks., Get user's library playlists. (+18 more)
...
Cohesion: 0.1
Nodes (20): Start AirPlay device discovery., Initialize the output target.                  Override this for setup that need, Start Chromecast discovery., Discover media_player entities., Initialize all available output targets., Get all available devices from all output types., Initialize all available providers.                  Called on startup to regist, close_pool() (+12 more)
...
Cohesion: 0.1
Nodes (29): get_contact(), get_reports(), get_session_by_code(), Look up an active session by its short join code., Recipient retrieves the contact details., add_item(), create_list(), delete_item() (+21 more)
...
Cohesion: 0.09
Nodes (20): IntEnum, _AudioStream, _ConnState, _DataPacket, _Frame, _FrameEvent, _LocalParticipant, make_audio_stream() (+12 more)
...
Cohesion: 0.12
Nodes (19): _get_vapid_keys(), get_vapid_public_key(), Web Push Notifications via VAPID. Generates VAPID keys on first run, stores subs, Send a push notification to all of a user's subscriptions.      ``message`` is a, send_push_to_user(), subscribe(), unsubscribe(), ack_ui_action() (+11 more)
...
Cohesion: 0.23
Nodes (21): Test P0-3: Temperature Adjustment, Color, failure(), get_docker_logs(), Test 1: Baseline with all features OFF, Test 3: P0-2 Confidence Formatting, Test 5: All P0 features enabled, Test 7: No regressions (+13 more)
...
Cohesion: 0.16
Nodes (15): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _append_audit(), _idempotency_key(), MemoryServiceError, Raised for operational failures., Store a fact. Returns None when silently dropped.          When ``scope`` is Non, Right-to-be-forgotten. Returns number of rows removed. (+7 more)
...
Cohesion: 0.16
Nodes (15): test_execute_admitted_hindsight_retain_plan_posts_exact_plan_payload(), test_execute_admitted_hindsight_retain_plan_refuses_when_disabled(), test_execute_admitted_hindsight_retain_plan_reports_sidecar_rejection(), test_execute_admitted_hindsight_retain_plan_returns_structured_sidecar_error(), HindsightMemoryError, Raised when Hindsight is unavailable or returns an invalid response., execute_admitted_hindsight_retain_plan(), _execution_reason() (+7 more)
...
Cohesion: 0.12
Nodes (16): Normalize a YouTube Music item to standard format., Convert Apple Music track data to Track., Search for tracks on Apple Music., Get tracks similar to a given track (not directly supported)., get_album_tracks(), get_playlist_tracks(), get_similar_tracks(), Get all tracks in an album. (+8 more)
...
Cohesion: 0.18
Nodes (14): _retained_outcome(), test_capability_trust_update_blocks_failed_proposal(), test_capability_trust_update_blocks_unretained_outcome(), test_capability_trust_update_candidate_validates_trust_levels(), test_capability_trust_update_candidates_require_retained_verified_outcome(), test_capability_trust_update_metadata_is_read_only_and_serializable(), build_capability_trust_update_plan(), _proposed_trust_level() (+6 more)

### Community 178 - "Community 178"
Cohesion: 0.24
Nodes (14): _env_float(), _extract_model_ids(), _models_url(), _package_info(), _package_snapshot(), _probe_openai_compatible_llm(), Read-only Graphiti runtime compatibility probe for Zoe.  This probe checks wheth, _config_values() (+6 more)

### Community 179 - "Community 179"
Cohesion: 0.18
Nodes (15): test_extract_model_ids_accepts_openai_and_llama_shapes(), test_models_url_handles_v1_base(), test_runtime_probe_rejects_public_llm_base_url(), test_runtime_probe_reports_backend_offline(), test_runtime_probe_reports_disabled_without_backend_or_llm(), test_runtime_probe_reports_llm_unavailable(), test_runtime_probe_reports_missing_llm_model(), test_runtime_probe_reports_missing_python_dependencies() (+7 more)

### Community 180 - "Community 180"
Cohesion: 0.17
Nodes (15): _matching_lines(), _scan_containers(), _scan_processes(), _scan_runtime(), _embeddings_base_url_snapshot(), HindsightSidecarProbeResult, Read-only Hindsight sidecar readiness probe for Zoe., _slug_snapshot() (+7 more)
...
Cohesion: 0.26
Nodes (8): _compact_context(), _embeddings_base_url_from_env(), HindsightOfflineConfigError, _is_local_or_private_url(), _positive_count(), Hindsight sidecar adapter for Zoe's memory bake-off.  The adapter is disabled by, Raised when Hindsight config would violate Zoe's offline-only rule., _retain_result_succeeded()
...
Cohesion: 0.29
Nodes (5): Test classification performance., Test that Tier 0 (HassIL) meets <5ms target., Test batch classification performance., Test 6: Performance check, test_performance()
...
## Knowledge Gaps
- **2927 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2922 more)
...
- **Why does `main()` connect `Community 1` to `Community 129`, `Community 2`, `Community 130`, `Community 132`, `Community 5`, `Community 262`, `Community 264`, `Community 10`, `Community 140`, `Community 146`, `Community 19`, `Community 22`, `Community 23`, `Community 152`, `Community 26`, `Community 285`, `Community 158`, `Community 287`, `Community 160`, `Community 33`, `Community 38`, `Community 294`, `Community 169`, `Community 172`, `Community 46`, `Community 178`, `Community 179`, `Community 180`, `Community 310`, `Community 58`, `Community 61`, `Community 62`, `Community 189`, `Community 64`, `Community 322`, `Community 195`, `Community 196`, `Community 197`, `Community 70`, `Community 200`, `Community 73`, `Community 74`, `Community 204`, `Community 333`, `Community 205`, `Community 77`, `Community 83`, `Community 85`, `Community 213`, `Community 87`, `Community 217`, `Community 90`, `Community 96`, `Community 225`, `Community 226`, `Community 227`, `Community 228`, `Community 123`, `Community 235`, `Community 114`, `Community 117`, `Community 119`, `Community 248`, `Community 121`, `Community 251`, `Community 127`?**
  _High betweenness centrality (0.178) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 77` to `Community 256`, `Community 129`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 135`, `Community 9`, `Community 10`, `Community 11`, `Community 138`, `Community 146`, `Community 21`, `Community 22`, `Community 23`, `Community 281`, `Community 26`, `Community 27`, `Community 28`, `Community 157`, `Community 35`, `Community 38`, `Community 45`, `Community 48`, `Community 181`, `Community 54`, `Community 310`, `Community 56`, `Community 57`, `Community 58`, `Community 317`, `Community 62`, `Community 64`, `Community 192`, `Community 67`, `Community 69`, `Community 71`, `Community 72`, `Community 203`, `Community 205`, `Community 82`, `Community 84`, `Community 213`, `Community 86`, `Community 214`, `Community 96`, `Community 121`, `Community 226`, `Community 103`, `Community 234`, `Community 108`, `Community 114`, `Community 245`, `Community 249`, `Community 122`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 2` to `Community 1`, `Community 3`, `Community 68`, `Community 36`, `Community 197`, `Community 7`, `Community 15`, `Community 81`, `Community 18`, `Community 119`, `Community 249`, `Community 247`?**
