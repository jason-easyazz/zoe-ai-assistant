...
## Summary
- 7783 nodes · 13465 edges · 526 communities (339 shown, 187 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1754 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5dc4473`
...
- `Database Path Enforcement System` --references--> `Push Notification Service`  [EXTRACTED]
  docs/governance/DATABASE_PATH_ENFORCEMENT.md → services/zoe-core/services/push_notification_service.py
- `Model Configuration` --conceptually_related_to--> `gemma3:27b Model (Large, Accurate)`  [INFERRED]
  services/zoe-core/model_config.py → docs/architecture/GEMMA_MODELS_COMPARISON.md
- `init_db()` --calls--> `get_db_ctx()`  [INFERRED]
  modules/orbit/database.py → services/zoe-data/db_pool.py
- `init_db()` --calls--> `default_capability_matrix()`  [INFERRED]
  modules/orbit/database.py → services/zoe-data/guest_policy.py

## Communities (526 total, 187 thin omitted)
...
Cohesion: 0.02
Nodes (74): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail(), _is_allowed_line() (+66 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (92): get_auth_manager(), Get the singleton auth manager instance., Get track metadata from cache., Get or create a YTMusic client for a user.                  Args:             us, Normalize a YouTube Music item to standard format., Get user's library playlists., Get user's liked songs from YouTube Music.                  Args:             us, get_client() (+84 more)
...
Cohesion: 0.04
Nodes (79): Send a chat message to Zoe, Send a chat message and validate response, _broadcast_intent_nav(), _build_hermes_payload(), _build_panel_intent_card(), _build_research_package(), _capture_research_screenshot(), chat() (+71 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (77): Get current playback state from an AirPlay device, Get a specific device by ID, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100)., Get device info from database., Get current playback state for a zone, Seek to position in a zone (+69 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (64): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn(), ha_voice_wake() (+56 more)
...
Cohesion: 0.04
Nodes (51): Initialize Agent Zero client.                  Args:             base_url: Base, Initialize safety guardrails.                  Args:             mode: Safety mo, Initialize the affinity engine.                  Args:             half_life_day, AirPlayDevice, AirPlayService, AirPlay Integration Service Discovers and controls AirPlay devices for music pla, Start discovering AirPlay devices, Get all discovered AirPlay devices (+43 more)
...
Cohesion: 0.05
Nodes (55): FileSystemEventHandler, Admin-only: force-flush the skill discovery cache for a peer agent., Regenerate ZOE_SELF.md and distribute to all agents (OpenClaw, Hermes, compact)., reload_peer_skills(), trigger_agent_sync(), test_capabilities_snapshot_is_stable(), test_generated_context_mentions_hermes_engineering_loop(), test_graphify_rebuild_is_opt_in_by_default() (+47 more)
...
Cohesion: 0.07
Nodes (38): DatabaseValidator, Find all .db files in data directory, Check if file is in a backup/archive location, Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage. (+30 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (43): test_poll_v4_audit_protocol_recovery_reports_partial_for_next_phase(), test_mark_greptile_passes_only_on_five_of_five(), test_mark_reviewed_requires_zero_critical(), test_mark_tested_records_hashed_evidence(), test_record_evidence_retries_once_after_journal_conflict(), test_split_ticket_does_not_save_pipeline_block_when_children_fail(), test_split_ticket_does_not_save_pipeline_block_when_parent_update_fails(), test_split_ticket_retries_pipeline_conflict_without_duplicate_children() (+35 more)
...
Cohesion: 0.09
Nodes (31): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, Get a specific provider by type.                  Args:             provider_typ, _get(), _append_audit(), Return Atomic semantic hits as normalized records., _build_metadata(), MemoryRef (+23 more)
...
Cohesion: 0.07
Nodes (37): test_disabled_probe_is_acceptable_even_when_tools_are_missing(), test_disabled_runtime_does_not_surface_agent_files(), test_empty_env_does_not_fall_through_to_process_environment(), test_enabled_probe_reports_missing_node_before_pi(), test_enabled_runtime_detects_agent_files(), test_execution_can_be_configured_with_explicit_local_model_flag(), test_malformed_boolean_env_reports_misconfigured(), test_probe_uses_current_process_path_when_env_omits_path() (+29 more)
...
Cohesion: 0.1
Nodes (38): test_collect_observation_traces_accepts_valid_non_persistent_batch(), test_collect_observation_traces_can_require_single_scope_batch(), test_collect_observation_traces_discards_entire_batch_on_rejection(), test_collect_observation_traces_rejects_disallowed_surface(), test_collect_observation_traces_rejects_empty_batch(), test_collect_observation_traces_rejects_invalid_trace_shape(), test_collect_observation_traces_rejects_mixed_user_batch(), test_collect_observation_traces_reports_batch_rejections_from_original_input() (+30 more)
...
Cohesion: 0.08
Nodes (40): _audit_no_pr_issue(), _chain_for_issue(), _code_audit_implement_hint(), _engineering_mode(), _escalation_model_hint(), _existing_pr_url(), _goal_mode_args(), _greptile_mcp_bin() (+32 more)
...
Cohesion: 0.1
Nodes (34): _event(), test_event_to_hindsight_item_keeps_evidence_and_scope_tags(), test_event_to_hindsight_item_serializes_structured_context_as_json(), _admission_trace(), _plain_event(), test_build_hindsight_retain_admission_request_defaults_to_hindsight_target(), test_build_hindsight_retain_admission_request_keeps_caller_metadata_nested(), test_build_hindsight_retain_admission_request_rejects_invalid_backend() (+26 more)
...
Cohesion: 0.07
Nodes (27): AgentZeroClient, _compute_agent_zero_api_key(), Agent Zero Client =================  Client for communicating with Agent Zero's, Get or create context ID for a user.                  Args:             user_id:, Extract URLs from text as sources.                  Args:             text: Text, Send a message to Agent Zero and get response.                  Uses the /api_me, Execute a research task via Agent Zero.                  Args:             query, Create a multi-step plan for a task.                  Args:             task: Ta (+19 more)
...
Cohesion: 0.11
Nodes (34): Attach Hermes log evidence when a silent exit was really a budget stop., _with_recovered_log_budget(), _budget_phase(), implement_code_audit_post_patch_drift_reason_from_log(), implement_edit_safety_reason_from_log(), implement_pre_edit_drift_reason_from_log(), _is_code_audit_body(), _is_engineering_blocker_followup_body() (+26 more)
...
Cohesion: 0.08
Nodes (26): Create a person, run process_text → verify DB activity row AND MemPalace entry., recalc_and_save updates health_score in DB., Minimal compatibility wrapper so person_extractor works with raw asyncpg., test_health_score_recalc(), test_person_extractor_dual_fanout(), get_db(), FakeCursor, db_compat.py — asyncpg compatibility shim providing an aiosqlite-style cursor AP (+18 more)

### Community 64 - "Community 64"
Cohesion: 0.09
Nodes (30): ABC, MusicProvider, ProactiveTrigger, Abstract base class for music streaming providers.          All providers (YouTu, Like/save a track. Override if provider supports it., Add tracks to a playlist. Override if provider supports it., Save a track to user's library., Remove track from user's library. (+22 more)
...
Cohesion: 0.14
Nodes (27): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, AuthStatus, Provider authentication status., str, CardType (+19 more)
...
Cohesion: 0.08
Nodes (22): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, get_media_controller(), Get the singleton media controller instance., get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us, Check if user has valid YouTube Music authentication., Get the stream URL for a track.                  Uses caching to avoid repeated (+14 more)
...
Cohesion: 0.16
Nodes (24): get_agent_board(), Return Multica engineering ticket state for AG-UI display.      Falls back grace, test_create_issue_metadata_preserves_existing_ticket_fields(), test_update_ticket_progress_can_clear_dispatch_approval(), test_block_only_description_does_not_gain_leading_blank_lines(), test_progress_and_children_patch_metadata_only(), test_replacing_middle_block_preserves_suffix_newline(), test_ticket_block_preserves_human_description() (+16 more)
...
Cohesion: 0.1
Nodes (16): Search for k most similar tracks.                  Args:             query: 256-, Search with similarity scores.                  Args:             query: 256-dim, Search YouTube Music.                  Search works without authentication using, Return mock results when not authenticated., Protocol, test_create_hindsight_retain_candidate_uses_memory_service_pending_ingest(), FakeMemoryService, FakeRef (+8 more)
...
Cohesion: 0.12
Nodes (14): N8nIntegration, Sync Zoe user to n8n                  Args:             user_id: Zoe user ID, Sync user permissions to n8n                  Args:             user_id: User ID, Create workflow-specific permissions in n8n                  Args:             w, Get workflows accessible to user                  Args:             user_id: Use, Execute workflow on behalf of user                  Args:             user_id: U, Map Zoe user to n8n user format, n8n SSO integration manager (+6 more)
...
Cohesion: 0.19
Nodes (20): Tests for main.py Multica poll-loop helpers., RecordingClient, test_record_blocked_multica_chain_creates_budget_followup_once(), test_record_blocked_multica_chain_creates_iteration_budget_followup(), test_record_blocked_multica_chain_creates_protocol_followup(), test_record_blocked_multica_chain_does_not_create_recursive_harness_followup(), test_record_blocked_multica_chain_falls_back_to_classification_and_default(), test_record_blocked_multica_chain_records_terminal_block_metadata() (+12 more)
...
Cohesion: 0.11
Nodes (13): Check a single router file for authentication issues.     Returns list of (line_, check_file(), Check a single file for hardcoded database paths, Check a single file against rules, find_references(), load_critical_files(), Load critical files manifest, Find references to file in codebase (+5 more)
...
Cohesion: 0.21
Nodes (14): _Db, Tests for panel_* MCP tool definitions and execution paths., test_panel_announce_exists(), test_panel_check_auth_exists(), test_panel_clear_exists(), test_panel_navigate_exists(), test_panel_request_auth_exists(), test_panel_set_mode_exists() (+6 more)
...
Cohesion: 0.26
Nodes (14): Engineering Harness Loop Guide, append_report(), build_report(), _is_test_task_ref(), monitor_pipeline(), parse_pipeline_findings(), _pipeline_store_path(), Exclude pytest fixture refs accidentally written to the operator store. (+6 more)
...
Cohesion: 0.18
Nodes (11): Action Plan Progress Report, AG-UI Protocol Implementation Status, AG-UI Chat Protocol for Zoe, Architecture Protection System, Chat Backend (chat.py), Chat Page Frontend (chat.html), Zoe Code Execution with MCP - Implementation Summary, LLM Capabilities Awareness Audit (+3 more)
...
Cohesion: 0.29
Nodes (10): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), Chat Router, Enhanced MemAgent Client (+2 more)

### Community 250 - "Community 250"
Cohesion: 0.2
Nodes (10): All Documentation Complete Index, Creating Skills Guide, Cursor And AI Assistant Best Practices For Zoe, Governed Self-Evolution Guide, Hermes Engineering Skills Guide, Quick Journal Widget Guide, Multica-First Engineering Driver Guide, Zoe People System Quick Start Guide (+2 more)
...
Cohesion: 0.22
Nodes (9): API Versioning Strategy, Documentation & Rules Audit Report, Backend lists.py Router, Data Migration SQL Commands, Database Query in GET /api/lists/{list_type}, Default Lists in Database, GET /api/lists/{list_type} Endpoint, Updated Response Format in GET /api/lists/{list_type} (+1 more)
...
Cohesion: 0.4
Nodes (6): Chat Model Fix - GPU Allocation Error, Chat Performance Fix, GPU Model Setup - gemma3n-e2b-gpu:latest, LiteLLM Gateway Integration, RouteLLM & LiteLLM Status, System Test Results - Comprehensive Testing
...
Cohesion: 0.4
Nodes (5): Desktop Dashboard Fixes Complete, Drag and Drop Fix, Floating Action Button Edit Mode, Touch Dashboard Navigation Bar Upgrade, Widget Persistence Fix
...
Cohesion: 0.5
Nodes (4): Non-blocking Session Loading Fix, Created manifest.json for PWA, Protocol Handling Fix in Chat SSL, PWA Phase 1 Implementation Complete

### Community 325 - "Community 325"
Cohesion: 0.5
Nodes (4): Dashboard Layout Protection, Dashboard Loaders, WidgetManager, Widget Manifest

### Community 326 - "Community 326"
Cohesion: 0.5
Nodes (4): Chat Router Intent Integration, HassIL Classifier, Intent Executor, Lists Intent Handlers
...
Cohesion: 0.67
Nodes (3): Lists & Calendar Page Errors Fix, Updated lists.py Router for Schema Fix, Lists Database Schema Fix

### Community 344 - "Community 344"
Cohesion: 0.67
Nodes (3): Calendar Router, Lists Router, Memories Router

## Knowledge Gaps
- **2861 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2856 more)
...
- **Why does `main()` connect `Community 2` to `Community 1`, `Community 133`, `Community 262`, `Community 137`, `Community 139`, `Community 140`, `Community 141`, `Community 273`, `Community 145`, `Community 148`, `Community 276`, `Community 22`, `Community 23`, `Community 24`, `Community 153`, `Community 27`, `Community 156`, `Community 30`, `Community 286`, `Community 32`, `Community 33`, `Community 165`, `Community 38`, `Community 40`, `Community 44`, `Community 303`, `Community 48`, `Community 177`, `Community 178`, `Community 310`, `Community 63`, `Community 321`, `Community 65`, `Community 67`, `Community 68`, `Community 197`, `Community 70`, `Community 66`, `Community 198`, `Community 199`, `Community 74`, `Community 75`, `Community 77`, `Community 78`, `Community 207`, `Community 208`, `Community 81`, `Community 82`, `Community 83`, `Community 206`, `Community 89`, `Community 220`, `Community 221`, `Community 94`, `Community 229`, `Community 230`, `Community 232`, `Community 104`, `Community 233`, `Community 109`, `Community 116`, `Community 118`, `Community 247`, `Community 248`, `Community 124`, `Community 127`?**
  _High betweenness centrality (0.194) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 75` to `Community 2`, `Community 260`, `Community 133`, `Community 4`, `Community 7`, `Community 6`, `Community 137`, `Community 9`, `Community 139`, `Community 13`, `Community 141`, `Community 19`, `Community 20`, `Community 22`, `Community 24`, `Community 27`, `Community 28`, `Community 29`, `Community 32`, `Community 33`, `Community 44`, `Community 46`, `Community 303`, `Community 48`, `Community 51`, `Community 179`, `Community 54`, `Community 185`, `Community 58`, `Community 57`, `Community 66`, `Community 199`, `Community 72`, `Community 200`, `Community 78`, `Community 213`, `Community 222`, `Community 227`, `Community 228`, `Community 101`, `Community 100`, `Community 103`, `Community 104`, `Community 234`, `Community 111`, `Community 112`, `Community 239`, `Community 245`, `Community 118`, `Community 117`, `Community 127`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `get_memory_service()` connect `Community 30` to `Community 2`, `Community 4`, `Community 264`, `Community 17`, `Community 26`, `Community 28`, `Community 29`, `Community 287`, `Community 170`, `Community 44`, `Community 180`, `Community 54`, `Community 189`, `Community 84`, `Community 91`, `Community 102`, `Community 111`, `Community 121`, `Community 252`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Are the 19 inferred relationships involving `main()` (e.g. with `get_memory_service()` and `read_guard_state()`) actually correct?**
