...
## Summary
- 7991 nodes · 14036 edges · 560 communities (350 shown, 210 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1898 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bcec0016`
...
- `User Isolation Audit & Fix Report` --conceptually_related_to--> `Lists Router Code Fix`  [INFERRED]
  docs/architecture/user-isolation-audit.md → services/zoe-core/routers/lists.py
- `API Versioning Strategy` --conceptually_related_to--> `Lists Router Code Fix`  [INFERRED]
  docs/architecture/API_VERSIONING_STRATEGY.md → services/zoe-core/routers/lists.py

## Communities (560 total, 210 thin omitted)
...
Cohesion: 0.02
Nodes (93): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail(), _is_allowed_line() (+85 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (92): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+84 more)
...
Cohesion: 0.06
Nodes (83): _issue_sort_key(), Return (sequence_key, phase_number) when title encodes a phased track., True when every lower phase in the same sequence is ``done`` (or missing)., Pick up to ``count`` backlog issues respecting phased ordering.      ``all_issue, select_batch(), _event(), _admission_trace(), _plain_event() (+75 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (57): get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker., Play previous track (from history)., Add a track to the queue.                  Args:             position: If specif (+49 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (76): Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100)., Get device info from database. (+68 more)
...
Cohesion: 0.06
Nodes (67): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Validate database structure, Enum, Run all validations.                  Returns:             True if all validatio, OutputState, OutputType (+59 more)
...
Cohesion: 0.05
Nodes (54): BaseHTTPMiddleware, evaluate(), ProactiveTrigger, Manually trigger the morning brief for the calling user.     Useful for testing, trigger_morning_brief(), check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe (+46 more)
...
Cohesion: 0.07
Nodes (60): add_activity(), add_bucket_item(), add_gift_idea(), add_important_date(), add_relationship(), _archive_person_mempalace(), create_people_field(), create_person() (+52 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (56): test_dispatch_after_scout_evidence_creates_next_phase(), test_audit_profile_closeout_requires_log_not_greptile(), test_audit_profile_verify_does_not_require_test(), test_block_fingerprint_aborts_after_two_identical(), test_block_preserves_phase_and_evidence_until_restarted(), test_evidence_metadata_rejects_secret_fields(), test_explicit_scope_split_is_allowed_from_scout(), test_failed_evidence_does_not_satisfy_gate() (+48 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (52): print_results(), Scan entire project and categorize all files., Check if path should be ignored., Categorize a file and determine if it's in the right location.          Returns:, scan_project(), should_ignore(), check_for_dangerous_patterns(), Print validation results.          Returns:         Exit code (0 if all files ex (+44 more)
...
Cohesion: 0.05
Nodes (49): Get all active sessions for a specific user (admin only)          Args:, get_current_user(), get_passcode_status(), get_user_profile(), get_user_sessions(), guest_login(), InitialPasswordSetupRequest, LoginRequest (+41 more)
...
Cohesion: 0.06
Nodes (41): MusicProvider, Complete auth with Music User Token from MusicKit JS.                  The auth_, Convert Apple Music album data to Album., Convert Apple Music playlist data to Playlist., Search for albums on Apple Music., Search for playlists on Apple Music., Album, AuthStatus (+33 more)
...
Cohesion: 0.06
Nodes (41): _broadcast_calendar_chat_prefill_ui(), _broadcast_shopping_chat_ui(), chatgpt_auth_status(), _env_int(), _extract_complete_sentences(), _get_faster_whisper_model(), get_livekit_token(), _log_voice_stt_sample() (+33 more)
...
Cohesion: 0.07
Nodes (40): get_reports(), create_entry(), get_entry(), get_mood_stats(), get_prompts(), get_streak_stats(), list_entries(), list_on_this_day() (+32 more)
...
Cohesion: 0.08
Nodes (30): Tests for background_runner enqueue, task lifecycle, and Hermes routing., Requests beyond _MAX_REQUEST_DEPTH must raise ValueError immediately., Requests at exactly _MAX_REQUEST_DEPTH must be accepted., enqueue_background_task should INSERT a row and return the new task id., _run_task should set status='done' and store result when Hermes succeeds., _run_task should set status='error' when Hermes raises an exception., Minimal async DB context that records calls., test_enqueue_accepts_max_depth() (+22 more)

### Community 45 - "Community 45"
Cohesion: 0.08
Nodes (29): get_airplay_output(), AirPlay Output Target =====================  Implementation of OutputTarget for, Get the singleton AirPlay output instance., is_initialized(), output_type(), Output Target Base Class ========================  Abstract base class for all a, Chromecast Output Target ========================  Implementation of OutputTarge, get_homeassistant_output() (+21 more)
...
Cohesion: 0.08
Nodes (32): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, Get or create a YTMusic client for a user.                  Args:             us, Check if user has valid YouTube Music authentication., Normalize a YouTube Music item to standard format., Get video stream URL for a track (for video playback).                  YouTube, YouTube Music integration provider.          Handles:     - Searching tracks, al, Get playlist with tracks. (+24 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (37): test_dispatch_does_not_parent_recovered_phase_to_blocked_prior_row(), test_dispatch_resumed_todo_archives_blocked_current_phase_before_retry(), test_dispatch_resumed_todo_reports_archive_failure_without_create(), test_dispatch_retro_uses_main_repo_workspace(), test_poll_ignores_stale_terminal_row_for_revision_phase(), test_poll_non_v4_pipeline_terminal_block_stays_blocked(), test_poll_v4_partial_clears_stale_prior_phase_blocker(), test_poll_v4_resumed_skip_scout_ignores_stale_scout_blocker() (+29 more)

### Community 49 - "Community 49"
Cohesion: 0.08
Nodes (20): test_enabled_status_includes_embedding_config(), test_event_to_hindsight_item_keeps_evidence_and_scope_tags(), test_event_to_hindsight_item_serializes_structured_context_as_json(), test_operation_status_gets_hindsight_operation_endpoint(), test_recall_posts_trace_enabled_request(), test_request_wraps_non_json_response(), test_retain_posts_to_hindsight_memories_endpoint(), test_retain_refuses_auto_write_when_gate_closed() (+12 more)
...
Cohesion: 0.16
Nodes (14): BaseHTTPRequestHandler, _HealthHandler, Handle orb-tap activation from the touch UI (POST /activate)., _discover_zoe_server(), _get_local_subnet(), _get_mac(), _probe_host(), ProvisionHandler (+6 more)

### Community 104 - "Community 104"
Cohesion: 0.11
Nodes (20): Make a request to the Home Assistant API., AppleMusicProvider, Get user's Music User Token from database., Make authenticated API request., Convert Apple Music artist data to Artist., Search for artists on Apple Music., Apple Music implementation of MusicProvider.          Uses the Apple Music API w, Generate or return cached developer token. (+12 more)

### Community 105 - "Community 105"
Cohesion: 0.11
Nodes (23): Insert a proactive_scheduled row and register an APScheduler job.     Returns th, schedule_reminder(), init_pool(), Initialize the asyncpg connection pool. Call once at startup., _active_agents_list(), _enqueue_panel_tool(), _execute_tool(), _get_weather_default_location() (+15 more)

### Community 106 - "Community 106"
Cohesion: 0.11
Nodes (19): migrate_self_entries(), Create self entries for users in the people table, _compute_compatibility(), Compute compatibility score and shared traits between two check-ins., Get all registered providers., test_graphiti_episode_payloads_include_evidence(), test_graphiti_supersession_payloads_have_temporal_order(), test_score_graphiti_answer_reports_missing_terms() (+11 more)
...
Cohesion: 0.17
Nodes (22): test_collect_observation_traces_accepts_valid_non_persistent_batch(), test_collect_observation_traces_can_require_single_scope_batch(), test_collect_observation_traces_discards_entire_batch_on_rejection(), test_collect_observation_traces_rejects_disallowed_surface(), test_collect_observation_traces_rejects_empty_batch(), test_collect_observation_traces_rejects_invalid_trace_shape(), test_collect_observation_traces_rejects_mixed_user_batch(), test_collect_observation_traces_reports_batch_rejections_from_original_input() (+14 more)
...
Cohesion: 0.13
Nodes (14): test_dispatch_adjusts_running_scout_journal_when_scout_row_is_done(), test_dispatch_adjusts_stale_scout_journal_for_scope_split_child(), test_dispatch_archives_stale_terminal_revision_phase_row(), test_dispatch_does_not_adjust_running_scout_journal_with_active_row(), test_poll_v4_audit_protocol_recovery_reports_partial_for_next_phase(), test_mark_greptile_passes_only_on_five_of_five(), test_mark_reviewed_requires_zero_critical(), test_mark_tested_records_hashed_evidence() (+6 more)
...
Cohesion: 0.1
Nodes (20): get_auth_manager(), Get the singleton auth manager instance., get_media_controller(), Get the singleton media controller instance., youtube(), get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us, Get the singleton YouTube Music provider instance. (+12 more)
...
Cohesion: 0.12
Nodes (12): Unified track representation across all providers.          All providers must n, Track, get_provider_registry(), ProviderRegistry, Music Provider Registry =======================  Singleton registry that manages, Get the appropriate provider for a track.                  Uses track ID prefix, Search across all connected providers.                  Args:             query:, Get authentication status for all providers.                  Args: (+4 more)
...
Cohesion: 0.21
Nodes (16): Lazy load the underlying provider., available_providers(), _get_info(), _get_players(), _get_providers(), _get_queue_items(), _ma_headers(), _ma_url() (+8 more)
...
Cohesion: 0.16
Nodes (16): test_load_target_patterns_extracts_contract_metadata(), test_measure_phase_treats_contract_target_patterns_as_no_patterns(), test_dump_and_load_contract_snapshot_round_trip(), test_legacy_contract_snapshot_preserves_target_patterns_and_writer(), test_legacy_contract_snapshot_supports_user_issue_report(), test_loader_rejects_legacy_non_contract_payloads(), test_mcp_contract_snapshot_has_source_evidence_when_freeform_evidence_is_empty(), test_mcp_contract_snapshot_is_valid_and_review_only() (+8 more)

### Community 169 - "Community 169"
Cohesion: 0.18
Nodes (11): _compact_context(), _embeddings_base_url_from_env(), _env_bool(), event_to_hindsight_item(), from_env(), HindsightMemoryError, Hindsight sidecar adapter for Zoe's memory bake-off.  The adapter is disabled by, Convert a validated Zoe memory event into a Hindsight retain item. (+3 more)

### Community 170 - "Community 170"
Cohesion: 0.15
Nodes (16): AuthResponse, login(), login_passcode(), Authenticate with username and password          Args:         request: Login cr, Authenticate with username (or user_id) and passcode.      Accepts either ``user, Register new user (admin only)          Args:         request: User registration, Authentication response model, register() (+8 more)
...
Cohesion: 0.17
Nodes (15): Zoe Module Generator Configuration, Database Protection Rules, Zoe Docker Compose Base, Jetson Docker Compose Override, Supplemental Docker Compose Modules, Raspberry Pi Docker Compose Override, Hardware Compatibility Guide, Zoe Project Structure & Governance Rules (+7 more)
...
Cohesion: 0.17
Nodes (11): test_percentile_rejects_out_of_range_values(), test_maintenance_runner_imports_real_bakeoff_module(), test_score_recall_response_reports_missing_terms(), test_summarize_bakeoff_scores_reports_score_and_latency(), test_synthetic_events_validate_and_include_required_cases(), Synthetic Hindsight bake-off fixtures and scoring helpers., recall_response_text(), score_recall_response() (+3 more)
...
Cohesion: 0.2
Nodes (11): Role-Based Access Control Manager, Create a custom role                  Args:             role_id: Unique role ide, Validate permission strings, return list of invalid ones, Initialize default permission definitions, RBACManager, Current-contract RBAC behavior tests., test_permission_format_validation_accepts_supported_patterns(), test_permission_format_validation_rejects_invalid_patterns() (+3 more)
...
Cohesion: 0.25
Nodes (11): _env_float(), _config_values(), _env_bool_snapshot(), _env_float_snapshot(), _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers(), _scan_processes() (+3 more)
...
Cohesion: 0.18
Nodes (10): AccessContext, Context for permission checks, Enhanced Session Management for Multi-Factor Authentication Supports different s, Validate that session has permission with escalation handling                  A, Configuration for different session types, Security policies for session management, Get owner of resource for permission checks, requires_password_escalation() (+2 more)
...
Cohesion: 0.18
Nodes (8): AuthValidationResult, Verify user password                  Args:             user_id: User identifier, Result of authentication validation, Parse stored auth timestamp strings., Check if password change is required due to age, Log authentication attempt - non-blocking, errors suppressed, Verify password authentication, Verify user password for escalation
...
Cohesion: 0.18
Nodes (11): API Versioning Strategy, Documentation & Rules Audit Report, Standardized Error Handling Guide, Database List Items Table, Database Lists Table, Default Lists (IDs 1-4), GET /api/lists/{list_type} Endpoint, Lists & Calendar Page Errors - Fixed (+3 more)
...
Cohesion: 0.22
Nodes (7): Get the stream URL for a track.                  Uses caching to avoid repeated, Check if a cached stream URL is expiring soon.                  Args:, Refresh stream URL if it's expiring soon.                  This is called proact, Get audio stream URL for a track.                  NOTE: Apple Music doesn't pro, get_stream_url(), Get audio stream URL for a track.                  Args:             track_id: P, Get audio stream URL for a track.                  NOTE: Spotify doesn't provide
...
Cohesion: 0.22
Nodes (6): check_permission(), Check if current user has specific permission          Args:         permission:, Check if user has specific permission                  Args:             user_id, Check multiple permissions at once                  Args:             user_id: U, Check if any wildcard permissions grant access, Check resource-specific permissions
...
Cohesion: 0.33
Nodes (8): test_normalize_mcp_evolution_proposal_type_matches_contract_fallback(), _evidence_refs(), build_legacy_evolution_proposal_contract(), normalize_legacy_evolution_proposal_type(), normalize_mcp_evolution_proposal_type(), Adapters that bridge legacy Zoe proposal writers to the proposal contract.  The, Normalize legacy MCP proposal types before DB and contract storage., Build a validated contract snapshot for a legacy proposal writer.      The retur
...
Cohesion: 0.33
Nodes (9): MCP-Only Architecture for Zoe Modules, Music Module Migration Guide, Module Intent Auto-Discovery System Complete, Zoe Module Requirements, Zoe Module System Implementation Complete, Music Module Dependency Audit, Music Module Extraction Execution Plan, Self-Contained Modules Complete Guide (+1 more)
...
Cohesion: 0.25
Nodes (8): Action Plan Progress Report, AG-UI Protocol Implementation Status, AG-UI Chat Protocol for Zoe, Architecture Protection System - Preventing Hardcoded Logic, Chat Backend (chat.py), Chat Page Frontend (chat.html), Zoe Code Execution with MCP - Implementation Summary, LLM Capabilities Awareness Audit
...
Cohesion: 0.38
Nodes (7): Agent Zero Docker Compose Module, Agent Zero Implementation Checklist, Agent Zero Integration - COMPLETE, Agent Zero Intent Patterns, Agent Zero Live Integration Test Report, Agent Zero Module for Zoe, Agent Zero + Zoe Integration Summary
...
Cohesion: 0.4
Nodes (5): Desktop Dashboard Fixes - COMPLETE, Touch Dashboard Upgrade - Drag & Drop Fix, Touch Dashboard Upgrade - Floating Edit Mode, Touch Dashboard Upgrade - Navigation Bar, Touch Dashboard Upgrade - Persistence Fix

### Community 327 - "Community 327"
Cohesion: 0.4
Nodes (5): Cursor Prompt Templates, Decision Log, Metrics Tracking, Implementation Progress, Memory & Hallucination Reduction Implementation Directory
...
Cohesion: 0.5
Nodes (4): Chat SSL Fix - Fetch Interceptor, Chat SSL Fix - manifest.json, Chat SSL Fix - Protocol Handling, PWA Phase 1 Implementation Complete
...
## Knowledge Gaps
- **2900 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2895 more)
...
- **Why does `main()` connect `Community 1` to `Community 129`, `Community 2`, `Community 4`, `Community 261`, `Community 260`, `Community 9`, `Community 137`, `Community 14`, `Community 274`, `Community 19`, `Community 147`, `Community 22`, `Community 23`, `Community 25`, `Community 26`, `Community 283`, `Community 32`, `Community 162`, `Community 292`, `Community 38`, `Community 49`, `Community 178`, `Community 56`, `Community 185`, `Community 313`, `Community 187`, `Community 60`, `Community 186`, `Community 191`, `Community 192`, `Community 65`, `Community 194`, `Community 67`, `Community 321`, `Community 69`, `Community 70`, `Community 71`, `Community 196`, `Community 75`, `Community 78`, `Community 79`, `Community 208`, `Community 210`, `Community 211`, `Community 85`, `Community 214`, `Community 90`, `Community 220`, `Community 221`, `Community 222`, `Community 99`, `Community 100`, `Community 229`, `Community 103`, `Community 105`, `Community 106`, `Community 107`, `Community 235`, `Community 111`, `Community 112`, `Community 113`, `Community 243`, `Community 244`, `Community 116`, `Community 122`, `Community 123`, `Community 125`?**
  _High betweenness centrality (0.181) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 106` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 258`, `Community 6`, `Community 9`, `Community 266`, `Community 11`, `Community 12`, `Community 142`, `Community 20`, `Community 22`, `Community 23`, `Community 153`, `Community 32`, `Community 35`, `Community 38`, `Community 40`, `Community 169`, `Community 42`, `Community 43`, `Community 48`, `Community 49`, `Community 177`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 313`, `Community 60`, `Community 189`, `Community 191`, `Community 192`, `Community 70`, `Community 74`, `Community 203`, `Community 210`, `Community 83`, `Community 90`, `Community 94`, `Community 225`, `Community 226`, `Community 105`, `Community 107`, `Community 108`, `Community 237`, `Community 236`, `Community 242`, `Community 116`, `Community 117`, `Community 247`, `Community 251`, `Community 125`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 26` to `Community 1`, `Community 2`, `Community 100`, `Community 5`, `Community 6`, `Community 39`, `Community 8`, `Community 47`, `Community 242`, `Community 115`, `Community 185`, `Community 219`?**
...
- **Are the 85 inferred relationships involving `list()` (e.g. with `get_matches()` and `_compute_compatibility()`) actually correct?**
  _`list()` has 85 INFERRED edges - model-reasoned connections that need verification._
