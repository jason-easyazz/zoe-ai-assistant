...
## Summary
- 7756 nodes · 13290 edges · 578 communities (343 shown, 235 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1704 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `87fcab07`
...
- `Code Execution Pattern with MCP` --conceptually_related_to--> `RouteLLM (Intelligent Model Router)`  [INFERRED]
  docs/architecture/MCP_BEST_PRACTICES_REVIEW.md → services/zoe-core/route_llm.py
...
Cohesion: 0.04
Nodes (57): _broadcast_intent_nav(), _build_calendar_form_props(), _build_hermes_payload(), _build_reminder_form_props(), _chatgpt_connect_flow(), _check_frustration(), _create_pending_approval(), _detect_preview_urls() (+49 more)
...
Cohesion: 0.05
Nodes (60): Get current playback state from an AirPlay device, Get a specific device by ID, Get current playback state from a Chromecast, Set playback volume (0-100)., Get device info from database., Set volume for a zone, AirPlayOutput, Stop playback on an AirPlay device. (+52 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (62): a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_cancel(), board_review(), build_engineering_guard_packet(), delegate_to_agent(), _EngineeringGuardRunRequest (+54 more)
...
Cohesion: 0.06
Nodes (40): MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Seek to position in current track., Controls music playback across devices.          Supports:     - Browser/panel p, Get the current queue., Reorder a track in the queue., Send message to device via WebSocket. (+32 more)
...
Cohesion: 0.08
Nodes (38): BaseHTTPMiddleware, evaluate(), ProactiveTrigger, Manually trigger the morning brief for the calling user.     Useful for testing, trigger_morning_brief(), check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe (+30 more)
...
Cohesion: 0.06
Nodes (43): Manually trigger the weekly consolidation pass.      Admin-only when ``user_id``, Manually trigger the LLM memory digest for a user (or the requesting user)., trigger_memory_consolidation(), trigger_memory_digest(), _deep_sleep_pass(), _emotional_memory_pass(), _extract_concept_tags(), _extract_facts_with_gemma() (+35 more)

### Community 33 - "Community 33"
Cohesion: 0.07
Nodes (41): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+33 more)
...
Cohesion: 0.07
Nodes (33): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, get_media_controller(), Get the singleton media controller instance., youtube(), get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us, Get or create a YTMusic client for a user.                  Args:             us (+25 more)
...
Cohesion: 0.11
Nodes (37): _contract(), _load_fixture(), Tests for Zoe card contract validation., test_content_required_fields_are_per_card_type(), test_every_card_type_has_minimal_valid_content(), test_idempotency_key_is_optional_but_not_blank(), test_invalid_card_contract_fixtures_return_actionable_errors(), test_invalid_card_type_is_rejected() (+29 more)
...
Cohesion: 0.08
Nodes (28): test_dispatch_adjusts_running_scout_journal_when_scout_row_is_done(), test_dispatch_adjusts_stale_scout_journal_for_scope_split_child(), test_dispatch_archives_stale_terminal_revision_phase_row(), test_dispatch_does_not_adjust_running_scout_journal_with_active_row(), test_poll_v4_audit_protocol_recovery_reports_partial_for_next_phase(), test_mark_greptile_passes_only_on_five_of_five(), test_mark_reviewed_requires_zero_critical(), test_mark_tested_records_hashed_evidence() (+20 more)
...
Cohesion: 0.08
Nodes (26): AgentZeroClient, _compute_agent_zero_api_key(), Agent Zero Client =================  Client for communicating with Agent Zero's, Get or create context ID for a user.                  Args:             user_id:, Extract URLs from text as sources.                  Args:             text: Text, Send a message to Agent Zero and get response.                  Uses the /api_me, Execute a research task via Agent Zero.                  Args:             query, Create a multi-step plan for a task.                  Args:             task: Ta (+18 more)

### Community 58 - "Community 58"
Cohesion: 0.11
Nodes (29): addFeedItem(), applyStats(), autoEndSession(), bumpStat(), clearHostSession(), confirmEndSession(), connectWS(), endSpeedDating() (+21 more)
...
Cohesion: 0.12
Nodes (10): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., Lazy load event tracker., Add a track to the queue.                  Args:             position: If specif, Pop the next track from queue., Skip to next track in queue (+2 more)

### Community 66 - "Community 66"
Cohesion: 0.08
Nodes (25): Tests for Zoe card service foundation., Test building a valid card contract., Test domain builder registry functionality., Test global card service instance., Test validating a valid card contract., Test validating an invalid card contract raises error., Test converting compatible contract for emission., Test converting incompatible contract raises error. (+17 more)
...
Cohesion: 0.15
Nodes (28): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, str, CardType, Renderer-facing card payload families., HindsightEvalQuery (+20 more)
...
Cohesion: 0.09
Nodes (23): migrate_self_entries(), Create self entries for users in the people table, _compute_compatibility(), Compute compatibility score and shared traits between two check-ins., Get all registered providers., test_graphiti_episode_payloads_include_evidence(), test_graphiti_supersession_payloads_have_temporal_order(), test_percentile_rejects_out_of_range_values() (+15 more)
...
Cohesion: 0.09
Nodes (20): DatabaseValidator, Find all .db files in data directory, Check if file is in a backup/archive location, Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage. (+12 more)
...
Cohesion: 0.08
Nodes (19): Feature Improvement Testing Test each feature individually, measure impact, vali, Test P0-3: Validate temperature appropriateness, Test that temperature ranges are appropriate for intent types, Test that temperature adjusts based on context availability, Test P0-4: Validate grounding detection, Test P0-1: Measure actual latency improvements, Test that all features can be imported without conflicts, Measure latency improvement for Tier 0 intents (+11 more)
...
Cohesion: 0.1
Nodes (24): attachCardActions(), buildActionButtons(), buildMatchCard(), hideSDTimerOverlay(), hideSpeedDatingBanner(), loadMatches(), loadPendingConnections(), metPeople (+16 more)

### Community 95 - "Community 95"
Cohesion: 0.1
Nodes (16): Search for k most similar tracks.                  Args:             query: 256-, Search with similarity scores.                  Args:             query: 256-dim, Search YouTube Music.                  Search works without authentication using, Return mock results when not authenticated., Protocol, FakeMemoryService, FakeRef, test_recall_text_from_results_supports_refs_dicts_and_strings() (+8 more)
...
Cohesion: 0.08
Nodes (22): Proactive adapters — thin wrappers that translate external service events into T, get_user_profile(), Get current user profile (alias for /user for UI compatibility)          Args:, Get list of active user profiles for login page.     No authentication required, Executor adapters for Multica-dispatched work.  Multica is the agnostic source o, get_capabilities(), Music Service Module ====================  Platform-aware music system with: - Y, Get music system capabilities for this platform.          Returns:         Dict (+14 more)
...
Cohesion: 0.09
Nodes (24): Shut down APScheduler and the slow loop., Register a Tier 2 slow-loop trigger., register_trigger(), stop_proactive_engine(), stop_scheduler(), _hermes_review_proposal(), Ask Hermes to review an evolution proposal before implementation is queued., Use Hermes for foreground voice escalation; OpenClaw is manual-only. (+16 more)

### Community 102 - "Community 102"
Cohesion: 0.12
Nodes (17): Health check endpoint.          Returns service health and Agent Zero availabili, health(), test_event_to_hindsight_item_keeps_evidence_and_scope_tags(), test_event_to_hindsight_item_serializes_structured_context_as_json(), _compact_context(), _embeddings_base_url_from_env(), event_to_hindsight_item(), from_env() (+9 more)
...
Cohesion: 0.09
Nodes (19): get_airplay_output(), AirPlay Output Target =====================  Implementation of OutputTarget for, Get the singleton AirPlay output instance., is_initialized(), output_type(), Chromecast Output Target ========================  Implementation of OutputTarge, get_homeassistant_output(), Home Assistant Output Target ============================  Implementation of Out (+11 more)
...
Cohesion: 0.09
Nodes (22): create_note(), delete_note(), list_notes(), _owner_filter_sql(), patch_note(), FastAPI router for notes. Mounted at prefix="/api/notes" with tag "notes"., Update an existing note., Alias for update_note to support existing note editors using PATCH. (+14 more)
...
Cohesion: 0.14
Nodes (15): test_disabled_probe_is_acceptable_even_when_tools_are_missing(), test_disabled_runtime_does_not_surface_agent_files(), test_empty_env_does_not_fall_through_to_process_environment(), test_enabled_probe_reports_missing_node_before_pi(), test_enabled_runtime_detects_agent_files(), test_execution_can_be_configured_with_explicit_local_model_flag(), test_malformed_boolean_env_reports_misconfigured(), test_probe_uses_current_process_path_when_env_omits_path() (+7 more)
...
Cohesion: 0.1
Nodes (22): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), CODEX_HELP_REQUEST.md, FINAL_STATUS_REPORT.md (+14 more)
...
Cohesion: 0.17
Nodes (17): get_memory_router_status(), Read-only status for Zoe's disabled-by-default memory router runtime., test_build_memory_route_trace_requires_user_for_personal_scope(), test_disabled_runtime_does_not_compute_route_decision(), test_disabled_runtime_trace_is_skipped_and_does_not_route(), test_memory_router_runtime_enabled_is_observe_only(), test_memory_router_runtime_is_disabled_by_default(), test_runtime_route_can_include_observation_trace() (+9 more)
...
Cohesion: 0.15
Nodes (16): DESIRE_LABELS, getMyCheckinId(), goDiscover(), INTENT_LABELS, load(), loadQuiz(), params, pathParts (+8 more)
...
Cohesion: 0.18
Nodes (15): _config_values(), _env_bool_snapshot(), GraphitiSidecarProbeResult, _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers(), _scan_processes(), _scan_runtime() (+7 more)
...
Cohesion: 0.16
Nodes (14): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _append_audit(), MemoryServiceError, Raised for operational failures., Fast metadata-filter read for system prompt injection., Right-to-be-forgotten. Returns number of rows removed., Full JSON dump for GDPR-style export. (+6 more)

### Community 169 - "Community 169"
Cohesion: 0.16
Nodes (12): test_maintenance_runner_imports_real_bakeoff_module(), test_score_recall_response_reports_missing_terms(), test_summarize_bakeoff_scores_reports_score_and_latency(), test_synthetic_events_validate_and_include_required_cases(), percentile(), Synthetic Hindsight bake-off fixtures and scoring helpers., recall_response_text(), score_recall_response() (+4 more)
...
Cohesion: 0.14
Nodes (16): Agent Spike Playbook, Cleanup Safety Rules, Critical Files - Do Not Delete, Disk Space Protection System, Disk Space Protection - Implementation Complete, Docker Networking Rules, File Tagging System for Unused Files, Hermes Optimization Playbook (+8 more)
...
Cohesion: 0.18
Nodes (12): OpenClaw message context prefix (zoe-auth role → agent)., test_context_prefix_includes_user_role_and_name(), test_context_prefix_unknown_role_when_omitted(), discover_openclaw_capabilities(), openclaw_cli(), openclaw_gateway_call(), OpenClaw gateway client: ACP-based communication with the OpenClaw agent.  Uses, Send message through OpenClaw agent via ACP (browser, tools, memory, personality (+4 more)
...
Cohesion: 0.22
Nodes (5): Test P0-1: Context Validation, Tier 0 deterministic intents should skip context, Data-fetching Tier 0 intents need context, Memory keywords should always require context, Complex queries (>15 words) should require context

### Community 265 - "Community 265"
Cohesion: 0.33
Nodes (9): Zoe Module Generator Configuration, Database Protection Rules, Jetson Docker Compose Override, Supplemental Docker Compose Modules, Raspberry Pi Docker Compose Override, Zoe Docker Compose Base, Zoe Project Structure & Governance Rules, Zoe AI Assistant Quick Start (+1 more)
...
Cohesion: 0.33
Nodes (6): Database Consolidation Plan, memory.db Specialized Database, zoe.db Primary Database, List Isolation Bug Fix, Lists Database Fixes, zoe-auth Service

### Community 305 - "Community 305"
Cohesion: 0.33
Nodes (6): Zoe Data Agents Registry YAML, Zoe Data Memory Rollout Flags, OpenClaw AG-UI Streaming, OpenClaw Chat Rollout, Zoe Test Plan, Zoe Data Visibility Matrix
...
Cohesion: 0.4
Nodes (5): Intent System Implementation, HassIL Classifier, Intent Executor, Lists Intent Handlers, Lists Intent Patterns

### Community 313 - "Community 313"
Cohesion: 0.5
Nodes (4): Home Assistant MCP Bridge Requirements, N8N MCP Bridge Requirements, Zoe Authentication Service README, Zoe Auth Requirements
...
Cohesion: 0.5
Nodes (3): Test P1-1: Validate behavioral pattern extraction, Test that all pattern types can be extracted, TestP11BehavioralMemoryImprovements
...
Cohesion: 0.5
Nodes (4): OpenClaw Calendar Orchestration Guide, Creating Skills, Intent System Development Rules, iOS Shortcuts Integration Guide for Zoe

### Community 328 - "Community 328"
Cohesion: 1.0
Nodes (4): Architecture Diagram: Memory & Hallucination Reduction, Executive Summary: Memory & Hallucination Reduction for Zoe, Quick-Start Implementation Guide: P0 Recommendations, Memory & Hallucination Reduction Analysis for Zoe

### Community 329 - "Community 329"
Cohesion: 0.5
Nodes (4): Zoe Music Docker Compose Module YAML, Zoe Music Intents YAML, Zoe Music Module README, Zoe Music Requirements

### Community 345 - "Community 345"
Cohesion: 1.0
Nodes (3): Calendar Router Consolidation, Lists Router Consolidation, Memories Router Consolidation

### Community 346 - "Community 346"
Cohesion: 0.67
Nodes (3): Zoe Orb Fix - Quick Summary, Zoe Widget Development Guide, Widget System Quick Start Guide

### Community 347 - "Community 347"
Cohesion: 0.67
Nodes (3): Orbit Checkin HTML, Orbit Host HTML, Orbit Profile HTML

## Knowledge Gaps
- **2906 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2901 more)
...
- **Why does `main()` connect `Community 1` to `Community 256`, `Community 132`, `Community 134`, `Community 270`, `Community 16`, `Community 17`, `Community 18`, `Community 148`, `Community 277`, `Community 280`, `Community 281`, `Community 157`, `Community 30`, `Community 160`, `Community 33`, `Community 161`, `Community 162`, `Community 164`, `Community 169`, `Community 41`, `Community 42`, `Community 298`, `Community 45`, `Community 173`, `Community 52`, `Community 309`, `Community 55`, `Community 184`, `Community 185`, `Community 59`, `Community 61`, `Community 192`, `Community 65`, `Community 322`, `Community 68`, `Community 73`, `Community 202`, `Community 203`, `Community 77`, `Community 79`, `Community 83`, `Community 213`, `Community 214`, `Community 87`, `Community 216`, `Community 217`, `Community 90`, `Community 91`, `Community 88`, `Community 215`, `Community 95`, `Community 224`, `Community 225`, `Community 99`, `Community 108`, `Community 111`, `Community 112`, `Community 239`, `Community 115`, `Community 125`, `Community 117`, `Community 118`, `Community 253`, `Community 254`?**
  _High betweenness centrality (0.179) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 73` to `Community 1`, `Community 2`, `Community 258`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 13`, `Community 141`, `Community 143`, `Community 17`, `Community 18`, `Community 148`, `Community 21`, `Community 282`, `Community 31`, `Community 168`, `Community 41`, `Community 169`, `Community 171`, `Community 298`, `Community 45`, `Community 47`, `Community 50`, `Community 178`, `Community 52`, `Community 54`, `Community 55`, `Community 189`, `Community 61`, `Community 196`, `Community 72`, `Community 202`, `Community 77`, `Community 78`, `Community 80`, `Community 84`, `Community 214`, `Community 90`, `Community 247`, `Community 222`, `Community 249`, `Community 102`, `Community 233`, `Community 108`, `Community 238`, `Community 240`, `Community 246`, `Community 119`, `Community 118`, `Community 121`, `Community 124`, `Community 126`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `_FakeAdapter` connect `Community 0` to `Community 96`, `Community 7`, `Community 201`, `Community 108`, `Community 46`?**
