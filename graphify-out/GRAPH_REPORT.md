...
## Summary
- 8272 nodes · 14760 edges · 564 communities (365 shown, 199 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2117 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `796705a8`
...
## Communities (564 total, 199 thin omitted)
...
Cohesion: 0.02
Nodes (95): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, check_chat_router_intelligence(), Validate chat router uses intelligent systems, _active_memory_files(), _assert_hindsight_policy() (+87 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (121): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, get_auth_manager(), Get the singleton auth manager instance., Get track metadata from cache., Get or create a YTMusic client for a user.                  Args:             us, Check if user has valid YouTube Music authentication., Normalize a YouTube Music item to standard format. (+113 more)
...
Cohesion: 0.05
Nodes (93): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Validate database structure, Enum, Run all validations.                  Returns:             True if all validatio, OutputState, OutputType (+85 more)
...
Cohesion: 0.03
Nodes (77): ABC, Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Get device info from database., Get current playback state for a zone (+69 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (71): _build_hermes_payload(), _build_panel_intent_card(), _build_research_package(), _capture_research_screenshot(), chat_inject_background(), chat_stream_generator(), _chatgpt_connect_flow(), _check_frustration() (+63 more)
...
Cohesion: 0.05
Nodes (62): get_memory_router_status(), Read-only status for Zoe's disabled-by-default memory router runtime., _trace(), test_default_chat_route_keeps_hindsight_and_graphiti_off_hot_path(), test_failure_and_fix_queries_route_to_reflective_memory(), test_fast_chat_layers_are_boring_hot_path_only(), test_reflective_route_is_timeout_bounded_candidate_only(), test_sidecar_layers_are_async_enrichment_not_required_for_chat() (+54 more)
...
Cohesion: 0.05
Nodes (42): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+34 more)
...
Cohesion: 0.06
Nodes (49): _broadcast_calendar_chat_prefill_ui(), _broadcast_shopping_chat_ui(), chatgpt_auth_status(), _env_int(), _extract_complete_sentences(), _get_faster_whisper_model(), get_livekit_token(), _has_espeak_ng() (+41 more)
...
Cohesion: 0.08
Nodes (34): BaseHTTPMiddleware, Manually trigger the morning brief for the calling user.     Useful for testing, trigger_morning_brief(), check(), What a trigger wants to send., TriggerResult, EveningWindDownTrigger, Evening wind-down trigger — journal prompt if user hasn't written in 3+ days. (+26 more)
...
Cohesion: 0.12
Nodes (20): Get a specific provider by type.                  Args:             provider_typ, _get(), Return Atomic semantic hits as normalized records., _build_metadata(), _memory_status_visible(), _memory_visible_to_user(), MemoryRef, _metadata_value() (+12 more)
...
Cohesion: 0.1
Nodes (30): get_contact(), get_reports(), get_session_by_code(), Look up an active session by its short join code., Recipient retrieves the contact details., add_item(), create_list(), delete_item() (+22 more)
...
Cohesion: 0.13
Nodes (21): _NoticeDb, test_record_frustration_signal_stores_contract_snapshot(), test_record_user_issue_stores_contract_snapshot(), test_run_evolution_notice_stores_contract_snapshots(), _WriterDb, _Db, Tests for panel_* MCP tool definitions and execution paths., _RecordingDb (+13 more)
...
Cohesion: 0.12
Nodes (17): quick_user_switch(), Quick user switching for touch panels          Args:         request: Quick swit, Background sync loop for HA integration, QuickAuthManager, QuickAuthResult, Quick Authentication for Touch Panels Optimized for fast user switching and offl, Quick user switching for touch panels                  Args:             current, Manually trigger sync with server (+9 more)

### Community 112 - "Community 112"
Cohesion: 0.1
Nodes (17): _board(), _expected_phases(), _protocol_violation_count(), Stop a running worker when its code-enforced phase budget is exhausted., True when a worker pushed HEAD then got interrupted before PR handoff., Create/record a PR after the worker pushed but lost the terminal handoff., Report aggregate state of a chain by idempotency-key prefix.          Returns {f, Pull a PR URL from the implement/closeout task summaries or comments. (+9 more)
...
Cohesion: 0.13
Nodes (18): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _append_audit(), _idempotency_key(), MemoryServiceError, Raised for operational failures., Store a fact. Returns None when silently dropped.          When ``scope`` is Non, Fast metadata-filter read for system prompt injection. (+10 more)
...
Cohesion: 0.2
Nodes (20): _event(), test_blocked_multica_record_blocks_even_when_approval_flag_is_present(), test_blocked_multica_record_without_approval_flag_fails_closed(), test_description_nulls_do_not_clear_raw_metadata_blocker(), test_explicit_multica_memory_approval_builds_success_trace_and_allows_write(), test_explicit_target_backends_override_multica_metadata(), test_graphiti_target_from_multica_metadata_still_requires_relationship(), test_multica_record_without_explicit_approval_stays_pending() (+12 more)

### Community 131 - "Community 131"
Cohesion: 0.18
Nodes (18): _env_float(), _package_info(), _package_snapshot(), Read-only Graphiti runtime compatibility probe for Zoe.  This probe checks wheth, _config_values(), _env_bool_snapshot(), _env_float_snapshot(), _matching_lines() (+10 more)
...
Cohesion: 0.15
Nodes (20): boot(), btnJoin, code, codeError, doCheckin(), enterWelcomeScreen(), joinCodeInput, joinNameInput (+12 more)
...
Cohesion: 0.12
Nodes (11): Health check endpoint.          Returns service health and Agent Zero availabili, health(), test_event_to_hindsight_item_keeps_evidence_and_scope_tags(), test_event_to_hindsight_item_serializes_structured_context_as_json(), event_to_hindsight_item(), Convert a validated Zoe memory event into a Hindsight retain item., Submit an evidence-backed event to Hindsight.          By default this refuses t, Submit a pre-admitted retain payload to Hindsight.          This method delibera (+3 more)
...
Cohesion: 0.17
Nodes (13): get_discover(), get_radio(), get_similar(), MetadataRecommendationEngine, Recommendation engine using YouTube Music search + affinity scoring.          Wo, Find similar tracks using YouTube Music's watch playlist.                  Falls, Generate personal radio.                  If seed_track_id provided, builds radi, Find new music user hasn't heard that matches their taste.                  Uses (+5 more)
...
Cohesion: 0.15
Nodes (15): _mock_repo_validators(), test_content_hash_is_stable(), test_sync_pipeline_auto_validators_on_implement_done(), Tests for harness-run repo validators., test_run_repo_validators_failure(), test_run_repo_validators_success(), test_validator_evidence_item_tags_phase(), content_hash() (+7 more)
...
Cohesion: 0.23
Nodes (11): _issue_sort_key(), Return (sequence_key, phase_number) when title encodes a phased track., True when every lower phase in the same sequence is ``done`` (or missing)., Pick up to ``count`` backlog issues respecting phased ordering.      ``all_issue, select_batch(), _has_matching_evolution_contract(), _metadata_sequence(), parse_phased_title() (+3 more)
...
Cohesion: 0.42
Nodes (12): Browser Cache Fix - Clear Old Broken State, Critical Files - Do Not Delete, Database Path Enforcement System, Critical Files Manifest, File Dependency Map, Enhanced Pre-Commit Hook, Automated Testing Before Cleanup Script, Pre-Deletion Validation Script (+4 more)
...
Cohesion: 0.38
Nodes (10): Zoe Module Generator Configuration, Auto-Generated Module Compose, Jetson Docker Compose Override, Supplemental Docker Compose Modules, Raspberry Pi Docker Compose Override, Zoe Docker Compose Base, Hardware Compatibility Guide, Zoe Project Structure & Governance Rules (+2 more)
...
Cohesion: 0.29
Nodes (5): get_mood_match(), Match current listening mood.                  On metadata engine, uses recent t, Get recently played track IDs., Match current listening mood using embedding average.                  Calculate, Get embedding for track, creating if needed.                  Returns numpy arra
...
Cohesion: 0.29
Nodes (7): Agent Zero Docker Compose Module, Agent Zero Implementation Checklist, Agent Zero Integration - COMPLETE, Agent Zero Live Integration Test Report, Agent Zero Quick Start Guide, Agent Zero Module for Zoe, Agent Zero Integration Test Results
...
Cohesion: 0.8
Nodes (5): Music Module Migration Guide, Module Intent Auto-Discovery System - Complete!, Zoe Module System - Implementation Complete, Music Module Dependency Audit, Music Module Extraction - Complete Execution Plan
...
Cohesion: 0.67
Nodes (4): List Items Table Schema, Lists Table Schema, Migration Script migrate_lists_items.py, Updated Routers in lists.py

### Community 351 - "Community 351"
Cohesion: 0.5
Nodes (4): Deprecation Middleware for Legacy API, API Versioning Strategy in main.py, API Versioning Test Cases, Version 2 Router Example

### Community 352 - "Community 352"
Cohesion: 0.5
Nodes (4): Add to Zoe Shortcut, Open Zoe Calendar Shortcut, Show Zoe Dashboard Shortcut, Talk to Zoe Shortcut

### Community 353 - "Community 353"
Cohesion: 0.5
Nodes (4): Creating Skills, File Tagging System for Unused Files, Quick Journal Widget Guide, Zoe People System - Quick Start

### Community 354 - "Community 354"
Cohesion: 0.5
Nodes (4): Agent Zero Research Skill, Agent Zero Comparison Skill, Agent Zero Planning Skill, Agent Zero Deep Research Skill
...
Cohesion: 0.67
Nodes (3): Non-blocking Session Loading, Created manifest.json for PWA, Protocol Handling Fix in Chat SSL
...
## Knowledge Gaps
- **2924 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2919 more)
...
- **Why does `main()` connect `Community 1` to `Community 128`, `Community 3`, `Community 132`, `Community 131`, `Community 4`, `Community 255`, `Community 264`, `Community 139`, `Community 13`, `Community 14`, `Community 143`, `Community 141`, `Community 21`, `Community 22`, `Community 281`, `Community 26`, `Community 157`, `Community 287`, `Community 288`, `Community 35`, `Community 36`, `Community 38`, `Community 166`, `Community 294`, `Community 43`, `Community 171`, `Community 48`, `Community 58`, `Community 315`, `Community 64`, `Community 65`, `Community 67`, `Community 195`, `Community 197`, `Community 196`, `Community 71`, `Community 72`, `Community 329`, `Community 328`, `Community 75`, `Community 204`, `Community 81`, `Community 86`, `Community 215`, `Community 88`, `Community 216`, `Community 91`, `Community 219`, `Community 94`, `Community 224`, `Community 225`, `Community 226`, `Community 99`, `Community 228`, `Community 227`, `Community 250`, `Community 236`, `Community 112`, `Community 244`, `Community 118`, `Community 122`, `Community 251`, `Community 127`?**
  _High betweenness centrality (0.202) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 72` to `Community 128`, `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 138`, `Community 10`, `Community 266`, `Community 13`, `Community 18`, `Community 149`, `Community 22`, `Community 152`, `Community 25`, `Community 27`, `Community 156`, `Community 158`, `Community 31`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 38`, `Community 41`, `Community 42`, `Community 175`, `Community 48`, `Community 51`, `Community 55`, `Community 56`, `Community 58`, `Community 315`, `Community 188`, `Community 62`, `Community 64`, `Community 74`, `Community 77`, `Community 79`, `Community 81`, `Community 210`, `Community 85`, `Community 216`, `Community 91`, `Community 94`, `Community 96`, `Community 226`, `Community 231`, `Community 107`, `Community 109`, `Community 112`, `Community 116`, `Community 245`, `Community 121`, `Community 122`, `Community 254`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `_FakeAdapter` connect `Community 0` to `Community 98`, `Community 41`, `Community 176`, `Community 16`, `Community 112`, `Community 19`?**
