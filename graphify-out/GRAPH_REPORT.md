...
## Summary
- 8127 nodes · 14364 edges · 563 communities (344 shown, 219 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2005 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d58ac5e3`
...
- `review_capability_trust_update_plan()` --calls--> `Decision Log`  [EXTRACTED]
  services/zoe-data/zoe_capability_trust_review.py → docs/implementation/decision_log.md
...
## Communities (563 total, 219 thin omitted)
...
Cohesion: 0.04
Nodes (107): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, Get track metadata from cache., Get or create a YTMusic client for a user.                  Args:             us, Check if user has valid YouTube Music authentication., Normalize a YouTube Music item to standard format., Get the stream URL for a track.                  Uses caching to avoid repeated, Get video stream URL for a track (for video playback).                  YouTube (+99 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (85): ABC, Get current playback state from an AirPlay device, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100)., Get current playback state for a zone, Seek to position in a zone, Set volume for a zone (+77 more)
...
Cohesion: 0.04
Nodes (96): Override to customise the prompt per-check., Local voice session WebSocket for voice.html.      Accepts text and binary (audi, websocket_voice(), _bash(), _build_memory_context(), _build_prompt(), _build_tools(), _build_voice_tools() (+88 more)
...
Cohesion: 0.04
Nodes (78): Send a chat message to Zoe, Send a chat message and validate response, _build_hermes_payload(), _build_panel_intent_card(), _build_research_package(), _capture_research_screenshot(), chat(), chat_inject_background() (+70 more)
...
Cohesion: 0.04
Nodes (55): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn(), ha_voice_wake() (+47 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (61): _broadcast_intent_nav(), _build_calendar_form_props(), _build_reminder_form_props(), _intent_action_form_payload(), _intent_card_data(), Build a panel_show_action_form payload for intents that show an in-place overlay, Broadcast UI actions to the touch panel when an intent is detected.      For act, Build show_card data payload from intent slots for Google Home-style card. (+53 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (50): All Documentation - Complete Index, Cursor Prompt Templates, Decision Log, Metrics Tracking, Implementation Progress, Memory & Hallucination Reduction - Implementation Directory, Convert to dictionary for API responses., _review_result() (+42 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (41): Generate comprehensive audit report, Test that API endpoints are accessible, IntelligentSystemTester, Test manual model adaptation, Run comprehensive test of the intelligent system, Test the intelligent model management system, Test the enhanced chat endpoint, Test the performance monitoring endpoints (+33 more)
...
Cohesion: 0.04
Nodes (57): a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_cancel(), board_review(), delegate_to_agent(), _EngineeringGuardRunRequest, _EngineeringTaskRequest (+49 more)
...
Cohesion: 0.09
Nodes (51): test_capability_trust_update_blocks_failed_proposal(), test_capability_trust_update_blocks_unretained_outcome(), test_failed_outcome_remains_pending_only_and_never_trusted_durable_memory(), test_graphiti_target_is_allowed_for_relational_outcome_candidate(), test_none_items_are_ignored_in_backend_and_approval_sequences(), test_outcome_admission_requires_proposal_memory_admission_gate(), test_result_serializes_candidate_request_and_decision(), test_retired_outcome_remains_blocked_until_retirement_memory_policy_exists() (+43 more)

### Community 22 - "Community 22"
Cohesion: 0.07
Nodes (48): get_memory_router_status(), Read-only status for Zoe's disabled-by-default memory router runtime., test_embedding_probe_accepts_cached_huggingface_model(), test_embedding_probe_accepts_existing_local_model_path(), test_embedding_probe_accepts_huggingface_hub_cache_override(), test_embedding_probe_accepts_local_tei_service(), test_embedding_probe_health_url_for_openai_compatible_base(), test_embedding_probe_rejects_cloud_embedding_provider() (+40 more)
...
Cohesion: 0.07
Nodes (46): _audit_no_pr_issue(), _chain_for_issue(), _code_audit_implement_hint(), _engineering_mode(), _escalation_model_hint(), _existing_pr_url(), _expected_phases(), _goal_mode_args() (+38 more)
...
Cohesion: 0.08
Nodes (44): _env_float(), test_extract_model_ids_accepts_openai_and_llama_shapes(), test_models_url_handles_v1_base(), test_runtime_probe_rejects_public_llm_base_url(), test_runtime_probe_reports_backend_offline(), test_runtime_probe_reports_disabled_without_backend_or_llm(), test_runtime_probe_reports_llm_unavailable(), test_runtime_probe_reports_missing_llm_model() (+36 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (47): fresh_collection(), _install_mempalace_stubs(), Comprehensive MemPalace integration tests.  Tests: user isolation, upsert behavi, Install mempalace module stubs so zoe_agent doesn't require the real package., Reset the in-memory Chroma collection before each test.      Also resets the Mem, Writing for 'jason' must not appear when loading facts for 'family-admin'., Deleting a CRM entity should archive all scoped MemPalace facts for it., Writing for 'family-admin' must not appear when loading facts for 'jason'. (+39 more)

### Community 31 - "Community 31"
Cohesion: 0.1
Nodes (45): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, AuthStatus, Provider authentication status., str, test_experience_memory_requires_evidence() (+37 more)
...
Cohesion: 0.07
Nodes (36): BaseHTTPMiddleware, evaluate(), check(), What a trigger wants to send., TriggerResult, EveningWindDownTrigger, Evening wind-down trigger — journal prompt if user hasn't written in 3+ days., EvolutionWeeklyDigestTrigger (+28 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (41): get_contact(), get_session_by_code(), Look up an active session by its short join code., Recipient retrieves the contact details., add_item(), create_list(), delete_item(), delete_list() (+33 more)
...
Cohesion: 0.08
Nodes (39): board_approve(), create_engineering_workflow_task(), evolution_proposal_action(), list_engineering_workflow_tasks(), multica_webhook(), _multica_webhook_dispatch_allowed(), Create a Hermes-assigned Multica issue and dispatch it via the executor seam., Return True when a webhook is allowed to start code-changing work. (+31 more)
...
Cohesion: 0.1
Nodes (40): build_engineering_guard_packet(), get_engineering_guard(), PR-keyed Greptile grep-loop guard state., run_engineering_guard_once(), acquire_lock(), _actionable_greptile_findings(), analyze_result(), _append_progress() (+32 more)
...
Cohesion: 0.15
Nodes (35): _event(), _approved_evolution_issue(), _issue(), Tests for safe production backlog admission., test_approved_blocked_ticket_halts_single_ticket_lane(), test_blocked_evolution_ticket_without_contract_does_not_halt_lane(), test_blocked_execute_ticket_without_approval_refs_does_not_halt_lane(), test_evolution_proposal_ticket_requires_matching_contract_marker() (+27 more)
...
Cohesion: 0.1
Nodes (26): BaseRecommendationEngine, get_discover(), get_mood_match(), get_radio(), get_recommendation_engine(), get_similar(), MetadataRecommendationEngine, MLRecommendationEngine (+18 more)
...
Cohesion: 0.12
Nodes (29): get_agent_board(), Return Multica engineering ticket state for AG-UI display.      Falls back grace, test_dispatch_skips_scout_for_code_audit_ticket_block(), test_create_issue_metadata_preserves_existing_ticket_fields(), test_update_ticket_progress_can_clear_dispatch_approval(), test_block_only_description_does_not_gain_leading_blank_lines(), test_progress_and_children_patch_metadata_only(), test_replacing_middle_block_preserves_suffix_newline() (+21 more)
...
Cohesion: 0.14
Nodes (27): Create a multi-step plan for a task.                  Args:             task: Ta, plan(), Planning endpoint - creates multi-step plans.          Uses Agent Zero to:, test_execute_admitted_hindsight_retain_plan_posts_exact_plan_payload(), test_execute_admitted_hindsight_retain_plan_refuses_when_disabled(), test_execute_admitted_hindsight_retain_plan_reports_sidecar_rejection(), test_execute_admitted_hindsight_retain_plan_returns_structured_sidecar_error(), test_capability_trust_review_applies_approved_existing_profile_in_memory() (+19 more)
...
Cohesion: 0.11
Nodes (26): Get user information (without sensitive data), consume_auth_code(), delete_pending_auth(), _future_iso(), get_pending_auth(), issue_auth_code(), Auth code issuance and consumption using oauth_states table., Issue a single-use auth code valid for 60 seconds. (+18 more)

### Community 86 - "Community 86"
Cohesion: 0.09
Nodes (25): Test P1-1: Validate behavioral pattern extraction, Test that pattern extraction is fast enough for nightly jobs, Test that all pattern types can be extracted, TestP11BehavioralMemoryImprovements, _extract_memory_candidates(), Back-compat shim: legacy dict shape over the unified extractor.      Kept so in-, test_extracts_preference_signal(), test_no_signal_returns_empty() (+17 more)
...
Cohesion: 0.11
Nodes (27): create_memory_proposal(), export_user_memories(), forget_user(), get_memory_opt_out(), link_preview(), list_memories(), list_review_queue(), _normalise_status() (+19 more)

### Community 90 - "Community 90"
Cohesion: 0.09
Nodes (22): check_router_expectations(), Check what routers expect vs what database has, migrate_self_entries(), Create self entries for users in the people table, _compute_compatibility(), Compute compatibility score and shared traits between two check-ins., Get all registered providers., test_graphiti_episode_payloads_include_evidence() (+14 more)
...
Cohesion: 0.09
Nodes (25): Register a Tier 2 slow-loop trigger., register_trigger(), load_device_tokens(), Load all active device tokens from DB into the in-memory cache (call at startup), _hermes_review_proposal(), Ask Hermes to review an evolution proposal before implementation is queued., Use Hermes for foreground voice escalation; OpenClaw is manual-only., _run_hermes_voice_escalation() (+17 more)
...
Cohesion: 0.09
Nodes (23): accept_pending_suggestion(), dismiss_pending_suggestion(), list_pending_suggestions(), list_schedules(), Proactive Engine REST router.  Endpoints:   POST   /api/proactive/schedule, Manually trigger the morning brief for the calling user.     Useful for testing, List unresolved save offers for the current chat session., Execute a pending save offer (direct API — no intent re-parse). (+15 more)
...
Cohesion: 0.09
Nodes (23): test_build_scope_split_packet_preserves_worker_reason(), test_explicit_scope_split_is_allowed_from_scout(), test_repeated_scope_split_is_still_implement_only(), block_fingerprint(), build_scope_split_packet(), evidence_kinds(), implement_validator_hash(), Evidence-gated engineering pipeline state.  This is intentionally independent of (+15 more)
...
Cohesion: 0.1
Nodes (25): _now_iso(), parse_json_fields(), get_connection_icebreaker(), Shorter icebreaker for the QR scan connect page., create_checkin(), create_connection(), create_session(), _gen_join_code() (+17 more)
...
Cohesion: 0.08
Nodes (25): _broadcast_calendar_ui(), _broadcast_lets_talk_ui(), _broadcast_reminder_ui(), _contains_decision_keyword(), _get_or_create_voice_session(), _handle_introduce_intent(), _load_voice_history(), _parse_voice_form_field() (+17 more)
...
Cohesion: 0.12
Nodes (13): ProviderType, Supported music provider types., get_provider_registry(), ProviderRegistry, Music Provider Registry =======================  Singleton registry that manages, Get the appropriate provider for a track.                  Uses track ID prefix, Search across all connected providers.                  Args:             query:, Get authentication status for all providers.                  Args: (+5 more)
...
Cohesion: 0.14
Nodes (12): generate(), Orbit icebreaker engine — rule cascade, strongest signal wins., Generate the best icebreaker line for a match pair., get_enabled_modules(), Zoe Module CLI, ComposeGenerator, Write the generated compose file., Generate docker-compose.generated-modules.yml from enabled modules. (+4 more)
...
Cohesion: 0.15
Nodes (14): _board(), Pull a PR URL from the implement/closeout task summaries or comments., _oidc_client_id_configured(), _probe(), run(), _uploads_configured(), test_run_hermes_background_task_uses_worker_cli(), test_zoe_repo_root_is_portable() (+6 more)
...
Cohesion: 0.13
Nodes (10): test_session(), Test session statistics, Test cases for session API endpoints, Test session creation endpoint, Test session retrieval endpoint, Test session extension endpoint, Test session invalidation endpoint, Test get user sessions endpoint (+2 more)
...
Cohesion: 0.2
Nodes (12): ensure_signing_key(), generate_rsa_key(), get_active_key(), RSA signing key management for the OIDC provider., Generate a new RSA-2048 key pair and return as dict., Return the active signing key row from DB, or None., Return the active key, generating and storing one if needed., _jwks_for() (+4 more)
...
Cohesion: 0.15
Nodes (12): get_auth_manager(), Get the singleton auth manager instance., get_media_controller(), Get the singleton media controller instance., get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us, Get the singleton YouTube Music provider instance., Disconnect user from Apple Music. (+4 more)
...
Cohesion: 0.15
Nodes (9): Feature Improvement Testing Test each feature individually, measure impact, vali, Ensure we don't add qualifiers to already-qualified responses, Test P0-4: Validate grounding detection, Test that all features can be imported without conflicts, Test P0-2: Validate confidence expression quality, Test that confidence qualifiers are appropriate, test_integration_no_conflicts(), TestP02ConfidenceImprovements (+1 more)
...
Cohesion: 0.18
Nodes (11): hash_secret(), OIDC client registration and secret verification., Exact match only — no wildcards., Insert or update a client. Safe to call on every startup., upsert_client(), validate_redirect_uri(), verify_secret(), bootstrap_oidc() (+3 more)
...
Cohesion: 0.24
Nodes (12): Browser Cache Fix, Cleanup Safety Rules, Critical Files - Do Not Delete, Database Path Enforcement System, Docker Networking Rules, Enhanced Enforcement System, Issue Analysis - October 23, 2025, LiteLLM Gateway - Development Rules & Guidelines (+4 more)
...
Cohesion: 0.25
Nodes (9): MCP-Only Architecture for Zoe Modules, Music Module Migration Guide, Module Intent Auto-Discovery System - Complete!, Zoe Module System - Implementation Complete, Music Module Dependency Audit, Music Module Extraction - Complete Execution Plan, Music Routing Options - Detailed Breakdown, Self-Contained Modules: Complete Guide (+1 more)
...
Cohesion: 0.32
Nodes (8): Cloudflared Service, Home Assistant MCP Bridge Service, Home Assistant Service, Keeper.sh Calendar Sync Service, LiveKit Service, Zoe Auth Service, Zoe Database Service, Zoe UI Service

### Community 282 - "Community 282"
Cohesion: 0.25
Nodes (8): Core Capabilities, MCP Tools, OpenClaw Skills, UI Pages, MCP Client, ModuleWidgetLoader, WidgetRegistry, Zoe Music Module
...
Cohesion: 0.4
Nodes (4): Apple Music Provider ====================  Integration with Apple Music using th, display_name(), supports_streaming(), Spotify Music Provider ======================  Integration with Spotify using sp

### Community 292 - "Community 292"
Cohesion: 0.33
Nodes (5): Like/save a track. Override if provider supports it., Save a track to user's library., Remove track from user's library., Like a track on YouTube Music., Remove like from a track.
...
Cohesion: 0.33
Nodes (6): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router)

### Community 309 - "Community 309"
Cohesion: 0.33
Nodes (6): Data Migration for Misplaced Items, Database Query in GET /api/lists/{list_type}, Default Lists in Database, GET /api/lists/{list_type} Endpoint, Updated Response Format in GET /api/lists/{list_type}, User Isolation Audit & Fix Report
...
Cohesion: 0.4
Nodes (5): Orbit Checkin Page, Orbit Connect Page, Orbit Discover Page, Orbit Host Page, Orbit Profile Page
...
Cohesion: 0.5
Nodes (4): Touch Dashboard Upgrade: Drag & Drop Fix, Touch Dashboard Upgrade: Floating Edit Mode FAB, Touch Dashboard Upgrade: Navigation Bar, Touch Dashboard Upgrade: Widget Persistence Fix
...
Cohesion: 0.67
Nodes (3): API Versioning Strategy, Migration Script migrate_lists_items.py, Lists Database Schema Update

### Community 348 - "Community 348"
Cohesion: 0.67
Nodes (3): Chat SSL Fix: Non-blocking Session Loading, Chat SSL Fix: manifest.json Creation, Chat SSL Fix: Protocol Handling Change

### Community 349 - "Community 349"
Cohesion: 0.67
Nodes (3): AG-UI Chat Protocol for Zoe, Chat Page Verification: Backend chat.py, Chat Page Verification: Frontend chat.html

### Community 350 - "Community 350"
Cohesion: 0.67
Nodes (3): Chat Model Fix: GPU Allocation Error, Chat Performance Fix: num_predict Reduction, Chat Performance Fix: Warmup Script Fix

### Community 351 - "Community 351"
Cohesion: 0.67
Nodes (3): GPU Model Setup: gemma3n-e2b-gpu:latest, LiteLLM Gateway Integration, RouteLLM and LiteLLM Status

### Community 352 - "Community 352"
Cohesion: 0.67
Nodes (3): Standardized Error Handling Guide, Lists & Calendar Page Errors Fix: Reminders API, Lists & Calendar Page Errors Fix: WebSocket Connection

## Knowledge Gaps
- **2920 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2915 more)
...
- **Why does `main()` connect `Community 1` to `Community 128`, `Community 130`, `Community 4`, `Community 266`, `Community 11`, `Community 139`, `Community 141`, `Community 16`, `Community 22`, `Community 279`, `Community 24`, `Community 153`, `Community 26`, `Community 280`, `Community 29`, `Community 157`, `Community 32`, `Community 160`, `Community 161`, `Community 38`, `Community 39`, `Community 169`, `Community 42`, `Community 43`, `Community 173`, `Community 174`, `Community 47`, `Community 184`, `Community 185`, `Community 186`, `Community 59`, `Community 188`, `Community 316`, `Community 191`, `Community 70`, `Community 73`, `Community 202`, `Community 203`, `Community 204`, `Community 75`, `Community 78`, `Community 81`, `Community 211`, `Community 83`, `Community 213`, `Community 214`, `Community 87`, `Community 215`, `Community 90`, `Community 91`, `Community 228`, `Community 229`, `Community 108`, `Community 238`, `Community 239`, `Community 114`, `Community 116`, `Community 252`, `Community 120`, `Community 123`, `Community 124`, `Community 253`?**
  _High betweenness centrality (0.189) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 90` to `Community 128`, `Community 1`, `Community 3`, `Community 5`, `Community 134`, `Community 263`, `Community 136`, `Community 7`, `Community 11`, `Community 140`, `Community 15`, `Community 16`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 153`, `Community 25`, `Community 26`, `Community 283`, `Community 27`, `Community 33`, `Community 36`, `Community 38`, `Community 168`, `Community 169`, `Community 43`, `Community 44`, `Community 48`, `Community 50`, `Community 178`, `Community 56`, `Community 57`, `Community 59`, `Community 68`, `Community 199`, `Community 72`, `Community 74`, `Community 75`, `Community 204`, `Community 77`, `Community 80`, `Community 82`, `Community 219`, `Community 102`, `Community 233`, `Community 106`, `Community 107`, `Community 108`, `Community 237`, `Community 242`, `Community 119`, `Community 120`, `Community 250`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `run()` connect `Community 174` to `Community 0`, `Community 1`, `Community 266`, `Community 43`, `Community 139`, `Community 44`, `Community 91`, `Community 303`, `Community 241`, `Community 121`, `Community 250`, `Community 27`, `Community 95`?**
...
- **Are the 87 inferred relationships involving `list()` (e.g. with `get_matches()` and `_compute_compatibility()`) actually correct?**
