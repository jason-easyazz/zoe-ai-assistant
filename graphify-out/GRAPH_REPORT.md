...
## Summary
- 7867 nodes · 13626 edges · 584 communities (357 shown, 227 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1773 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `94c99f7f`
...
Cohesion: 0.03
Nodes (91): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+83 more)
...
Cohesion: 0.05
Nodes (47): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker. (+39 more)
...
Cohesion: 0.05
Nodes (32): check_readme_links(), find_doc_references(), find_hardcoded_paths(), generate_report(), Check if README references are current, Generate audit report, Find all references to documentation files in code, Find hardcoded paths to documentation (+24 more)
...
Cohesion: 0.09
Nodes (36): _audit_no_pr_issue(), _chain_for_issue(), _code_audit_implement_hint(), _engineering_mode(), _escalation_model_hint(), _existing_pr_url(), _goal_mode_args(), _greptile_mcp_bin() (+28 more)
...
Cohesion: 0.12
Nodes (34): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Zoe Evolution Proposal Contract, Zoe Evolution Harness Implementation Status, Enum, str, HindsightEvalQuery (+26 more)
...
Cohesion: 0.09
Nodes (23): DatabaseValidator, Find all .db files in data directory, Check if file is in a backup/archive location, Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage. (+15 more)
...
Cohesion: 0.09
Nodes (19): Start background thread for cache cleanup, EnhancedSessionManager, Enhanced session manager with multi-factor support, Authenticate user and create session                  Args:             request:, Invalidate all sessions for user except optionally one, Verify credentials based on auth method, Verify API key authentication, Determine appropriate session type based on request (+11 more)
...
Cohesion: 0.12
Nodes (26): BaseHTTPMiddleware, ProactiveTrigger, check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe, TriggerResult, EveningWindDownTrigger, Evening wind-down trigger — journal prompt if user hasn't written in 3+ days. (+18 more)
...
Cohesion: 0.13
Nodes (18): add_chat_turn(), enhance_memory_search_with_temporal(), Get context from current and recent episodes, Integrates temporal memory with Zoe's chat system, Get active episode for user, Store conversation turn in episode, Start a new conversation episode, Enhance existing memory search with temporal context (+10 more)
...
Cohesion: 0.11
Nodes (18): Minimal compatibility wrapper so person_extractor works with raw asyncpg., get_db(), db_compat.py — asyncpg compatibility shim providing an aiosqlite-style cursor AP, Thin wrapper around asyncpg Connection providing aiosqlite-compatible execute AP, _adapt_params(), AsyncpgCompat, close_pool(), get_pool() (+10 more)
...
Cohesion: 0.16
Nodes (13): _NoticeDb, test_record_frustration_signal_stores_contract_snapshot(), test_record_user_issue_stores_contract_snapshot(), test_run_evolution_notice_stores_contract_snapshots(), _WriterDb, _Db, test_panel_ssh_exec_happy_path_uses_logger_without_logging_command(), test_panel_ssh_exec_subprocess_error_returns_tool_error() (+5 more)
...
Cohesion: 0.13
Nodes (17): Register a Tier 2 slow-loop trigger., register_trigger(), Start the nightly memory digest loop (if not disabled)., start_memory_digest_background(), hermes_api_key(), lifespan(), _memory_capture_retry_task(), _probe_runtimes() (+9 more)
...
Cohesion: 0.19
Nodes (9): Episode, Get or generate episode summary, Extends Light RAG with temporal capabilities, Get episode history for user, Clean up old episodes to prevent database bloat, Initialize temporal memory database schema, Test the temporal memory system, TemporalMemoryExtension (+1 more)
...
Cohesion: 0.67
Nodes (3): close_chat_episode(), Close current episode, Close an episode and optionally generate summary
...
## Knowledge Gaps
- **2890 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2885 more)
...
- **Why does `main()` connect `Community 1` to `Community 2`, `Community 7`, `Community 264`, `Community 138`, `Community 267`, `Community 16`, `Community 18`, `Community 19`, `Community 276`, `Community 147`, `Community 150`, `Community 279`, `Community 23`, `Community 153`, `Community 22`, `Community 155`, `Community 31`, `Community 34`, `Community 35`, `Community 293`, `Community 295`, `Community 181`, `Community 182`, `Community 183`, `Community 53`, `Community 57`, `Community 60`, `Community 63`, `Community 192`, `Community 321`, `Community 66`, `Community 67`, `Community 70`, `Community 72`, `Community 74`, `Community 75`, `Community 204`, `Community 76`, `Community 206`, `Community 79`, `Community 205`, `Community 80`, `Community 330`, `Community 207`, `Community 86`, `Community 343`, `Community 88`, `Community 217`, `Community 218`, `Community 247`, `Community 91`, `Community 219`, `Community 231`, `Community 106`, `Community 108`, `Community 239`, `Community 112`, `Community 243`, `Community 116`, `Community 118`, `Community 119`, `Community 120`, `Community 122`, `Community 125`, `Community 254`, `Community 127`?**
  _High betweenness centrality (0.182) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 88` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 263`, `Community 265`, `Community 138`, `Community 11`, `Community 15`, `Community 16`, `Community 145`, `Community 19`, `Community 22`, `Community 283`, `Community 28`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 163`, `Community 167`, `Community 40`, `Community 39`, `Community 43`, `Community 48`, `Community 50`, `Community 51`, `Community 180`, `Community 53`, `Community 57`, `Community 192`, `Community 321`, `Community 69`, `Community 72`, `Community 75`, `Community 204`, `Community 203`, `Community 207`, `Community 209`, `Community 223`, `Community 97`, `Community 98`, `Community 101`, `Community 230`, `Community 237`, `Community 111`, `Community 113`, `Community 241`, `Community 244`, `Community 117`, `Community 118`, `Community 246`, `Community 120`, `Community 127`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 7` to `Community 1`, `Community 2`, `Community 99`, `Community 4`, `Community 9`, `Community 242`, `Community 244`, `Community 181`, `Community 86`, `Community 62`, `Community 191`?**
