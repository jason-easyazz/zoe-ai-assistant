...
## Communities (557 total, 227 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (57): _FakeAdapter, Tests for the Hermes Kanban executor adapter (CLI mocked)., A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., KanbanAdapter with the CLI replaced by a scripted recorder., _row(), test_audit_no_pr_phases_do_not_preload_broad_skills(), test_dispatch_blocks_existing_pr_revision_when_precheckout_fails(), test_dispatch_blocks_on_first_worker_failure() (+49 more)
...
Cohesion: 0.04
Nodes (96): Override to customise the prompt per-check., Resolve a browser session_id to a user_id via zoe-auth HTTP.      Calls the same, Local voice session WebSocket for voice.html.      Accepts text and binary (audi, _resolve_ws_user(), websocket_voice(), _bash(), _build_memory_context(), _build_prompt() (+88 more)
...
Cohesion: 0.03
Nodes (77): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn(), ha_voice_wake() (+69 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (66): _build_hermes_payload(), _build_panel_intent_card(), _build_reminder_form_props(), chat_inject_background(), chat_stream_generator(), _chatgpt_connect_flow(), _check_frustration(), _create_pending_approval() (+58 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (64): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Validate database structure, Enum, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents. (+56 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (72): a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_cancel(), board_review(), build_engineering_guard_packet(), delegate_to_agent(), _EngineeringGuardRunRequest (+64 more)
...
Cohesion: 0.07
Nodes (61): add_activity(), add_bucket_item(), add_gift_idea(), add_important_date(), add_relationship(), _archive_person_mempalace(), create_people_field(), create_person() (+53 more)

### Community 15 - "Community 15"
Cohesion: 0.05
Nodes (54): BaseHTTPMiddleware, evaluate(), ProactiveTrigger, load_device_tokens(), Load all active device tokens from DB into the in-memory cache (call at startup), Manually trigger the morning brief for the calling user.     Useful for testing, trigger_morning_brief(), check() (+46 more)
...
Cohesion: 0.06
Nodes (27): Execute comprehensive test suite, Test RouteLLM classification, Test Enhanced MemAgent, Test RAG enhancements, Test full chat API endpoint with authentication, Get JWT token from zoe-auth service for authenticated requests, SystemTester, test_conversation() (+19 more)
...
Cohesion: 0.07
Nodes (35): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, get_media_controller(), Get the singleton media controller instance., youtube(), get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us, Get or create a YTMusic client for a user.                  Args:             us (+27 more)
...
Cohesion: 0.11
Nodes (32): _budget_phase(), implement_code_audit_post_patch_drift_reason_from_log(), implement_edit_safety_reason_from_log(), implement_pre_edit_drift_reason_from_log(), _is_code_audit_body(), _is_engineering_blocker_followup_body(), _is_expected_worker(), _latest_log_session() (+24 more)
...
Cohesion: 0.15
Nodes (31): acquire_lock(), _actionable_greptile_findings(), _append_progress(), assess_merge_readiness(), _ci_status_from_rollup(), _finding_hash(), _gh_mergeable_state(), _gh_unresolved_review_thread_count() (+23 more)
...
Cohesion: 0.08
Nodes (27): _board(), _protocol_violation_count(), Block a task after repeated Hermes protocol violations (silent worker exit)., _oidc_client_id_configured(), _probe(), run(), _uploads_configured(), _hermes_review_proposal() (+19 more)
...
Cohesion: 0.11
Nodes (27): _build_calendar_form_props(), _intent_action_form_payload(), Build a panel_show_action_form payload for intents that show an in-place overlay, _build_command(), _execute_calculate(), _execute_daily_briefing(), _execute_greeting(), execute_intent() (+19 more)
...
Cohesion: 0.1
Nodes (23): hash_secret(), OIDC client registration and secret verification., Exact match only — no wildcards., Insert or update a client. Safe to call on every startup., upsert_client(), validate_redirect_uri(), verify_secret(), ensure_signing_key() (+15 more)
...
Cohesion: 0.13
Nodes (22): get_openclaw_info(), post_openclaw_upgrade(), OpenClaw brain info: skills, cron, gateway, versions., Background: daily npm check, notify users, optional auto-upgrade., run_scheduled_openclaw_version_check(), clear_satisfied_update_notifications(), fetch_gateway_status(), fetch_npm_latest_version() (+14 more)
...
Cohesion: 0.18
Nodes (18): RuntimeError, _greptile_confidence_from_github_comments(), Parse Greptile confidence from PR issue comments (summary posts)., get_pr_status(), GreptileAuthError, list_pr_comments(), _load_api_key(), _mcp_call() (+10 more)

### Community 148 - "Community 148"
Cohesion: 0.14
Nodes (17): HA full-setup shorthand intent and OpenClaw message expansion., test_detect_ha_full_setup(), test_execute_ha_full_setup_returns_none(), test_openclaw_user_message_expands_with_intent(), test_openclaw_user_message_expands_without_intent(), Open-domain creative intent routing., test_joke_requests_route_to_open_domain_agent(), detect_intent() (+9 more)
...
Cohesion: 0.12
Nodes (17): clear_all_device_caches(), clear_device_cache(), list_touch_panel_devices(), Touch Panel API Endpoints Optimized endpoints for touch panel quick authenticati, Validate touch panel session (with offline support)          Args:         reque, Touch panel authentication request, Clear cache for touch panel device          Args:         device_id: Touch panel, Session validation request (+9 more)
...
Cohesion: 0.16
Nodes (9): FakeCursor, Buffered cursor wrapping a list of asyncpg Records., _Cursor, Return dual-mode result: awaitable or async context manager., aiosqlite-compatible shorthand: execute and return all rows immediately., Buffered cursor providing aiosqlite-compatible fetchall/fetchone/iteration., _AudioStream, Await the next AudioFrame from the underlying aiortc track. (+1 more)
...
Cohesion: 0.13
Nodes (14): IntEnum, _ConnState, _DataPacket, _Frame, _FrameEvent, make_room(), livekit_aiortc.py — LiveKit room participant using pure-Python aiortc.  Replaces, Create a new LiveKit room using the aiortc backend. (+6 more)
...
Cohesion: 0.21
Nodes (13): _config_values(), _env_bool_snapshot(), GraphitiSidecarProbeResult, _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers(), _scan_processes(), _scan_runtime() (+5 more)
...
Cohesion: 0.16
Nodes (12): get_db(), db_compat.py — asyncpg compatibility shim providing an aiosqlite-style cursor AP, _adapt_params(), close_pool(), get_pool(), lastrowid(), db_pool.py — PostgreSQL async connection pool for zoe-data.  Migration strategy:, Async generator yielding AsyncpgCompat for a pooled connection.      Works with: (+4 more)
...
Cohesion: 0.25
Nodes (13): _call_with_tool(), _extract_calendar(), _extract_journal(), _extract_list_add(), _extract_note(), _extract_people(), _extract_reminder(), _extract_transaction() (+5 more)

### Community 204 - "Community 204"
Cohesion: 0.15
Nodes (13): get_device_config(), QuickSwitchRequest, Logout from touch panel session          Args:         session_id: Session ID to, Manually trigger cache sync for touch panel          Args:         device_id: To, Quick user switch request, Get touch panel configuration          Args:         device_id: Touch panel devi, sync_device_cache(), touch_panel_logout() (+5 more)
...
Cohesion: 0.41
Nodes (12): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), Zoe Architecture Review, Code Execution Testing Results (+4 more)
...
Cohesion: 0.27
Nodes (10): Changelog, Database Protection Rules, Zoe Project Structure & Governance Rules, Zoe AI Assistant README, Zoe Modular Architecture README, MCP Client, ModuleWidgetLoader, WidgetRegistry (+2 more)
...
Cohesion: 0.22
Nodes (9): Cloudflare Tunnel Service, Home Assistant MCP Bridge Service, Home Assistant Service, Keeper.sh Calendar Sync Service, LiveKit Service, Zoe Auth Service, Zoe Database Service, Zoe UI Service (+1 more)

### Community 261 - "Community 261"
Cohesion: 0.25
Nodes (9): Agent Zero Docker Compose Module, Agent Zero Implementation Checklist, Agent Zero Integration Complete, Agent Zero Intent Patterns, Agent Zero Live Integration Test Report, Agent Zero Quick Start Guide, Agent Zero Module README, Agent Zero Requirements (+1 more)
...
Cohesion: 0.43
Nodes (7): Data Migration for Misplaced Items, Database Query in GET /api/lists/{list_type}, Default Lists in Database, GET /api/lists/{list_type} Endpoint, lists.py Router, Updated Response Format for Lists API, Zoe Database (zoe.db)
...
Cohesion: 0.87
Nodes (6): Architecture Diagram, P0 Recommendations, Behavioral Memory Extractor, Context Validator, Response Formatter, Memory & Hallucination Reduction Analysis
...
Cohesion: 0.5
Nodes (4): detect_and_extract_intent(), Async wrapper around detect_intent that populates structured slots for create, extract_slots_for_intent(), Extract structured slots for a create intent via the local LLM.      Returns a d
...
Cohesion: 0.67
Nodes (3): get_cached_users(), Get cached users for touch panel (offline display)          Args:         device, Get list of cached users for offline display
...
- **Why does `main()` connect `Community 1` to `Community 2`, `Community 7`, `Community 136`, `Community 139`, `Community 268`, `Community 141`, `Community 270`, `Community 271`, `Community 15`, `Community 146`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 150`, `Community 27`, `Community 28`, `Community 30`, `Community 158`, `Community 162`, `Community 163`, `Community 165`, `Community 294`, `Community 45`, `Community 46`, `Community 48`, `Community 305`, `Community 55`, `Community 184`, `Community 185`, `Community 186`, `Community 192`, `Community 65`, `Community 67`, `Community 196`, `Community 68`, `Community 70`, `Community 71`, `Community 199`, `Community 74`, `Community 205`, `Community 78`, `Community 206`, `Community 82`, `Community 86`, `Community 216`, `Community 217`, `Community 90`, `Community 88`, `Community 89`, `Community 223`, `Community 101`, `Community 122`, `Community 236`, `Community 239`, `Community 113`, `Community 120`, `Community 121`, `Community 250`, `Community 126`?**
  _High betweenness centrality (0.210) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 89` to `Community 1`, `Community 3`, `Community 4`, `Community 134`, `Community 7`, `Community 6`, `Community 137`, `Community 8`, `Community 11`, `Community 139`, `Community 141`, `Community 146`, `Community 147`, `Community 19`, `Community 21`, `Community 22`, `Community 24`, `Community 26`, `Community 27`, `Community 30`, `Community 294`, `Community 167`, `Community 42`, `Community 171`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 53`, `Community 54`, `Community 55`, `Community 188`, `Community 61`, `Community 63`, `Community 195`, `Community 196`, `Community 199`, `Community 73`, `Community 75`, `Community 206`, `Community 79`, `Community 210`, `Community 90`, `Community 222`, `Community 230`, `Community 237`, `Community 240`, `Community 114`, `Community 243`, `Community 122`, `Community 123`, `Community 252`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `get_memory_service()` connect `Community 25` to `Community 191`, `Community 129`, `Community 3`, `Community 35`, `Community 99`, `Community 134`, `Community 1`, `Community 137`, `Community 107`, `Community 14`, `Community 15`, `Community 16`, `Community 114`, `Community 178`, `Community 85`, `Community 53`, `Community 285`, `Community 255`?**
