...
## Summary
- 7684 nodes · 13365 edges · 504 communities (348 shown, 156 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1726 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dc2f582e`
...
## Communities (504 total, 156 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (73): _should_supersede_voice_weather_action(), _FakeAdapter, Tests for the Hermes Kanban executor adapter (CLI mocked)., A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., KanbanAdapter with the CLI replaced by a scripted recorder., _row(), test_dispatch_blocks_existing_pr_revision_when_precheckout_fails(), test_dispatch_blocks_on_first_worker_failure() (+65 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (81): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail(), _is_allowed_line() (+73 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (93): Override to customise the prompt per-check., Local voice session WebSocket for voice.html.      Accepts text and binary (audi, websocket_voice(), _bash(), _build_memory_context(), _build_prompt(), _build_tools(), _build_voice_tools() (+85 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (77): Send a chat message to Zoe, Send a chat message and validate response, _broadcast_intent_nav(), _build_hermes_payload(), _build_panel_intent_card(), _build_research_package(), _capture_research_screenshot(), chat() (+69 more)
...
Cohesion: 0.04
Nodes (61): a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_cancel(), board_review(), build_engineering_guard_packet(), delegate_to_agent(), _EngineeringGuardRunRequest (+53 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (55): FileSystemEventHandler, get_peer_agent_card(), Return a live A2A v1.0 proxy card for a peer agent with dynamic skills[]., Admin-only: force-flush the skill discovery cache for a peer agent., reload_peer_skills(), test_capabilities_snapshot_is_stable(), test_generated_context_mentions_hermes_engineering_loop(), test_graphify_rebuild_is_opt_in_by_default() (+47 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (51): MULClient, list_projects(), evolution_proposal_action(), Act on an evolution proposal: approve|reject|defer.      On approve: creates a M, close_stale_autopilot_wrappers(), _fire_autopilot_job(), get_autopilot_triggers(), get_multica_autopilots() (+43 more)
...
Cohesion: 0.05
Nodes (58): AuthResponse, get_current_user(), get_passcode_status(), guest_login(), InitialPasswordSetupRequest, login(), login_passcode(), LoginRequest (+50 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (44): Context Optimization Integration, Enhanced MEM Agent Integration, Expert Orchestrator Integration, GPU Model gemma3n-e2b-gpu:latest, RAG System Integration, Temporal Memory Integration, Vector Search Integration, add_chat_turn() (+36 more)
...
Cohesion: 0.05
Nodes (49): Seek to position in current track., Set playback volume (0-100)., Send message to device via WebSocket., Broadcast to all user's devices., Update playback state in database., Mark a device as disconnected, Pause playback in a zone, Resume playback in a zone (+41 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (40): test_disabled_probe_is_acceptable_even_when_tools_are_missing(), test_disabled_runtime_does_not_surface_agent_files(), test_empty_env_does_not_fall_through_to_process_environment(), test_enabled_probe_reports_missing_node_before_pi(), test_enabled_runtime_detects_agent_files(), test_execution_can_be_configured_with_explicit_local_model_flag(), test_malformed_boolean_env_reports_misconfigured(), test_probe_uses_current_process_path_when_env_omits_path() (+32 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (37): DatabaseValidator, Find all .db files in data directory, Check if file is in a backup/archive location, Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage. (+29 more)
...
Cohesion: 0.06
Nodes (33): AirPlayDevice, AirPlayService, AirPlay Integration Service Discovers and controls AirPlay devices for music pla, Start discovering AirPlay devices, Connect to an AirPlay device, Play media on an AirPlay device                  Args:             device_id: Ta, Represents a discovered AirPlay device, Send a control command to an AirPlay device                  Args:             d (+25 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (42): _broadcast_calendar_chat_prefill_ui(), _broadcast_shopping_chat_ui(), chatgpt_auth_status(), _extract_complete_sentences(), _get_kokoro_instance(), get_livekit_token(), _has_espeak_ng(), _parse_voice_escalation_delta() (+34 more)
...
Cohesion: 0.07
Nodes (25): escalate_session(), Refresh current session expiration          Args:         current_session: Curre, Escalate passcode session to full session with password verification          Ar, refresh_session(), EnhancedSessionManager, Enhanced session manager with multi-factor support, Authenticate user and create session                  Args:             request:, Refresh session expiration (+17 more)

### Community 36 - "Community 36"
Cohesion: 0.07
Nodes (33): Get or create a YTMusic client for a user.                  Args:             us, get_client(), Make a request to the Home Assistant API., AppleMusicProvider, Get user's Music User Token from database., Make authenticated API request., Convert Apple Music album data to Album., Convert Apple Music artist data to Artist. (+25 more)
...
Cohesion: 0.07
Nodes (39): add_item(), create_list(), delete_item(), delete_list(), get_list(), get_list_types(), list_items(), list_lists() (+31 more)

### Community 39 - "Community 39"
Cohesion: 0.11
Nodes (34): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, str, HindsightEvalQuery, EvolutionSignal, ProposalRisk (+26 more)
...
Cohesion: 0.08
Nodes (38): create_event(), delete_event(), _enforce_calendar_read_access(), get_event(), list_events(), list_today_events(), FastAPI router for calendar events. Mounted at prefix="/api/calendar" with tag ", Get a single event by ID. (+30 more)
...
Cohesion: 0.07
Nodes (24): Play previous track (from history)., Music Zone Manager Handles multi-zone playback with device routing and state syn, Create a new music zone, Current playback state for a zone, Delete a zone (only owner can delete), Get all zones accessible by a user, Add a device to a zone, Remove a device from a zone (+16 more)
...
Cohesion: 0.07
Nodes (29): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, get_media_controller(), Get the singleton media controller instance., youtube(), Search for k most similar tracks.                  Args:             query: 256-, get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us (+21 more)
...
Cohesion: 0.11
Nodes (33): get_agent_board(), Return Multica engineering ticket state for AG-UI display.      Falls back grace, test_dispatch_skips_scout_for_code_audit_ticket_block(), test_create_issue_metadata_preserves_existing_ticket_fields(), test_update_ticket_progress_can_clear_dispatch_approval(), test_block_only_description_does_not_gain_leading_blank_lines(), test_progress_and_children_patch_metadata_only(), test_replacing_middle_block_preserves_suffix_newline() (+25 more)

### Community 49 - "Community 49"
Cohesion: 0.11
Nodes (34): test_collect_observation_traces_accepts_valid_non_persistent_batch(), test_collect_observation_traces_can_require_single_scope_batch(), test_collect_observation_traces_discards_entire_batch_on_rejection(), test_collect_observation_traces_rejects_disallowed_surface(), test_collect_observation_traces_rejects_empty_batch(), test_collect_observation_traces_rejects_invalid_trace_shape(), test_collect_observation_traces_rejects_mixed_user_batch(), test_collect_observation_traces_reports_batch_rejections_from_original_input() (+26 more)

### Community 50 - "Community 50"
Cohesion: 0.1
Nodes (32): BaseHTTPMiddleware, evaluate(), ProactiveTrigger, check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe, TriggerResult, EveningWindDownTrigger (+24 more)
...
Cohesion: 0.12
Nodes (15): Get a specific provider by type.                  Args:             provider_typ, _get(), Return Atomic semantic hits as normalized records., _build_metadata(), MemoryRef, _metadata_value(), MemoryService - the sole read/write surface for Zoe memory.  This module is the, The sole read/write surface for Zoe memory. (+7 more)
...
Cohesion: 0.06
Nodes (27): Proactive adapters — thin wrappers that translate external service events into T, Executor adapters for Multica-dispatched work.  Multica is the agnostic source o, get_capabilities(), Music Service Module ====================  Platform-aware music system with: - Y, Get music system capabilities for this platform.          Returns:         Dict, Music Output Targets Package ============================  Unified interface for, Zoe Proactive Engine — public surface., claim_pending() (+19 more)
...
Cohesion: 0.09
Nodes (29): test_build_scope_split_packet_preserves_worker_reason(), test_explicit_scope_split_is_allowed_from_scout(), test_repeated_scope_split_is_still_implement_only(), build_scope_split_packet(), implement_validator_hash(), Classify broad failures that should become split/escalation packets., Machine-readable handoff for creating smaller child Multica issues., Latest handoff-recorded validator hash from implement (ignores sync-time harness (+21 more)

### Community 80 - "Community 80"
Cohesion: 0.12
Nodes (29): Attach Hermes log evidence when a silent exit was really a budget stop., _with_recovered_log_budget(), _budget_phase(), implement_edit_safety_reason_from_log(), implement_pre_edit_drift_reason_from_log(), _is_engineering_blocker_followup_body(), _is_expected_worker(), _latest_log_session() (+21 more)
...
Cohesion: 0.12
Nodes (5): saveZoneEditor(), showToast(), MusicPlaylistsWidget, MusicQueueWidget, Remove a track from the queue.                  Args:             position: If s
...
Cohesion: 0.08
Nodes (26): accept_pending_suggestion(), create_schedule(), delete_schedule(), dismiss_pending_suggestion(), list_pending_suggestions(), list_schedules(), Proactive Engine REST router.  Endpoints:   POST   /api/proactive/schedule, List unresolved save offers for the current chat session. (+18 more)
...
Cohesion: 0.1
Nodes (24): _extract_memory_candidates(), Back-compat shim: legacy dict shape over the unified extractor.      Kept so in-, test_extracts_preference_signal(), test_no_signal_returns_empty(), All runtime agent paths should persist through shared MemPalace pipeline., test_memory_capture_paths_pi_hermes_openclaw(), LLM fact extraction on a single conversation exchange.      Runs in the backgrou, run_turn_digest() (+16 more)
...
Cohesion: 0.16
Nodes (20): get_memory_router_status(), Read-only status for Zoe's disabled-by-default memory router runtime., test_build_memory_route_trace_requires_user_for_personal_scope(), test_collect_memory_route_trace_rejects_non_memory_surface(), test_disabled_runtime_does_not_compute_route_decision(), test_disabled_runtime_trace_is_skipped_and_does_not_route(), test_memory_router_runtime_enabled_is_observe_only(), test_memory_router_runtime_is_disabled_by_default() (+12 more)
...
Cohesion: 0.08
Nodes (19): Test code execution service directly, Test search_tools function, Test MCP tool execution via code, Test chat router's code execution integration, test_chat_router_code_execution(), test_code_execution_service(), test_mcp_tool_via_code(), Verify chat router has real enhancement system integration (+11 more)

### Community 116 - "Community 116"
Cohesion: 0.13
Nodes (19): test_default_chat_route_keeps_hindsight_and_graphiti_off_hot_path(), test_failure_and_fix_queries_route_to_reflective_memory(), test_fast_chat_layers_are_boring_hot_path_only(), test_reflective_route_is_timeout_bounded_candidate_only(), test_sidecar_layers_are_async_enrichment_not_required_for_chat(), test_supersession_queries_route_to_relational_memory(), test_code_questions_route_to_graphify(), test_default_chat_uses_mempalace_fast_path() (+11 more)
...
Cohesion: 0.1
Nodes (21): get_user_profile(), Get current user profile (alias for /user for UI compatibility)          Args:, Get list of active user profiles for login page.     No authentication required, create_note(), delete_note(), list_notes(), _owner_filter_sql(), patch_note() (+13 more)
...
Cohesion: 0.14
Nodes (17): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _append_audit(), _idempotency_key(), _luhn_valid(), MemoryServiceError, Return (possibly-redacted-text, reject_reason_or_None)., Raised for operational failures. (+9 more)
...
Cohesion: 0.15
Nodes (17): Invalidate a specific session (user can only invalidate their own sessions), quick_user_switch(), Quick user switching for touch panels          Args:         request: Quick swit, Invalidate specific session, validateSession(), QuickAuthManager, QuickAuthResult, Quick Authentication for Touch Panels Optimized for fast user switching and offl (+9 more)
...
Cohesion: 0.12
Nodes (9): Test getting all user sessions, Test session expiration, Test session metadata handling, Test concurrent session handling, Test cases for SessionManager class, Test session creation, Test session retrieval, Test session extension (+1 more)
...
Cohesion: 0.15
Nodes (14): Normalize a YouTube Music item to standard format., Convert Apple Music track data to Track., Search for tracks on Apple Music., Get tracks similar to a given track (not directly supported)., get_recommendations(), get_similar_tracks(), Get personalized recommendations., Get tracks similar to a given track. (+6 more)

### Community 180 - "Community 180"
Cohesion: 0.13
Nodes (9): MediaController, Media Controller ================  Routes playback commands to appropriate devic, Controls music playback across devices.          Supports:     - Browser/panel p, Get the current queue., Reorder a track in the queue., Play on Home Assistant media_player in room., Pre-fetch stream URL for next track in queue (runs in background)., Pop the next track from queue. (+1 more)
...
Cohesion: 0.17
Nodes (9): Protocol, FakeMemoryService, FakeRef, test_recall_text_from_results_supports_refs_dicts_and_strings(), test_run_mempalace_baseline_scores_fake_service(), MemPalaceBaselineService, Repeatable MemPalace baseline fixtures and scoring helpers.  The baseline is int, recall_text_from_results() (+1 more)
...
Cohesion: 0.14
Nodes (10): test_session(), Test cases for session API endpoints, Test session creation endpoint, Test session retrieval endpoint, Test session extension endpoint, Test session invalidation endpoint, Test get user sessions endpoint, Test retrieval of non-existent session (+2 more)
...
Cohesion: 0.15
Nodes (13): board_approve(), create_engineering_workflow_task(), list_engineering_workflow_tasks(), Create a Hermes-assigned Multica issue and dispatch it via the executor seam., Add a Hermes-assigned Multica issue and dispatch it to the Kanban seam., Status view: Hermes-assigned Multica issues with journaled driver state., _adapter_for_assignee(), dispatch_issue() (+5 more)

### Community 193 - "Community 193"
Cohesion: 0.21
Nodes (10): test_capability_profile_index_rejects_duplicate_ids(), test_capability_profile_rejects_unknown_owner_surface(), test_default_capability_profiles_validate_and_cover_core_surfaces(), test_metadata_is_read_only(), test_profiles_requiring_approval_includes_install_memory_and_graph_surfaces(), test_trusted_profile_requires_evidence(), CapabilityProfile, profiles_requiring_approval() (+2 more)
...
Cohesion: 0.18
Nodes (14): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), Code Execution Testing, Intent System Implementation (+6 more)
...
Cohesion: 0.17
Nodes (9): _FakeCollection, _match_where(), Deleting a CRM entity should archive all scoped MemPalace facts for it., Minimal Chroma collection stub backed by a plain dict., Facts should be returned most-recent-first., migrate_mempalace_legacy_records must retag wing='zoe' → wing='family-admin'., test_archive_by_entity_archives_user_and_wing_rows(), test_migration_retags_legacy_records() (+1 more)
...
Cohesion: 0.29
Nodes (6): FakeCursor, Buffered cursor wrapping a list of asyncpg Records., _Cursor, Buffered cursor providing aiosqlite-compatible fetchall/fetchone/iteration., _AudioStream, Async iterable that drains an aiortc audio track, resampling to     16 kHz / mon
...
Cohesion: 0.2
Nodes (10): _extract_concept_tags(), _extract_open_loops(), Extract open loops from recent messages and store in open_loops table.      An o, Run the full dreaming cycle for a user.      Called by nightly-training-cycle.sh, Use Gemma to extract concept tags from a fact. Returns [] on failure., REM pass: for each new memory ingested tonight, strengthen related existing memo, Synthesis pass: cluster approved memories by concept tag; synthesize patterns., _rem_reinforce_pass() (+2 more)
...
Cohesion: 0.31
Nodes (10): Database Protection Rules, Auto-Generated Module Compose, Jetson Docker Compose Override, Supplemental Docker Compose Modules, Raspberry Pi Docker Compose Override, Zoe Docker Compose Base, Hardware Compatibility Guide, Zoe Project Structure & Governance Rules (+2 more)

### Community 259 - "Community 259"
Cohesion: 0.2
Nodes (10): Agent Zero Implementation Checklist, Agent Zero Integration - COMPLETE, Agent Zero Intent Patterns, Agent Zero Live Integration Test Report, Agent Zero Module for Zoe, Agent Zero Comparison Skill, Agent Zero Planning Skill, Agent Zero Deep Research Skill (+2 more)
...
Cohesion: 0.22
Nodes (7): Comprehensive Test Suite for Session Management System Tests all session managem, Test cases for session middleware, Test that middleware skips excluded paths, Run all session management tests, run_session_tests(), TestSessionMiddleware, client()
...
Cohesion: 0.33
Nodes (6): Data Migration SQL, Database Lists Table, Default Lists in Database, Frontend Lists Handling, get_lists Endpoint, API Response Format Update
...
Cohesion: 0.5
Nodes (4): _memory_capture_retry_task(), Validate memory capture plumbing at startup.      This is a non-invasive probe:, Background retry: re-run the startup probe once, 45 s after boot.      Clears fa, _run_memory_capture_startup_probe()

### Community 321 - "Community 321"
Cohesion: 0.5
Nodes (4): _probe_runtimes(), Probe agent runtime ports at startup; update _RUNTIME_HEALTH., Re-probe runtime health every 5 minutes., _runtime_health_refresh_loop()
...
Cohesion: 1.0
Nodes (3): Calendar Routers Consolidation, Lists Routers Consolidation, Memories Routers Consolidation

### Community 351 - "Community 351"
Cohesion: 0.67
Nodes (3): lists.py Router Updates, migrate_lists_items.py, Lists Database Schema Fix

### Community 352 - "Community 352"
Cohesion: 0.67
Nodes (3): Session Loading Error Handling, manifest.json Creation, Protocol Handling Fix

### Community 353 - "Community 353"
Cohesion: 0.67
Nodes (3): Chat Backend (chat.py), RouteLLM Integration, LiteLLM Gateway Integration

### Community 354 - "Community 354"
Cohesion: 0.67
Nodes (3): Error Handling Improvements, GPU Allocation Error Fix, Model Configuration Update

### Community 355 - "Community 355"
Cohesion: 0.67
Nodes (3): Reduced num_predict Tokens, Performance Optimizations, Warmup Script Fix

## Knowledge Gaps
- **2811 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2806 more)
...
- **Why does `main()` connect `Community 1` to `Community 128`, `Community 133`, `Community 10`, `Community 269`, `Community 143`, `Community 16`, `Community 17`, `Community 146`, `Community 18`, `Community 19`, `Community 277`, `Community 23`, `Community 152`, `Community 151`, `Community 157`, `Community 158`, `Community 289`, `Community 34`, `Community 165`, `Community 166`, `Community 42`, `Community 174`, `Community 47`, `Community 302`, `Community 175`, `Community 50`, `Community 182`, `Community 186`, `Community 59`, `Community 314`, `Community 61`, `Community 64`, `Community 70`, `Community 200`, `Community 201`, `Community 203`, `Community 81`, `Community 210`, `Community 211`, `Community 212`, `Community 84`, `Community 86`, `Community 213`, `Community 88`, `Community 90`, `Community 220`, `Community 221`, `Community 95`, `Community 98`, `Community 232`, `Community 104`, `Community 235`, `Community 236`, `Community 237`, `Community 112`, `Community 113`, `Community 114`, `Community 115`, `Community 252`, `Community 123`, `Community 124`, `Community 253`, `Community 126`?**
  _High betweenness centrality (0.184) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 98` to `Community 1`, `Community 3`, `Community 8`, `Community 10`, `Community 267`, `Community 138`, `Community 14`, `Community 143`, `Community 17`, `Community 18`, `Community 19`, `Community 146`, `Community 21`, `Community 23`, `Community 25`, `Community 291`, `Community 164`, `Community 39`, `Community 40`, `Community 302`, `Community 48`, `Community 178`, `Community 52`, `Community 313`, `Community 57`, `Community 59`, `Community 60`, `Community 58`, `Community 61`, `Community 64`, `Community 72`, `Community 73`, `Community 201`, `Community 203`, `Community 204`, `Community 79`, `Community 80`, `Community 81`, `Community 83`, `Community 212`, `Community 126`, `Community 228`, `Community 101`, `Community 238`, `Community 111`, `Community 113`, `Community 241`, `Community 117`, `Community 248`, `Community 122`, `Community 125`, `Community 254`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 47` to `Community 1`, `Community 3`, `Community 35`, `Community 5`, `Community 38`, `Community 234`, `Community 46`, `Community 238`, `Community 15`, `Community 174`, `Community 179`?**
