...
- `Zoe Graphify Refresh Evidence` --references--> `HindsightConfig`  [EXTRACTED]
  docs/architecture/zoe-graphify-refresh-evidence.md → services/zoe-data/hindsight_memory.py
...
Cohesion: 0.04
Nodes (71): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker. (+63 more)
...
Cohesion: 0.04
Nodes (69): Start discovering AirPlay devices, Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Get device info from database., Get current playback state for a zone (+61 more)
...
Cohesion: 0.04
Nodes (56): a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_cancel(), board_review(), build_engineering_guard_packet(), delegate_to_agent(), _EngineeringGuardRunRequest (+48 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (58): AuthResponse, escalate_session(), get_current_user(), get_passcode_status(), guest_login(), InitialPasswordSetupRequest, login(), login_passcode() (+50 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (51): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, Convert to dictionary for API responses., str, test_experience_memory_requires_evidence(), test_mapping_rejects_missing_scope() (+43 more)
...
Cohesion: 0.06
Nodes (30): Refresh current session expiration          Args:         current_session: Curre, refresh_session(), Verify user password                  Args:             user_id: User identifier, Parse stored auth timestamp strings., Check if password change is required due to age, Log authentication attempt - non-blocking, errors suppressed, EnhancedSessionManager, Enhanced session manager with multi-factor support (+22 more)
...
Cohesion: 0.08
Nodes (35): Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage., Check for potential security issues., Validates intent system configuration., Run all validations.                  Returns:             True if all validatio (+27 more)
...
Cohesion: 0.06
Nodes (39): Journal visibility is always personal - user_id must match., SQL fragment: (visibility='family' OR user_id=?) AND deleted=0, _visibility_filter_sql(), Create a notification., acknowledge_reminder(), create_reminder(), delete_reminder(), list_pending_notifications() (+31 more)
...
Cohesion: 0.08
Nodes (34): Regenerate ZOE_SELF.md and distribute to all agents (OpenClaw, Hermes, compact)., trigger_agent_sync(), test_capabilities_snapshot_is_stable(), test_generated_context_mentions_hermes_engineering_loop(), test_graphify_rebuild_is_opt_in_by_default(), test_graphify_rebuild_opt_in_env_is_recognized(), test_patch_soul_block_is_idempotent_per_marker(), test_zoe_why_block_teaches_mission_and_stays_lean() (+26 more)
...
Cohesion: 0.08
Nodes (32): BaseHTTPMiddleware, ProactiveTrigger, What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe, TriggerResult, EveningWindDownTrigger, Evening wind-down trigger — journal prompt if user hasn't written in 3+ days., EvolutionWeeklyDigestTrigger (+24 more)
...
Cohesion: 0.07
Nodes (29): accept_pending_suggestion(), create_schedule(), delete_schedule(), dismiss_pending_suggestion(), list_pending_suggestions(), list_schedules(), Proactive Engine REST router.  Endpoints:   POST   /api/proactive/schedule, List unresolved save offers for the current chat session. (+21 more)

### Community 69 - "Community 69"
Cohesion: 0.06
Nodes (28): Proactive adapters — thin wrappers that translate external service events into T, get_user_profile(), Get current user profile (alias for /user for UI compatibility)          Args:, Get list of active user profiles for login page.     No authentication required, Executor adapters for Multica-dispatched work.  Multica is the agnostic source o, get_capabilities(), Music Service Module ====================  Platform-aware music system with: - Y, Get music system capabilities for this platform.          Returns:         Dict (+20 more)
...
Cohesion: 0.09
Nodes (24): evaluate(), Manually trigger the morning brief for the calling user.     Useful for testing, trigger_morning_brief(), check(), Fire once per week on Friday at 6pm local time., _build_morning_context(), _compose_morning_message(), MorningCheckInTrigger (+16 more)
...
Cohesion: 0.17
Nodes (26): get_engineering_guard(), PR-keyed Greptile grep-loop guard state., acquire_lock(), _append_progress(), _ci_status_from_rollup(), _finding_hash(), _gh_mergeable_state(), GuardPacket (+18 more)
...
Cohesion: 0.11
Nodes (19): Browser Cache Fix - Clear Old Broken State, CLEANUP SAFETY RULES - MANDATORY FOR ALL AI ASSISTANTS, CRITICAL FILES - DO NOT DELETE, Disk Space Protection System, Disk Space Protection - Implementation Complete Summary, Intent System Development Rules, iOS Shortcuts Integration Guide for Zoe, Journal Widget - Visual Example (+11 more)
...
Cohesion: 0.18
Nodes (16): create_event(), delete_event(), _enforce_calendar_read_access(), get_event(), list_events(), list_today_events(), FastAPI router for calendar events. Mounted at prefix="/api/calendar" with tag ", Get a single event by ID. (+8 more)
...
Cohesion: 0.24
Nodes (10): _embeddings_base_url_from_env(), _env_bool(), from_env(), HindsightOfflineConfigError, _is_local_or_private_url(), _positive_count(), Hindsight sidecar adapter for Zoe's memory bake-off.  The adapter is disabled by, Raised when Hindsight config would violate Zoe's offline-only rule. (+2 more)
...
Cohesion: 0.16
Nodes (12): check_for_dangerous_patterns(), Check for dangerous file patterns that indicate backups/duplicates.          Ret, Validate all critical files exist.          Returns:         Tuple of (existing_, _active_memory_files(), _assert_hindsight_policy(), _fail(), _is_allowed_line(), _scan_active_memory_files() (+4 more)
...
Cohesion: 0.38
Nodes (7): Backend lists.py Router, Data Migration SQL Commands, Database Query in GET /api/lists/{list_type}, Default Lists Creation SQL, Frontend Lists Loading Logic, GET /api/lists/{list_type} Endpoint, Response Format Update in GET /api/lists/{list_type}
...
Cohesion: 0.33
Nodes (6): Docker Networking Rules - MANDATORY, Hermes Optimization Playbook, LiteLLM Gateway - Development Rules & Guidelines, Zoe Operator Runbook, Raspberry Pi Touchscreen Stack (192.168.1.61), Zoe Touch Pi Production Rollout (2026-03-23)
...
Cohesion: 0.4
Nodes (5): Intent System (HassIL-based), HassIL Classifier, Intent Handlers for Lists, Chat Router with Intent Integration, Zoe Orb Component
...
Cohesion: 0.67
Nodes (3): Database Path Enforcement System, Enhanced Enforcement System, Issue Analysis - October 23, 2025
...
- **Why does `main()` connect `Community 1` to `Community 2`, `Community 132`, `Community 5`, `Community 267`, `Community 268`, `Community 14`, `Community 143`, `Community 144`, `Community 20`, `Community 21`, `Community 150`, `Community 23`, `Community 26`, `Community 283`, `Community 31`, `Community 33`, `Community 290`, `Community 163`, `Community 161`, `Community 289`, `Community 166`, `Community 35`, `Community 296`, `Community 43`, `Community 175`, `Community 190`, `Community 191`, `Community 65`, `Community 194`, `Community 195`, `Community 196`, `Community 67`, `Community 66`, `Community 199`, `Community 328`, `Community 73`, `Community 74`, `Community 72`, `Community 200`, `Community 79`, `Community 82`, `Community 84`, `Community 85`, `Community 86`, `Community 215`, `Community 216`, `Community 217`, `Community 90`, `Community 92`, `Community 94`, `Community 98`, `Community 227`, `Community 228`, `Community 229`, `Community 230`, `Community 104`, `Community 113`, `Community 242`, `Community 116`, `Community 118`, `Community 120`, `Community 249`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.183) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 79` to `Community 256`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 134`, `Community 8`, `Community 264`, `Community 265`, `Community 14`, `Community 16`, `Community 144`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 24`, `Community 281`, `Community 27`, `Community 157`, `Community 31`, `Community 32`, `Community 33`, `Community 34`, `Community 38`, `Community 39`, `Community 43`, `Community 44`, `Community 46`, `Community 47`, `Community 56`, `Community 184`, `Community 59`, `Community 65`, `Community 194`, `Community 198`, `Community 71`, `Community 72`, `Community 74`, `Community 75`, `Community 80`, `Community 208`, `Community 82`, `Community 215`, `Community 91`, `Community 94`, `Community 102`, `Community 109`, `Community 110`, `Community 239`, `Community 237`, `Community 113`, `Community 119`, `Community 120`, `Community 121`, `Community 253`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `_FakeAdapter` connect `Community 0` to `Community 164`, `Community 10`, `Community 75`, `Community 74`, `Community 173`, `Community 149`?**
