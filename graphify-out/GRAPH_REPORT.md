...
## Summary
- 7898 nodes · 13876 edges · 543 communities (350 shown, 193 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1842 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9bd39b2c`
...
## Communities (543 total, 193 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (134): ABC, rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, get_auth_manager(), Get the singleton auth manager instance., Get track metadata from cache., Get or create a YTMusic client for a user.                  Args:             us, Check if user has valid YouTube Music authentication. (+126 more)
...
Cohesion: 0.03
Nodes (85): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker. (+77 more)
...
Cohesion: 0.04
Nodes (76): Start discovering AirPlay devices, Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Get device info from database., Get current playback state for a zone (+68 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (74): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Validate database structure, Enum, Run all validations.                  Returns:             True if all validatio, OutputState, OutputType (+66 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (71): get_memory_router_status(), Read-only status for Zoe's disabled-by-default memory router runtime., test_default_chat_route_keeps_hindsight_and_graphiti_off_hot_path(), test_failure_and_fix_queries_route_to_reflective_memory(), test_fast_chat_layers_are_boring_hot_path_only(), test_reflective_route_is_timeout_bounded_candidate_only(), test_sidecar_layers_are_async_enrichment_not_required_for_chat(), test_supersession_queries_route_to_relational_memory() (+63 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (74): _issue_sort_key(), Return (sequence_key, phase_number) when title encodes a phased track., True when every lower phase in the same sequence is ``done`` (or missing)., Pick up to ``count`` backlog issues respecting phased ordering.      ``all_issue, select_batch(), _event(), _admission_trace(), _plain_event() (+66 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (74): Override to customise the prompt per-check., _build_memory_context(), _build_prompt(), _build_tools(), _build_voice_tools(), _cap_tool_result(), _chat_capability_shortcut(), _check_fast_response() (+66 more)
...
Cohesion: 0.06
Nodes (35): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+27 more)
...
Cohesion: 0.06
Nodes (41): get_current_user(), get_passcode_status(), get_user_profile(), guest_login(), LoginRequest, logout(), logout_all(), Authentication API Endpoints RESTful API for authentication, session management, (+33 more)
...
Cohesion: 0.07
Nodes (22): IntEnum, AiortcRoom, _ConnState, _DataPacket, _Frame, _FrameEvent, make_room(), livekit_aiortc.py — LiveKit room participant using pure-Python aiortc.  Replaces (+14 more)
...
Cohesion: 0.11
Nodes (16): Get a specific provider by type.                  Args:             provider_typ, _get(), _FakeCollection, _match_where(), Minimal Chroma collection stub backed by a plain dict., Return Atomic semantic hits as normalized records., MemoryRef, MemoryService - the sole read/write surface for Zoe memory.  This module is the (+8 more)
...
Cohesion: 0.1
Nodes (32): INTENT_LABELS, attachCardActions(), buildActionButtons(), buildMatchCard(), hideSDTimerOverlay(), hideSpeedDatingBanner(), loadMatches(), loadPendingConnections() (+24 more)
...
Cohesion: 0.1
Nodes (29): BaseHTTPMiddleware, Manually trigger the morning brief for the calling user.     Useful for testing, trigger_morning_brief(), check(), What a trigger wants to send., TriggerResult, EvolutionWeeklyDigestTrigger, EvolutionWeeklyDigestTrigger — Friday 6pm weekly evolution summary.  Fires every (+21 more)
...
Cohesion: 0.08
Nodes (16): Test that temperature adjusts based on context availability, Test P0-1: Measure actual latency improvements, Measure latency improvement for Tier 0 intents, Ensure data-fetching intents get context (no regression), Test memory keyword detection accuracy, TestP01ContextValidationImprovements, Tier 0 intents should have 0.0 temperature, Factual queries should have low temperature (+8 more)
...
Cohesion: 0.2
Nodes (25): test_all_proposal_evidence_refs_get_relationship_edges(), test_failed_proposal_outcome_builds_failure_memory_event(), test_failed_proposal_requires_failed_or_blocked_trace(), test_latest_trace_content_uses_created_at_not_input_order_and_conservative_confidence(), test_missing_trace_confidence_defaults_to_neutral_memory_confidence(), test_non_terminal_proposal_cannot_create_outcome_memory(), test_outcome_memory_requires_user_scope(), test_retired_proposal_outcome_builds_capability_memory_event() (+17 more)

### Community 89 - "Community 89"
Cohesion: 0.11
Nodes (26): test_acceptance_status_in_free_text_does_not_skip_implementation(), test_acceptance_status_is_not_a_routing_signal(), test_audit_only_from_handoff_detects_kv_field(), test_implementation_required_from_structured_scout_handoff(), test_structured_implementation_decision_wins_over_text(), audit_only_from_handoff(), _greptile_from_closeout(), _haystacks() (+18 more)
...
Cohesion: 0.09
Nodes (25): AuthResponse, InitialPasswordSetupRequest, login(), login_passcode(), PasswordChangeRequest, Authenticate with username and password          Args:         request: Login cr, Authenticate with username (or user_id) and passcode.      Accepts either ``user, User registration request model (+17 more)
...
Cohesion: 0.12
Nodes (20): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _append_audit(), _build_metadata(), _idempotency_key(), MemoryServiceError, _metadata_value(), Raised for operational failures. (+12 more)
...
Cohesion: 0.13
Nodes (21): _env_float(), _config_values(), _env_bool_snapshot(), _env_float_snapshot(), GraphitiSidecarProbeResult, _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers() (+13 more)
...
Cohesion: 0.13
Nodes (21): Questions must not be extracted as memory facts., _fire_memory_capture must write facts to the correct user's wing., Writing same fact twice via _background_memory_save should not create duplicates, test_background_dedup(), test_fire_memory_capture_user_scoped(), test_question_not_extracted(), _clean(), extract_and_ingest() (+13 more)
...
Cohesion: 0.14
Nodes (13): _compact_context(), _embeddings_base_url_from_env(), _env_bool(), event_to_hindsight_item(), from_env(), HindsightMemoryError, Hindsight sidecar adapter for Zoe's memory bake-off.  The adapter is disabled by, Convert a validated Zoe memory event into a Hindsight retain item. (+5 more)
...
Cohesion: 0.11
Nodes (19): _bash(), _cloak_search(), _ddg_search_sync(), _dispatch_tool(), _google_maps_local_search(), _mempalace_search(), Semantic search of this user's MemPalace facts via MemoryService.      Returns t, Run an allowed bash command and return stdout (max 2000 chars). (+11 more)

### Community 141 - "Community 141"
Cohesion: 0.14
Nodes (12): disable_passcode(), Disable passcode for current user          Args:         current_session: Curren, PasscodeManager, Disable passcode for user                  Args:             user_id: User ident, Get passcode information for user (without hash), Reset failed attempts counter (admin function), Validate passcode against policy, Check if passcode is already used by another user (+4 more)
...
Cohesion: 0.11
Nodes (17): check_no_archive_folders(), check_no_databases_in_git(), check_no_duplicate_configs(), check_no_temp_files(), check_required_docs(), check_root_md_files(), check_schema_files_exist(), check_structure_exists() (+9 more)
...
Cohesion: 0.12
Nodes (11): Check a single router file for authentication issues.     Returns list of (line_, check_file(), Check a single file for hardcoded database paths, Check a single file against rules, find_references(), load_critical_files(), Load critical files manifest, Find references to file in codebase (+3 more)

### Community 175 - "Community 175"
Cohesion: 0.12
Nodes (12): Feature Improvement Testing Test each feature individually, measure impact, vali, Ensure we don't add qualifiers to already-qualified responses, Test P0-3: Validate temperature appropriateness, Test that temperature ranges are appropriate for intent types, Test P0-4: Validate grounding detection, Test that all features can be imported without conflicts, Test P0-2: Validate confidence expression quality, Test that confidence qualifiers are appropriate (+4 more)
...
Cohesion: 0.18
Nodes (10): EveningWindDownTrigger, Evening wind-down trigger — journal prompt if user hasn't written in 3+ days., get_compat_db(), Async context manager yielding AsyncpgCompat wrapping a pooled connection., Run the morning check-in trigger for all active users., Run the evening wind-down trigger for all active users., Run the evolution weekly digest trigger for all active users., _run_evening_winddown() (+2 more)
...
Cohesion: 0.2
Nodes (10): _memory_digest_loop(), Wait until 3am, then run LLM digest for all active users daily., Start the nightly memory digest loop (if not disabled)., Manually trigger the LLM memory digest for a user (or the requesting user)., Manually trigger full nightly dreaming cycle including evolution notice (admin o, start_memory_digest_background(), trigger_memory_digest(), trigger_run_digest() (+2 more)
...
Cohesion: 0.2
Nodes (9): create_docs_folder(), create_project_status(), move_to_archive(), Create organized docs folder structure, Move old docs to archive, Create docs/README.md index, Create consolidated PROJECT_STATUS.md, create_docs_index() (+1 more)

### Community 263 - "Community 263"
Cohesion: 0.28
Nodes (9): _broadcast_intent_nav(), _build_calendar_form_props(), _build_reminder_form_props(), _intent_action_form_payload(), Build a panel_show_action_form payload for intents that show an in-place overlay, Broadcast UI actions to the touch panel when an intent is detected.      For act, _build_command(), _parse_date() (+1 more)
...
Cohesion: 0.32
Nodes (5): Apple Music Provider ====================  Integration with Apple Music using th, display_name(), supports_streaming(), Spotify Music Provider ======================  Integration with Spotify using sp, YouTube Music Provider Adapter ==============================  Adapts the existi
...
Cohesion: 0.46
Nodes (8): MCP-Only Architecture for Zoe Modules, Music Module Migration Guide, Module Intent Auto-Discovery System, Zoe Module Requirements, Zoe Module System - Implementation Complete, Music Module Dependency Audit, Music Module Extraction Execution Plan, Music Routing Options
...
Cohesion: 0.29
Nodes (6): Test P1-1: Validate behavioral pattern extraction, Test that pattern extraction is fast enough for nightly jobs, Test that all pattern types can be extracted, TestP11BehavioralMemoryImprovements, Each extraction pattern must fire on its canonical example., test_pattern_extraction()
...
Cohesion: 0.29
Nodes (6): fix_file(), Fix references in a single file, Update README.md to reference new structure, Update documentation/DOCUMENTATION_INDEX.md, update_documentation_index(), update_readme()

### Community 297 - "Community 297"
Cohesion: 0.52
Nodes (7): Auto-Generated Module Compose, Jetson Docker Compose Override, Supplemental Docker Compose Modules, Raspberry Pi Docker Compose Override, Zoe Docker Compose Base, Hardware Compatibility Guide, Zoe AI Assistant README

### Community 298 - "Community 298"
Cohesion: 0.48
Nodes (7): Agent Zero Implementation Checklist, Agent Zero Integration - COMPLETE, Agent Zero Intent Patterns, Agent Zero Live Integration Test Report, Agent Zero Module for Zoe, Agent Zero + Zoe Integration Summary, Agent Zero Integration Test Results
...
Cohesion: 0.33
Nodes (5): get_media_controller(), Get the singleton media controller instance., get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us, Get the singleton YouTube Music provider instance.
...
Cohesion: 0.67
Nodes (4): Database Query in GET /api/lists/{list_type}, GET /api/lists/{list_type} Endpoint, lists.py Router, Updated Response Format for Lists API
...
Cohesion: 0.67
Nodes (4): Dashboard Loaders, Widget Builder API Endpoints, Widget Manifest, WidgetManager

### Community 356 - "Community 356"
Cohesion: 0.67
Nodes (3): check_no_root_tests(), No test files in root except allowed, No .sh files in root except allowed

### Community 358 - "Community 358"
Cohesion: 0.67
Nodes (3): Code Execution Service Status, Code Execution Testing Results, MCP Best Practices Review

## Knowledge Gaps
- **2841 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2836 more)
...
- **Why does `main()` connect `Community 3` to `Community 2`, `Community 258`, `Community 259`, `Community 5`, `Community 135`, `Community 7`, `Community 142`, `Community 144`, `Community 19`, `Community 148`, `Community 20`, `Community 22`, `Community 278`, `Community 153`, `Community 281`, `Community 156`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 291`, `Community 163`, `Community 174`, `Community 178`, `Community 54`, `Community 312`, `Community 57`, `Community 185`, `Community 186`, `Community 187`, `Community 59`, `Community 65`, `Community 194`, `Community 323`, `Community 69`, `Community 70`, `Community 73`, `Community 75`, `Community 76`, `Community 205`, `Community 206`, `Community 81`, `Community 210`, `Community 83`, `Community 84`, `Community 337`, `Community 216`, `Community 217`, `Community 90`, `Community 218`, `Community 96`, `Community 226`, `Community 104`, `Community 110`, `Community 111`, `Community 112`, `Community 241`, `Community 114`, `Community 240`, `Community 116`, `Community 117`, `Community 242`, `Community 119`, `Community 120`, `Community 249`?**
  _High betweenness centrality (0.190) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 59` to `Community 128`, `Community 130`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 136`, `Community 260`, `Community 140`, `Community 12`, `Community 142`, `Community 17`, `Community 19`, `Community 148`, `Community 20`, `Community 30`, `Community 31`, `Community 166`, `Community 39`, `Community 40`, `Community 44`, `Community 47`, `Community 51`, `Community 52`, `Community 53`, `Community 54`, `Community 179`, `Community 312`, `Community 57`, `Community 63`, `Community 71`, `Community 72`, `Community 201`, `Community 74`, `Community 200`, `Community 206`, `Community 215`, `Community 88`, `Community 90`, `Community 225`, `Community 100`, `Community 102`, `Community 103`, `Community 234`, `Community 237`, `Community 111`, `Community 114`, `Community 243`, `Community 119`, `Community 120`, `Community 251`, `Community 127`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 2` to `Community 0`, `Community 3`, `Community 37`, `Community 41`, `Community 11`, `Community 13`, `Community 238`, `Community 243`, `Community 149`, `Community 186`?**
