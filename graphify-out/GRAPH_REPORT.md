...
## Summary
- 5270 nodes · 8640 edges · 447 communities (272 shown, 175 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 607 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5960635`
...
1. `main()` - 281 edges
2. `init()` - 159 edges
3. `require_feature_access()` - 78 edges
4. `list()` - 62 edges
5. `GameManager` - 54 edges
6. `chat()` - 45 edges
7. `_row_to_dict()` - 44 edges
8. `SpotifyProvider` - 40 edges
9. `YouTubeMusicAdapter` - 39 edges
10. `AppleMusicProvider` - 38 edges

## Surprising Connections (you probably didn't know these)
- `get_reports()` --calls--> `_row_to_dict()`  [INFERRED]
  modules/orbit/main.py → services/zoe-data/routers/lists.py
- `_broadcast_calendar_ui()` --calls--> `get_db()`  [INFERRED]
  services/zoe-data/routers/voice_tts.py → modules/orbit/database.py
- `_broadcast_list_ui()` --calls--> `get_db()`  [INFERRED]
  services/zoe-data/routers/voice_tts.py → modules/orbit/database.py
- `_broadcast_reminder_ui()` --calls--> `get_db()`  [INFERRED]
  services/zoe-data/routers/voice_tts.py → modules/orbit/database.py
- `_request_auth_ui()` --calls--> `get_db()`  [INFERRED]
  services/zoe-data/routers/voice_tts.py → modules/orbit/database.py

## Communities (447 total, 175 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (55): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, fix_router_file(), Fix a single router file's database paths, Fix all routers in the routers directory, Main cleanup function. (+47 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (54): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn(), ha_voice_wake() (+46 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (66): DESIRE_LABELS, getMyCheckinId(), goDiscover(), INTENT_LABELS, load(), loadQuiz(), params, pathParts (+58 more)
...
Cohesion: 0.04
Nodes (65): activate_scene(), analyze_home_assistant(), control_device(), get_automations(), get_entities(), get_entity(), get_lights(), get_scenes() (+57 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (55): Get current playback state from an AirPlay device, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100)., Get current playback state for a zone, Seek to position in a zone, Set volume for a zone, Stop playback on an AirPlay device. (+47 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (55): get_plugins(), get_skills(), install_plugin_endpoint(), install_skill_endpoint(), preview_skill_endpoint(), routers/openclaw.py — REST API for OpenClaw plugin and skill management.  Endpoi, Install a skill (allowlist-gated). Returns 403 if not in allowlist., Update a workspace skill from ClawHub. (+47 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (54): Override to customise the prompt per-check., _bash(), _build_memory_context(), _build_prompt(), _build_tools(), _chat_capability_shortcut(), _check_fast_response(), _dispatch_tool() (+46 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (55): AuthResponse, get_current_user(), get_passcode_status(), get_user_profile(), guest_login(), InitialPasswordSetupRequest, login(), login_passcode() (+47 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (40): get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker., Play previous track (from history)., Add a track to the queue.                  Args:             position: If specif (+32 more)

### Community 10 - "Community 10"
Cohesion: 0.07
Nodes (33): escalate_session(), Refresh current session expiration          Args:         current_session: Curre, Escalate passcode session to full session with password verification          Ar, refresh_session(), EnhancedSessionManager, get_config(), Enhanced session manager with multi-factor support, Authenticate user and create session                  Args:             request: (+25 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (48): BaseModel, contactData, ChallengeAnswerCreate, ChallengeCreate, CheckInCreate, CheckInPublic, Connection, ConnectionCreate (+40 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (9): escapeHtml(), saveZoneEditor(), showToast(), attemptReconnect(), onError(), MusicPlaylistsWidget, MusicQueueWidget, MusicSearchWidget (+1 more)

### Community 13 - "Community 13"
Cohesion: 0.14
Nodes (11): pickWinner(), submitCards(), _cancel_timer(), GameError, GameManager, get_game(), start_game(), ws_console() (+3 more)

### Community 14 - "Community 14"
Cohesion: 0.06
Nodes (32): chat_stream_generator(), _create_pending_approval(), _detect_preview_urls(), _ensure_user_and_chat_session(), _extract_ui_actions(), _iter_openclaw_heartbeats(), _map_ui_payload_to_action(), _persist_ag_ui_run() (+24 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (39): Normalize a YouTube Music item to standard format., AppleMusicProvider, Convert Apple Music track data to Track., Convert Apple Music album data to Album., Convert Apple Music artist data to Artist., Search for tracks on Apple Music., Search for albums on Apple Music., Search for artists on Apple Music. (+31 more)
...
Cohesion: 0.06
Nodes (30): AirPlayDevice, AirPlayService, AirPlay Integration Service Discovers and controls AirPlay devices for music pla, Start discovering AirPlay devices, Connect to an AirPlay device, Play media on an AirPlay device                  Args:             device_id: Ta, Represents a discovered AirPlay device, Send a control command to an AirPlay device                  Args:             d (+22 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (37): fresh_collection(), _install_mempalace_stubs(), Comprehensive MemPalace integration tests.  Tests: user isolation, upsert behavi, Install mempalace module stubs so pi_agent doesn't require the real package., Reset the in-memory Chroma collection before each test.      Also resets the Mem, Writing for 'jason' must not appear when loading facts for 'family-admin'., Writing for 'family-admin' must not appear when loading facts for 'jason'., Each user's facts are independent — count is per-user. (+29 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (37): create_pin_challenge(), get_panel_bindings(), _hash_token(), issue_token(), lookup_device_token(), panel_public_info(), _pin_check_locked(), _pin_clear() (+29 more)
...
Cohesion: 0.09
Nodes (35): create_entry(), delete_entry(), get_entry(), get_mood_stats(), get_prompts(), get_streak_stats(), list_entries(), list_on_this_day() (+27 more)

### Community 26 - "Community 26"
Cohesion: 0.08
Nodes (35): print_results(), Scan entire project and categorize all files., Check if path should be ignored., Categorize a file and determine if it's in the right location.          Returns:, scan_project(), should_ignore(), Print validation results.          Returns:         Exit code (0 if all files ex, check_root_md_limit() (+27 more)

### Community 27 - "Community 27"
Cohesion: 0.07
Nodes (28): check_readme_links(), find_doc_references(), find_hardcoded_paths(), generate_report(), Check if README references are current, Generate audit report, Find all references to documentation files in code, Find hardcoded paths to documentation (+20 more)

### Community 28 - "Community 28"
Cohesion: 0.11
Nodes (32): tryRestoreSession(), showScreen(), closeAndReconnect(), connectWebSocket(), dom, esc(), formatCardText(), isLightColor() (+24 more)
...
Cohesion: 0.08
Nodes (21): Music Zone Manager Handles multi-zone playback with device routing and state syn, Create a new music zone, Current playback state for a zone, Delete a zone (only owner can delete), Get all zones accessible by a user, Add a device to a zone, Remove a device from a zone, Mark a device as connected and store its websocket (+13 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (20): create_user(), Create new user (admin only)          Args:         request: User creation detai, change_password(), Change current user's password          Args:         request: Current and new p, AuthManager, Change user password                  Args:             user_id: User identifier, Reset user password (admin function)                  Args:             user_id:, Unlock user account (admin function)                  Args:             user_id: (+12 more)

### Community 35 - "Community 35"
Cohesion: 0.11
Nodes (31): _build_calendar_form_props(), _build_reminder_form_props(), HA full-setup shorthand intent and OpenClaw message expansion., test_detect_ha_full_setup(), test_execute_ha_full_setup_returns_none(), test_openclaw_user_message_expands_with_intent(), test_openclaw_user_message_expands_without_intent(), _build_command() (+23 more)
...
Cohesion: 0.09
Nodes (30): _extract_complete_sentences(), _get_kokoro_instance(), _has_espeak_ng(), Convert float32 [-1,1] samples to mono WAV bytes., Yield WAV chunks from Kokoro create_stream() for one sentence., Streaming TTS endpoint: sentence-splits text and streams WAV chunks.      Pi dae, Return cached Kokoro instance, loading lazily on first call., Allow voice endpoints if caller has a valid device token OR is authenticated. (+22 more)

### Community 41 - "Community 41"
Cohesion: 0.08
Nodes (22): analyze_login_patterns(), AuditLogger, log_authentication_attempt(), log_security_event(), RateLimiter, RateLimitRule, Security Features and Controls Rate limiting, audit logging, and advanced securi, Clear rate limit for identifier (admin function) (+14 more)
...
Cohesion: 0.14
Nodes (11): Get a specific provider by type.                  Args:             provider_typ, Return Atomic semantic hits as normalized records., MemoryRef, MemoryService - the sole read/write surface for Zoe memory.  This module is the, The sole read/write surface for Zoe memory., List rows for a user by status, newest first., Soft-delete the most recently ingested memory for a user., Soft-archive low-score approved memories. (+3 more)
...
Cohesion: 0.07
Nodes (19): Initialize Agent Zero client.                  Args:             base_url: Base, Initialize safety guardrails.                  Args:             mode: Safety mo, init(), setupColorPicker(), Initialize the affinity engine.                  Args:             half_life_day, Initialize the AirPlay service, Initialize the audio analyzer with Essentia., Initialize the auth manager.                  Args:             encryption_key: (+11 more)

### Community 53 - "Community 53"
Cohesion: 0.09
Nodes (26): startChallenge(), parse_json_fields(), get_connection_icebreaker(), Orbit icebreaker engine — rule cascade, strongest signal wins., Shorter icebreaker for the QR scan connect page., _auto_end_challenge(), create_checkin(), create_connection() (+18 more)

### Community 54 - "Community 54"
Cohesion: 0.09
Nodes (23): MusicProvider, Convert Apple Music playlist data to Playlist., Search for playlists on Apple Music., Playlist, Unified playlist representation., Abstract base class for music streaming providers.          All providers (YouTu, Search for playlists., Like/save a track. Override if provider supports it. (+15 more)
...
Cohesion: 0.15
Nodes (3): MCPMusicStateManager, Pop the next track from queue., Skip to next track in queue
...
Cohesion: 0.09
Nodes (20): get_display_preferences(), get_updates(), _memory_consolidation_loop(), _memory_digest_loop(), openclaw_background_loop(), post_display_brightness(), _proxy_reload_to_pi(), put_display_preferences() (+12 more)

### Community 60 - "Community 60"
Cohesion: 0.11
Nodes (16): disable_passcode(), Disable passcode for current user          Args:         current_session: Curren, PasscodeManager, Verify passcode for user                  Args:             user_id: User identi, Disable passcode for user                  Args:             user_id: User ident, Get passcode information for user (without hash), Reset failed attempts counter (admin function), Validate passcode against policy (+8 more)
...
Cohesion: 0.13
Nodes (18): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _build_metadata(), _idempotency_key(), _luhn_valid(), MemoryServiceError, Return (possibly-redacted-text, reject_reason_or_None)., Raised for operational failures. (+10 more)
...
Cohesion: 0.1
Nodes (18): Analyze a target (file, system, configuration).                  Args:, analyze(), Analysis endpoint - analyzes files, configurations, systems.          Uses Agent, Analyze all files in root, AudioAnalyzer, Audio Analyzer ==============  Extracts audio features from music tracks using E, Analyze a track and extract audio features.                  Args:             t, Synchronous audio analysis (runs in thread pool).                  Args: (+10 more)

### Community 67 - "Community 67"
Cohesion: 0.11
Nodes (24): Manually trigger the weekly consolidation pass.      Admin-only when ``user_id``, Manually trigger the LLM memory digest for a user (or the requesting user)., trigger_memory_consolidation(), trigger_memory_digest(), _extract_facts_with_gemma(), _is_contradiction(), _load_todays_messages(), _merge_near_duplicates() (+16 more)

### Community 68 - "Community 68"
Cohesion: 0.14
Nodes (24): get_openclaw_info(), _load_skills_and_cron(), post_openclaw_upgrade(), OpenClaw brain info: skills, cron, gateway, versions., Background: daily npm check, notify users, optional auto-upgrade., run_scheduled_openclaw_version_check(), clear_satisfied_update_notifications(), fetch_gateway_status() (+16 more)

### Community 69 - "Community 69"
Cohesion: 0.11
Nodes (16): create_synapse_auth_provider(), MatrixIntegration, MatrixUser, Matrix (Synapse/Dendrite) SSO Integration Authentication provider for Matrix hom, Deactivate Matrix user                  Args:             username: Username to, Matrix user representation, Join user to Matrix room                  Args:             user_id: Zoe user ID, Get Matrix rooms for user                  Args:             user_id: Zoe user I (+8 more)

### Community 70 - "Community 70"
Cohesion: 0.08
Nodes (17): Feature Improvement Testing Test each feature individually, measure impact, vali, Ensure we don't add qualifiers to already-qualified responses, Test P0-4: Validate grounding detection, Test P1-1: Validate behavioral pattern extraction, Test that all pattern types can be extracted, Test safeguards and error handling, Verify all features are disabled by default (safety), Test that features fail gracefully when disabled (+9 more)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (24): get_media_controller(), Get the singleton media controller instance., startup(), get_music_services(), MCP Tool: music.search          Search for music (songs, albums, artists, playli, MCP Tool: music.play_song          Play a song, album, or playlist by query or t, MCP Tool: music.pause          Pause current playback., MCP Tool: music.resume          Resume paused playback. (+16 more)

### Community 72 - "Community 72"
Cohesion: 0.14
Nodes (23): add_item(), create_list(), delete_item(), delete_list(), get_list(), get_list_types(), list_items(), list_lists() (+15 more)

### Community 73 - "Community 73"
Cohesion: 0.16
Nodes (22): _row_to_prefs(), _fetch_openmeteo_current(), _fetch_openmeteo_forecast(), _fetch_owm_current(), _fetch_owm_forecast(), _get_current(), get_current_weather(), get_default_location() (+14 more)
...
Cohesion: 0.1
Nodes (17): get_airplay_output(), AirPlay Output Target =====================  Implementation of OutputTarget for, Get the singleton AirPlay output instance., is_initialized(), output_type(), Chromecast Output Target ========================  Implementation of OutputTarge, get_homeassistant_output(), Home Assistant Output Target ============================  Implementation of Out (+9 more)
...
Cohesion: 0.11
Nodes (20): get_auth_manager(), Get the singleton auth manager instance., Check if user is authenticated with Apple Music., Get developer token for MusicKit JS authentication.                  Apple Music, Complete auth with Music User Token from MusicKit JS.                  The auth_, Disconnect user from Apple Music., Generate or return cached developer token., complete_auth() (+12 more)

### Community 87 - "Community 87"
Cohesion: 0.11
Nodes (20): Get all discovered AirPlay devices, Get all discovered Chromecast devices, AirPlayOutput, Discover available AirPlay devices., Refresh the device list., AirPlay implementation of OutputTarget.          Discovers and controls AirPlay, Disconnect from all devices., DeviceInfo (+12 more)

### Community 88 - "Community 88"
Cohesion: 0.16
Nodes (20): create_people_field(), create_person(), delete_person(), get_person(), list_people(), list_people_fields(), _load_custom_fields(), People/contacts API router. (+12 more)

### Community 89 - "Community 89"
Cohesion: 0.1
Nodes (16): Proactive adapters — thin wrappers that translate external service events into T, get_capabilities(), Music Service Module ====================  Platform-aware music system with: - Y, Get music system capabilities for this platform.          Returns:         Dict, Music Output Targets Package ============================  Unified interface for, Zoe Proactive Engine — public surface., Music Providers Package =======================  Unified interface for music str, get_pending_notifications() (+8 more)

### Community 90 - "Community 90"
Cohesion: 0.13
Nodes (19): get_db(), create_background_task(), get_pending_tasks(), Queue a long-running task for background execution.      Body: {"message": "find, Return completed background tasks not yet shown to the user., _broadcast_calendar_chat_prefill_ui(), _broadcast_shopping_chat_ui(), _broadcast_weather_ui() (+11 more)

### Community 91 - "Community 91"
Cohesion: 0.11
Nodes (19): Register a Tier 2 slow-loop trigger., register_trigger(), load_device_tokens(), Load all active device tokens from DB into the in-memory cache (call at startup), _blocking_synthesize(), _load_pipeline(), _pcm_to_wav(), Convert a torch.FloatTensor of PCM samples to WAV bytes.      Uses struct.pack i (+11 more)
...
Cohesion: 0.12
Nodes (14): Execute a single test query and measure performance, test_query(), Run comprehensive test of the intelligent system, Test microservice-specific endpoints, Run all tests and return comprehensive results, Test all service health endpoints, Run comprehensive tests for all core components, Calculate overall system health metrics (+6 more)
...
Cohesion: 0.13
Nodes (16): ProactiveTrigger, check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe, TriggerResult, OpenClawTrigger, Tier 2 trigger: slow-loop OpenClaw-powered checks.  Subclass this to implement e, Base for triggers that delegate their check logic to an OpenClaw agent call. (+8 more)
...
Cohesion: 0.13
Nodes (11): RootCleaner, BrowserActionPlan, BrowserBackendCapabilities, BrowserEvidence, build_openclaw_gateway_executor(), create_default_browser_broker(), Browser broker for Zoe multi-surface browser orchestration.  This module is inte, Provide side-by-side backend summary and current recommendation. (+3 more)

### Community 99 - "Community 99"
Cohesion: 0.12
Nodes (17): chat_capabilities(), chat_inject_background(), Fire-and-forget: inject a summary into the correct user's OpenClaw session., OpenClaw message context prefix (zoe-auth role → agent)., test_context_prefix_includes_user_role_and_name(), test_context_prefix_unknown_role_when_omitted(), chat_inject(), discover_openclaw_capabilities() (+9 more)
...
Cohesion: 0.16
Nodes (17): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+9 more)

### Community 105 - "Community 105"
Cohesion: 0.15
Nodes (17): _cleanup_expired_pending(), fire_notification(), _is_in_quiet_hours(), Proactive Engine — coordinates all trigger tiers.  Tier 1: APScheduler fires _fi, Internal: import push router and call send_push_to_user., Tier 2 loop: poll registered triggers every SLOW_LOOP_INTERVAL seconds., Periodically prune expired, unclaimed proactive_pending rows., Swallow APScheduler's double-shutdown error that occurs on rapid restarts. (+9 more)

### Community 106 - "Community 106"
Cohesion: 0.11
Nodes (9): test_conversation(), Test if Zoe knows the user's name, Test if Zoe can recall stored facts, Test if new facts are extracted and stored, Test natural language calendar additions (Andrew's issue), Create a demo user with comprehensive profile, Test adding items to lists via natural language, Test if Zoe remembers earlier in the conversation (+1 more)
...
Cohesion: 0.19
Nodes (13): Output Target Base Class ========================  Abstract base class for all a, Apple Music Provider ====================  Integration with Apple Music using th, AuthStatus, display_name(), ProviderType, Music Provider Base Class =========================  Abstract base class for all, Supported music provider types., Provider authentication status. (+5 more)
...
Cohesion: 0.17
Nodes (16): Test that pattern extraction is fast enough for nightly jobs, Each extraction pattern must fire on its canonical example., Questions must not be extracted as memory facts., test_pattern_extraction(), test_question_not_extracted(), _clean(), extract_and_ingest(), extract_candidates() (+8 more)
...
Cohesion: 0.17
Nodes (16): Exception, _enqueue_panel_tool(), _execute_tool(), _get_weather_default_location(), handle_tool(), _MissingUserId, _notify_ui(), MCP Server for zoe-data. Exposes family data tools that OpenClaw skills can call (+8 more)
...
Cohesion: 0.12
Nodes (11): check_home_directory(), get_category(), Determine where a file should go, Check /home/pi for violations, check_chat_router_intelligence(), Validate chat router uses intelligent systems, check_database(), Send a message to the API and return the response (+3 more)
...
Cohesion: 0.12
Nodes (16): _broadcast_calendar_ui(), _broadcast_list_ui(), _broadcast_reminder_ui(), _contains_decision_keyword(), _get_or_create_voice_session(), Receive a transcribed voice command from the Pi daemon (after wake word + STT)., Return the existing session_id for this panel, or create a new one., Mirror calendar intents on voice path with durable delivery. (+8 more)

### Community 126 - "Community 126"
Cohesion: 0.17
Nodes (13): AccessContext, Role-Based Access Control Manager, Create a custom role                  Args:             role_id: Unique role ide, Context for permission checks, Validate permission strings, return list of invalid ones, Initialize default permission definitions, RBACManager, Current-contract RBAC behavior tests. (+5 more)

### Community 127 - "Community 127"
Cohesion: 0.12
Nodes (13): Test required directories exist, Test model manager CLI, Test if Unsloth is installed, Test that all required modules can be imported, Test that API endpoints are accessible, Test training database is set up correctly, test_database(), test_directories() (+5 more)
...
Cohesion: 0.2
Nodes (10): ComponentTestResult, Test LiteLLM performance metrics, Test LightRAG contextual vector memory, Test LightRAG memory management capabilities, Test Mem Agent specialized experts, Comprehensive testing of all Zoe core components, Test MCP Server tool interface and orchestration, Test MCP Server tool execution (+2 more)
...
Cohesion: 0.13
Nodes (14): _fire_memory_capture must write facts to the correct user's wing., Writing same fact twice via _background_memory_save should not create duplicates, test_background_dedup(), test_fire_memory_capture_user_scoped(), prometheus_metrics(), Prometheus scrape endpoint.      Exposes counters/gauges from `memory_metrics.RE, Prometheus metrics for Zoe memory + self-learning.  Exposed via `/metrics` on th, Best-effort refresh of per-user MemPalace size gauge.      Called by the `/metri (+6 more)
...
Cohesion: 0.2
Nodes (9): Execute comprehensive test suite, Test RouteLLM classification, Test Enhanced MemAgent, Test RAG enhancements, Test full chat API endpoint with authentication, Get JWT token from zoe-auth service for authenticated requests, SystemTester, Run the complete test suite (+1 more)
...
Cohesion: 0.19
Nodes (10): Test a natural language prompt, Send a chat message and get response, send_chat_message(), test_prompt(), Comprehensive Test Suite for Zoe Performance Optimization Tests 100+ natural lan, Get or create a test session, Test a single prompt and measure performance, ZoeTester (+2 more)

### Community 144 - "Community 144"
Cohesion: 0.18
Nodes (10): generate(), Generate the best icebreaker line for a match pair., get_enabled_modules(), ComposeGenerator, Write the generated compose file., Generate docker-compose.modules.yml from enabled modules., Load modules configuration., Load a module's docker-compose.module.yml file. (+2 more)

### Community 145 - "Community 145"
Cohesion: 0.19
Nodes (9): generate_recommendations(), PromptTestResult, PromptTestSuite, Real-world prompt testing for Zoe capabilities, Execute a single prompt test, Analyze if response meets success criteria, Calculate score based on success analysis, Extract actions executed from response data (+1 more)
...
Cohesion: 0.18
Nodes (11): BaseHTTPMiddleware, createGame(), roundConfigs, WSMessage, NoCacheStaticMiddleware, CreateGameRequest, GameConfig, GamePhase (+3 more)

### Community 151 - "Community 151"
Cohesion: 0.17
Nodes (9): _check_memory_headroom(), Check if enough memory is available for ML components., Initialize ML components if available., Set audio quality based on platform capabilities., detect_hardware(), get_platform_capabilities(), Platform detection for music module. Provides hardware detection independent of, Detect hardware platform.          Returns:         str: Platform identifier ('j (+1 more)

### Community 152 - "Community 152"
Cohesion: 0.15
Nodes (4): Unit tests for the Pi Agent skills classifier and tool builder.  Tests _select_s, _llm_call must accept tool_choice kwarg defaulting to 'auto'., TestBuildPrompt, TestLlmCallSignature

### Community 153 - "Community 153"
Cohesion: 0.15
Nodes (8): check_permission(), Check if current user has specific permission          Args:         permission:, Check if user has specific permission                  Args:             user_id, Check multiple permissions at once                  Args:             user_id: U, Check if any wildcard permissions grant access, Check resource-specific permissions, Check conditional permissions based on context, Check if current time satisfies constraints
...
Cohesion: 0.17
Nodes (9): Health check endpoint.          Returns service health and Agent Zero availabili, health(), api_health_check(), metrics(), Zoe Core Service - Enhanced Main Application with Enhancement Systems ==========, API health check endpoint (for frontend compatibility), Prometheus metrics endpoint, health_check() (+1 more)

### Community 161 - "Community 161"
Cohesion: 0.18
Nodes (11): Ensure audio features table exists., Initialize music auth table., Ensure embeddings table exists., Ensure music_events table exists., Initialize music playback tables., init_db(), migrate_db(), Module-local SQLite database for Orbit. (+3 more)

### Community 162 - "Community 162"
Cohesion: 0.24
Nodes (10): save_message(), test_assistant_prefix_stripped(), test_code_block_not_in_title(), test_derive_strips_markdown(), test_derive_truncates_words(), test_weak_titles(), derive_session_title(), Derive short, human-readable chat session titles from message content. (+2 more)

### Community 163 - "Community 163"
Cohesion: 0.17
Nodes (9): AuthValidationResult, Verify user password                  Args:             user_id: User identifier, Result of authentication validation, Check if password change is required due to age, Log authentication attempt - non-blocking, errors suppressed, Verify credentials based on auth method, Verify password authentication, Verify API key authentication (+1 more)
...
Cohesion: 0.2
Nodes (9): Print test results summary, print_summary(), Print completion summary, Run a conversation and display full Q&A, run_conversation_test(), Print benchmark summary, ConversationTester, Check if response meets expectations (+1 more)
...
Cohesion: 0.29
Nodes (11): Agent Zero Intent Patterns, Agent Zero Module for Zoe README, Agent Zero Research Skill, Agent Zero Comparison Skill, Agent Zero Planning Skill, Agent Zero Deep Research Skill, Agent Zero + Zoe Integration Summary, Agent Zero Integration Test Results (+3 more)

### Community 182 - "Community 182"
Cohesion: 0.25
Nodes (11): Building Zoe Modules - Developer Guide, MCP-Only Architecture for Zoe Modules, Music Module Migration Guide, Module Intent Auto-Discovery System, Zoe Module Requirements - MANDATORY, Music Module Dependency Audit, Music Module Execution Plan, Music Routing Options (+3 more)
...
Cohesion: 0.24
Nodes (9): Shut down APScheduler and the slow loop., stop_proactive_engine(), cancel_job(), get_scheduler(), APScheduler wrapper (Tier 1 — precision scheduling).  Uses SQLite job store so j, Schedule func(**kwargs) at run_at (UTC datetime). Returns job_id., Cancel a scheduled job. Returns True if found and removed., register_job() (+1 more)

### Community 188 - "Community 188"
Cohesion: 0.2
Nodes (10): create_schedule(), delete_schedule(), Schedule a one-shot proactive nudge., Cancel a scheduled nudge., cancel_reminder(), Insert a proactive_scheduled row and register an APScheduler job.     Returns th, Cancel a scheduled reminder by its proactive_scheduled.id., Snooze / reschedule a reminder. Returns True on success. (+2 more)
...
Cohesion: 0.2
Nodes (4): headers(), Real Conversation Quality Tests Tests actual multi-message conversations with co, Test real conversations with context retention and usefulness, Test response quality metrics
...
Cohesion: 0.29
Nodes (3): docs/GOVERNANCE_IMPLEMENTATION_COMPLETE.md, docs/IMPLEMENTATION_SUMMARY_V2.4.0.md, docs/RESTORATION_ANALYSIS.md
...
Cohesion: 0.28
Nodes (7): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, PermissionResult, Role-Based Access Control (RBAC) System Advanced permission management with inhe, Permission check results, Enum

### Community 202 - "Community 202"
Cohesion: 0.22
Nodes (5): IntelligentSystemTester, Test manual model adaptation, Test the intelligent model management system, Test the enhanced chat endpoint, Test the performance monitoring endpoints
...
Cohesion: 0.32
Nodes (5): _get_vapid_keys(), get_vapid_public_key(), Web Push Notifications via VAPID. Generates VAPID keys on first run, stores subs, Send a push notification to all of a user's subscriptions.      ``message`` is a, send_push_to_user()

### Community 208 - "Community 208"
Cohesion: 0.25
Nodes (8): _compute_resemblyzer_embedding(), _cosine_similarity(), Compute a 256-dim resemblyzer voice embedding from a WAV file.      Returns raw, Cosine similarity between two float32 byte blobs., Enroll a speaker voice profile using a WAV audio sample.      Request: { "audio_, Identify speaker from a WAV audio sample by comparing to enrolled profiles., voice_enroll(), voice_identify()
...
Cohesion: 0.29
Nodes (4): Search for k most similar tracks.                  Args:             query: 256-, Search with similarity scores.                  Args:             query: 256-dim, Search YouTube Music.                  Search works without authentication using, Return mock results when not authenticated.

### Community 215 - "Community 215"
Cohesion: 0.29
Nodes (6): claim_pending_endpoint(), list_schedules(), Proactive Engine REST router.  Endpoints:   POST   /api/proactive/schedule, List pending scheduled nudges for the calling user., Claim a pending proactive notification (called when user taps push).     Creates, ScheduleRequest
...
Cohesion: 0.29
Nodes (7): Zoe Code Execution Service, Context Optimization, Expert Orchestrator, Enhanced MEM Agent Client, RAG Enhancements, Chat Router, Vector Search

### Community 224 - "Community 224"
Cohesion: 0.33
Nodes (5): claim_pending(), create_pending(), Helpers for deferred / lazy session creation for proactive notifications.  When, Insert a proactive_pending row and return its id.     The push notification's de, Mark a pending notification as claimed and create a chat session seeded     with

### Community 225 - "Community 225"
Cohesion: 0.33
Nodes (3): _PI_SOUL_STATIC must not contain any day/time strings (KV cache stability)., Every tool in _TOOLS must appear in either _SKILL_TOOLS or _ALWAYS_ON_TOOLS., TestStablePrompt

### Community 226 - "Community 226"
Cohesion: 0.33
Nodes (5): Enhanced Session Management for Multi-Factor Authentication Supports different s, Configuration for different session types, Security policies for session management, SessionConfig, SessionSecurityPolicy
...
Cohesion: 0.53
Nodes (5): zoe-core service in docker-compose.jetson.yml, zoe-litellm service in docker-compose.jetson.yml, zoe-llamacpp service in docker-compose.jetson.yml, zoe-mcp-server service in docker-compose.jetson.yml, zoe-tts service in docker-compose.jetson.yml

### Community 234 - "Community 234"
Cohesion: 0.33
Nodes (6): Chat Router Integration, HassIL Classifier, Intent Executor, Intent Patterns, Intent System, Lists Handlers
...
Cohesion: 0.4
Nodes (4): youtube(), get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us, Get the singleton YouTube Music provider instance.

### Community 237 - "Community 237"
Cohesion: 0.4
Nodes (5): Should not crash with empty username., test_pi_soul_contains_datetime(), test_pi_soul_empty_user(), _pi_soul(), Build the Pi Agent system prompt with live datetime and user identity stamped in
...
Cohesion: 0.67
Nodes (4): Commit Message Validation, Critical Files Validation, File Deletion Protection, Project Structure Validation

### Community 255 - "Community 255"
Cohesion: 0.67
Nodes (4): LLM Knowledge of Tools and Experts, Code Execution Pattern, Code Execution Pattern vs Direct Tool Calls, Direct Tool Calls Pattern

### Community 256 - "Community 256"
Cohesion: 0.5
Nodes (4): gemma2:9b Model, gemma3:27b Model, gemma3n:e2b Model, gemma3n:e4b Model

### Community 257 - "Community 257"
Cohesion: 0.5
Nodes (4): list_items Table, Lists Database Schema Fix, lists Table, Migration Script for Lists Items

### Community 269 - "Community 269"
Cohesion: 0.67
Nodes (3): journal.js Widget, Quick Journal Widget Guide, Journal Widget Implementation Summary

### Community 270 - "Community 270"
Cohesion: 0.67
Nodes (3): llama3.2:3b Model, phi3:mini Model, qwen2.5:7b Model

### Community 271 - "Community 271"
Cohesion: 0.67
Nodes (3): Zoe Orb Chat API Endpoint, Intelligence WebSocket (Not Implemented), Zoe Orb Component

### Community 272 - "Community 272"
Cohesion: 1.0
Nodes (3): Agent Zero System, Moltbot System, Zoe Core System

### Community 273 - "Community 273"
Cohesion: 1.0
Nodes (3): Chat Page Frontend (chat.html), Chat Backend Router, Chat SSL Certificate Fix
...
## Knowledge Gaps
- **2193 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2188 more)
...
- **Why does `init()` connect `Community 52` to `Community 0`, `Community 4`, `Community 5`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 21`, `Community 27`, `Community 28`, `Community 29`, `Community 33`, `Community 34`, `Community 37`, `Community 38`, `Community 39`, `Community 41`, `Community 42`, `Community 45`, `Community 46`, `Community 48`, `Community 49`, `Community 50`, `Community 57`, `Community 60`, `Community 61`, `Community 62`, `Community 63`, `Community 65`, `Community 66`, `Community 69`, `Community 74`, `Community 77`, `Community 80`, `Community 82`, `Community 85`, `Community 86`, `Community 87`, `Community 93`, `Community 94`, `Community 95`, `Community 97`, `Community 98`, `Community 102`, `Community 103`, `Community 106`, `Community 107`, `Community 109`, `Community 110`, `Community 111`, `Community 112`, `Community 113`, `Community 115`, `Community 119`, `Community 121`, `Community 123`, `Community 124`, `Community 126`, `Community 127`, `Community 128`, `Community 130`, `Community 132`, `Community 137`, `Community 138`, `Community 139`, `Community 140`, `Community 141`, `Community 142`, `Community 143`, `Community 144`, `Community 145`, `Community 148`, `Community 150`, `Community 151`, `Community 154`, `Community 161`, `Community 165`, `Community 170`, `Community 172`, `Community 173`, `Community 177`, `Community 194`, `Community 195`, `Community 200`, `Community 201`, `Community 202`, `Community 210`, `Community 235`, `Community 244`?**
  _High betweenness centrality (0.408) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 0` to `Community 128`, `Community 130`, `Community 10`, `Community 140`, `Community 141`, `Community 142`, `Community 143`, `Community 144`, `Community 145`, `Community 20`, `Community 154`, `Community 27`, `Community 156`, `Community 157`, `Community 26`, `Community 155`, `Community 164`, `Community 37`, `Community 165`, `Community 38`, `Community 42`, `Community 47`, `Community 177`, `Community 178`, `Community 51`, `Community 194`, `Community 202`, `Community 75`, `Community 74`, `Community 80`, `Community 211`, `Community 92`, `Community 93`, `Community 95`, `Community 228`, `Community 103`, `Community 104`, `Community 107`, `Community 111`, `Community 240`, `Community 120`, `Community 121`, `Community 125`, `Community 127`?**
  _High betweenness centrality (0.164) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 42` to `Community 0`, `Community 132`, `Community 133`, `Community 6`, `Community 13`, `Community 14`, `Community 142`, `Community 144`, `Community 16`, `Community 20`, `Community 148`, `Community 27`, `Community 30`, `Community 38`, `Community 44`, `Community 172`, `Community 48`, `Community 49`, `Community 176`, `Community 52`, `Community 180`, `Community 185`, `Community 189`, `Community 195`, `Community 79`, `Community 80`, `Community 87`, `Community 92`, `Community 93`, `Community 95`, `Community 228`, `Community 102`, `Community 118`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Are the 72 inferred relationships involving `require_feature_access()` (e.g. with `create_reminder()` and `list_reminders()`) actually correct?**
  _`require_feature_access()` has 72 INFERRED edges - model-reasoned connections that need verification._
- **Are the 57 inferred relationships involving `list()` (e.g. with `get_matches()` and `_compute_compatibility()`) actually correct?**
  _`list()` has 57 INFERRED edges - model-reasoned connections that need verification._
