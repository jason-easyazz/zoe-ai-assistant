...
## Summary
- 5277 nodes · 8634 edges · 466 communities (253 shown, 213 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 608 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6329837b`
...
- `File Deletion Protection` --conceptually_related_to--> `Junk File Pattern Detection`  [INFERRED]
  tools/audit/validate_before_delete.py → docs/governance/ENHANCED_ENFORCEMENT.md
- `Junk File Pattern Detection` --conceptually_related_to--> `Database Path Enforcement`  [INFERRED]
  docs/governance/ENHANCED_ENFORCEMENT.md → tools/audit/check_database_paths.py
- `CHANGELOG Validation` --conceptually_related_to--> `Large File Detection`  [INFERRED]
  tools/audit/validate_changelog.py → docs/governance/ENHANCED_ENFORCEMENT.md
...
Cohesion: 0.04
Nodes (105): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, Get track metadata from cache., Get or create a YTMusic client for a user.                  Args:             us, Check if user has valid YouTube Music authentication., Normalize a YouTube Music item to standard format., Get the stream URL for a track.                  Uses caching to avoid repeated, Get video stream URL for a track (for video playback).                  YouTube (+97 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (56): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker. (+48 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (66): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, fix_router_file(), Fix a single router file's database paths, Fix all routers in the routers directory, Main cleanup function. (+58 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (84): Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100)., Get device info from database. (+76 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (58): AnalyzeRequest, browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., Request model for analysis endpoint., startup_event(), AutomationTriggerRequest, DeviceControlRequest (+50 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (67): DESIRE_LABELS, getMyCheckinId(), goDiscover(), INTENT_LABELS, load(), loadQuiz(), params, pathParts (+59 more)
...
Cohesion: 0.05
Nodes (53): AgentPlanner, MemAgentClient, Model Config, Chat Router, Warmup Models Script, Zoe Code Execution Service, gemma3n:e2b Model, Context Optimization (+45 more)
...
Cohesion: 0.05
Nodes (20): Unit tests for the Pi Agent skills classifier and tool builder.  Tests _select_s, When only memory is selected, ha_control should not be included., Selecting all skills should produce the full _TOOLS list., A typical single-skill query should load far fewer tools than the full set., _PI_SOUL_STATIC must not contain any day/time strings (KV cache stability)., Every tool in _TOOLS must appear in either _SKILL_TOOLS or _ALWAYS_ON_TOOLS., _llm_call must accept tool_choice kwarg defaulting to 'auto'., Verify the inputs to the _first_turn_choice expression are correct.      We can' (+12 more)
...
Cohesion: 0.05
Nodes (32): Ensure audio features table exists., MusicAuthManager, Store encrypted authentication credentials.                  Args:             u, Retrieve and decrypt authentication credentials.                  Args:, Get the refresh token for a provider., Manages encrypted authentication credentials for music providers.          Suppo, Delete authentication credentials.                  Args:             user_id: U, Check authentication status for a provider.                  Returns: (+24 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (48): Override to customise the prompt per-check., _bash(), _build_memory_context(), _build_prompt(), _build_tools(), _chat_capability_shortcut(), _check_fast_response(), _dispatch_tool() (+40 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (31): Get detailed status of Agent Zero service.          Returns:         Status info, status(), check_api_endpoints(), check_router_expectations(), check_ui_pages(), Check database table schemas, Check what routers expect vs what database has, Test critical API endpoints (+23 more)
...
Cohesion: 0.08
Nodes (32): ABC, Enum, AirPlay Output Target =====================  Implementation of OutputTarget for, is_initialized(), output_type(), OutputState, OutputType, Output Target Base Class ========================  Abstract base class for all a (+24 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (38): print_results(), Scan entire project and categorize all files., Check if path should be ignored., Categorize a file and determine if it's in the right location.          Returns:, scan_project(), should_ignore(), check_for_dangerous_patterns(), Print validation results.          Returns:         Exit code (0 if all files ex (+30 more)
...
Cohesion: 0.12
Nodes (39): $(), addTeamToLobby(), buildTeamStatusRow(), clearSession(), clearTimers(), deckNamesForConfig(), displayRevealedCard(), enterGameOver() (+31 more)
...
Cohesion: 0.1
Nodes (34): showScreen(), attemptReconnect(), closeAndReconnect(), dom, esc(), formatCardText(), isLightColor(), joinGame() (+26 more)
...
Cohesion: 0.09
Nodes (22): Get all active sessions for a specific user (admin only)          Args:, get_user_sessions(), Get all active sessions for current user          Args:         current_session:, Invalidate a specific session (user can only invalidate their own sessions), EnhancedSessionManager, Enhanced session manager with multi-factor support, Authenticate user and create session                  Args:             request:, Invalidate specific session (+14 more)
...
Cohesion: 0.08
Nodes (25): AgentZeroClient, _compute_agent_zero_api_key(), Agent Zero Client =================  Client for communicating with Agent Zero's, Get or create context ID for a user.                  Args:             user_id:, Extract URLs from text as sources.                  Args:             text: Text, Send a message to Agent Zero and get response.                  Uses the /api_me, Execute a research task via Agent Zero.                  Args:             query, Create a multi-step plan for a task.                  Args:             task: Ta (+17 more)
...
Cohesion: 0.07
Nodes (19): Test P0-3: Validate temperature appropriateness, Test that temperature ranges are appropriate for intent types, Test that temperature adjusts based on context availability, Test P0-1: Measure actual latency improvements, Measure latency improvement for Tier 0 intents, Ensure data-fetching intents get context (no regression), Test memory keyword detection accuracy, TestP01ContextValidationImprovements (+11 more)

### Community 45 - "Community 45"
Cohesion: 0.08
Nodes (29): startChallenge(), parse_json_fields(), get_connection_icebreaker(), Orbit icebreaker engine — rule cascade, strongest signal wins., Shorter icebreaker for the QR scan connect page., _auto_end_challenge(), create_connection(), create_session() (+21 more)
...
Cohesion: 0.1
Nodes (18): generate_report(), Generate audit report, Generate final audit report, Generate comprehensive audit report, ProjectCleaner, Find outdated/redundant documentation, Find Mac OS resource fork files, Find archive folders that can be removed (+10 more)
...
Cohesion: 0.15
Nodes (10): Get a specific provider by type.                  Args:             provider_typ, Return Atomic semantic hits as normalized records., MemoryRef, MemoryService - the sole read/write surface for Zoe memory.  This module is the, The sole read/write surface for Zoe memory., List rows for a user by status, newest first., Soft-delete the most recently ingested memory for a user., Soft-archive low-score approved memories. (+2 more)

### Community 56 - "Community 56"
Cohesion: 0.08
Nodes (15): CompareRequest, Request model for comparison endpoint., Check if file path is within allowed directories.                  Args:, Check if system command is whitelisted.                  Args:             comma, Get user-friendly message when capability is blocked.                  Args:, Safety guardrails for Agent Zero capabilities.          Controls what Agent Zero, Allow research/web search operations., Allow task planning operations. (+7 more)
...
Cohesion: 0.1
Nodes (25): get_db(), _broadcast_calendar_chat_prefill_ui(), _broadcast_calendar_ui(), _broadcast_list_ui(), _broadcast_reminder_ui(), _broadcast_shopping_chat_ui(), _broadcast_weather_ui(), _contains_decision_keyword() (+17 more)

### Community 65 - "Community 65"
Cohesion: 0.13
Nodes (21): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+13 more)
...
Cohesion: 0.09
Nodes (22): Shut down APScheduler and the slow loop., Register a Tier 2 slow-loop trigger., register_trigger(), stop_proactive_engine(), stop_scheduler(), load_device_tokens(), Load all active device tokens from DB into the in-memory cache (call at startup), _blocking_synthesize() (+14 more)
...
Cohesion: 0.11
Nodes (21): activate_scene(), analyze_home_assistant(), control_device(), get_automations(), get_scenes(), get_scripts(), get_services(), get_switches() (+13 more)
...
Cohesion: 0.09
Nodes (18): Proactive adapters — thin wrappers that translate external service events into T, get_capabilities(), Music Service Module ====================  Platform-aware music system with: - Y, Get music system capabilities for this platform.          Returns:         Dict, More Overlay Modal, Navigation Bar, Music Output Targets Package ============================  Unified interface for, Zoe Proactive Engine — public surface. (+10 more)
...
Cohesion: 0.11
Nodes (15): Check for overly large router files, Check for hardcoded command detection patterns, Check for duplicate router patterns, Check main.py for excessive imports, Check for TODO/FIXME/HACK comments, Authentication Security Check, CHANGELOG Validation, Commit Message Validation (+7 more)

### Community 85 - "Community 85"
Cohesion: 0.1
Nodes (18): Initialize Agent Zero client.                  Args:             base_url: Base, Initialize safety guardrails.                  Args:             mode: Safety mo, Load active sessions from database on startup, init(), Initialize the affinity engine.                  Args:             half_life_day, Initialize the AirPlay service, Initialize the audio analyzer with Essentia., Initialize the auth manager.                  Args:             encryption_key: (+10 more)

### Community 86 - "Community 86"
Cohesion: 0.1
Nodes (19): get_auth_manager(), Get the singleton auth manager instance., get_media_controller(), Get the singleton media controller instance., get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us, Get the singleton YouTube Music provider instance., Get developer token for MusicKit JS authentication.                  Apple Music (+11 more)
...
Cohesion: 0.16
Nodes (14): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _build_metadata(), _idempotency_key(), MemoryServiceError, Raised for operational failures., Store a fact. Returns None when silently dropped., Right-to-be-forgotten. Returns number of rows removed. (+6 more)

### Community 89 - "Community 89"
Cohesion: 0.13
Nodes (17): check(), What a trigger wants to send., TriggerResult, OpenClawTrigger, Tier 2 trigger: slow-loop OpenClaw-powered checks.  Subclass this to implement e, Base for triggers that delegate their check logic to an OpenClaw agent call., Post a task to OpenClaw and return the parsed JSON response dict,         or Non, Override in subclasses.  Return TriggerResult objects to fire,         or an emp (+9 more)
...
Cohesion: 0.15
Nodes (12): LLMBenchmark, Analyze response quality based on prompt type and expected behavior, Benchmark all models with all test prompts, Test a single model with a single prompt, BenchmarkResult, ModelBenchmark, Analyze if the model correctly used tools, Analyze response quality on 1-10 scale (+4 more)

### Community 95 - "Community 95"
Cohesion: 0.16
Nodes (12): ComponentTestResult, generate_recommendations(), Test LiteLLM performance metrics, Test LightRAG contextual vector memory, Test LightRAG memory management capabilities, Test Mem Agent specialized experts, Comprehensive testing of all Zoe core components, Test MCP Server tool interface and orchestration (+4 more)
...
Cohesion: 0.11
Nodes (13): Feature Improvement Testing Test each feature individually, measure impact, vali, Test P0-4: Validate grounding detection, Test P1-1: Validate behavioral pattern extraction, Test that all pattern types can be extracted, Test safeguards and error handling, Verify all features are disabled by default (safety), Test that features fail gracefully when disabled, Test that platform configs are valid (+5 more)
...
Cohesion: 0.11
Nodes (5): Comprehensive Test Suite for Session Management System Tests all session managem, Comprehensive test suite for Light RAG Memory System Tests all functionality inc, temp_db(), client(), Voice /transcribe endpoint: auth gate and whisper stub.
...
Cohesion: 0.13
Nodes (10): _get_vapid_keys(), get_vapid_public_key(), Web Push Notifications via VAPID. Generates VAPID keys on first run, stores subs, Send a push notification to all of a user's subscriptions.      ``message`` is a, send_push_to_user(), PushBroadcaster, Client reconnection catch-up. For now, just send current sequence., WebSocket push broadcaster for real-time UI updates.      Clients subscribe to a (+2 more)
...
Cohesion: 0.12
Nodes (14): AuthValidationResult, PasswordPolicy, Verify user password                  Args:             user_id: User identifier, Password security policy, Result of authentication validation, Check if password change is required due to age, Log authentication attempt - non-blocking, errors suppressed, PasscodePolicy (+6 more)
...
Cohesion: 0.17
Nodes (10): BrowserActionPlan, BrowserBackendCapabilities, BrowserEvidence, build_openclaw_gateway_executor(), create_default_browser_broker(), Browser broker for Zoe multi-surface browser orchestration.  This module is inte, Provide side-by-side backend summary and current recommendation., Create an OpenClaw browser executor backed by gateway HTTP endpoints. (+2 more)
...
Cohesion: 0.23
Nodes (14): ack_ui_action(), bind_panel(), create_ui_action(), get_action_ledger(), get_pending_ui_actions(), get_session_context(), requeue_stale_actions(), retry_ui_action() (+6 more)
...
Cohesion: 0.16
Nodes (12): Execute a single test query and measure performance, test_query(), Run comprehensive test of the intelligent system, Run all tests and return comprehensive results, Run comprehensive tests for all core components, Calculate overall system health metrics, Test quality metrics collection, Test memory agent integration (+4 more)

### Community 125 - "Community 125"
Cohesion: 0.14
Nodes (7): Test cases for session middleware, Test that middleware skips excluded paths, Run all session management tests, run_session_tests(), TestSessionMiddleware, In-memory session state and WebSocket fan-out for Orbit., Send a message to all players in a session.
...
Cohesion: 0.15
Nodes (10): Check a single router file for authentication issues.     Returns list of (line_, check_file(), Check a single file for hardcoded database paths, Audit a directory against rules, Check a single file against rules, find_references(), load_critical_files(), Load critical files manifest (+2 more)

### Community 139 - "Community 139"
Cohesion: 0.14
Nodes (12): Test required directories exist, Test model manager CLI, Test if Unsloth is installed, Test that all required modules can be imported, Test that API endpoints are accessible, Test training database is set up correctly, test_database(), test_directories() (+4 more)
...
Cohesion: 0.15
Nodes (12): get_entities(), get_entity(), get_lights(), get_sensors(), Get all entities from Home Assistant with optional filtering, Get specific entity state from Home Assistant, Get all lights from Home Assistant, Get all sensors from Home Assistant (+4 more)

### Community 145 - "Community 145"
Cohesion: 0.18
Nodes (12): get_plugins(), Remove a workspace skill by deleting its directory., Return all plugins (installed + available) for the openclaw_manager component., remove_skill_endpoint(), _build_openclaw_env(), _installed_plugins_from_config(), list_plugins(), openclaw_manager.py — OpenClaw plugin and skill management interface.  Wraps `op (+4 more)
...
Cohesion: 0.15
Nodes (9): escalate_session(), Refresh current session expiration          Args:         current_session: Curre, Escalate passcode session to full session with password verification          Ar, refresh_session(), Refresh session expiration, Create temporary guest session, Save session to database, Log successful session escalation (+1 more)
...
Cohesion: 0.23
Nodes (11): routers/openclaw.py — REST API for OpenClaw plugin and skill management.  Endpoi, Call Telegram Bot API to verify the token and return bot info., Write the bot token into openclaw.json and enable the Telegram channel., Attempt to restart the OpenClaw gateway service (best effort)., Validate a Telegram bot token, write it to openclaw.json, and restart the gatewa, Return Telegram connection status., _restart_openclaw_gateway(), _save_telegram_token() (+3 more)
...
Cohesion: 0.18
Nodes (9): get_config(), Enhanced Session Management for Multi-Factor Authentication Supports different s, Validate that session has permission with escalation handling                  A, Configuration for different session types, Security policies for session management, Get owner of resource for permission checks, requires_password_escalation(), SessionConfig (+1 more)

### Community 159 - "Community 159"
Cohesion: 0.21
Nodes (11): create_background_task(), get_pending_tasks(), Queue a long-running task for background execution.      Body: {"message": "find, Return completed background tasks not yet shown to the user., enqueue_background_task(), _ensure_table(), background_runner.py — Background task queue for Zoe.  Enables "fire and forget", Return completed-but-unseen tasks for a user, then mark them seen. (+3 more)
...
Cohesion: 0.2
Nodes (7): Search for k most similar tracks.                  Args:             query: 256-, Search with similarity scores.                  Args:             query: 256-dim, Search YouTube Music.                  Search works without authentication using, Return mock results when not authenticated., _luhn_valid(), Return (possibly-redacted-text, reject_reason_or_None)., scrub_pii()

### Community 177 - "Community 177"
Cohesion: 0.36
Nodes (9): _clean(), extract_and_ingest(), extract_candidates(), MemoryCandidate, _person_name_from_fragment(), Unified conversational memory extraction for Zoe.  This module turns user uttera, Extract candidates and ingest them via MemoryService.      Returns the number of, Extract memory candidates from a user turn. (+1 more)
...
Cohesion: 0.22
Nodes (9): Get index statistics., _broadcast_stats(), checkout(), _compute_stats(), create_checkin(), get_stats(), host_remove_user(), ws_host() (+1 more)

### Community 189 - "Community 189"
Cohesion: 0.22
Nodes (8): prometheus_metrics(), Prometheus scrape endpoint.      Exposes counters/gauges from `memory_metrics.RE, Prometheus metrics for Zoe memory + self-learning.  Exposed via `/metrics` on th, Best-effort refresh of per-user MemPalace size gauge.      Called by the `/metri, snapshot_collection_sizes(), get_memory_service(), _mempalace_search(), Semantic search of this user's MemPalace facts via MemoryService.      Returns t
...
Cohesion: 0.64
Nodes (8): Agent Zero Intent Patterns, Agent Zero Module for Zoe, Agent Zero Research Skill, Agent Zero Comparison Skill, Agent Zero Planning Skill, Agent Zero Deep Research Skill, Agent Zero + Zoe Integration Summary, Agent Zero Integration Test Results

### Community 203 - "Community 203"
Cohesion: 0.36
Nodes (7): Zoe Modular Architecture Complete, MCP Client, ModuleWidgetLoader, validate_module.py validation tool, WidgetRegistry, zoe_module.py CLI tool, Zoe Music Module
...
Cohesion: 0.33
Nodes (6): preview_skill_endpoint(), Read SKILL.md and run automated security scan. Returns content + security verdic, preview_skill(), Run automated security scan on SKILL.md text. Returns verdict + findings., Read a skill's SKILL.md and run an automated security scan.      Sources checked, _scan_skill_content()
...
Cohesion: 0.33
Nodes (3): Test microservice-specific endpoints, Test all service health endpoints, UIFunctionalityTester
...
Cohesion: 0.4
Nodes (6): zoe-litellm service in docker-compose.jetson.yml, zoe-mcp-server service in docker-compose.jetson.yml, zoe-tts service in docker-compose.jetson.yml, zoe-llamacpp service in docker-compose.pi.yml, zoe-whisper service in docker-compose.pi.yml, Hardware Compatibility Guide
...
Cohesion: 0.5
Nodes (3): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode

### Community 236 - "Community 236"
Cohesion: 0.5
Nodes (4): Search ClawHub registry. Returns offline:true gracefully when network unavailabl, search_skills(), Search ClawHub registry. Returns results or a graceful offline error., search_clawhub_skills()

### Community 237 - "Community 237"
Cohesion: 0.5
Nodes (4): _broadcast_intent_nav(), _intent_card_data(), Build show_card data payload from intent slots for Google Home-style card., Instantly broadcast panel_navigate + panel_open_form + show_card when intent is
...
Cohesion: 1.0
Nodes (3): install_plugin_endpoint(), Install an OpenClaw plugin., install_plugin()

### Community 246 - "Community 246"
Cohesion: 1.0
Nodes (3): Remove an OpenClaw plugin., remove_plugin_endpoint(), remove_plugin()

### Community 247 - "Community 247"
Cohesion: 1.0
Nodes (3): Update a workspace skill from ClawHub., update_skill_endpoint(), update_skill()
...
Cohesion: 0.67
Nodes (3): Database Protection Rules, zoe-ui service in docker-compose.yml, Zoe Project Structure & Governance Rules
...
## Knowledge Gaps
- **2211 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2206 more)
...
- **Why does `init()` connect `Community 85` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 7`, `Community 11`, `Community 13`, `Community 14`, `Community 24`, `Community 26`, `Community 28`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 38`, `Community 39`, `Community 41`, `Community 43`, `Community 44`, `Community 47`, `Community 49`, `Community 50`, `Community 53`, `Community 55`, `Community 56`, `Community 59`, `Community 60`, `Community 61`, `Community 68`, `Community 69`, `Community 71`, `Community 73`, `Community 76`, `Community 77`, `Community 84`, `Community 90`, `Community 93`, `Community 94`, `Community 95`, `Community 98`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 105`, `Community 106`, `Community 107`, `Community 109`, `Community 110`, `Community 111`, `Community 112`, `Community 114`, `Community 116`, `Community 117`, `Community 118`, `Community 119`, `Community 121`, `Community 123`, `Community 124`, `Community 125`, `Community 127`, `Community 133`, `Community 134`, `Community 135`, `Community 136`, `Community 137`, `Community 140`, `Community 141`, `Community 144`, `Community 148`, `Community 149`, `Community 160`, `Community 166`, `Community 170`, `Community 171`, `Community 174`, `Community 175`, `Community 185`, `Community 190`, `Community 196`, `Community 204`, `Community 205`, `Community 217`, `Community 224`, `Community 225`, `Community 234`, `Community 235`?**
  _High betweenness centrality (0.411) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 2` to `Community 1`, `Community 130`, `Community 136`, `Community 137`, `Community 138`, `Community 139`, `Community 140`, `Community 13`, `Community 17`, `Community 148`, `Community 149`, `Community 22`, `Community 151`, `Community 152`, `Community 150`, `Community 27`, `Community 160`, `Community 38`, `Community 39`, `Community 170`, `Community 171`, `Community 43`, `Community 48`, `Community 51`, `Community 53`, `Community 185`, `Community 190`, `Community 64`, `Community 65`, `Community 69`, `Community 198`, `Community 73`, `Community 203`, `Community 216`, `Community 217`, `Community 94`, `Community 95`, `Community 99`, `Community 101`, `Community 102`, `Community 114`, `Community 123`, `Community 124`?**
  _High betweenness centrality (0.165) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 13` to `Community 2`, `Community 3`, `Community 136`, `Community 267`, `Community 141`, `Community 14`, `Community 15`, `Community 18`, `Community 148`, `Community 22`, `Community 27`, `Community 28`, `Community 30`, `Community 39`, `Community 168`, `Community 169`, `Community 45`, `Community 46`, `Community 179`, `Community 53`, `Community 55`, `Community 184`, `Community 73`, `Community 74`, `Community 84`, `Community 85`, `Community 214`, `Community 216`, `Community 98`, `Community 233`, `Community 113`, `Community 124`, `Community 125`?**
