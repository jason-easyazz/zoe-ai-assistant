...
## Summary
- 7989 nodes · 14004 edges · 560 communities (347 shown, 213 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1868 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6300b71a`
...
7. `chat()` - 47 edges
8. `Zoe Evolution Harness Implementation Status` - 46 edges
...
- `Setup Verification Report` --references--> `RouteLLM (Intelligent Model Router)`  [INFERRED]
  docs/architecture/SETUP_VERIFICATION.md → services/zoe-core/route_llm.py
- `Extensibility Architecture` --conceptually_related_to--> `RouteLLM (Intelligent Model Router)`  [INFERRED]
  docs/architecture/EXTENSIBILITY.md → services/zoe-core/route_llm.py
...
## Communities (560 total, 213 thin omitted)
...
Cohesion: 0.03
Nodes (74): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker. (+66 more)
...
Cohesion: 0.04
Nodes (80): Send a chat message to Zoe, Send a chat message and validate response, _broadcast_intent_nav(), _build_hermes_payload(), _build_panel_intent_card(), _build_research_package(), _capture_research_screenshot(), chat() (+72 more)
...
Cohesion: 0.04
Nodes (76): _broadcast_weather_ui(), Mirror chat weather navigation on voice path with durable delivery., _should_supersede_voice_weather_action(), _FakeAdapter, A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., KanbanAdapter with the CLI replaced by a scripted recorder., _row(), test_dispatch_blocks_existing_pr_revision_when_precheckout_fails() (+68 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (66): Start discovering AirPlay devices, Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Get device info from database., Get current playback state for a zone (+58 more)
...
Cohesion: 0.07
Nodes (40): MULClient, list_projects(), close_stale_autopilot_wrappers(), _fire_autopilot_job(), get_autopilot_triggers(), get_multica_autopilots(), _headers(), _is_configured() (+32 more)
...
Cohesion: 0.05
Nodes (36): check_permission(), Check if current user has specific permission          Args:         permission:, AccessContext, PermissionResult, Role-Based Access Control (RBAC) System Advanced permission management with inhe, Role-Based Access Control Manager, Check if user has specific permission                  Args:             user_id, Check multiple permissions at once                  Args:             user_id: U (+28 more)
...
Cohesion: 0.06
Nodes (48): get_auth_manager(), Get the singleton auth manager instance., Normalize a YouTube Music item to standard format., AppleMusicProvider, Check if user is authenticated with Apple Music., Get developer token for MusicKit JS authentication.                  Apple Music, Complete auth with Music User Token from MusicKit JS.                  The auth_, Disconnect user from Apple Music. (+40 more)

### Community 24 - "Community 24"
Cohesion: 0.06
Nodes (32): Refresh current session expiration          Args:         current_session: Curre, refresh_session(), Verify passcode for user                  Args:             user_id: User identi, AuthenticationResult, EnhancedSessionManager, Enhanced Session Management for Multi-Factor Authentication Supports different s, Enhanced session manager with multi-factor support, Authenticate user and create session                  Args:             request: (+24 more)
...
Cohesion: 0.05
Nodes (47): get_current_user(), get_passcode_status(), get_user_profile(), guest_login(), InitialPasswordSetupRequest, LoginRequest, logout(), logout_all() (+39 more)
...
Cohesion: 0.07
Nodes (44): Exception, RuntimeError, _actionable_greptile_findings(), assess_merge_readiness(), _gh_unresolved_review_thread_count(), _greptile_confidence_from_github_comments(), Inline review comments only; PR-level Greptile summaries are not merge blockers., Parse Greptile confidence from PR issue comments (summary posts). (+36 more)
...
Cohesion: 0.09
Nodes (41): test_collect_observation_traces_accepts_valid_non_persistent_batch(), test_collect_observation_traces_can_require_single_scope_batch(), test_collect_observation_traces_discards_entire_batch_on_rejection(), test_collect_observation_traces_rejects_disallowed_surface(), test_collect_observation_traces_rejects_empty_batch(), test_collect_observation_traces_rejects_invalid_trace_shape(), test_collect_observation_traces_rejects_mixed_user_batch(), test_collect_observation_traces_reports_batch_rejections_from_original_input() (+33 more)
...
Cohesion: 0.06
Nodes (25): Check a single router file for authentication issues.     Returns list of (line_, check_file(), Check a single file for hardcoded database paths, check_api_endpoints(), check_ui_pages(), Check database table schemas, Test critical API endpoints, Audit PROJECT_ROOT root (+17 more)
...
Cohesion: 0.07
Nodes (34): ADR Graphiti Bakeoff, ADR Hindsight Bakeoff, ADR Zoe Memory Layer, ADR Zoe North Star Layer, Graphify Graph JSON, Graphify Graph Report, pi_runtime_probe.py (script), test_default_chat_route_keeps_hindsight_and_graphiti_off_hot_path() (+26 more)

### Community 54 - "Community 54"
Cohesion: 0.09
Nodes (35): board_approve(), create_engineering_workflow_task(), evolution_proposal_action(), get_agent_board(), list_engineering_workflow_tasks(), Return Multica engineering ticket state for AG-UI display.      Falls back grace, Create a Hermes-assigned Multica issue and dispatch it via the executor seam., Act on an evolution proposal: approve|reject|defer.      On approve: creates a M (+27 more)
...
Cohesion: 0.11
Nodes (30): addFeedItem(), applyStats(), autoEndSession(), bumpStat(), clearHostSession(), confirmEndSession(), connectWS(), endSpeedDating() (+22 more)
...
Cohesion: 0.09
Nodes (25): MusicProvider, Convert Apple Music playlist data to Playlist., Search for playlists on Apple Music., Playlist, Unified playlist representation., Abstract base class for music streaming providers.          All providers (YouTu, Search for playlists., Like/save a track. Override if provider supports it. (+17 more)
...
Cohesion: 0.1
Nodes (21): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), Zoe Architecture Review, Database Consolidation Plan (+13 more)
...
Cohesion: 0.18
Nodes (16): _config_values(), _env_bool_snapshot(), _env_float_snapshot(), _env_int_snapshot(), GraphitiSidecarProbeResult, _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers() (+8 more)
...
Cohesion: 0.19
Nodes (14): test_load_target_patterns_extracts_contract_metadata(), test_measure_phase_treats_contract_target_patterns_as_no_patterns(), test_legacy_contract_snapshot_preserves_target_patterns_and_writer(), test_normalize_mcp_evolution_proposal_type_matches_contract_fallback(), _evidence_refs(), build_legacy_evolution_proposal_contract(), dump_legacy_evolution_proposal_contract(), dump_mcp_evolution_proposal_contract() (+6 more)

### Community 194 - "Community 194"
Cohesion: 0.13
Nodes (13): AuthResponse, escalate_session(), login(), login_passcode(), Authenticate with username and password          Args:         request: Login cr, Authenticate with username (or user_id) and passcode.      Accepts either ``user, Register new user (admin only)          Args:         request: User registration, Escalate passcode session to full session with password verification          Ar (+5 more)
...
Cohesion: 0.24
Nodes (12): Zoe Capabilities, Database Protection Rules, Auto-Generated Module Compose, Jetson Docker Compose Override, Supplemental Docker Compose Modules, Raspberry Pi Docker Compose Override, Zoe Docker Compose Base, Docker Networking Rules - MANDATORY (+4 more)
...
Cohesion: 0.22
Nodes (11): Register a Tier 2 slow-loop trigger., register_trigger(), lifespan(), _memory_capture_retry_task(), _probe_runtimes(), Validate memory capture plumbing at startup.      This is a non-invasive probe:, Background retry: re-run the startup probe once, 45 s after boot.      Clears fa, Probe agent runtime ports at startup; update _RUNTIME_HEALTH. (+3 more)
...
Cohesion: 0.25
Nodes (11): Agent Zero Docker Compose Module, Agent Zero Integration - COMPLETE, Agent Zero Intent Patterns, Agent Zero Live Integration Test Report, Agent Zero Quick Start Guide, Agent Zero Module for Zoe, Agent Zero Requirements, Agent Zero Comparison Skill (+3 more)
...
Cohesion: 0.29
Nodes (7): parse_json_fields(), get_connection_icebreaker(), Shorter icebreaker for the QR scan connect page., get_pending_connections(), Get all pending connection requests for a user., Accept or decline a pending connection request., respond_to_connection()
...
Cohesion: 0.4
Nodes (5): Database List Items Table, Database Lists Table, Default Lists (IDs 1-4), GET /api/lists/{list_type} Endpoint, Lists Router Code (lists.py)
...
Cohesion: 0.5
Nodes (4): Chat SSL Fix - Error Handling, Chat SSL Fix - manifest.json Creation, Chat SSL Fix - Protocol Handling, PWA Phase 1 Implementation Complete

### Community 334 - "Community 334"
Cohesion: 0.5
Nodes (4): Touch Dashboard Upgrade - Drag & Drop Fix, Touch Dashboard Upgrade - Floating Edit Mode (FAB), Touch Dashboard Upgrade - Navigation Bar, Touch Dashboard Upgrade - Persistence Fix
...
Cohesion: 0.67
Nodes (3): Action Plan Progress Report, Zoe Code Execution with MCP - Implementation Summary, LLM Capabilities Awareness Audit

## Knowledge Gaps
- **2916 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2911 more)
...
- **Why does `main()` connect `Community 0` to `Community 1`, `Community 129`, `Community 259`, `Community 260`, `Community 5`, `Community 7`, `Community 136`, `Community 140`, `Community 273`, `Community 17`, `Community 147`, `Community 19`, `Community 20`, `Community 154`, `Community 155`, `Community 157`, `Community 30`, `Community 160`, `Community 288`, `Community 34`, `Community 163`, `Community 37`, `Community 293`, `Community 165`, `Community 45`, `Community 50`, `Community 54`, `Community 186`, `Community 314`, `Community 188`, `Community 187`, `Community 190`, `Community 65`, `Community 322`, `Community 71`, `Community 72`, `Community 75`, `Community 206`, `Community 79`, `Community 209`, `Community 81`, `Community 83`, `Community 210`, `Community 215`, `Community 216`, `Community 217`, `Community 89`, `Community 87`, `Community 92`, `Community 218`, `Community 95`, `Community 100`, `Community 232`, `Community 105`, `Community 234`, `Community 250`, `Community 110`, `Community 112`, `Community 244`, `Community 117`, `Community 245`, `Community 119`, `Community 122`, `Community 127`?**
  _High betweenness centrality (0.192) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 87` to `Community 0`, `Community 258`, `Community 3`, `Community 4`, `Community 5`, `Community 134`, `Community 7`, `Community 9`, `Community 10`, `Community 138`, `Community 12`, `Community 13`, `Community 140`, `Community 271`, `Community 17`, `Community 18`, `Community 19`, `Community 147`, `Community 21`, `Community 20`, `Community 31`, `Community 37`, `Community 43`, `Community 44`, `Community 173`, `Community 47`, `Community 50`, `Community 179`, `Community 52`, `Community 54`, `Community 56`, `Community 58`, `Community 314`, `Community 190`, `Community 62`, `Community 65`, `Community 193`, `Community 71`, `Community 203`, `Community 210`, `Community 86`, `Community 92`, `Community 221`, `Community 223`, `Community 97`, `Community 105`, `Community 237`, `Community 242`, `Community 114`, `Community 117`, `Community 120`, `Community 251`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 1` to `Community 0`, `Community 194`, `Community 131`, `Community 4`, `Community 98`, `Community 10`, `Community 242`, `Community 24`, `Community 186`, `Community 60`?**
