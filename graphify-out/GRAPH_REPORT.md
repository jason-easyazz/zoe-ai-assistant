...
## Summary
- 8258 nodes · 14712 edges · 554 communities (346 shown, 208 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2103 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ae49ed8a`
...
## Communities (554 total, 208 thin omitted)
...
Cohesion: 0.03
Nodes (84): Send a chat message to Zoe, Send a chat message and validate response, _broadcast_intent_nav(), _build_hermes_payload(), _build_panel_intent_card(), _build_research_package(), _capture_research_screenshot(), chat() (+76 more)
...
Cohesion: 0.04
Nodes (62): Start discovering AirPlay devices, Get all discovered AirPlay devices, Get all discovered Chromecast devices, Get a specific device by ID, Get device info from database., AirPlayOutput, get_airplay_output(), AirPlay Output Target =====================  Implementation of OutputTarget for (+54 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (62): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), deprecation.py Middleware, AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn() (+54 more)
...
Cohesion: 0.07
Nodes (65): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, OutputState, OutputType, Types of output targets., Playback state of an output. (+57 more)
...
Cohesion: 0.05
Nodes (48): chat.py Router, model_config.py, chat.html Frontend, warmup_models.py, context_optimizer.py, cross_agent_collaboration.py, enhanced_mem_agent_client.py, rag_enhancements.py (+40 more)
...
Cohesion: 0.06
Nodes (51): get_auth_manager(), Get the singleton auth manager instance., Make a request to the Home Assistant API., AppleMusicProvider, Get user's Music User Token from database., Make authenticated API request., Check if user is authenticated with Apple Music., Get developer token for MusicKit JS authentication.                  Apple Music (+43 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (54): Write a journal-derived fact to MemPalace through MemoryService., _store_journal_memory(), Manually trigger the LLM memory digest for a user (or the requesting user)., trigger_memory_digest(), _deep_sleep_pass(), _emotional_memory_pass(), _extract_concept_tags(), _extract_facts_with_gemma() (+46 more)
...
Cohesion: 0.11
Nodes (23): Get a specific provider by type.                  Args:             provider_typ, _get(), Return Atomic semantic hits as normalized records., _build_metadata(), _idempotency_key(), _memory_status_visible(), _memory_visible_to_user(), MemoryRef (+15 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (33): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, Get track metadata from cache., Get or create a YTMusic client for a user.                  Args:             us, Check if user has valid YouTube Music authentication., Normalize a YouTube Music item to standard format., Get video stream URL for a track (for video playback).                  YouTube, YouTube Music integration provider.          Handles:     - Searching tracks, al (+25 more)
...
Cohesion: 0.09
Nodes (29): ABC, _check_memory_headroom(), Check if enough memory is available for ML components., BaseRecommendationEngine, get_discover(), get_mood_match(), get_radio(), get_recommendation_engine() (+21 more)
...
Cohesion: 0.07
Nodes (24): check_api_endpoints(), check_router_expectations(), check_ui_pages(), Check database table schemas, Check what routers expect vs what database has, Test critical API endpoints, Audit PROJECT_ROOT root, Audit all service directories (+16 more)
...
Cohesion: 0.1
Nodes (26): Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage., Check for potential security issues., Validates intent system configuration., Run all validations.                  Returns:             True if all validatio (+18 more)
...
Cohesion: 0.09
Nodes (24): Output Target Base Class ========================  Abstract base class for all a, Apple Music Provider ====================  Integration with Apple Music using th, AuthStatus, display_name(), ProviderType, Music Provider Base Class =========================  Abstract base class for all, Supported music provider types., Provider authentication status. (+16 more)
...
Cohesion: 0.11
Nodes (28): _build_calendar_form_props(), _build_reminder_form_props(), _intent_action_form_payload(), _intent_card_data(), _normalized_list_items(), Build a panel_show_action_form payload for intents that show an in-place overlay, Build show_card data payload from intent slots for Google Home-style card., Tests for calendar intent canonical card emission. (+20 more)
...
Cohesion: 0.08
Nodes (27): Get current playback state from an AirPlay device, Get current playback state from a Chromecast, Set playback volume (0-100)., Get current playback state for a zone, Set volume for a zone, get_connect_info(), QR scan landing — returns scanned person's public profile + compatibility., Get or create connection to a device. (+19 more)
...
Cohesion: 0.1
Nodes (15): Health check endpoint.          Returns service health and Agent Zero availabili, health(), HindsightMemoryError, HindsightOfflineConfigError, _is_local_or_private_url(), _positive_count(), Hindsight sidecar adapter for Zoe's memory bake-off.  The adapter is disabled by, Raised when Hindsight is unavailable or returns an invalid response. (+7 more)
...
Cohesion: 0.18
Nodes (4): Get session by ID with validation, MCPMusicStateManager, Skip to next track in queue, get_session()
...
Cohesion: 0.09
Nodes (24): Browser Cache Fix - Clear Old Broken State, Cleanup Safety Rules - Mandatory for All AI Assistants, Critical Files - Do Not Delete, Database Path Enforcement System, Disk Space Protection System, Disk Space Protection - Implementation Complete Summary, Docker Networking Rules - MANDATORY, Enhanced Enforcement System (+16 more)
...
Cohesion: 0.13
Nodes (19): test_maintenance_runner_imports_real_bakeoff_module(), test_score_recall_response_reports_missing_terms(), test_summarize_bakeoff_scores_reports_score_and_latency(), test_summarize_recall_latency_ignores_disabled_latencies_in_mixed_run(), test_summarize_recall_latency_ignores_missing_enabled_latency(), test_summarize_recall_latency_marks_disabled_runs_not_measured(), test_summarize_recall_latency_reports_budget_status(), test_summarize_recall_latency_reports_hot_path_eligible() (+11 more)
...
Cohesion: 0.1
Nodes (18): Seek to position in current track., Send message to device via WebSocket., Broadcast to all user's devices., Mark a device as disconnected, Resume playback in a zone, Seek to position in a zone, Send message to all connected devices in a zone, Send a message to a specific device (+10 more)
...
Cohesion: 0.12
Nodes (14): build_calendar_event_editor_content(), build_calendar_timeline_content(), build_shopping_item_editor_content(), build_shopping_list_content(), build_weather_current_content(), build_weather_forecast_content(), Build canonical content for a shopping/list view card., Build canonical content for a shopping/list item editor card. (+6 more)
...
Cohesion: 0.19
Nodes (16): _env_float(), _config_values(), _env_bool_snapshot(), _env_float_snapshot(), GraphitiSidecarProbeResult, _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers() (+8 more)
...
Cohesion: 0.12
Nodes (16): _board(), _protocol_violation_count(), Pull a PR URL from the implement/closeout task summaries or comments., Block a task after repeated Hermes protocol violations (silent worker exit)., _oidc_client_id_configured(), _probe(), run(), _uploads_configured() (+8 more)
...
Cohesion: 0.15
Nodes (13): Play a track on the target device.                  Args:             track_id:, Play previous track (from history)., Add a track to the queue.                  Args:             position: If specif, Start playback in a zone, Go to previous track in queue, Add a track to the zone queue, Broadcast current zone state to all connected devices, Save zone state to database (+5 more)

### Community 175 - "Community 175"
Cohesion: 0.12
Nodes (11): get_media_controller(), MediaController, Media Controller ================  Routes playback commands to appropriate devic, Controls music playback across devices.          Supports:     - Browser/panel p, Get the current queue., Reorder a track in the queue., Play on Home Assistant media_player in room., Pre-fetch stream URL for next track in queue (runs in background). (+3 more)
...
Cohesion: 0.19
Nodes (12): Zoe Capabilities Inventory, Auto-Generated Module Compose, Jetson Docker Compose Override, Supplemental Docker Compose Modules, Raspberry Pi Docker Compose Override, Zoe Docker Compose Base, Zoe Modular Architecture README, MCP Client (+4 more)
...
Cohesion: 0.38
Nodes (12): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), Zoe Architecture Review, Fixes Applied for 100% System Reliability (+4 more)
...
Cohesion: 0.25
Nodes (7): Update playback state in database., Pause playback in a zone, Pause playback on an AirPlay device., pause(), Pause playback on a Home Assistant media player., Pause playback on a device (or current device if not specified)., Stop playback on a device.
...
Cohesion: 0.33
Nodes (7): Data Migration for Misplaced Items, Database Query in GET /api/lists/{list_type}, Default Lists in Database, GET /api/lists/{list_type} Endpoint, Updated Response Format for Lists API, lists.py Router, migrate_lists_items.py Migration Script
...
Cohesion: 0.4
Nodes (5): Dashboard HTML, journal.js Widget Implementation, journal Widget Manifest Configuration, Lists HTML, Quick Journal Widget
...
Cohesion: 0.5
Nodes (4): Fetch Interceptor, normalizeToHttps() Function, manifest.json PWA Manifest, Session Loading Error Handling
...
- `enforce_structure.py` → `Zoe Project Structure & Governance Rules`  [AMBIGUOUS]
  PROJECT_STRUCTURE_RULES.md · relation: references

## Knowledge Gaps
- **2935 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2930 more)
...
- **What is the exact relationship between `enforce_structure.py` and `Zoe Project Structure & Governance Rules`?**
  _Edge tagged AMBIGUOUS (relation: references) - confidence is low._
- **Why does `main()` connect `Community 1` to `Community 131`, `Community 4`, `Community 132`, `Community 134`, `Community 136`, `Community 266`, `Community 267`, `Community 146`, `Community 19`, `Community 147`, `Community 22`, `Community 279`, `Community 23`, `Community 156`, `Community 32`, `Community 289`, `Community 290`, `Community 160`, `Community 163`, `Community 41`, `Community 169`, `Community 299`, `Community 171`, `Community 46`, `Community 47`, `Community 57`, `Community 59`, `Community 317`, `Community 63`, `Community 195`, `Community 196`, `Community 197`, `Community 324`, `Community 199`, `Community 200`, `Community 202`, `Community 76`, `Community 333`, `Community 77`, `Community 78`, `Community 79`, `Community 81`, `Community 86`, `Community 215`, `Community 88`, `Community 89`, `Community 90`, `Community 216`, `Community 92`, `Community 220`, `Community 223`, `Community 224`, `Community 96`, `Community 226`, `Community 225`, `Community 100`, `Community 108`, `Community 111`, `Community 124`, `Community 240`, `Community 241`, `Community 115`, `Community 251`, `Community 248`, `Community 123`, `Community 252`, `Community 126`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 57` to `Community 256`, `Community 1`, `Community 2`, `Community 3`, `Community 131`, `Community 4`, `Community 6`, `Community 132`, `Community 8`, `Community 9`, `Community 10`, `Community 264`, `Community 136`, `Community 141`, `Community 17`, `Community 147`, `Community 276`, `Community 150`, `Community 23`, `Community 24`, `Community 22`, `Community 26`, `Community 30`, `Community 32`, `Community 33`, `Community 38`, `Community 41`, `Community 43`, `Community 47`, `Community 48`, `Community 49`, `Community 51`, `Community 59`, `Community 60`, `Community 61`, `Community 317`, `Community 63`, `Community 187`, `Community 199`, `Community 72`, `Community 206`, `Community 207`, `Community 84`, `Community 85`, `Community 216`, `Community 217`, `Community 95`, `Community 99`, `Community 100`, `Community 231`, `Community 107`, `Community 235`, `Community 116`, `Community 244`, `Community 119`, `Community 249`, `Community 125`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `_FakeAdapter` connect `Community 0` to `Community 160`, `Community 209`, `Community 20`, `Community 21`, `Community 24`, `Community 154`?**
