...
## Summary
- 7661 nodes · 13305 edges · 496 communities (335 shown, 161 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1705 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3ecaae18`
...
- `Zoe Modular Architecture README` --references--> `Zoe Module CLI`  [EXTRACTED]
  README_MODULE_SYSTEM.md → tools/zoe_module.py
- `init_db()` --calls--> `init_pool()`  [INFERRED]
  modules/orbit/database.py → services/zoe-data/db_pool.py

## Communities (496 total, 161 thin omitted)
...
Cohesion: 0.03
Nodes (110): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, get_auth_manager(), Get the singleton auth manager instance., Get track metadata from cache., Get or create a YTMusic client for a user.                  Args:             us, Check if user has valid YouTube Music authentication., Normalize a YouTube Music item to standard format. (+102 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (76): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail(), _is_allowed_line() (+68 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (82): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Validate database structure, Enum, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents. (+74 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (95): Override to customise the prompt per-check., Resolve a browser session_id to a user_id via zoe-auth HTTP.      Calls the same, Local voice session WebSocket for voice.html.      Accepts text and binary (audi, _resolve_ws_user(), websocket_voice(), _bash(), _build_prompt(), _build_tools() (+87 more)
...
Cohesion: 0.04
Nodes (73): Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100)., Get device info from database. (+65 more)
...
Cohesion: 0.04
Nodes (68): a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_cancel(), board_review(), delegate_to_agent(), _EngineeringGuardRunRequest, _EngineeringTaskRequest (+60 more)
...
Cohesion: 0.05
Nodes (53): run_music_digest(), Manually trigger the LLM memory digest for a user (or the requesting user)., trigger_memory_digest(), _deep_sleep_pass(), _emotional_memory_pass(), _extract_concept_tags(), _extract_facts_with_gemma(), _extract_open_loops() (+45 more)

### Community 20 - "Community 20"
Cohesion: 0.11
Nodes (50): test_dispatch_after_scout_evidence_creates_next_phase(), test_audit_profile_closeout_requires_log_not_greptile(), test_audit_profile_verify_does_not_require_test(), test_block_fingerprint_aborts_after_two_identical(), test_block_preserves_phase_and_evidence_until_restarted(), test_evidence_metadata_rejects_secret_fields(), test_failed_evidence_does_not_satisfy_gate(), test_implement_requires_tool_evidence_before_complete() (+42 more)
...
Cohesion: 0.14
Nodes (41): _candidate(), _signal(), test_approved_status_requires_approval_gate(), test_build_proposal_collects_signal_and_candidate_evidence(), test_candidate_gate_blocks_unknown_offline_candidate(), test_execute_gate_requires_pr_evidence_even_with_approval(), test_execute_proposal_requires_approval(), test_high_risk_proposal_can_prepare_with_user_or_admin_approval() (+33 more)
...
Cohesion: 0.07
Nodes (35): ABC, get_media_controller(), Get the singleton media controller instance., get_youtube_music(), YouTube Music Provider ======================  Integration with YouTube Music us, Get the singleton YouTube Music provider instance., MusicProvider, ProactiveTrigger (+27 more)
...
Cohesion: 0.11
Nodes (30): Attach Hermes log evidence when a silent exit was really a budget stop., Stop a running worker when its code-enforced phase budget is exhausted., _with_recovered_log_budget(), _budget_phase(), implement_edit_safety_reason_from_log(), implement_pre_edit_drift_reason_from_log(), _is_engineering_blocker_followup_body(), _is_expected_worker() (+22 more)
...
Cohesion: 0.1
Nodes (29): Get user information (without sensitive data), Exact match only — no wildcards., validate_redirect_uri(), verify_secret(), consume_auth_code(), delete_pending_auth(), _future_iso(), get_pending_auth() (+21 more)
...
Cohesion: 0.09
Nodes (25): _board(), _expected_phases(), _protocol_violation_count(), Report aggregate state of a chain by idempotency-key prefix.          Returns {f, Pull a PR URL from the implement/closeout task summaries or comments., Block a task after repeated Hermes protocol violations (silent worker exit)., _issue_sort_key(), Return (sequence_key, phase_number) when title encodes a phased track. (+17 more)

### Community 75 - "Community 75"
Cohesion: 0.1
Nodes (26): BaseHTTPMiddleware, check(), What a trigger wants to send., TriggerResult, EveningWindDownTrigger, Evening wind-down trigger — journal prompt if user hasn't written in 3+ days., EvolutionWeeklyDigestTrigger, EvolutionWeeklyDigestTrigger — Friday 6pm weekly evolution summary.  Fires every (+18 more)
...
Cohesion: 0.1
Nodes (27): hash_secret(), OIDC client registration and secret verification., Insert or update a client. Safe to call on every startup., upsert_client(), _now_iso(), parse_json_fields(), get_connection_icebreaker(), Shorter icebreaker for the QR scan connect page. (+19 more)
...
Cohesion: 0.13
Nodes (18): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _append_audit(), _idempotency_key(), MemoryServiceError, Raised for operational failures., Store a fact. Returns None when silently dropped., Fast metadata-filter read for system prompt injection. (+10 more)
...
Cohesion: 0.12
Nodes (13): HomeAssistantIntegration, initialize_ha_integration(), Sync user deletion to Home Assistant                  Args:             username, Authenticate user for Home Assistant (called by HA auth provider), Get Home Assistant areas for user assignment, Assign user to specific Home Assistant areas                  Args:, Sync all active Zoe users to Home Assistant                  Returns:, Sync user to HA person entity (+5 more)

### Community 123 - "Community 123"
Cohesion: 0.11
Nodes (21): clear_all_device_caches(), clear_device_cache(), list_touch_panel_devices(), QuickSwitchRequest, Touch Panel API Endpoints Optimized endpoints for touch panel quick authenticati, Validate touch panel session (with offline support)          Args:         reque, Touch panel authentication request, Quick user switch request (+13 more)
...
Cohesion: 0.11
Nodes (15): get_airplay_output(), AirPlay Output Target =====================  Implementation of OutputTarget for, Get the singleton AirPlay output instance., is_initialized(), output_type(), Chromecast Output Target ========================  Implementation of OutputTarge, get_homeassistant_output(), Home Assistant Output Target ============================  Implementation of Out (+7 more)
...
Cohesion: 0.1
Nodes (17): Initialize Agent Zero client.                  Args:             base_url: Base, Initialize safety guardrails.                  Args:             mode: Safety mo, Initialize the affinity engine.                  Args:             half_life_day, Initialize the AirPlay service, Initialize the audio analyzer with Essentia., Initialize the auth manager.                  Args:             encryption_key:, Initialize the Cast service, Initialize embedding models (lazy loaded). (+9 more)
...
Cohesion: 0.24
Nodes (16): _issue(), Tests for safe production backlog admission., test_approved_blocked_ticket_halts_single_ticket_lane(), test_malformed_queue_order_cannot_wedge_admission(), test_non_hermes_blocked_ticket_does_not_halt_lane(), test_phased_ticket_waits_for_predecessor(), test_selects_one_approved_issue_by_queue_order(), test_smoke_sources_and_parent_tickets_are_never_auto_admitted() (+8 more)
...
Cohesion: 0.19
Nodes (14): _config_values(), _env_bool_snapshot(), GraphitiSidecarProbeResult, _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers(), _scan_processes(), _scan_runtime() (+6 more)
...
Cohesion: 0.15
Nodes (9): Print test results summary, print_summary(), Print completion summary, Run a conversation and display full Q&A, run_conversation_test(), Print benchmark summary, Check if response meets expectations, Run a full conversation and track results (+1 more)
...
Cohesion: 0.19
Nodes (9): test_capability_profile_index_rejects_duplicate_ids(), test_capability_profile_rejects_unknown_owner_surface(), test_default_capability_profiles_validate_and_cover_core_surfaces(), test_metadata_is_read_only(), test_profiles_requiring_approval_includes_install_memory_and_graph_surfaces(), test_trusted_profile_requires_evidence(), CapabilityProfile, profiles_requiring_approval() (+1 more)
...
Cohesion: 0.2
Nodes (12): Zoe Capabilities Inventory, Building Zoe Modules - Developer Guide, MCP-Only Architecture for Zoe Modules, Module Intent Auto-Discovery System, Music Module Dependency Audit, Music Module Execution Plan, Zoe Modular Architecture README, MCP Client (+4 more)
...
Cohesion: 0.17
Nodes (12): Fixed GPU Model gemma3n-e2b-gpu-fixed, Model Config Updates, Context Optimization, Enhanced MEM Agent, Expert Orchestrator, GPU Model gemma3n-e2b-gpu:latest, RAG System, Temporal Memory (+4 more)
...
Cohesion: 0.22
Nodes (5): Background sync loop for HA integration, Sync user states between Zoe and HA, Manually trigger sync with server, Sync cache with server data, Check if server is reachable
...
Cohesion: 0.22
Nodes (10): Zoe Module Generator Configuration, Database Protection Rules, Zoe Docker Compose Base, Jetson Docker Compose Override, Supplemental Docker Compose Modules, Raspberry Pi Docker Compose Override, Hardware Compatibility Guide, Zoe Project Structure & Governance Rules (+2 more)
...
Cohesion: 0.6
Nodes (5): Agent Zero Implementation Checklist, Agent Zero Integration - COMPLETE, Agent Zero Live Integration Test Report, Agent Zero Module for Zoe, Agent Zero Integration Test Results
...
Cohesion: 0.5
Nodes (4): Fetch Interceptor in auth.js, normalizeToHttps() in common.js, manifest.json for PWA, Non-blocking Session Loading

## Knowledge Gaps
- **2813 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2808 more)
...
- **Why does `main()` connect `Community 2` to `Community 257`, `Community 3`, `Community 134`, `Community 265`, `Community 138`, `Community 142`, `Community 145`, `Community 274`, `Community 19`, `Community 21`, `Community 22`, `Community 149`, `Community 25`, `Community 281`, `Community 157`, `Community 159`, `Community 32`, `Community 33`, `Community 162`, `Community 36`, `Community 38`, `Community 167`, `Community 296`, `Community 41`, `Community 177`, `Community 305`, `Community 52`, `Community 183`, `Community 55`, `Community 185`, `Community 184`, `Community 58`, `Community 62`, `Community 63`, `Community 192`, `Community 72`, `Community 74`, `Community 203`, `Community 76`, `Community 204`, `Community 78`, `Community 202`, `Community 83`, `Community 84`, `Community 213`, `Community 214`, `Community 87`, `Community 215`, `Community 222`, `Community 223`, `Community 232`, `Community 105`, `Community 106`, `Community 237`, `Community 112`, `Community 242`, `Community 115`, `Community 116`, `Community 117`, `Community 243`, `Community 120`?**
  _High betweenness centrality (0.193) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 58` to `Community 129`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 255`, `Community 7`, `Community 10`, `Community 139`, `Community 268`, `Community 138`, `Community 142`, `Community 17`, `Community 21`, `Community 24`, `Community 25`, `Community 28`, `Community 29`, `Community 32`, `Community 33`, `Community 161`, `Community 164`, `Community 40`, `Community 296`, `Community 41`, `Community 177`, `Community 50`, `Community 51`, `Community 178`, `Community 53`, `Community 55`, `Community 190`, `Community 64`, `Community 65`, `Community 198`, `Community 199`, `Community 73`, `Community 74`, `Community 202`, `Community 76`, `Community 77`, `Community 120`, `Community 220`, `Community 94`, `Community 103`, `Community 233`, `Community 235`, `Community 108`, `Community 238`, `Community 112`, `Community 248`, `Community 127`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 22` to `Community 1`, `Community 2`, `Community 5`, `Community 7`, `Community 8`, `Community 234`, `Community 11`, `Community 139`, `Community 143`, `Community 54`, `Community 183`?**
