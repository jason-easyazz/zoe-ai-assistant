...
## Summary
- 7646 nodes · 13144 edges · 543 communities (336 shown, 207 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1665 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0ee19f03`
...
- `Person Expert Recommendation` --conceptually_related_to--> `Enhanced MemAgent (Multi-Expert Model)`  [INFERRED]
  docs/architecture/PERSON_EXPERT_RECOMMENDATION.md → services/zoe-core/enhanced_mem_agent_client.py
- `Code Execution Pattern` --conceptually_related_to--> `Code Execution Testing`  [INFERRED]
  docs/architecture/MCP_BEST_PRACTICES_REVIEW.md → services/zoe-core/routers/chat.py
...
## Communities (543 total, 207 thin omitted)
...
Cohesion: 0.02
Nodes (56): _FakeAdapter, Tests for the Hermes Kanban executor adapter (CLI mocked)., A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., KanbanAdapter with the CLI replaced by a scripted recorder., _row(), test_audit_no_pr_phases_do_not_preload_broad_skills(), test_dispatch_blocks_existing_pr_revision_when_precheckout_fails(), test_dispatch_blocks_on_first_worker_failure() (+48 more)
...
Cohesion: 0.03
Nodes (68): Get session by ID with validation, MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker. (+60 more)
...
Cohesion: 0.05
Nodes (75): Validate database structure, Enum, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage., Check for potential security issues., Validates intent system configuration. (+67 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (79): Send a chat message to Zoe, Send a chat message and validate response, _build_hermes_payload(), _build_panel_intent_card(), _build_research_package(), _capture_research_screenshot(), chat(), chat_inject_background() (+71 more)
...
Cohesion: 0.06
Nodes (35): Get all active sessions for a specific user (admin only)          Args:, escalate_session(), get_user_sessions(), Refresh current session expiration          Args:         current_session: Curre, Escalate passcode session to full session with password verification          Ar, Get all active sessions for current user          Args:         current_session:, refresh_session(), Verify user password                  Args:             user_id: User identifier (+27 more)
...
Cohesion: 0.06
Nodes (44): Get user information (without sensitive data), Parse stored auth timestamp strings., hash_secret(), OIDC client registration and secret verification., Exact match only — no wildcards., Insert or update a client. Safe to call on every startup., upsert_client(), validate_redirect_uri() (+36 more)
...
Cohesion: 0.09
Nodes (34): Unit tests for person_extractor.py — pattern matching and process_text() logic., Integration-style tests that mock DB and MemPalace., Create a mock DB that returns person_id on SELECT., test_birthday_pattern_known_person_writes_date(), test_bucket_list_pattern_writes_bucket(), test_empty_text_returns_zero(), test_gift_pattern_known_person_writes_gift(), test_guest_returns_zero() (+26 more)
...
Cohesion: 0.06
Nodes (24): AnalyzeRequest, BrowseRequest, CompareRequest, PlanRequest, Request model for browser automation endpoint., Request model for planning endpoint., Request model for analysis endpoint., Request model for comparison endpoint. (+16 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (30): RootCleaner, db_conn(), Integration tests: People CRM — PostgreSQL + MemPalace sync.  Tests the dual fan, All CRM tables must exist., 0007 migration columns must exist on people table., Create a person, run process_text → verify DB activity row AND MemPalace entry., recalc_and_save updates health_score in DB., The /api/people/fields route fix: /fields must come before /{person_id} in sourc (+22 more)

### Community 49 - "Community 49"
Cohesion: 0.09
Nodes (26): test_poll_v4_audit_protocol_recovery_reports_partial_for_next_phase(), test_mark_greptile_passes_only_on_five_of_five(), test_mark_reviewed_requires_zero_critical(), test_mark_tested_records_hashed_evidence(), test_record_evidence_retries_once_after_journal_conflict(), test_split_ticket_does_not_save_pipeline_block_when_children_fail(), test_split_ticket_does_not_save_pipeline_block_when_parent_update_fails(), test_split_ticket_retries_pipeline_conflict_without_duplicate_children() (+18 more)
...
Cohesion: 0.12
Nodes (27): Attach Hermes log evidence when a silent exit was really a budget stop., Stop a running worker when its code-enforced phase budget is exhausted., _with_recovered_log_budget(), _budget_phase(), implement_edit_safety_reason_from_log(), implement_pre_edit_drift_reason_from_log(), _is_expected_worker(), _latest_log_session() (+19 more)
...
Cohesion: 0.17
Nodes (27): get_engineering_guard(), PR-keyed Greptile grep-loop guard state., acquire_lock(), _append_progress(), _ci_status_from_rollup(), _finding_hash(), _gh_mergeable_state(), GuardError (+19 more)
...
Cohesion: 0.1
Nodes (25): INTENT_LABELS, attachCardActions(), buildActionButtons(), buildMatchCard(), hideSDTimerOverlay(), hideSpeedDatingBanner(), loadMatches(), loadPendingConnections() (+17 more)
...
Cohesion: 0.14
Nodes (24): Tests for main.py Multica poll-loop helpers., RecordingClient, test_record_blocked_multica_chain_creates_budget_followup_once(), test_record_blocked_multica_chain_creates_iteration_budget_followup(), test_record_blocked_multica_chain_does_not_create_recursive_harness_followup(), test_record_blocked_multica_chain_falls_back_to_classification_and_default(), test_record_blocked_multica_chain_records_terminal_block_metadata(), test_record_blocked_multica_chain_reopens_after_done_budget_followup() (+16 more)
...
Cohesion: 0.16
Nodes (21): test_probe_rejects_public_backend_host(), test_probe_rejects_unknown_backend(), test_probe_reports_disabled_without_tcp_check(), test_probe_reports_healthy_falkordb_backend(), test_probe_reports_healthy_neo4j_backend(), test_probe_reports_malformed_port_as_misconfigured(), test_probe_reports_offline_backend(), test_probe_reports_out_of_range_port_as_misconfigured() (+13 more)

### Community 107 - "Community 107"
Cohesion: 0.15
Nodes (14): test_operation_status_gets_hindsight_operation_endpoint(), test_recall_posts_trace_enabled_request(), test_request_wraps_non_json_response(), test_retain_posts_to_hindsight_memories_endpoint(), test_retain_refuses_auto_write_when_gate_closed(), test_retain_refuses_write_when_disabled(), test_wait_for_operation_returns_immediately_when_disabled(), test_wait_for_retain_results_polls_async_operations_concurrently() (+6 more)
...
Cohesion: 0.11
Nodes (18): _board(), _expected_phases(), KanbanCLIError, _protocol_violation_count(), Report aggregate state of a chain by idempotency-key prefix.          Returns {f, Pull a PR URL from the implement/closeout task summaries or comments., Raised when a hermes kanban CLI call fails., Correlate a Kanban list row back to its ``multica:{id}:{phase}`` ref.      The l (+10 more)
...
Cohesion: 0.21
Nodes (13): _config_values(), _elapsed_ms(), _env_bool_snapshot(), GraphitiSidecarProbeResult, _matching_lines(), Read-only Graphiti graph-backend readiness probe for Zoe., _scan_containers(), _scan_processes() (+5 more)

### Community 169 - "Community 169"
Cohesion: 0.17
Nodes (13): _compact_context(), _env_bool(), event_to_hindsight_item(), from_env(), HindsightMemoryError, HindsightOfflineConfigError, _is_local_or_private_url(), Hindsight sidecar adapter for Zoe's memory bake-off.  The adapter is disabled by (+5 more)
...
Cohesion: 0.14
Nodes (14): Agent Zero Research Skill, Calendar Events Skill, Channel Setup Skill, Manual UI Test - People System, Personal Facts Skill, Proactive Agent Skill, Self-Improvement Skill, Shopping List Skill (+6 more)
...
Cohesion: 0.22
Nodes (11): _event(), test_event_to_hindsight_item_keeps_evidence_and_scope_tags(), test_event_to_hindsight_item_serializes_structured_context_as_json(), test_build_hindsight_retain_candidate_is_pending_and_evidence_tagged(), test_create_hindsight_retain_candidate_uses_memory_service_pending_ingest(), build_hindsight_retain_candidate(), _candidate_text(), create_hindsight_retain_candidate() (+3 more)
...
Cohesion: 0.2
Nodes (5): Health check endpoint.          Returns service health and Agent Zero availabili, health(), Submit an evidence-backed event to Hindsight.          By default this refuses t, Fetch a Hindsight async operation status., Poll a Hindsight async operation until it completes, fails, or times out.
...
Cohesion: 0.31
Nodes (10): Building Zoe Modules - Developer Guide, MCP-Only Architecture for Zoe Modules, Music Module Migration Guide, Module Intent Auto-Discovery System - Complete!, Zoe Module Requirements - MANDATORY, Zoe Module System - Implementation Complete, Music Module Dependency Audit, Music Module Extraction - Complete Execution Plan (+2 more)
...
Cohesion: 0.28
Nodes (8): MCP Tools, OpenClaw Skills, Zoe Modular Architecture - Complete, MCP Client, ModuleWidgetLoader, WidgetRegistry, Zoe Module CLI, Zoe Music Module
...
Cohesion: 0.32
Nodes (7): Cleanup Safety, Docker Networking Rules, LiteLLM Rules, Manifest System, Project Organization Complete, Quick Reference, Zoe Design Principles

### Community 275 - "Community 275"
Cohesion: 0.32
Nodes (8): Cloudflare Tunnel Service, Home Assistant MCP Bridge Service, Home Assistant Service, Keeper.sh Calendar Sync Service, LiveKit Service, Zoe Database Service, Zoe UI Service, zoe-auth Service
...
Cohesion: 0.29
Nodes (7): LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), Intent System Implementation, List Isolation Bug Fix, zoe-litellm Service
...
Cohesion: 0.4
Nodes (5): Database Protection Rules, Hardware Compatibility Guide, Zoe Project Structure & Governance Rules, Zoe AI Assistant - Quick Start, Zoe AI Assistant Overview
...
Cohesion: 0.5
Nodes (4): Manual Production Testing Guide, Zoe Authentication Service README, Zoe Auth Requirements, Authentication Integration Summary
...
Cohesion: 0.5
Nodes (4): Enhanced MemAgent (Multi-Expert Model), MemAgent (Memory Agent), Person Expert Recommendation, UI Backend Integration Map
...
Cohesion: 0.67
Nodes (3): Check In — Orbit HTML, Your Profile — Orbit HTML, Touch Panel Skill

### Community 342 - "Community 342"
Cohesion: 0.67
Nodes (3): Zoe Page Builder Skill, Zoe UI Version History, Zoe Widget Builder Skill

## Knowledge Gaps
- **2872 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2867 more)
...
- **Why does `main()` connect `Community 2` to `Community 3`, `Community 131`, `Community 6`, `Community 135`, `Community 136`, `Community 138`, `Community 269`, `Community 273`, `Community 148`, `Community 149`, `Community 21`, `Community 23`, `Community 152`, `Community 22`, `Community 27`, `Community 155`, `Community 29`, `Community 283`, `Community 156`, `Community 40`, `Community 168`, `Community 299`, `Community 48`, `Community 178`, `Community 179`, `Community 307`, `Community 53`, `Community 59`, `Community 318`, `Community 65`, `Community 66`, `Community 195`, `Community 194`, `Community 69`, `Community 70`, `Community 71`, `Community 73`, `Community 76`, `Community 77`, `Community 205`, `Community 207`, `Community 208`, `Community 209`, `Community 206`, `Community 83`, `Community 84`, `Community 94`, `Community 223`, `Community 227`, `Community 233`, `Community 234`, `Community 106`, `Community 107`, `Community 236`, `Community 111`, `Community 112`, `Community 114`, `Community 116`, `Community 118`, `Community 248`, `Community 251`?**
  _High betweenness centrality (0.201) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 70` to `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 263`, `Community 136`, `Community 7`, `Community 10`, `Community 135`, `Community 138`, `Community 16`, `Community 21`, `Community 23`, `Community 28`, `Community 29`, `Community 35`, `Community 38`, `Community 39`, `Community 40`, `Community 169`, `Community 167`, `Community 299`, `Community 49`, `Community 50`, `Community 51`, `Community 53`, `Community 182`, `Community 185`, `Community 59`, `Community 194`, `Community 67`, `Community 71`, `Community 72`, `Community 200`, `Community 75`, `Community 207`, `Community 213`, `Community 214`, `Community 215`, `Community 225`, `Community 98`, `Community 100`, `Community 231`, `Community 107`, `Community 109`, `Community 238`, `Community 112`, `Community 114`, `Community 117`, `Community 246`, `Community 125`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `_FakeAdapter` connect `Community 1` to `Community 14`, `Community 49`, `Community 18`, `Community 114`, `Community 82`, `Community 89`, `Community 191`?**
...
- **Are the 82 inferred relationships involving `list()` (e.g. with `get_matches()` and `_compute_compatibility()`) actually correct?**
  _`list()` has 82 INFERRED edges - model-reasoned connections that need verification._
