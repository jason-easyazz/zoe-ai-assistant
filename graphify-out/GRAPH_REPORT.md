...
## Summary
- 8132 nodes · 14476 edges · 566 communities (357 shown, 209 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2012 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `50df8e94`
...
- `PersonExpert Analysis & Recommendation` --conceptually_related_to--> `Enhanced MemAgent (Multi-Expert Model)`  [INFERRED]
  docs/architecture/PERSON_EXPERT_RECOMMENDATION.md → services/zoe-core/enhanced_mem_agent_client.py
- `UI to Backend to Expert Integration Map` --conceptually_related_to--> `Enhanced MemAgent (Multi-Expert Model)`  [INFERRED]
...
## Communities (566 total, 209 thin omitted)
...
Cohesion: 0.02
Nodes (98): Main optimization function, Agent Spike Playbook, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail() (+90 more)
...
Cohesion: 0.04
Nodes (86): Get current playback state from an AirPlay device, Get a specific device by ID, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100)., Get device info from database., Broadcast to all user's devices., Pause playback in a zone (+78 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (79): Send a chat message to Zoe, Send a chat message and validate response, _build_hermes_payload(), _build_panel_intent_card(), _build_reminder_form_props(), _build_research_package(), _capture_research_screenshot(), chat() (+71 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (83): _issue_sort_key(), Return (sequence_key, phase_number) when title encodes a phased track., True when every lower phase in the same sequence is ``done`` (or missing)., Pick up to ``count`` backlog issues respecting phased ordering.      ``all_issue, select_batch(), _event(), _plain_event(), test_admitted_hindsight_retain_plan_defaults_to_env_config() (+75 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (69): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Validate database structure, Enum, Run all validations.                  Returns:             True if all validatio, OutputState, OutputType (+61 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (47): Health check endpoint.          Returns service health and Agent Zero availabili, health(), test_enabled_status_includes_embedding_config(), test_event_to_hindsight_item_keeps_evidence_and_scope_tags(), test_event_to_hindsight_item_serializes_structured_context_as_json(), test_operation_status_gets_hindsight_operation_endpoint(), test_recall_posts_trace_enabled_request(), test_request_wraps_non_json_response() (+39 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (63): browse(), Browser automation endpoint - navigates websites and extracts data.          Use, Log startup information., startup_event(), AutomationTriggerRequest, DeviceControlRequest, ha_voice_turn(), ha_voice_wake() (+55 more)
...
Cohesion: 0.03
Nodes (67): a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, board_cancel(), board_review(), build_engineering_guard_packet(), delegate_to_agent(), _EngineeringGuardRunRequest (+59 more)
...
Cohesion: 0.05
Nodes (50): print_results(), Scan entire project and categorize all files., Check if path should be ignored., Categorize a file and determine if it's in the right location.          Returns:, scan_project(), should_ignore(), check_for_dangerous_patterns(), Print validation results.          Returns:         Exit code (0 if all files ex (+42 more)
...
Cohesion: 0.07
Nodes (24): MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker., Add a track to the queue.                  Args:             position: If specif (+16 more)
...
Cohesion: 0.11
Nodes (44): test_failed_outcome_remains_pending_only_and_never_trusted_durable_memory(), test_graphiti_target_is_allowed_for_relational_outcome_candidate(), test_none_items_are_ignored_in_backend_and_approval_sequences(), test_outcome_admission_requires_proposal_memory_admission_gate(), test_result_serializes_candidate_request_and_decision(), test_retired_outcome_remains_blocked_until_retirement_memory_policy_exists(), test_retired_outcome_requires_matching_retirement_trace_before_admission_request(), test_verified_outcome_with_memory_approval_can_write_hindsight_candidate() (+36 more)

### Community 24 - "Community 24"
Cohesion: 0.07
Nodes (42): BaseHTTPMiddleware, evaluate(), ProactiveTrigger, check(), What a trigger wants to send., Abstract trigger.  Two tiers derive from this:       - Tier 1: APScheduler-backe, TriggerResult, EveningWindDownTrigger (+34 more)

### Community 25 - "Community 25"
Cohesion: 0.06
Nodes (29): Play previous track (from history)., Send message to device via WebSocket., Music Zone Manager Handles multi-zone playback with device routing and state syn, Create a new music zone, Current playback state for a zone, Delete a zone (only owner can delete), Get all zones accessible by a user, Get current playback state for a zone (+21 more)
...
Cohesion: 0.05
Nodes (45): Get all active sessions for a specific user (admin only)          Args:, get_current_user(), get_passcode_status(), get_user_profile(), get_user_sessions(), guest_login(), LoginRequest, logout() (+37 more)

### Community 32 - "Community 32"
Cohesion: 0.07
Nodes (40): Normalize a YouTube Music item to standard format., Make a request to the Home Assistant API., AppleMusicProvider, Get user's Music User Token from database., Make authenticated API request., Convert Apple Music track data to Track., Convert Apple Music album data to Album., Search for tracks on Apple Music. (+32 more)
...
Cohesion: 0.11
Nodes (34): _promotion_plan(), _source_text(), test_profile_patch_writer_blocks_missing_source_profile(), test_profile_patch_writer_blocks_stale_source_trust_level(), test_profile_patch_writer_blocks_unapplyable_promotion_plan(), test_profile_patch_writer_renders_deterministic_unified_diff(), test_profile_patch_writer_validates_record_and_plan_invariants(), _review_result() (+26 more)
...
Cohesion: 0.11
Nodes (19): Get a specific provider by type.                  Args:             provider_typ, _get(), Return Atomic semantic hits as normalized records., _build_metadata(), MemoryRef, _metadata_value(), MemoryService - the sole read/write surface for Zoe memory.  This module is the, The sole read/write surface for Zoe memory. (+11 more)

### Community 59 - "Community 59"
Cohesion: 0.1
Nodes (30): _env_float(), test_extract_model_ids_accepts_openai_and_llama_shapes(), test_models_url_handles_v1_base(), test_runtime_probe_rejects_public_llm_base_url(), test_runtime_probe_reports_backend_offline(), test_runtime_probe_reports_disabled_without_backend_or_llm(), test_runtime_probe_reports_llm_unavailable(), test_runtime_probe_reports_missing_llm_model() (+22 more)
...
Cohesion: 0.09
Nodes (30): test_block_fingerprint_aborts_after_two_identical(), test_build_scope_split_packet_preserves_worker_reason(), test_explicit_scope_split_is_allowed_from_scout(), test_repeated_scope_split_is_still_implement_only(), block_fingerprint(), build_scope_split_packet(), can_complete_phase(), evidence_kinds() (+22 more)

### Community 67 - "Community 67"
Cohesion: 0.09
Nodes (25): Create a person, run process_text → verify DB activity row AND MemPalace entry., recalc_and_save updates health_score in DB., Minimal compatibility wrapper so person_extractor works with raw asyncpg., test_health_score_recalc(), test_person_extractor_dual_fanout(), get_db(), FakeCursor, db_compat.py — asyncpg compatibility shim providing an aiosqlite-style cursor AP (+17 more)
...
Cohesion: 0.1
Nodes (24): test_disabled_probe_is_acceptable_even_when_tools_are_missing(), test_disabled_runtime_does_not_surface_agent_files(), test_empty_env_does_not_fall_through_to_process_environment(), test_enabled_probe_reports_missing_node_before_pi(), test_enabled_runtime_detects_agent_files(), test_execution_can_be_configured_with_explicit_local_model_flag(), test_malformed_boolean_env_reports_misconfigured(), test_probe_uses_current_process_path_when_env_omits_path() (+16 more)

### Community 73 - "Community 73"
Cohesion: 0.13
Nodes (28): test_record_blocked_multica_chain_creates_protocol_followup(), test_record_blocked_multica_chain_reopens_after_done_budget_followup(), test_create_issue_metadata_preserves_existing_ticket_fields(), test_update_ticket_progress_can_clear_dispatch_approval(), test_block_only_description_does_not_gain_leading_blank_lines(), test_progress_and_children_patch_metadata_only(), test_replacing_middle_block_preserves_suffix_newline(), test_ticket_block_preserves_human_description() (+20 more)

### Community 74 - "Community 74"
Cohesion: 0.07
Nodes (31): Create a notification., create_schedule(), delete_schedule(), Schedule a one-shot proactive nudge., Cancel a scheduled nudge., acknowledge_reminder(), create_reminder(), delete_reminder() (+23 more)
...
Cohesion: 0.17
Nodes (29): acquire_lock(), analyze_result(), _append_progress(), _ci_status_from_rollup(), _diff_changed_lines(), _diff_files(), _finding_hash(), _gh_mergeable_state() (+21 more)
...
Cohesion: 0.1
Nodes (21): _board(), _expected_phases(), KanbanCLIError, Report aggregate state of a chain by idempotency-key prefix.          Returns {f, Pull a PR URL from the implement/closeout task summaries or comments., Raised when a hermes kanban CLI call fails., Correlate a Kanban list row back to its ``multica:{id}:{phase}`` ref.      The l, Stop a running worker when its code-enforced phase budget is exhausted. (+13 more)
...
Cohesion: 0.09
Nodes (23): claim_pending(), create_pending(), Helpers for deferred / lazy session creation for proactive notifications.  When, Insert a proactive_pending row and return its id.     The push notification's de, Mark a pending notification as claimed and create a chat session seeded     with, accept_pending_suggestion(), claim_pending_endpoint(), dismiss_pending_suggestion() (+15 more)

### Community 102 - "Community 102"
Cohesion: 0.1
Nodes (17): Check if Agent Zero is available.                  Returns:             True if, EmbeddingService, Embedding Service =================  Generates audio and metadata embeddings for, Initialize projection layer for fused embeddings., Generate audio embedding from audio file using CLAP.                  Args:, Generate text embedding from track metadata.                  Args:, Generate fused embedding from audio and metadata embeddings.                  If, Create and cache all embeddings for a track.                  Args: (+9 more)
...
Cohesion: 0.14
Nodes (23): Tests for main.py Multica poll-loop helpers., RecordingClient, test_record_blocked_multica_chain_creates_budget_followup_once(), test_record_blocked_multica_chain_creates_iteration_budget_followup(), test_record_blocked_multica_chain_does_not_create_recursive_harness_followup(), test_record_blocked_multica_chain_falls_back_to_classification_and_default(), test_record_blocked_multica_chain_records_terminal_block_metadata(), test_record_blocked_multica_chain_uses_non_terminal_block_reason_without_prefix() (+15 more)
...
Cohesion: 0.12
Nodes (15): Search for k most similar tracks.                  Args:             query: 256-, Search YouTube Music.                  Search works without authentication using, Return mock results when not authenticated., Protocol, FakeMemoryService, FakeRef, test_recall_text_from_results_supports_refs_dicts_and_strings(), test_run_mempalace_baseline_scores_fake_service() (+7 more)
...
Cohesion: 0.08
Nodes (23): check_no_archive_folders(), check_no_databases_in_git(), check_no_duplicate_configs(), check_no_root_tests(), check_no_temp_files(), check_no_venv_in_git(), check_required_docs(), check_root_md_files() (+15 more)
...
Cohesion: 0.1
Nodes (21): Register a Tier 2 slow-loop trigger., register_trigger(), Use Hermes for foreground voice escalation; OpenClaw is manual-only., _run_hermes_voice_escalation(), hermes_api_key(), hermes_auth_headers(), hermes_bin(), Shared Hermes helpers (gateway auth, CLI paths, repo root). (+13 more)

### Community 129 - "Community 129"
Cohesion: 0.09
Nodes (18): Initialize Agent Zero client.                  Args:             base_url: Base, Initialize safety guardrails.                  Args:             mode: Safety mo, Load active sessions from database on startup, Initialize the affinity engine.                  Args:             half_life_day, Initialize the AirPlay service, Initialize the audio analyzer with Essentia., Initialize the auth manager.                  Args:             encryption_key:, Initialize the Cast service (+10 more)
...
Cohesion: 0.11
Nodes (20): AuthResponse, InitialPasswordSetupRequest, login(), login_passcode(), PasswordChangeRequest, Authenticate with username and password          Args:         request: Login cr, Authenticate with username (or user_id) and passcode.      Accepts either ``user, User registration request model (+12 more)
...
Cohesion: 0.26
Nodes (20): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), Zoe Architecture Review, Code Execution Status (+12 more)
...
Cohesion: 0.12
Nodes (13): get_homeassistant_output(), Home Assistant Output Target ============================  Implementation of Out, Get the singleton Home Assistant output instance., get_output_manager(), Output Manager ==============  Central manager for all audio output targets. Han, Get the singleton output manager instance., create_ha_auth_script(), HomeAssistantUser (+5 more)
...
Cohesion: 0.16
Nodes (13): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _append_audit(), _idempotency_key(), MemoryServiceError, Raised for operational failures., Right-to-be-forgotten. Returns number of rows removed., Soft-delete the most recently ingested memory for a user. (+5 more)
...
Cohesion: 0.24
Nodes (10): Output Target Base Class ========================  Abstract base class for all a, Apple Music Provider ====================  Integration with Apple Music using th, display_name(), ProviderType, Music Provider Base Class =========================  Abstract base class for all, Supported music provider types., supports_streaming(), Spotify Music Provider ======================  Integration with Spotify using sp (+2 more)
...
Cohesion: 0.32
Nodes (8): _broadcast_intent_nav(), _build_calendar_form_props(), _intent_action_form_payload(), Build a panel_show_action_form payload for intents that show an in-place overlay, Broadcast UI actions to the touch panel when an intent is detected.      For act, _build_command(), _parse_date(), _parse_time()
...
Cohesion: 0.52
Nodes (6): Zoe Modular Architecture Complete, MCP Client, ModuleWidgetLoader, WidgetRegistry, Zoe Module CLI, Zoe Music Module
...
## Knowledge Gaps
- **2909 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2904 more)
...
- **Why does `main()` connect `Community 1` to `Community 130`, `Community 131`, `Community 5`, `Community 6`, `Community 135`, `Community 7`, `Community 265`, `Community 266`, `Community 138`, `Community 140`, `Community 267`, `Community 16`, `Community 17`, `Community 18`, `Community 146`, `Community 22`, `Community 24`, `Community 153`, `Community 282`, `Community 27`, `Community 160`, `Community 34`, `Community 35`, `Community 292`, `Community 165`, `Community 166`, `Community 301`, `Community 302`, `Community 178`, `Community 307`, `Community 59`, `Community 316`, `Community 60`, `Community 191`, `Community 192`, `Community 193`, `Community 65`, `Community 197`, `Community 71`, `Community 72`, `Community 329`, `Community 202`, `Community 76`, `Community 77`, `Community 204`, `Community 81`, `Community 82`, `Community 83`, `Community 84`, `Community 214`, `Community 342`, `Community 88`, `Community 89`, `Community 90`, `Community 225`, `Community 226`, `Community 98`, `Community 228`, `Community 229`, `Community 227`, `Community 237`, `Community 117`, `Community 120`, `Community 121`, `Community 250`, `Community 251`, `Community 252`?**
  _High betweenness centrality (0.187) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 65` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 133`, `Community 6`, `Community 7`, `Community 5`, `Community 258`, `Community 10`, `Community 131`, `Community 140`, `Community 269`, `Community 14`, `Community 17`, `Community 18`, `Community 21`, `Community 23`, `Community 279`, `Community 26`, `Community 34`, `Community 35`, `Community 37`, `Community 41`, `Community 43`, `Community 45`, `Community 176`, `Community 49`, `Community 178`, `Community 55`, `Community 57`, `Community 58`, `Community 316`, `Community 60`, `Community 67`, `Community 195`, `Community 73`, `Community 202`, `Community 78`, `Community 82`, `Community 87`, `Community 216`, `Community 217`, `Community 96`, `Community 226`, `Community 98`, `Community 105`, `Community 234`, `Community 110`, `Community 244`, `Community 249`, `Community 122`, `Community 123`, `Community 125`, `Community 254`, `Community 255`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 27` to `Community 32`, `Community 248`, `Community 192`, `Community 3`, `Community 4`, `Community 1`, `Community 99`, `Community 8`, `Community 19`, `Community 120`, `Community 254`?**
