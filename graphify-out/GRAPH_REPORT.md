...
## Summary
- 8031 nodes · 14103 edges · 600 communities (359 shown, 241 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1944 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7a51714f`
...
- `Moltbot + Zoe + Agent Zero Architecture` --conceptually_related_to--> `MemAgent (Memory Agent)`  [INFERRED]
  docs/architecture/MOLTBOT_ZOE_AGENT_ZERO_ARCHITECTURE.md → services/zoe-core/mem_agent_client.py

## Communities (600 total, 241 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (89): Main optimization function, Analyze a single database and return schema information, Main analysis function, Run comprehensive audit, _active_memory_files(), _assert_hindsight_policy(), _fail(), _is_allowed_line() (+81 more)
...
Cohesion: 0.06
Nodes (76): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Validate database structure, Enum, Run all validations.                  Returns:             True if all validatio, OutputState, OutputType (+68 more)
...
Cohesion: 0.04
Nodes (60): _build_hermes_payload(), _build_panel_intent_card(), chat_stream_generator(), _chatgpt_connect_flow(), _check_frustration(), _create_pending_approval(), _detect_preview_urls(), _ensure_user_and_chat_session() (+52 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (72): _should_supersede_voice_weather_action(), _FakeAdapter, A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., KanbanAdapter with the CLI replaced by a scripted recorder., _row(), test_dispatch_blocks_existing_pr_revision_when_precheckout_fails(), test_dispatch_blocks_on_first_worker_failure(), test_dispatch_blocks_regular_worktree_failures_with_generic_reason() (+64 more)
...
Cohesion: 0.05
Nodes (61): _broadcast_calendar_chat_prefill_ui(), _broadcast_shopping_chat_ui(), chatgpt_auth_status(), _env_int(), _get_faster_whisper_model(), _get_kokoro_instance(), get_livekit_token(), _has_espeak_ng() (+53 more)
...
Cohesion: 0.09
Nodes (26): Create a multi-step plan for a task.                  Args:             task: Ta, plan(), Planning endpoint - creates multi-step plans.          Uses Agent Zero to:, test_enabled_status_includes_embedding_config(), test_operation_status_gets_hindsight_operation_endpoint(), test_recall_posts_trace_enabled_request(), test_request_wraps_non_json_response(), test_retain_payload_refuses_when_disabled() (+18 more)
...
Cohesion: 0.07
Nodes (26): create_user(), Create new user (admin only)          Args:         request: User creation detai, change_password(), Change current user's password          Args:         request: Current and new p, AuthManager, AuthValidationResult, Verify user password                  Args:             user_id: User identifier, Change user password                  Args:             user_id: User identifier (+18 more)
...
Cohesion: 0.08
Nodes (25): Minimal compatibility wrapper so person_extractor works with raw asyncpg., get_db(), FakeCursor, db_compat.py — asyncpg compatibility shim providing an aiosqlite-style cursor AP, Buffered cursor wrapping a list of asyncpg Records., Thin wrapper around asyncpg Connection providing aiosqlite-compatible execute AP, _adapt_params(), AsyncpgCompat (+17 more)
...
Cohesion: 0.09
Nodes (29): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+21 more)
...
Cohesion: 0.1
Nodes (27): addFeedItem(), applyStats(), autoEndSession(), bumpStat(), clearHostSession(), confirmEndSession(), connectWS(), endSpeedDating() (+19 more)
...
Cohesion: 0.13
Nodes (27): attachCardActions(), buildActionButtons(), buildMatchCard(), hideSDTimerOverlay(), hideSpeedDatingBanner(), loadMatches(), loadPendingConnections(), metPeople (+19 more)
...
Cohesion: 0.11
Nodes (25): get_pending_notifications(), list_notifications(), mark_read(), FastAPI router for notifications. Mounted at prefix="/api/notifications" with ta, Mark a notification as read/delivered., Delete a notification., List notifications for the current user., Get unread/pending notifications count and items. (+17 more)
...
Cohesion: 0.18
Nodes (23): test_all_proposal_evidence_refs_get_relationship_edges(), test_failed_proposal_outcome_builds_failure_memory_event(), test_failed_proposal_requires_failed_or_blocked_trace(), test_latest_trace_content_uses_created_at_not_input_order_and_conservative_confidence(), test_missing_trace_confidence_defaults_to_neutral_memory_confidence(), test_non_terminal_proposal_cannot_create_outcome_memory(), test_outcome_memory_requires_user_scope(), test_retired_proposal_outcome_builds_capability_memory_event() (+15 more)
...
Cohesion: 0.08
Nodes (20): Test code execution service directly, Test search_tools function, Test MCP tool execution via code, Test chat router's code execution integration, test_chat_router_code_execution(), test_code_execution_service(), test_mcp_tool_via_code(), Test File Migration - November 16, 2025 (+12 more)

### Community 105 - "Community 105"
Cohesion: 0.21
Nodes (23): acquire_lock(), analyze_result(), _append_progress(), _diff_changed_lines(), _diff_files(), _finding_hash(), GuardError, GuardPacket (+15 more)
...
Cohesion: 0.11
Nodes (16): generate(), Orbit icebreaker engine — rule cascade, strongest signal wins., Generate the best icebreaker line for a match pair., get_enabled_modules(), MCP Client, ModuleWidgetLoader, WidgetRegistry, Zoe Module CLI (+8 more)
...
Cohesion: 0.15
Nodes (16): test_event_to_hindsight_item_keeps_evidence_and_scope_tags(), test_event_to_hindsight_item_serializes_structured_context_as_json(), test_retain_payload_posts_pre_admitted_payload_without_auto_retain(), _compact_context(), _embeddings_base_url_from_env(), _env_bool(), event_to_hindsight_item(), from_env() (+8 more)
...
Cohesion: 0.1
Nodes (17): Initialize Agent Zero client.                  Args:             base_url: Base, Initialize safety guardrails.                  Args:             mode: Safety mo, Load active sessions from database on startup, Initialize the affinity engine.                  Args:             half_life_day, Initialize the AirPlay service, Initialize the audio analyzer with Essentia., Initialize the auth manager.                  Args:             encryption_key:, Initialize the Cast service (+9 more)
...
Cohesion: 0.16
Nodes (16): DESIRE_LABELS, getMyCheckinId(), goDiscover(), INTENT_LABELS, load(), loadQuiz(), pathParts, renderCompatibility() (+8 more)

### Community 143 - "Community 143"
Cohesion: 0.15
Nodes (18): _extract_memory_candidates(), _persist_memory_candidates(), Back-compat shim: legacy dict shape over the unified extractor.      Kept so in-, Single post-turn memory hook.      Runs two passes in parallel:     1. Regex ext, test_extracts_preference_signal(), test_no_signal_returns_empty(), LLM fact extraction on a single conversation exchange.      Runs in the backgrou, run_turn_digest() (+10 more)

### Community 144 - "Community 144"
Cohesion: 0.17
Nodes (19): _base_ref(), ensure_worktree(), _extract_pr_number(), kanban_db_path(), pin_kanban_workspace(), prepare_existing_pr_revision_worktree(), prepare_kanban_worktree(), Bootstrap git worktrees for Hermes Kanban implement/verify phases. (+11 more)

### Community 145 - "Community 145"
Cohesion: 0.11
Nodes (12): check_api_endpoints(), check_router_expectations(), check_ui_pages(), Check database table schemas, Check what routers expect vs what database has, Test critical API endpoints, Audit PROJECT_ROOT root, Audit all service directories (+4 more)
...
Cohesion: 0.13
Nodes (20): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), Zoe Architecture Review, Code Execution Testing Results (+12 more)
...
Cohesion: 0.17
Nodes (15): _deep_sleep_pass(), _extract_concept_tags(), _extract_open_loops(), _promotion_score(), LLM-driven nightly memory digest.  Reads today's chat messages for a user, promp, Extract open loops from recent messages and store in open_loops table.      An o, Run the full dreaming cycle for a user.      Called by nightly-training-cycle.sh, Use Gemma to extract concept tags from a fact. Returns [] on failure. (+7 more)
...
Cohesion: 0.14
Nodes (11): Check a single router file for authentication issues.     Returns list of (line_, check_file(), Check a single file for hardcoded database paths, Audit a directory against rules, Check a single file against rules, find_references(), load_critical_files(), Load critical files manifest (+3 more)

### Community 210 - "Community 210"
Cohesion: 0.25
Nodes (14): Service Health Fixes, test_embedding_probe_health_url_for_openai_compatible_base(), test_service_health_reports_malformed_json_as_unhealthy(), _elapsed_ms(), _candidate_local_model_paths(), _dedupe_paths(), _embedding_snapshot(), _health_url() (+6 more)
...
Cohesion: 0.16
Nodes (14): _actionable_greptile_findings(), assess_merge_readiness(), _ci_status_from_rollup(), _gh_mergeable_state(), _gh_unresolved_review_thread_count(), _greptile_confidence_from_github_comments(), merge_pr_when_ready(), _parse_gh_json() (+6 more)
...
Cohesion: 0.15
Nodes (14): Manually trigger the LLM memory digest for a user (or the requesting user)., Manually trigger full nightly dreaming cycle including evolution notice (admin o, trigger_memory_digest(), trigger_run_digest(), _emotional_memory_pass(), _extract_facts_with_gemma(), _load_todays_messages(), Extract facts from today's chat history and write to MemPalace + memory_items. (+6 more)
...
Cohesion: 0.16
Nodes (6): Health check endpoint.          Returns service health and Agent Zero availabili, health(), Submit an evidence-backed event to Hindsight.          By default this refuses t, Submit a pre-admitted retain payload to Hindsight.          This method delibera, Fetch a Hindsight async operation status., Poll a Hindsight async operation until it completes, fails, or times out.
...
Cohesion: 0.24
Nodes (10): test_approved_evolution_outcome_does_not_write_when_hindsight_disabled(), test_approved_evolution_outcome_retains_exact_hindsight_payload(), test_failed_evolution_outcome_stays_blocked_and_unexecuted(), test_retain_admitted_evolution_outcome_refuses_pending_admission(), test_wrapper_returns_non_write_result_for_pending_admission(), evaluate_and_retain_evolution_outcome_in_hindsight(), Execute admitted Zoe evolution outcome memory through Hindsight.  This is the du, Retain an already-evaluated evolution outcome when admission approves it. (+2 more)
...
Cohesion: 0.22
Nodes (8): Convert Apple Music artist data to Artist., Search for artists on Apple Music., Artist, Unified artist representation., search_artists(), Convert Spotify artist data to Artist., Search for artists on Spotify., Convert provider-specific artist data to Artist dataclass.
...
Cohesion: 0.25
Nodes (8): Action Plan Progress Report, API Versioning Strategy, Database Table: list_items, Database Table: lists, Default Lists (IDs 1-4), Frontend lists.html, GET /api/lists/{list_type} Endpoint, User Isolation Audit & Fix Report
...
Cohesion: 0.33
Nodes (6): Chat Model Fix - GPU Allocation Error, Chat Performance Fix, GPU Model Setup: gemma3n-e2b-gpu:latest, LiteLLM Gateway Integration, RouteLLM & LiteLLM Status, System Test Results
...
Cohesion: 0.5
Nodes (5): homeassistant-mcp-bridge Service, homeassistant Service, zoe-auth Service, zoe-database Service, zoe-ui Service
...
Cohesion: 0.4
Nodes (5): Desktop Dashboard Fixes Complete, Touch Dashboard Drag & Drop Fix, Touch Dashboard Floating Action Button Edit Mode, Touch Dashboard Navigation Bar Upgrade, Touch Dashboard Widget Persistence Fix

### Community 336 - "Community 336"
Cohesion: 0.4
Nodes (5): Architecture Protection System, Zoe Code Execution with MCP Implementation, LLM Capabilities Audit in chat.py, Expert Orchestrator in cross_agent_collaboration.py, Prompt Templates for LLM Capabilities
...
Cohesion: 0.5
Nodes (4): AG-UI Protocol Implementation Status, AG-UI Chat Protocol for Zoe, Backend chat.py Router, Frontend chat.html

### Community 350 - "Community 350"
Cohesion: 0.5
Nodes (4): Lists & Calendar Page Errors Fix, Fixed list_items Table Schema, Updated lists.py Router, Fixed lists Table Schema
...
Cohesion: 0.67
Nodes (3): PWA Manifest and Service Worker, PWA Service Worker (sw.js), PWA Service Worker Registration

## Knowledge Gaps
- **2944 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2939 more)
...
- **Why does `main()` connect `Community 0` to `Community 257`, `Community 259`, `Community 4`, `Community 262`, `Community 135`, `Community 141`, `Community 271`, `Community 145`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 151`, `Community 154`, `Community 286`, `Community 31`, `Community 32`, `Community 34`, `Community 290`, `Community 162`, `Community 167`, `Community 168`, `Community 298`, `Community 44`, `Community 172`, `Community 174`, `Community 49`, `Community 183`, `Community 58`, `Community 59`, `Community 63`, `Community 65`, `Community 67`, `Community 198`, `Community 199`, `Community 72`, `Community 201`, `Community 202`, `Community 203`, `Community 200`, `Community 332`, `Community 80`, `Community 81`, `Community 210`, `Community 209`, `Community 213`, `Community 85`, `Community 86`, `Community 345`, `Community 222`, `Community 223`, `Community 104`, `Community 105`, `Community 233`, `Community 106`, `Community 235`, `Community 237`, `Community 108`, `Community 250`, `Community 111`, `Community 113`, `Community 236`, `Community 115`, `Community 118`, `Community 121`, `Community 122`?**
  _High betweenness centrality (0.160) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 80` to `Community 0`, `Community 2`, `Community 130`, `Community 4`, `Community 260`, `Community 6`, `Community 135`, `Community 132`, `Community 137`, `Community 134`, `Community 7`, `Community 9`, `Community 269`, `Community 16`, `Community 17`, `Community 145`, `Community 149`, `Community 22`, `Community 21`, `Community 151`, `Community 154`, `Community 31`, `Community 32`, `Community 40`, `Community 42`, `Community 44`, `Community 176`, `Community 49`, `Community 50`, `Community 310`, `Community 55`, `Community 56`, `Community 58`, `Community 59`, `Community 186`, `Community 68`, `Community 69`, `Community 70`, `Community 74`, `Community 76`, `Community 82`, `Community 215`, `Community 220`, `Community 222`, `Community 98`, `Community 102`, `Community 108`, `Community 240`, `Community 113`, `Community 114`, `Community 119`, `Community 122`, `Community 254`, `Community 255`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `get_memory_service()` connect `Community 203` to `Community 0`, `Community 3`, `Community 132`, `Community 134`, `Community 143`, `Community 15`, `Community 275`, `Community 282`, `Community 32`, `Community 33`, `Community 50`, `Community 187`, `Community 188`, `Community 68`, `Community 216`, `Community 218`, `Community 224`, `Community 352`, `Community 96`, `Community 112`, `Community 123`?**
