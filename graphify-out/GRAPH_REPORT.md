...
- `Zoe Observation Trace Collector` --conceptually_related_to--> `Zoe Observation Trace Schema`  [INFERRED]
  services/zoe-data/zoe_observation_trace_collector.py → docs/architecture/zoe-observation-trace-schema.md
...
Cohesion: 0.04
Nodes (96): test_zoe_soul_contains_datetime(), Override to customise the prompt per-check., Local voice session WebSocket for voice.html.      Accepts text and binary (audi, websocket_voice(), _bash(), _build_prompt(), _build_tools(), _build_voice_tools() (+88 more)
...
Cohesion: 0.04
Nodes (74): Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Seek to position in current track., Get device info from database., Get current playback state for a zone (+66 more)
...
Cohesion: 0.05
Nodes (46): Health check endpoint.          Returns service health and Agent Zero availabili, health(), test_enabled_status_includes_embedding_config(), test_event_to_hindsight_item_keeps_evidence_and_scope_tags(), test_event_to_hindsight_item_serializes_structured_context_as_json(), test_operation_status_gets_hindsight_operation_endpoint(), test_recall_posts_trace_enabled_request(), test_recall_uses_user_and_scope_isolated_bank_ids() (+38 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (63): DatabaseValidator, Find all .db files in data directory, Check if file is in a backup/archive location, Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage. (+55 more)
...
Cohesion: 0.04
Nodes (66): AuthResponse, get_current_user(), get_passcode_status(), get_user_profile(), guest_login(), InitialPasswordSetupRequest, login(), login_passcode() (+58 more)
...
Cohesion: 0.04
Nodes (43): Initialize Agent Zero client.                  Args:             base_url: Base, Initialize safety guardrails.                  Args:             mode: Safety mo, Initialize the affinity engine.                  Args:             half_life_day, AirPlayDevice, AirPlayService, AirPlay Integration Service Discovers and controls AirPlay devices for music pla, Start discovering AirPlay devices, Connect to an AirPlay device (+35 more)
...
Cohesion: 0.07
Nodes (43): _promotion_plan(), _source_text(), test_profile_patch_writer_blocks_missing_source_profile(), test_profile_patch_writer_blocks_stale_source_trust_level(), test_profile_patch_writer_blocks_unapplyable_promotion_plan(), test_profile_patch_writer_renders_deterministic_unified_diff(), test_profile_patch_writer_validates_record_and_plan_invariants(), _review_result() (+35 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (46): print_results(), Scan entire project and categorize all files., Check if path should be ignored., Categorize a file and determine if it's in the right location.          Returns:, scan_project(), should_ignore(), Print validation results.          Returns:         Exit code (0 if all files ex, check_root_md_limit() (+38 more)
...
Cohesion: 0.11
Nodes (37): acquire_lock(), _actionable_greptile_findings(), analyze_result(), _append_progress(), assess_merge_readiness(), _ci_status_from_rollup(), _diff_changed_lines(), _diff_files() (+29 more)
...
Cohesion: 0.11
Nodes (31): Create a multi-step plan for a task.                  Args:             task: Ta, plan(), Planning endpoint - creates multi-step plans.          Uses Agent Zero to:, test_profile_promotion_plan_blocks_unclean_review_result(), test_profile_promotion_plan_only_manifests_approved_decisions(), test_capability_trust_review_applies_approved_existing_profile_in_memory(), test_capability_trust_review_applies_approved_profiles_when_other_candidates_are_rejected(), test_capability_trust_review_blocks_stale_current_profile_level() (+23 more)
...
Cohesion: 0.12
Nodes (30): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, OutputState, OutputType, Types of output targets., Playback state of an output. (+22 more)
...
Cohesion: 0.08
Nodes (27): test_block_fingerprint_aborts_after_two_identical(), test_build_scope_split_packet_preserves_worker_reason(), test_explicit_scope_split_is_allowed_from_scout(), test_repeated_scope_split_is_still_implement_only(), block_fingerprint(), build_scope_split_packet(), evidence_kinds(), implement_validator_hash() (+19 more)

### Community 83 - "Community 83"
Cohesion: 0.16
Nodes (26): _retained_outcome(), test_capability_trust_update_candidate_validates_trust_levels(), test_capability_trust_update_candidates_require_retained_verified_outcome(), test_capability_trust_update_metadata_is_read_only_and_serializable(), test_capability_trust_update_skips_trusted_noop_candidate(), _candidate(), _signal(), test_approved_status_requires_approval_gate() (+18 more)
...
Cohesion: 0.22
Nodes (23): _plain_event(), test_admit_hindsight_retain_candidate_requires_event_id(), test_admit_hindsight_retain_candidate_stub_is_pending_and_non_writing(), test_admitted_hindsight_retain_plan_defaults_to_env_config(), test_admitted_hindsight_retain_plan_payload_is_immutable(), test_admitted_hindsight_retain_plan_rejects_mismatched_decision(), test_admitted_hindsight_retain_plan_rejects_pending_decision(), test_admitted_hindsight_retain_plan_rejects_wrong_backend() (+15 more)
...
Cohesion: 0.14
Nodes (18): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _append_audit(), _build_metadata(), _idempotency_key(), MemoryServiceError, _metadata_value(), _promote_event_metadata() (+10 more)
...
Cohesion: 0.17
Nodes (19): _env_float(), _package_info(), _package_snapshot(), Read-only Graphiti runtime compatibility probe for Zoe.  This probe checks wheth, _config_values(), _env_bool_snapshot(), _env_float_snapshot(), GraphitiSidecarProbeResult (+11 more)
...
Cohesion: 0.09
Nodes (23): Browser Cache Fix - Clear Old Broken State, CLEANUP SAFETY RULES - MANDATORY FOR ALL AI ASSISTANTS, CRITICAL FILES - DO NOT DELETE, Database Path Enforcement System, Docker Networking Rules - MANDATORY, Enhanced Enforcement System, Hermes Optimization Playbook, Intent System Development Rules (+15 more)
...
Cohesion: 0.14
Nodes (19): _agent_loop(), _build_room_handlers(), _cooldown_watchdog(), _get_current_user_soft(), livekit_audio(), livekit_cancel(), _make_participant_state(), _mint_agent_token() (+11 more)
...
Cohesion: 0.12
Nodes (17): _collect_audio_stream(), _on_pipeline_done(), _pcm_frames_to_wav(), Concatenate raw int16-LE PCM frames and wrap in a WAV header., Broadcast a JSON data message to all participants in the room., STT → LLM → TTS pipeline, called once end-of-speech is detected., LLM → TTS pipeline for text commands sent over the LiveKit data channel., Background task: run energy VAD on incoming audio frames.      Maintains per-par (+9 more)
...
Cohesion: 0.14
Nodes (10): Search for k most similar tracks.                  Args:             query: 256-, Search YouTube Music.                  Search works without authentication using, Return mock results when not authenticated., FakeMemoryService, FakeRef, test_recall_text_from_results_supports_refs_dicts_and_strings(), test_run_mempalace_baseline_scores_fake_service(), _luhn_valid() (+2 more)
...
Cohesion: 0.22
Nodes (12): Protocol, test_summarize_bakeoff_scores_reports_score_and_latency(), percentile(), Synthetic Hindsight bake-off fixtures and scoring helpers., recall_response_text(), score_recall_response(), score_recall_text(), summarize_bakeoff_scores() (+4 more)
...
Cohesion: 0.31
Nodes (9): Project Changelog, Database Protection Rules, Auto-Generated Module Compose, Zoe Docker Compose Supplemental Modules, Zoe Docker Compose Base, Hardware Compatibility Guide, Zoe Project Structure & Governance Rules, Zoe Quick Start Guide (+1 more)
...
Cohesion: 0.25
Nodes (5): test_percentile_rejects_out_of_range_values(), test_maintenance_runner_imports_real_bakeoff_module(), test_score_recall_response_reports_missing_terms(), test_synthetic_events_validate_and_include_required_cases(), synthetic_retain_payloads()

### Community 282 - "Community 282"
Cohesion: 0.25
Nodes (8): Backend lists.py Router, Data Migration SQL Commands, Database Query in GET /api/lists/{list_type}, Database zoe.db, Default Lists Creation SQL, Frontend Lists Loading Logic, GET /api/lists/{list_type} Endpoint, Response Format Update in GET /api/lists/{list_type}
...
Cohesion: 0.5
Nodes (4): Agent Zero Comparison, Agent Zero Planning, Agent Zero Research, Agent Zero Intent Patterns
...
Cohesion: 0.67
Nodes (3): Journal Widget - Visual Example, Zoe Widget Development Guide, Widget System Quick Start Guide

## Knowledge Gaps
- **2870 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2865 more)
...
- **Why does `main()` connect `Community 1` to `Community 256`, `Community 129`, `Community 3`, `Community 134`, `Community 135`, `Community 136`, `Community 8`, `Community 9`, `Community 271`, `Community 143`, `Community 145`, `Community 21`, `Community 278`, `Community 153`, `Community 26`, `Community 27`, `Community 28`, `Community 157`, `Community 30`, `Community 156`, `Community 164`, `Community 39`, `Community 43`, `Community 302`, `Community 48`, `Community 51`, `Community 311`, `Community 56`, `Community 185`, `Community 186`, `Community 187`, `Community 323`, `Community 195`, `Community 198`, `Community 73`, `Community 74`, `Community 77`, `Community 205`, `Community 206`, `Community 80`, `Community 81`, `Community 84`, `Community 214`, `Community 86`, `Community 88`, `Community 215`, `Community 216`, `Community 217`, `Community 92`, `Community 94`, `Community 224`, `Community 225`, `Community 226`, `Community 106`, `Community 235`, `Community 109`, `Community 113`, `Community 242`, `Community 241`, `Community 243`, `Community 117`, `Community 121`, `Community 122`, `Community 125`?**
  _High betweenness centrality (0.224) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 109` to `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 135`, `Community 136`, `Community 9`, `Community 8`, `Community 139`, `Community 134`, `Community 13`, `Community 17`, `Community 274`, `Community 146`, `Community 23`, `Community 25`, `Community 281`, `Community 27`, `Community 28`, `Community 29`, `Community 31`, `Community 163`, `Community 36`, `Community 37`, `Community 39`, `Community 43`, `Community 302`, `Community 47`, `Community 51`, `Community 308`, `Community 56`, `Community 58`, `Community 59`, `Community 60`, `Community 189`, `Community 68`, `Community 198`, `Community 73`, `Community 75`, `Community 76`, `Community 206`, `Community 208`, `Community 209`, `Community 81`, `Community 83`, `Community 91`, `Community 222`, `Community 101`, `Community 105`, `Community 106`, `Community 234`, `Community 244`, `Community 245`, `Community 246`, `Community 124`, `Community 125`, `Community 254`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 3` to `Community 1`, `Community 2`, `Community 5`, `Community 167`, `Community 41`, `Community 239`, `Community 16`, `Community 244`, `Community 85`, `Community 186`?**
