...
## Summary
- 8134 nodes · 14513 edges · 509 communities (333 shown, 176 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2046 edges (avg confidence: 0.76)
...
- `Zoe Music Module` --conceptually_related_to--> `MCP Client`  [INFERRED]
  modules/zoe-music/README.md → services/zoe-ui/dist/js/lib/mcp-client.js
- `Zoe Music Module` --conceptually_related_to--> `ModuleWidgetLoader`  [INFERRED]
  modules/zoe-music/README.md → services/zoe-ui/dist/js/lib/module-widget-loader.js
- `Zoe Music Module` --conceptually_related_to--> `WidgetRegistry`  [INFERRED]
  modules/zoe-music/README.md → services/zoe-ui/dist/js/lib/widget-registry.js
- `get_reports()` --calls--> `_row_to_dict()`  [INFERRED]
  modules/orbit/main.py → services/zoe-data/routers/lists.py

## Communities (509 total, 176 thin omitted)
...
Cohesion: 0.03
Nodes (111): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, get_auth_manager(), Get the singleton auth manager instance., Get track metadata from cache., Get or create a YTMusic client for a user.                  Args:             us, Check if user has valid YouTube Music authentication., Normalize a YouTube Music item to standard format. (+103 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (73): MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker., Play previous track (from history). (+65 more)
...
Cohesion: 0.04
Nodes (97): Override to customise the prompt per-check., Resolve a browser session_id to a user_id via zoe-auth HTTP.      Calls the same, Local voice session WebSocket for voice.html.      Accepts text and binary (audi, _resolve_ws_user(), websocket_voice(), _bash(), _build_memory_context(), _build_prompt() (+89 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (80): _build_hermes_payload(), _build_panel_intent_card(), _build_research_package(), _capture_research_screenshot(), chat_inject_background(), chat_stream_generator(), _chatgpt_connect_flow(), _check_frustration() (+72 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (80): _event(), _plain_event(), test_admit_hindsight_retain_candidate_requires_event_id(), test_admit_hindsight_retain_candidate_stub_is_pending_and_non_writing(), test_admitted_hindsight_retain_plan_defaults_to_env_config(), test_admitted_hindsight_retain_plan_payload_is_immutable(), test_admitted_hindsight_retain_plan_rejects_mismatched_decision(), test_admitted_hindsight_retain_plan_rejects_pending_decision() (+72 more)
...
Cohesion: 0.04
Nodes (75): _should_supersede_voice_weather_action(), _FakeAdapter, A Kanban list row shaped like the real CLI: body marker, NO idempotency_key., KanbanAdapter with the CLI replaced by a scripted recorder., _row(), test_dispatch_blocks_existing_pr_revision_when_precheckout_fails(), test_dispatch_blocks_on_first_worker_failure(), test_dispatch_blocks_regular_worktree_failures_with_generic_reason() (+67 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (47): BaseHTTPRequestHandler, get_hermes_model_profiles(), _hermes_profile_error(), post_hermes_model_profiles_apply(), post_hermes_model_profiles_rollback(), post_hermes_model_profiles_validate(), put_hermes_model_profiles_draft(), _HealthHandler (+39 more)
...
Cohesion: 0.03
Nodes (68): a2a_task_result(), a2a_task_stream(), _A2ATaskRequest, agent_card(), board_cancel(), board_review(), _build_agent_card(), build_engineering_guard_packet() (+60 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (63): Start discovering AirPlay devices, Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Get device info from database., Get current playback state for a zone (+55 more)
...
Cohesion: 0.08
Nodes (58): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Enum, OutputState, OutputType, Types of output targets., Playback state of an output. (+50 more)

### Community 19 - "Community 19"
Cohesion: 0.04
Nodes (42): Initialize Agent Zero client.                  Args:             base_url: Base, Initialize safety guardrails.                  Args:             mode: Safety mo, Initialize the affinity engine.                  Args:             half_life_day, Initialize the AirPlay service, Initialize the audio analyzer with Essentia., Initialize the auth manager.                  Args:             encryption_key:, Initialize the Cast service, Initialize the event tracker and ensure tables exist. (+34 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (42): Get all active sessions for a specific user (admin only)          Args:, get_user_sessions(), Refresh current session expiration          Args:         current_session: Curre, Get all active sessions for current user          Args:         current_session:, refresh_session(), EnhancedSessionManager, get_config(), Enhanced Session Management for Multi-Factor Authentication Supports different s (+34 more)
...
Cohesion: 0.05
Nodes (38): demo_action_execution(), demo_complex_queries(), demo_memory_storage(), Demo: Action execution (lists, calendar, etc.), Send a chat message to Zoe, Demo: Complex queries requiring reasoning, Demo: P0-2 Confidence formatting, Verify that a fact was stored in memory (+30 more)
...
Cohesion: 0.07
Nodes (39): DatabaseValidator, Find all .db files in data directory, Check if file is in a backup/archive location, Validate database structure, IntentValidator, Validate a single YAML file.                  Returns:             (success, int, Check that handlers are registered for all intents., Check pattern quality and coverage. (+31 more)
...
Cohesion: 0.1
Nodes (36): _promotion_plan(), _source_text(), test_profile_patch_writer_blocks_missing_source_profile(), test_profile_patch_writer_blocks_stale_source_trust_level(), test_profile_patch_writer_blocks_unapplyable_promotion_plan(), test_profile_patch_writer_renders_deterministic_unified_diff(), test_profile_patch_writer_validates_record_and_plan_invariants(), _review_result() (+28 more)
...
Cohesion: 0.07
Nodes (32): ABC, MusicProvider, AirPlay Output Target =====================  Implementation of OutputTarget for, is_initialized(), output_type(), Output Target Base Class ========================  Abstract base class for all a, Abstract base class for audio output targets.          All output implementation, Chromecast Output Target ========================  Implementation of OutputTarge (+24 more)
...
Cohesion: 0.11
Nodes (21): Get a specific provider by type.                  Args:             provider_typ, _get(), Return Atomic semantic hits as normalized records., _build_metadata(), _memory_status_visible(), _memory_visible_to_user(), MemoryRef, _metadata_value() (+13 more)
...
Cohesion: 0.07
Nodes (26): generate_report(), Generate audit report, Generate final audit report, Scan a single file for database references, Recursively scan directory for database references, Print formatted audit report, Print validation report, Generate cleanup report (+18 more)
...
Cohesion: 0.11
Nodes (26): BaseHTTPMiddleware, check(), What a trigger wants to send., TriggerResult, EveningWindDownTrigger, Evening wind-down trigger — journal prompt if user hasn't written in 3+ days., Fire once per week on Friday at 6pm local time., MorningCheckInTrigger (+18 more)
...
Cohesion: 0.11
Nodes (19): Create a person, run process_text → verify DB activity row AND MemPalace entry., recalc_and_save updates health_score in DB., Minimal compatibility wrapper so person_extractor works with raw asyncpg., test_health_score_recalc(), test_person_extractor_dual_fanout(), get_db(), db_compat.py — asyncpg compatibility shim providing an aiosqlite-style cursor AP, Thin wrapper around asyncpg Connection providing aiosqlite-compatible execute AP (+11 more)
...
Cohesion: 0.1
Nodes (21): Browser Cache Fix - Clear Old Broken State, CLEANUP SAFETY RULES - MANDATORY FOR ALL AI ASSISTANTS, CRITICAL FILES - DO NOT DELETE, Database Path Enforcement System, Disk Space Protection System, Disk Space Protection - Implementation Complete Summary, Enhanced Enforcement System, Intent System Development Rules (+13 more)

### Community 140 - "Community 140"
Cohesion: 0.15
Nodes (16): _retained_outcome(), test_capability_trust_update_blocks_failed_proposal(), test_capability_trust_update_blocks_unretained_outcome(), test_capability_trust_update_candidate_validates_trust_levels(), test_capability_trust_update_candidates_require_retained_verified_outcome(), test_capability_trust_update_metadata_is_read_only_and_serializable(), build_capability_trust_update_plan(), _evidence_refs() (+8 more)
...
Cohesion: 0.19
Nodes (16): _package_info(), _package_snapshot(), Read-only Graphiti runtime compatibility probe for Zoe.  This probe checks wheth, _config_values(), _env_bool_snapshot(), _env_float_snapshot(), _env_int_snapshot(), _matching_lines() (+8 more)

### Community 143 - "Community 143"
Cohesion: 0.12
Nodes (18): accept_pending_suggestion(), dismiss_pending_suggestion(), list_pending_suggestions(), list_schedules(), Proactive Engine REST router.  Endpoints:   POST   /api/proactive/schedule, List unresolved save offers for the current chat session., Execute a pending save offer (direct API — no intent re-parse)., List pending scheduled nudges for the calling user. (+10 more)
...
Cohesion: 0.16
Nodes (18): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), Zoe Architecture Review, Code Execution Testing Results (+10 more)
...
Cohesion: 0.15
Nodes (15): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, _append_audit(), MemoryServiceError, Raised for operational failures., Fast metadata-filter read for system prompt injection., Right-to-be-forgotten. Returns number of rows removed., Full JSON dump for GDPR-style export. (+7 more)
...
Cohesion: 0.25
Nodes (8): Zoe Modular Architecture Complete, MCP Client, ModuleWidgetLoader, WidgetRegistry, Zoe Module CLI, Zoe Music Docker Compose Module, Music Intents, Zoe Music Module
...
Cohesion: 0.22
Nodes (9): MCP-Only Architecture for Zoe Modules, Music Module Migration Guide, Module Intent Auto-Discovery System Complete, Music Module Dependency Audit, Music Module Extraction Execution Plan, Music Routing Options Detailed Breakdown, Music Module Test Results, Zoe Music Module System Complete (+1 more)
...
Cohesion: 0.43
Nodes (8): Database Protection Rules, Jetson Docker Compose Override, Supplemental Docker Compose Modules, Raspberry Pi Docker Compose Override, Zoe Docker Compose Base, Zoe Project Structure & Governance Rules, Zoe AI Assistant Quick Start, Zoe AI Assistant README
...
### Community 312 - "Community 312"
Cohesion: 0.4
Nodes (5): Docker Networking Rules - MANDATORY, Hermes Optimization Playbook, LiteLLM Gateway - Development Rules & Guidelines, Zoe Operator Runbook, Raspberry Pi Touchscreen Stack (192.168.1.61)
...
Cohesion: 0.4
Nodes (5): Agent Zero Analyze, Agent Zero Compare, Agent Zero Comparison Skill, Agent Zero Planning Skill, Agent Zero Research
...
Cohesion: 0.5
Nodes (3): Invalidate a specific session (user can only invalidate their own sessions), Invalidate specific session, Invalidate session on server and locally
...
## Knowledge Gaps
- **2888 isolated node(s):** `Orbit matching algorithm — weighted multi-factor scoring.`, `Jaccard with intensity weighting — shared high-intensity items score higher.`, `Score personality compatibility using per-trait similarity/complementarity.`, `Compute match score between two checkin dicts. Returns None if incompatible.`, `Return up to n best matches for a checkin from the active pool.` (+2883 more)
...
- **Why does `main()` connect `Community 0` to `Community 256`, `Community 255`, `Community 131`, `Community 10`, `Community 138`, `Community 141`, `Community 142`, `Community 271`, `Community 146`, `Community 20`, `Community 22`, `Community 278`, `Community 279`, `Community 25`, `Community 26`, `Community 27`, `Community 280`, `Community 150`, `Community 154`, `Community 159`, `Community 33`, `Community 34`, `Community 35`, `Community 37`, `Community 44`, `Community 306`, `Community 311`, `Community 186`, `Community 187`, `Community 58`, `Community 189`, `Community 190`, `Community 188`, `Community 69`, `Community 197`, `Community 72`, `Community 73`, `Community 77`, `Community 78`, `Community 79`, `Community 208`, `Community 209`, `Community 82`, `Community 83`, `Community 85`, `Community 87`, `Community 119`, `Community 217`, `Community 218`, `Community 216`, `Community 94`, `Community 95`, `Community 102`, `Community 234`, `Community 108`, `Community 239`, `Community 116`, `Community 254`, `Community 124`, `Community 125`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.228) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 108` to `Community 0`, `Community 4`, `Community 5`, `Community 134`, `Community 6`, `Community 8`, `Community 140`, `Community 13`, `Community 12`, `Community 146`, `Community 23`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 30`, `Community 31`, `Community 32`, `Community 161`, `Community 34`, `Community 35`, `Community 39`, `Community 42`, `Community 44`, `Community 174`, `Community 306`, `Community 51`, `Community 53`, `Community 55`, `Community 56`, `Community 58`, `Community 60`, `Community 189`, `Community 61`, `Community 69`, `Community 200`, `Community 75`, `Community 78`, `Community 79`, `Community 208`, `Community 84`, `Community 91`, `Community 221`, `Community 224`, `Community 105`, `Community 236`, `Community 238`, `Community 110`, `Community 112`, `Community 113`, `Community 244`, `Community 119`, `Community 120`, `Community 251`, `Community 252`, `Community 126`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `get_session()` connect `Community 20` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 8`, `Community 238`, `Community 21`, `Community 88`, `Community 122`, `Community 187`?**
