...
## Summary
- 8224 nodes · 14618 edges · 543 communities (349 shown, 194 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 2071 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e734c0da`
...
- `Zoe Project Structure & Governance Rules` --conceptually_related_to--> `Zoe Module CLI`  [INFERRED]
  PROJECT_STRUCTURE_RULES.md → tools/zoe_module.py
...
Cohesion: 0.04
Nodes (111): Agent Zero Safety Guardrails ============================  Provides safety contr, Safety modes for Agent Zero., SafetyMode, Validate database structure, Enum, Run all validations.                  Returns:             True if all validatio, OutputState, OutputType (+103 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (105): rate_limit(), Create a rate limiting dependency with Redis-based sliding window          Args:, get_auth_manager(), Get the singleton auth manager instance., Get track metadata from cache., Get or create a YTMusic client for a user.                  Args:             us, Check if user has valid YouTube Music authentication., Normalize a YouTube Music item to standard format. (+97 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (64): MCPMusicStateManager, get_event_tracker(), Get the singleton event tracker instance., MediaController, Media Controller ================  Routes playback commands to appropriate devic, Play a track on the target device.                  Args:             track_id:, Lazy load event tracker., Play previous track (from history). (+56 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (84): Start discovering AirPlay devices, Get all discovered AirPlay devices, Get current playback state from an AirPlay device, Get all discovered Chromecast devices, Get a specific device by ID, Get current playback state from a Chromecast, Seek to position in current track., Set playback volume (0-100). (+76 more)
...
Cohesion: 0.05
Nodes (67): _contract(), _load_fixture(), Tests for Zoe card contract validation., test_content_required_fields_are_per_card_type(), test_every_card_type_has_minimal_valid_content(), test_idempotency_key_is_optional_but_not_blank(), test_invalid_card_contract_fixtures_return_actionable_errors(), test_invalid_card_type_is_rejected() (+59 more)
...
Cohesion: 0.04
Nodes (55): _build_hermes_payload(), _build_panel_intent_card(), chat_stream_generator(), _chatgpt_connect_flow(), _check_frustration(), _create_pending_approval(), _ensure_user_and_chat_session(), _hermes_completion() (+47 more)
...
Cohesion: 0.06
Nodes (57): get_memory_router_status(), Read-only status for Zoe's disabled-by-default memory router runtime., _trace(), test_default_chat_route_keeps_hindsight_and_graphiti_off_hot_path(), test_failure_and_fix_queries_route_to_reflective_memory(), test_fast_chat_layers_are_boring_hot_path_only(), test_reflective_route_is_timeout_bounded_candidate_only(), test_sidecar_layers_are_async_enrichment_not_required_for_chat() (+49 more)
...
Cohesion: 0.07
Nodes (42): MULClient, list_projects(), close_stale_autopilot_wrappers(), _fire_autopilot_job(), get_autopilot_triggers(), get_multica_autopilots(), _headers(), _is_configured() (+34 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (54): Override to customise the prompt per-check., _build_prompt(), _cap_tool_result(), _check_fast_response(), _classify_tone(), _context_enhance(), _fire_memory_capture(), _is_hard_query() (+46 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (36): Get all active sessions for a specific user (admin only)          Args:, escalate_session(), get_user_sessions(), Refresh current session expiration          Args:         current_session: Curre, Escalate passcode session to full session with password verification          Ar, Get all active sessions for current user          Args:         current_session:, refresh_session(), EnhancedSessionManager (+28 more)
...
Cohesion: 0.06
Nodes (49): Get user information (without sensitive data), Parse stored auth timestamp strings., hash_secret(), OIDC client registration and secret verification., Exact match only — no wildcards., Insert or update a client. Safe to call on every startup., upsert_client(), validate_redirect_uri() (+41 more)
...
Cohesion: 0.08
Nodes (30): Create a person, run process_text → verify DB activity row AND MemPalace entry., recalc_and_save updates health_score in DB., Minimal compatibility wrapper so person_extractor works with raw asyncpg., test_health_score_recalc(), test_person_extractor_dual_fanout(), get_db(), _NoticeDb, test_measure_phase_treats_contract_target_patterns_as_no_patterns() (+22 more)
...
Cohesion: 0.07
Nodes (39): Manually trigger the weekly consolidation pass.      Admin-only when ``user_id``, trigger_memory_consolidation(), _deep_sleep_pass(), _emotional_memory_pass(), _extract_concept_tags(), _extract_facts_with_gemma(), _extract_open_loops(), _is_contradiction() (+31 more)
...
Cohesion: 0.08
Nodes (36): create_event(), delete_event(), _enforce_calendar_read_access(), get_event(), list_events(), list_today_events(), FastAPI router for calendar events. Mounted at prefix="/api/calendar" with tag ", Get a single event by ID. (+28 more)
...
Cohesion: 0.07
Nodes (31): claim_pending(), create_pending(), Helpers for deferred / lazy session creation for proactive notifications.  When, Insert a proactive_pending row and return its id.     The push notification's de, Mark a pending notification as claimed and create a chat session seeded     with, accept_pending_suggestion(), claim_pending_endpoint(), create_schedule() (+23 more)

### Community 61 - "Community 61"
Cohesion: 0.09
Nodes (31): get_pending_notifications(), list_notifications(), mark_read(), FastAPI router for notifications. Mounted at prefix="/api/notifications" with ta, Mark a notification as read/delivered., Delete a notification., List notifications for the current user., Get unread/pending notifications count and items. (+23 more)

### Community 62 - "Community 62"
Cohesion: 0.09
Nodes (32): board_approve(), create_engineering_workflow_task(), evolution_proposal_action(), get_agent_board(), list_engineering_workflow_tasks(), Return Multica engineering ticket state for AG-UI display.      Falls back grace, Create a Hermes-assigned Multica issue and dispatch it via the executor seam., Act on an evolution proposal: approve|reject|defer.      On approve: creates a M (+24 more)

### Community 63 - "Community 63"
Cohesion: 0.11
Nodes (17): Return Atomic semantic hits as normalized records., _memory_status_visible(), _memory_visible_to_user(), MemoryRef, MemoryService - the sole read/write surface for Zoe memory.  This module is the, Archive all MemPalace facts for a given entity (e.g. when a person is deleted)., Opaque reference returned by MemoryService., The sole read/write surface for Zoe memory. (+9 more)
...
Cohesion: 0.09
Nodes (20): disable_passcode(), Disable passcode for current user          Args:         current_session: Curren, PasswordPolicy, Password security policy, PasscodeManager, PasscodeValidationResult, Passcode Authentication System Secure handling of 4-8 digit PIN codes with advan, Verify passcode for user                  Args:             user_id: User identi (+12 more)
...
Cohesion: 0.09
Nodes (23): check_router_expectations(), Check what routers expect vs what database has, migrate_self_entries(), Create self entries for users in the people table, _compute_compatibility(), Compute compatibility score and shared traits between two check-ins., Get all registered providers., test_graphiti_episode_payloads_include_evidence() (+15 more)

### Community 84 - "Community 84"
Cohesion: 0.07
Nodes (30): Browser Cache Fix - Clear Old Broken State, CLEANUP SAFETY RULES - MANDATORY FOR ALL AI ASSISTANTS, CRITICAL FILES - DO NOT DELETE, Database Path Enforcement System, Disk Space Protection System, Disk Space Protection Summary, Docker Networking Rules - MANDATORY, Enhanced Enforcement System (+22 more)
...
Cohesion: 0.09
Nodes (21): _board(), _expected_phases(), _protocol_violation_count(), True when a worker pushed HEAD then got interrupted before PR handoff., Create/record a PR after the worker pushed but lost the terminal handoff., Report aggregate state of a chain by idempotency-key prefix.          Returns {f, Pull a PR URL from the implement/closeout task summaries or comments., Block a task after repeated Hermes protocol violations (silent worker exit). (+13 more)
...
Cohesion: 0.11
Nodes (21): delete_user(), Delete user (admin only)          Args:         user_id: User ID to delete, Exception, _append_audit(), _MissingUserId, Raised when strict mode rejects a tool call with no identity., _build_metadata(), _idempotency_key() (+13 more)
...
Cohesion: 0.12
Nodes (21): test_maintenance_runner_imports_real_bakeoff_module(), test_score_recall_response_reports_missing_terms(), test_summarize_bakeoff_scores_reports_score_and_latency(), test_summarize_recall_latency_ignores_disabled_latencies_in_mixed_run(), test_summarize_recall_latency_marks_disabled_runs_not_measured(), test_summarize_recall_latency_reports_budget_status(), test_summarize_recall_latency_reports_hot_path_eligible(), test_summarize_recall_latency_requires_positive_budget() (+13 more)
...
Cohesion: 0.09
Nodes (19): Initialize Agent Zero client.                  Args:             base_url: Base, Initialize safety guardrails.                  Args:             mode: Safety mo, PasscodePolicy, Passcode security policy configuration, Load active sessions from database on startup, Initialize the affinity engine.                  Args:             half_life_day, Initialize the AirPlay service, Initialize the audio analyzer with Essentia. (+11 more)
...
Cohesion: 0.1
Nodes (17): db_conn(), Integration tests: People CRM — PostgreSQL + MemPalace sync.  Tests the dual fan, All CRM tables must exist., 0007 migration columns must exist on people table., The /api/people/fields route fix: /fields must come before /{person_id} in sourc, Open an asyncpg connection for tests., New people table has circle, health_score, notification_count columns., test_create_person_has_crm_columns() (+9 more)
...
Cohesion: 0.13
Nodes (18): _load_recent_misses(), _load_target_patterns(), _proposal_exists(), evolution_notice.py — Phase 6 of the nightly dreaming cycle.  NOTICE phase of th, Write a user frustration proposal (called from chat.py inline)., Write a user-reported issue proposal (called from intent handler or agent tool)., Load intent miss texts from the last N days., Load target patterns from legacy arrays or proposal contract envelopes. (+10 more)
...
Cohesion: 0.15
Nodes (19): Enhanced MemAgent (Multi-Expert Model), LightRAG (Lightweight RAG System), LiteLLM (Universal LLM API), MemAgent (Memory Agent), RAG Enhancements (Query Expansion, Reranking, Hybrid Search), RouteLLM (Intelligent Model Router), Zoe Architecture Review, Database Consolidation Plan (+11 more)
...
Cohesion: 0.11
Nodes (16): Proactive adapters — thin wrappers that translate external service events into T, get_user_profile(), Get current user profile (alias for /user for UI compatibility)          Args:, Get list of active user profiles for login page.     No authentication required, Executor adapters for Multica-dispatched work.  Multica is the agnostic source o, get_capabilities(), Music Service Module ====================  Platform-aware music system with: - Y, Get music system capabilities for this platform.          Returns:         Dict (+8 more)
...
Cohesion: 0.18
Nodes (15): Tests for panel_* MCP tool definitions and execution paths., _RecordingDb, test_create_evolution_proposal_keeps_contract_when_multica_unconfigured(), test_create_evolution_proposal_stores_contract_snapshot(), test_panel_announce_exists(), test_panel_check_auth_exists(), test_panel_clear_exists(), test_panel_navigate_exists() (+7 more)
...
Cohesion: 0.21
Nodes (14): Zoe Module Generator Configuration, Jetson Docker Compose Override, Supplemental Docker Compose Modules, Raspberry Pi Docker Compose Override, Zoe Docker Compose Base, Hardware Compatibility Guide, Zoe Project Structure & Governance Rules, Zoe AI Assistant README (+6 more)

### Community 218 - "Community 218"
Cohesion: 0.26
Nodes (9): _embeddings_base_url_from_env(), _env_bool(), from_env(), HindsightOfflineConfigError, _is_local_or_private_url(), _positive_count(), Hindsight sidecar adapter for Zoe's memory bake-off.  The adapter is disabled by, Raised when Hindsight config would violate Zoe's offline-only rule. (+1 more)
...
Cohesion: 0.25
Nodes (8): _extract_complete_sentences(), Extract finished sentences from a streaming token buffer., Resolve a browser session_id to a user_id via zoe-auth HTTP.      Calls the same, Resolve voice text to real Skybridge data cards when a supported domain exists., Local voice session WebSocket for voice.html.      Accepts text and binary (audi, _resolve_voice_cards(), _resolve_ws_user(), websocket_voice()
...
Cohesion: 0.29
Nodes (7): Agent Zero Docker Compose Module, Agent Zero Integration - COMPLETE, Agent Zero Live Integration Test Report, Agent Zero Quick Start Guide, Agent Zero Module for Zoe, Agent Zero + Zoe Integration Summary, Agent Zero Integration Test Results
...
Cohesion: 0.33
Nodes (6): Data Migration of Misplaced Items, Database Query in GET /api/lists/{list_type}, Default Lists in Database, GET /api/lists/{list_type} Endpoint, Updated Response Format for Lists API, User Isolation Audit & Fix Report
...
Cohesion: 0.4
Nodes (5): journal.js Widget Implementation, Dashboard HTML, Lists HTML, Quick Journal Widget, Widget Manifest Configuration
...
Cohesion: 0.5
Nodes (4): Chat Model Fix - GPU Allocation Error, GPU Model Setup - gemma3n-e2b-gpu:latest, LiteLLM Gateway Integration, RouteLLM & LiteLLM Status

### Community 350 - "Community 350"
Cohesion: 0.67
Nodes (3): Non-blocking Session Loading Fix, Created manifest.json for PWA, Protocol Handling Fix in Chat

### Community 351 - "Community 351"
Cohesion: 0.67
Nodes (3): AG-UI Protocol Implementation Status, AG-UI Chat Protocol for Zoe, Chat Backend (chat.py)

### Community 352 - "Community 352"
Cohesion: 0.67
Nodes (3): Code Updates in lists.py for Schema Fix, Migration Script migrate_lists_items.py, Lists Database Schema Fix
...
Cohesion: 0.67
Nodes (3): Building Zoe Modules - Developer Guide, Zoe Module Requirements, Security & Architecture Fixes - November 17, 2025
...
- **Why does `main()` connect `Community 1` to `Community 128`, `Community 2`, `Community 132`, `Community 6`, `Community 135`, `Community 263`, `Community 17`, `Community 145`, `Community 147`, `Community 20`, `Community 22`, `Community 278`, `Community 152`, `Community 23`, `Community 24`, `Community 283`, `Community 150`, `Community 25`, `Community 154`, `Community 37`, `Community 167`, `Community 295`, `Community 170`, `Community 172`, `Community 178`, `Community 53`, `Community 54`, `Community 62`, `Community 319`, `Community 192`, `Community 193`, `Community 194`, `Community 67`, `Community 69`, `Community 70`, `Community 71`, `Community 202`, `Community 75`, `Community 78`, `Community 79`, `Community 208`, `Community 82`, `Community 83`, `Community 212`, `Community 85`, `Community 213`, `Community 87`, `Community 88`, `Community 90`, `Community 93`, `Community 94`, `Community 223`, `Community 224`, `Community 225`, `Community 107`, `Community 108`, `Community 239`, `Community 240`, `Community 119`, `Community 248`, `Community 121`, `Community 127`?**
  _High betweenness centrality (0.198) - this node is a cross-community bridge._
- **Why does `list()` connect `Community 83` to `Community 256`, `Community 1`, `Community 2`, `Community 128`, `Community 129`, `Community 5`, `Community 134`, `Community 6`, `Community 261`, `Community 9`, `Community 13`, `Community 15`, `Community 17`, `Community 19`, `Community 20`, `Community 149`, `Community 147`, `Community 23`, `Community 24`, `Community 152`, `Community 150`, `Community 27`, `Community 28`, `Community 39`, `Community 41`, `Community 42`, `Community 45`, `Community 304`, `Community 49`, `Community 52`, `Community 54`, `Community 59`, `Community 62`, `Community 63`, `Community 194`, `Community 68`, `Community 196`, `Community 71`, `Community 77`, `Community 79`, `Community 212`, `Community 88`, `Community 89`, `Community 216`, `Community 92`, `Community 108`, `Community 237`, `Community 112`, `Community 115`, `Community 243`, `Community 246`, `Community 247`, `Community 120`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `_FakeAdapter` connect `Community 0` to `Community 165`, `Community 10`, `Community 206`, `Community 88`, `Community 59`, `Community 125`?**
