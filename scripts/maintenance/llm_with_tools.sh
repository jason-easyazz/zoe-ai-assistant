#!/bin/bash
# Give LLM tools and let it decide everything
...
cat > services/zoe-core/routers/developer_tools.py << 'EOF'
...
cp services/zoe-core/routers/developer_tools.py services/zoe-core/routers/developer.py
docker restart zoe-core

echo "✅ LLM now has tools to run ANY command!"
echo ""
echo "Now you can ask ANYTHING:"
echo "- Check system health"
echo "- What's the CPU temperature?"
echo "- Show network connections"
echo "- Is Redis working?"
echo "- How long has the system been running?"
echo ""
echo "The LLM will figure out what commands to run!"
