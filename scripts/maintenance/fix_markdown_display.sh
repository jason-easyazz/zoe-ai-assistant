#!/bin/bash
# Fix markdown rendering in developer dashboard

echo "🎨 FIXING MARKDOWN DISPLAY"
echo "========================="

cd /home/pi/zoe

# Update the developer.js to properly render markdown
cat > services/zoe-ui/dist/developer/js/markdown_fix.js << 'EOF'
...
cat services/zoe-ui/dist/developer/js/markdown_fix.js >> services/zoe-ui/dist/developer/js/developer.js

echo "✅ Markdown display fixed!"
echo ""
echo "Now refresh the dashboard and you'll see:"
echo "• Proper headers"
echo "• Formatted bullets"
