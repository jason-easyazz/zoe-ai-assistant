#!/bin/bash
# Enable auto-execution in developer chat

echo "🚀 ENABLING AUTO-EXECUTION"
cd /home/pi/zoe

# Create a simple working developer router
cat > services/zoe-core/routers/developer_working.py << 'EOF'
...
cp services/zoe-core/routers/developer_working.py services/zoe-core/routers/developer.py

# Restart
docker restart zoe-core
sleep 10

echo "✅ Auto-execution enabled!"
echo ""
echo "Testing..."
curl -X POST http://localhost:8000/api/developer/chat \
  -H "Content-Type: application/json" \
  -d '{"message": "show docker containers"}' | jq '.'
