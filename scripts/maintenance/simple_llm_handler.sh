#!/bin/bash
# Super simple - let LLM handle everything

echo "🤖 SIMPLE LLM HANDLER"
echo "===================="

cd /home/pi/zoe

cat > services/zoe-core/routers/developer_simple.py << 'EOF'
...
cp services/zoe-core/routers/developer_simple.py services/zoe-core/routers/developer.py
docker restart zoe-core

echo "✅ Done! Now the LLM handles EVERYTHING"
echo ""
echo "No matter what you ask, it gets system data and responds appropriately"
