#!/usr/bin/env python3
"""Post-merge Zoe latency smoke probe.

Measures a small set of user-visible endpoints and compares them with the last
saved baseline. The probe is intentionally light enough for post-merge hooks:
...
DEFAULT_BASELINE = Path.home() / ".cache" / "zoe" / "post_merge_latency_baseline.json"
DEFAULT_RESULTS = Path.home() / ".cache" / "zoe" / "post_merge_latency_last.json"
