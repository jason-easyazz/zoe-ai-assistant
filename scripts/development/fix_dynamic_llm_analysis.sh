#!/bin/bash
# Make the developer chat use LLM to analyze real data, not hardcoded responses

echo "🧠 Fixing Developer Chat - Real LLM Analysis"
echo "============================================"

cd /home/pi/zoe

cat > services/zoe-core/routers/developer_dynamic.py << 'PYTHON'
...
echo "✅ Fixed! Now the LLM analyzes real data"
echo ""
echo "What changed:"
echo "  🧠 LLM receives actual system data"
echo "  📊 Analyzes real metrics, not hardcoded"
echo "  🎯 Provides insights based on what it sees"
echo "  ✨ No more template responses"
echo ""
echo "Try: 'Check system health' - it will analyze real data!"
