...
class ModelBenchmark:
    ...
    async def test_model(self, model_name: str, test_scenario: Dict) -> BenchmarkResult:
        ...
        try:
            ...
            system_prompt = f"""You are Zoe, an AI assistant with warm, direct, proactive continuity.
...
async def main():
    ...
    with open(str(PROJECT_ROOT / "COMPREHENSIVE_BENCHMARK_REPORT.md"), "w") as f:
        f.write(report)
    ...
    print("="*80)
    print(report)
    print("\n📄 Full report saved to: /home/zoe/assistant/COMPREHENSIVE_BENCHMARK_REPORT.md")
